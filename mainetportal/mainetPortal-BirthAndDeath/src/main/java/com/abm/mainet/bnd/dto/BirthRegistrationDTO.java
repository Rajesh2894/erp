...
@JsonSerialize
@JsonDeserialize
public class BirthRegistrationDTO implements Serializable {
	...
	private String cpdRegUnit; 
	private String orgCode;
	private String sex;
	private String birthtype; // cpdRefTypeId
	private String attentionType; // cpdAttntypeId
	private String deliveryMethod; // cpdDelMethId
	...
	private String appDateOfBirth;
	private String appDateOfRegistration;
	private String newDate;
	@JsonIgnore
	private String brDateOfBirth;
	...
	private String birthPlaceType; // brBirthPlaceType
	private String hospital; // hiId
	...
	public String getBrSexMar() {
		return brSexMar;
	}

	public void setBrSexMar(String brSexMar) {
		this.brSexMar = brSexMar;
	}
	...
	public String getCpdRegUnit() {
		return cpdRegUnit;
	}

	public void setCpdRegUnit(String cpdRegUnit) {
	...
	public String getAmountCharges() {
		return amountCharges;
	}

	public void setAmountCharges(String amountCharges) {
	...
	public String getBrDateOfBirth() {
		return brDateOfBirth;
	}

	public void setBrDateOfBirth(String brDateOfBirth) {
		this.brDateOfBirth = brDateOfBirth;
	}

	public String getAppDateOfBirth() {
		return appDateOfBirth;
	}

	public void setAppDateOfBirth(String appDateOfBirth) {
