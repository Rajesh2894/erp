...
public class EstatePropMaster implements Serializable {
    ...
    List<EstatePropDtlMaster> details = new ArrayList<>();

    private List<EstatePropertyAmenityDTO> aminityDTOlist = new ArrayList<EstatePropertyAmenityDTO>();
    private List<EstatePropertyAmenityDTO> facilityDTOlist = new ArrayList<EstatePropertyAmenityDTO>();
    private List<EstatePropertyEventDTO> eventDTOList = new ArrayList<EstatePropertyEventDTO>();
    private List<EstatePropertyShiftDTO> propertyShiftDTOList = new ArrayList<EstatePropertyShiftDTO>();
    ...
    public void setDetails(final List<EstatePropDtlMaster> details) {
    ...
    public void setTotalArea(final Integer totalArea) {
