...
public class MarriageDTO extends RequestDTO implements Serializable {
    ...
    private String hitFrom="PORTAL";//identify punch from
	...
	public String toString() {
		return "MarriageDTO [marId=" + marId + ", applicationId=" + applicationId + ", applicantName=" + applicantName
				...
				+ ", marDate=" + marDate + ", appDate=" + appDate + ", placeMarE=" + placeMarE + ", placeMarR="
				+ placeMarR + ", personalLaw=" + personalLaw + ", priestNameE=" + priestNameE + ", priestNameR="
				+ priestNameR + ", priestAddress=" + priestAddress + ", priestReligion=" + priestReligion
				+ ", priestAge=" + priestAge + ", status=" + status + ", urlParam=" + urlParam + ", orgId=" + orgId
				+ ", createdBy=" + createdBy + ", createdDate=" + createdDate + ", updatedBy=" + updatedBy
				+ ", updatedDate=" + updatedDate + ", lgIpMac=" + lgIpMac + ", lgIpMacUpd=" + lgIpMacUpd + ", serialNo="
				+ serialNo + ", volume=" + volume + ", ward1=" + ward1 + ", ward2=" + ward2 + ", ward3=" + ward3
				+ ", ward4=" + ward4 + ", ward5=" + ward5 + ", ward1Desc=" + ward1Desc + ", ward1RegDesc="
				+ ward1RegDesc + ", ward2Desc=" + ward2Desc + ", ward3Desc=" + ward3Desc + ", ward4Desc=" + ward4Desc
				+ ", ward5Desc=" + ward5Desc + ", applicantDetailDto=" + applicantDetailDto + ", husbandDTO="
				+ husbandDTO + ", wifeDTO=" + wifeDTO + ", witnessDetailsDTO=" + witnessDetailsDTO + ", appointmentDTO="
				+ appointmentDTO + ", noOfCopies=" + noOfCopies + ", urlShortCode=" + urlShortCode + ", uploadMap="
				+ uploadMap + ", noOfWitness=" + noOfWitness + ", errorList=" + errorList + ", hitFrom=" + hitFrom
				+ ", applnCopyTo=" + applnCopyTo + ", smServiceDuration=" + smServiceDuration + "]";
	}
