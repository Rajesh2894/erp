...
public class MarriageRequest implements Serializable {
	...
	public String toString() {
		return "MarriageRequest [orgId=" + orgId + ", serviceId=" + serviceId + ", deptId=" + deptId + ", smShortCode="
				+ smShortCode + ", marId=" + marId + ", applicationId=" + applicationId + ", marriageDate="
				+ marriageDate + ", appDate=" + appDate + ", status=" + status + ", serialNo=" + serialNo
				+ ", husbandId=" + husbandId + ", wifeId=" + wifeId + ", hitFrom=" + hitFrom + ", skdclENVPresent="
				+ skdclENVPresent + "]";
	}
