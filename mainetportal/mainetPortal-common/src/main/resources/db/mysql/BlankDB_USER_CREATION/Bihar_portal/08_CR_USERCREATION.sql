...
(empid,
 ...
 dsgid,
 locid,
 isdeleted,orgid,user_id,lmoddate, 
 empexpiredt,lang_id,lg_ip_mac,
 ...
 '2030-03-31 14:48:54',1,'AMCTP | 192.168.0.150 | 44-87-FC-D2-66-D1',
...
(empid,
 ...
 prompt "Creating Default Employee MBA_CHK"
...
(empid,
 ...
 (select cpd_value from TB_COMPARAM_MAS A, TB_COMPARAM_DET B
 where A.CPM_ID=B.CPM_ID AND cpm_prefix='GEN' and cpd_value='M'),
 'Y',(select gm_id from TB_GROUP_MAST WHERE GR_CODE='GR_CHEKER'));
 commit;
