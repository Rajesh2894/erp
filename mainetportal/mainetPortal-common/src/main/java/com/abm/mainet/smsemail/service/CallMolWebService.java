...
public class CallMolWebService
{
  ...
  public int sendPushSMSHttpsUrlNew(final String username, final String password,final String pushId, final String msgBody, final String mobileNo, final String smsId, final String vendorID, final String senderID, final String flash, final String scheduleDate, final String scheduleTime,String mahaTemplateId) {
    ...
    public int sendPushSMSHttpUrlNew(final String username, final String password,final String pushId, final String msgBody, final String mobileNo, final String smsId, final String vendorID, final String senderID, final String flash, final String scheduleDate, final String scheduleTime,String mahaTemplateId) {
