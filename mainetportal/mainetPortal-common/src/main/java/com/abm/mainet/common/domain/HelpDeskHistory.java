...
public class HelpDeskHistory implements Serializable {
    ...
    public Long getHelpIdH() {
        return helpIdH;
    }

    public void setHelpIdH(Long helpIdH) {
        this.helpIdH = helpIdH;
    }
    ...
    public String[] getPkValues() {
        return new String[] { "AUT", "TB_HELPDESK_MAS_HIST", "HELP_ID_H" };
    }
