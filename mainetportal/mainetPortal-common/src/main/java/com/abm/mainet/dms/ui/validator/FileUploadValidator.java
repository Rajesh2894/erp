package com.abm.mainet.dms.ui.validator;
...
public class FileUploadValidator {
    private static final Logger LOG = Logger.getLogger(FileUploadValidator.class);
    ...
    public static String getFieldLabel(final String field, final String param1[]) {
        return ApplicationSession.getInstance().getMessage(
                MainetConstants.ValidationMessageCode.CLASS_NAME + MainetConstants.operator.DOT + field, new Object[] { param1 });
    }
