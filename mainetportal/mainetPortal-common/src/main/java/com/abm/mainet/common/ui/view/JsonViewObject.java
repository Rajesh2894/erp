package com.abm.mainet.common.ui.view;
...
public final class JsonViewObject implements Serializable {
    ...
    public static JsonViewObject successResult(final String successMessage) {
        ...
        result.setHiddenOtherVal(MainetConstants.BLANK);
        return result;
    }
    ...
    public static JsonViewObject failureResult(final Exception ex) {
        final JsonViewObject result = new JsonViewObject();
    ...
    public static JsonViewObject notAllowableResult(final String message) {
        final JsonViewObject result = new JsonViewObject();
        result.setStatus(false);
