...
public class LoggingAspect {
  ...
  @Around("within(com.abm.mainet.*.*.ui.controller.* || com.abm.mainet.*.*.service.* ||  com.abm.mainet.*.*.dao.* ||  com.abm.mainet.*.*.repository.* ||  com.abm.mainet.*.service.* || com.abm.mainet.*.dao.*|| com.abm.mainet.*.mapper.* || com.abm.mainet.*.repository.* ||  com.abm.mainet.*.model.* || com.abm.mainet.*.validator.* || com.abm.mainet.*.ui.controller.* || com.abm.mainet.*.utility.Utility.java)")
