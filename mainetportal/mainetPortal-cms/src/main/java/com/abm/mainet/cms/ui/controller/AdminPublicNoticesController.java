...
import com.abm.mainet.cms.ui.model.AdminPublicNoticesModel;
 ...
 */
@Controller
@RequestMapping("/PublicNotices.html")
public class AdminPublicNoticesController extends AbstractFormController<AdminPublicNoticesModel> implements Serializable {
    ...
    public ModelAndView index(final HttpServletRequest httpServletRequest) {
        ...
        getModel().setCommonHelpDocs("PublicNotices.html");
        return super.index();
    }

    @RequestMapping(params = "SEARCH_RESULTS_PEN", produces = MainetConstants.URL_EVENT.JSON_APP)
    public @ResponseBody JQGridResponse<PublicNotices> getpublicNoticePen(final HttpServletRequest httpServletRequest,
    ...
    public @ResponseBody JQGridResponse<PublicNotices> getpublicNoticeApp(final HttpServletRequest httpServletRequest,
            @RequestParam final String page, @RequestParam final String rows) {
        String Flag = "Y";
        return getModel().paginate(httpServletRequest, page, rows, getModel().querySearchResults(Flag));
    }
    ...
    public @ResponseBody JQGridResponse<PublicNotices> getpublicNoticeRej(final HttpServletRequest httpServletRequest,
            @RequestParam final String page, @RequestParam final String rows) {
        String Flag = "N";
        return getModel().paginate(httpServletRequest, page, rows, getModel().querySearchResults(Flag));
    }
