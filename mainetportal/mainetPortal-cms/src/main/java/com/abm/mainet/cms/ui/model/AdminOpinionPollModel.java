...
@Component
@Scope("session")
public class AdminOpinionPollModel extends AbstractFormModel {
    private static final long serialVersionUID = 3098893916325519727L;

    @Autowired
    private IAdminOpinionPollService iAdminOpinionPollsService;
    ...
    public List<OpinionPoll> querySearchResults(String Flag) {
        return iAdminOpinionPollsService.getAllOpinionPolls(UserSession.getCurrent().getOrganisation(), Flag);
    }
