 ...
 */
@Controller
@RequestMapping("/SectionDetailsLink.html")
public class SectionDetailsLinkController extends AbstractEntryFormController<SectionDetailsModel> {
	@Autowired
    ...
    @RequestMapping(params = "editLnk", method = { RequestMethod.POST, RequestMethod.GET })
    public ModelAndView editLinkForm(@RequestParam final long rowId,
    ...
    public ModelAndView saveElement(final HttpServletRequest httpServletRequest) {
        ...
        final String realpath = "cache/" + UserSession.getCurrent().getOrganisation().getOrgid();
