...
@Component
@Scope("session")
public class AdminCommitteeFormModel extends AbstractEntryFormModel<ProfileMaster> implements Serializable {

    private static final long serialVersionUID = 1505863566820434713L;
