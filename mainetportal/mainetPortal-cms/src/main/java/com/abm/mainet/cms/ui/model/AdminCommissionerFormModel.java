...
@Component
@Scope("session")
public class AdminCommissionerFormModel extends AbstractEntryFormModel<ProfileMaster> implements Serializable {

    private static final long serialVersionUID = -3772636431764660190L;
    private static final Logger LOG = Logger.getLogger(AdminCommissionerFormModel.class);
    ...
    private String eipHomeImagesPath = UserSession.getCurrent().getOrganisation().getOrgid() + File.separator + date
            + File.separator
            + MainetConstants.DirectoryTree.EIP + File.separator + "HOME_IMAGES" + File.separator + "COMMISSIONER"
