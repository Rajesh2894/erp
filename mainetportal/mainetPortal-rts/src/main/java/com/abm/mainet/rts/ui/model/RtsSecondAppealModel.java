...
public class RtsSecondAppealModel extends AbstractFormModel {

	private static final long serialVersionUID = 1629176542225246240L;
	...
	public boolean saveForm() {
		...
		LookUp lookup = CommonMasterUtility.getValueFromPrefixLookUp("SRTS", "OBJ");// 2nd appeal RTS status
		...
		ObjectionDetailsDto objDto = appeal.saveSecondAppealInObjection(objectionDto);
		this.setObjectionDetailsDto(objDto);
		if (objDto.getObjectionNumber() != null) {
			setSuccessMessage("Second Appeal raised Successfully Application Number : " + objDto.getApmApplicationId()
