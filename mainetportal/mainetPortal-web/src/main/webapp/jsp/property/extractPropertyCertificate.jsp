...
<div class="content">
 ...
 --%>
				...
				<%-- <button type="button" class="btn btn-blue-2" onclick="showConfirmBoxToProceed(this)" id="submitdiv">
				...
				<div class="accordion-toggle padding-top-20">
					...
					<h4 class="panel-title">
						<a data-toggle="collapse" class="collapsed"
							...
							href="#propertyDetailsDiv" tabindex="-1"> <spring:message code="property.Propertydetail"
									...
									<c:when
										...
										<tr class="proDet0" id="proDet0">
											...
											<td><form:input
													...
													class="form-control read" type="text" id="ownerName0" /></td>
											<td><form:input
													path="noDuesCertificateDto.propertyDetails[0].ownerAddress" readonly="true"
													class="form-control read" type="text" id="address0" /></td>
