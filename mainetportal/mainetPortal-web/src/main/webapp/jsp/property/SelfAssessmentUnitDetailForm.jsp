...
<%--                             <th width="9%" class="required-control"><spring:message code="unitdetails.unittype"/></th> --%>
                            ...
                            <th width="15%" class="required-control"><spring:message code="unitdetails.FirstAssessmentDate" text="First Assessment Date"/></th>
                    	...
                    	<tr class="firstUnitRow">
							...
							<td>
								...
								<form:input type="text" path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].assdYearConstruction" class="form-control datepicker2 mandColorClass dateClass" id="yearOfConstruc0" data-rule-required="true" placeholder="DD/MM/YYYY" autocomplete="off" />									
								<span class="input-group-addon"><i class="fa fa-calendar"></i></span></div>
							</td>
							<td>
		 						<div class="input-group"> 
								<form:input type="text" path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].firstAssesmentDate" class="form-control lessthancurrdate mandColorClass dateClass" id="firstAssesmentDate0" data-rule-required="true" placeholder="DD/MM/YYYY" autocomplete="off" />									
								<span class="input-group-addon"><i class="fa fa-calendar"></i></span></div>
							</td>
                            <td> 
							...
							<td width="150"><form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].assdBuildupArea" type="text" class="form-control has2Decimal mandColorClass text-right Autocomplete" id="taxableArea${status.count-1}" data-rule-required="true" onkeypress="return hasAmount(event, this, 15, 2)" onchange="getAmountFormatInDynamic((this),'proAssdBuildupArea')" placeholder="999999.99"/></td>
...
<!-- 			                		</div>  -->
				               		...
				               		<div class="col-sm-4">	
				 						...
				 						<apptags:lookupField
													...
													hasChildLookup="false" hasId="true" showAll="false"
				 									selectOptionLabelCode="Select Occupancy Type" isMandatory="true" hasTableForm="true"/> 
		 							</div>
		 							
		 							
										<%-- <label for="proAssdAnnualRent${status.count-1}" class="col-sm-2 control-label"><spring:message code="property.rent"/></label>	 							
										<div class="col-sm-2">
										<form:input cssClass="form-control text-right Autocomplete"
										...
										<label for="occupierName${status.count-1}" class="col-sm-2 control-label"><spring:message code="unitdetails.OccupierName"/></label> 
 			          		   		<div class="col-sm-4"><form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].occupierName"  class="form-control hasSpecialChara preventSpace Autocomplete" id="occupierName${status.count-1}" /></div>
							...
							cssClass="form-control required-control" showAll="false"  columnWidth="10%"/>
								...
								<%-- <div class="form-group">
 			          				<label for="occupierName${status.count-1}" class="col-sm-2 control-label"><spring:message code="unitdetails.OccupierName"/></label> 
 			          		   		<div class="col-sm-2"><form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].occupierName"  class="form-control hasSpecialChara preventSpace Autocomplete" id="occupierName${status.count-1}" /></div>
			          			</div>	 --%>		
						</div>
			        	 </td>
			         	</tr> 
...
<%-- 		 					<form:hidden path="leastFinYear" id="minYear"/>	 --%>
                        	 ...
                        	 <td>
              					<form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[0].assdUnitNo" type="text" class="form-control text-center unit required-control Disabled" id="unitNo0" value="1" data-rule-required="true" readonly="true" />
              				</td>
							...
							<td>
		 						<div class="input-group"> 
								<form:input type="text" path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[0].assdYearConstruction" class="datepicker2 form-control mandColorClass dateClass" id="yearOfConstruc0" data-rule-required="true" placeholder="DD/MM/YYYY" autocomplete="off" />									
								<span class="input-group-addon"><i class="fa fa-calendar"></i></span></div>
								
							</td>
							<td>
		 						<div class="input-group"> 
								<form:input type="text" path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[0].firstAssesmentDate" class="form-control lessthancurrdate mandColorClass dateClass" id="firstAssesmentDate0" data-rule-required="true" placeholder="DD/MM/YYYY" autocomplete="off" />									
								<span class="input-group-addon"><i class="fa fa-calendar"></i></span></div>
							</td>
                            <td> 
                            	<c:set var="baseLookupCode" value="CSC" />
							...
							<form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[0].assdBuildupArea" type="text" class="form-control has2Decimal mandColorClass text-right Autocomplete" id="taxableArea0" data-rule-required="true" onkeypress="return hasAmount(event, this, 15, 2)" onchange="getAmountFormatInDynamic((this),'proAssdBuildupArea')" placeholder="${area}"/></td>
			               ...
			               <legend class="text-blue-3 text-left"><spring:message code="unitdetails.AdditionalUnitDetails" />
				             ...
				             <div class="addunitdetails0 col-xs-6 col-xs-offset-0 col-md-12">
				             	<div class="form-group" >   
									...
									<form:input cssClass="form-control text-right Autocomplete"
									 ...
									 <label for="occupier-name" class="col-sm-2 control-label "><spring:message code="unitdetails.OccupierName"/></label>
				          		    <div class="col-sm-4"><form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[0].occupierName" type="text" class="form-control Autocomplete hasSpecialChara preventSpace" id="occupierName" /></div>
								...
								<%-- <div class="form-group">
				          		    ...
				          		    <label for="occupier-name" class="col-sm-2 control-label "><spring:message code="unitdetails.OccupierName"/></label>
				          		    <div class="col-sm-2"><form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[0].occupierName" type="text" class="form-control Autocomplete hasSpecialChara preventSpace" id="occupierName" /></div>
...
<div class="panel-collapse collapse in" id="unitSpecificInfo">      
            ...
            <c:forEach items="${command.getLevelData(baseLookupCode)}" var="factor" varStatus="status"><!--Question loop  -->
	            <label class="col-sm-8 control-label" ><spring:message code="property.Is" text="Is "/>${factor.lookUpDesc}  <spring:message  code="property.Applicable" text=" Applicable?"/></label>
			...
			<c:otherwise>					
	            ...
	            <c:forEach items="${command.getLevelData(baseLookupCode)}" var="factor" varStatus="status">
					...
					<label for="Yes" class="radio-inline">	
					<form:radiobutton class="factorSet selectFactor" path="provisionalAssesmentMstDto.proAssfactor[${status.count-1}]" value="Y"  id="Yes"  onchange="showAddInfo('${facCode}','${status.count-1}')"/>
					<spring:message code="unitdetails.Yes"></spring:message></label>
					<label for="No_" class="radio-inline">
					<form:radiobutton class="factorStatus selectFactor" path="provisionalAssesmentMstDto.proAssfactor[${status.count-1}]" value="N"  id="No_"  onchange="showAddInfo('${facCode}','${status.count-1}')"/>
					<spring:message code="Unitdetails.No"></spring:message></label>
					</div>  
