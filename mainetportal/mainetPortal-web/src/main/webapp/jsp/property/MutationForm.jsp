...
<%-- 			<div class="padding-10"><strong><i><spring:message code="property.EnterDetailstosearchproperty" /></i></strong></div> --%>
		 ...
		 <c:if test="${command.isLastAuthorizer() ne true}">
			<div class="form-group">
					...
					<apptags:input labelCode="Enter Property No." path="provisionalAssesmentMstDto.assNo" maxlegnth="16" cssClass="mandColorClass"  isDisabled="${command.getMutationLevelFlag() eq 'A' ? true : false}"></apptags:input>
					<apptags:input labelCode="OLD PID." path="provisionalAssesmentMstDto.assOldpropno" maxlegnth="16" cssClass="mandColorClass"  isDisabled="${command.getMutationLevelFlag() eq 'A' ? true : false}"></apptags:input>	
...
<!------------------------------------------------------------Land Details------------------------------------------------------->
				...
				<div class="panel-collapse collapse in" id="propertyDetail">				
						...
						<div class="form-group">
<%-- 								<apptags:input cssClass="alphaNumeric preventSpace" labelCode="propertydetails.oldpropertyno" path="" maxlegnth="20" isReadonly="true" value="${command.provisionalAssesmentMstDto.assOldpropno}"></apptags:input>				 --%>
								<label class="col-sm-2 control-label"
									for="oldpropertyno"><spring:message code="propertydetails.oldpropertyno" text=""/></label>
								<div class="col-sm-4">									
									<form:input path="" type="text" class="form-control alphaNumeric preventSpace" id="oldpropertyno" disabled="true" value="${command.provisionalAssesmentMstDto.assOldpropno}"/>
								</div>
								<apptags:input cssClass="alphaNumeric preventSpace" labelCode="property.landType" path="provisionalAssesmentMstDto.assLandTypeDesc"  isDisabled="true"></apptags:input>
				...
				<div class="panel-collapse collapse in" id="propertyAddress">
						<div class="form-group">
							...
							<form:input class="form-control"
				 					path="provisionalAssesmentMstDto.locationName" id="location" disabled="true"></form:input>						 	
							</div> 
						</div>
	            		...
	            		<div class="form-group">
							...
							<form:input class="form-control hasPincode"
				 					path="provisionalAssesmentMstDto.assPincode" id="proAssPincode" maxlength="6" disabled="true"></form:input>
			            	</div>
			            </div>
	            </div> 
