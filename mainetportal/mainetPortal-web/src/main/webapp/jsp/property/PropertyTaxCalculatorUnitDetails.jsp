...
<script src="js/property/taxCalculatorFloorDetails.js"></script>
...
<%--                             <th width="9%" class="required-control"><spring:message code="unitdetails.unittype"/></th> --%>
                        	...
                        	<th colspan="2"><a href="javascript:void(0);" title="Add" class="addCF btn btn-blue-2 btn-sm unit" id="addUnitRow"><i class="fa fa-plus-circle"></i></a></th>
                    	...
                    	<tr class="firstUnitRow">
                      		 <td>                                       	
                        	    <form:select path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].faYearId" id="year${status.count-1}" class="form-control text-center mandColorClass displayYearList ">
                        	 ...
                        	 <td>
              					<form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].assdUnitNo" type="text" class="form-control mandColorClass text-center unit required-control" value="1" id="unitNo${status.count-1}" data-rule-required="true" readonly="true" />
              				</td>
...
<%--                             <th width="9%" class="required-control"><spring:message code="unitdetails.unittype"/></th> --%>
                    	...
                    	<tr class="firstUnitRow">
                      		 ...
                      		 <td>     
                        	    <form:select  path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[0].faYearId" id="year0" class="form-control text-center mandColorClass displayYearList" data-rule-required="true">
		  						<form:option value="0" label="Select Year"></form:option>
		  						<c:forEach items="${command.financialYearMap}" var="yearMap">
		  						<form:option value="${yearMap.key}" label="${yearMap.value}"></form:option>
		  						</c:forEach>
...
<div class="panel-collapse collapse in" id="unitSpecificInfo">      
            ...
            <c:forEach items="${command.getLevelData(baseLookupCode)}" var="factor" varStatus="status"><!--Question loop  -->
	            <label class="col-sm-8 control-label" ><spring:message code="" text="Is ${factor.lookUpDesc} Applicable?"/></label>
