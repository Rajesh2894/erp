...
<%--                   		<apptags:input labelCode="propertydetails.csnno" path="provisionalAssesmentMstDto.tppPlotNoCs" isDisabled="true"></apptags:input> --%>
            	...
            	<%--  <div class="form-group">                 
                  		<apptags:input labelCode="propertydetails.surveyno." path="provisionalAssesmentMstDto.tppSurveyNumber" isDisabled="true"></apptags:input>
						<apptags:input labelCode="propertydetails.khatano" path="provisionalAssesmentMstDto.tppKhataNo" isDisabled="true"></apptags:input>
            ...
            <%-- 	<div class="form-group">
            			<apptags:input labelCode="propertydetails.tojino" path="provisionalAssesmentMstDto.tppTojiNo" isDisabled="true"></apptags:input>
            			<apptags:input labelCode="propertydetails.plotno" path="provisionalAssesmentMstDto.tppPlotNo" isDisabled="true"></apptags:input>
            	...
            	<div class="form-group">                 
                  		<apptags:input labelCode="propertydetails.streetno" path="provisionalAssesmentMstDto.assStreetNo" isDisabled="true"></apptags:input>
                  		<apptags:input labelCode="propertydetails.village" path="provisionalAssesmentMstDto.tppVillageMauja" isDisabled="true"></apptags:input>
