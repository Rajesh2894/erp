 ...
 <apptags:breadcrumb></apptags:breadcrumb>
    ...
    <div class="content animated slideInDown"> 
      <div class="widget" id="receipt">
        ...
        <div class="row">
            ...
            <div class="clearfix"></div>
                    ...
                    <div class="col-xs-10 margin-top-10">
                        ...
                        <%-- <p class="margin-top-15"><span class="text-bold"><spring:message code="property.noDues.report.reference" text="Reference"/></span><spring:message code="property.noDues.content2" text=":Application for the No Dues Certificate Application number:"/><span class="text-bold">${command.noDuesCertificateDto.applicationNo}</span><spring:message code="property.noDues.content10" text=",and Application Date:"/><span class="text-bold">${command.date}</span>
                        </p> --%>
                    </div>
          
            		<div class="col-xs-12">
                        <p class="margin-top-15 text-justify"><spring:message code="" text="Dear Applicant"/></p>
                    </div>
                    
                    <div class="col-xs-11 col-xs-offset-1">
                       <p class="margin-top-15 text-justify"><spring:message code="" text="Your Application For "/>&nbsp;<span class="text-bold">${command.serviceName}</span><spring:message code="" text=" Submitted SuccessFully. And Your Application Number is :"/><span class="text-bold">${command.noDuesCertificateDto.applicationNo}</span>&nbsp;<spring:message code="" text=". Please Use it for Future Reference" />&nbsp;</p>
                    </div>
					...
					<div class = "form-group clearfix padding-vertical-15">
							...
							<div class="col-xs-4 text-center">
				              <p><spring:message code="property.report.content9" text="By Order,"/></p>
       ...
       <div class="text-center margin-top-10 buttonDiv">
