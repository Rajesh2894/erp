...
<div class="accordion-toggle">
	...
	<div class="panel-collapse collapse in" id="propertyAddress">
		<div class="form-group">
			...
			<apptags:textArea isMandatory="true" labelCode="property.propertyaddress" path="provisionalAssesmentMstDto.assAddress" maxlegnth="1000" cssClass="preventSpace"></apptags:textArea>
		...
		<div class="col-sm-4">
			<form:input  type="text" class="form-control hasPincode"
				 path="provisionalAssesmentMstDto.assPincode" id="proAssPincode" maxlength="6" data-rule-required="true" data-rule-digits="true" data-rule-minlength="6" data-rule-maxlength="6"></form:input>
		</div>
<%-- 			<apptags:input cssClass="hasemailclass preventSpace" labelCode="property.email" path="provisionalAssesmentMstDto.assEmail" maxlegnth="254" dataRuleEmail="true" ></apptags:input> --%>
		...
		<div class="form-group">
			<div class="col-sm-6">		
				...
				<label for="isCorrespondenceAddressSame" class="radio-inline">
...
<div class="accordion-toggle">
	...
	<div class="panel-collapse collapse in" id="correspondenceAddress">
		...
		<div class="form-group">
			<apptags:textArea labelCode="property.correspondenceaddress" path="provisionalAssesmentMstDto.assCorrAddress" maxlegnth="1000" cssClass="preventSpace"></apptags:textArea>			
