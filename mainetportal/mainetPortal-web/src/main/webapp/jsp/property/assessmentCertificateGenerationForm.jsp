...
<div class="content">
	...
	<div class="widget">
		<div class="widget-header">
			<h2>
				<strong><spring:message code="property.assessment.certificate"
						text="Assessment Certificate" /></strong>
			</h2>
		...
		<div class="widget-content padding">
			...
			<form:form action="AssessmentCertificateGenrator.html"
				...
				<form:hidden path="flatNumber" id="flatNumber" />
				<div
									...
									<c:when
										...
										<tr class="proDet0" id="proDet0">
											...
											<td><form:input
													...
													class="form-control read" type="text" id="ownerName0" readonly="true" /></td>
											<td><form:input
													path="noDuesCertificateDto.propertyDetails[0].ownerAddress"
													class="form-control read" type="text" id="address0" readonly="true" /></td>
				...
				<div class="form-group padding-top-20">
					<apptags:input labelCode="property.no.of.copies" cssClass="required-control hasNumber" isMandatory="true"
							...
							<div class="panel-group accordion-toggle">
								<h4 class="margin-top-0 margin-bottom-10 panel-title">
									<a data-toggle="collapse" href="#a3" tabindex="-1"><spring:message
											code="Document.DocumentAttachment" text="Document Attachment" /></a>
								</h4>
				...
				<c:if
					...
					<div class="text-center padding-top-10">
						...
						<button type="button" class="btn btn-success btn-submit"
							...
							<spring:message code="property.save.application"
