...
#phoW #addPhotoW .fileUpload,
#thumW #addThumbW .fileUpload {
	margin: 0rem;
}
#phoW #removePhotoW,
#thumW #removeThumbW {
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" class=""
							data-parent="#accordion_single_collapse1" href="#WifeDet"tabindex="-1"><spring:message
...
if('${command.applicableENV}' == 'true'){
	//D#128500 finally minor age validation req clear
