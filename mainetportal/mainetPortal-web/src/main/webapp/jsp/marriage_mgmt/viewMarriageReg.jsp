...
<script type="text/javascript">
	$(document).ready(
			function() {
				...
				if ('${command.modeType}' == 'D'&& '${command.modeType}' != undefined) {
					var urlParam = '${command.marriageDTO.urlParam}';
					var hitHref = $('[data-content-param =' + urlParam + ']').attr('href');
					...
					<div class="compalint-error-div">
						...
						<ul class="nav nav-tabs" id="mrmViewParentTab">
							...
							<li id="marriage-tab" class="active"><a data-toggle="tab"
								...
								data-loaded="true"><spring:message code="mrm.tab.marriageDetails" /></a></li>
