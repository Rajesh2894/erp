...
<!-- Start Content here -->
	...
	<div class="widget">
		<div class="widget-header">
			...
			<apptags:helpDoc url="bndApplyForDeathCertificate.html"></apptags:helpDoc>		
			
		</div>

		<div class="widget-content padding">
			<form:form id="frmDeathCertificateForm"
				action="bndApplyForDeathCertificate.html" method="POST"
								...
								<label class="col-sm-2 control-label required-control datePicker"><spring:message
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <c:if test="${command.saveMode ne 'V'}">
                                                ...
                                                <form:input class="form-control datepicker" path="deathCertificateDTO.dateOfDeath" 
                                                    isMandatory="true" id="drDod" disabled="${command.saveMode eq 'V' ? true : false }" />
                                                   </c:if>
						 ...
						 <label class="col-sm-2 control-label required-control"><spring:message
							...
							<div class="col-sm-4">
								<form:input class="form-control hasNumber"
									...
									maxlength="2" onblur="getAmount(this)"></form:input>
							</div> 
