	...
	<div class="content animated top">
		<div class="widget">
			<div class="widget-header">
				<h2>
					<spring:message code="Issuance.birth.certificate" text="Issue Birth Certificate" />
				</h2>
			...
			<div class="widget-content padding" id="ashish1">
				...
				<apptags:input labelCode="BirthRegDto.year" path="birthRegDto.year"
						cssClass="hasNumber form-control required-control" maxlegnth="4" isMandatory="true" >
					</apptags:input>
					<apptags:input labelCode="BirthRegDto.brRegNo"
						path="birthRegDto.brRegNo" cssClass="hasNumClass form-control required-control"
						maxlegnth="20" isMandatory="true" >
					</apptags:input>
                    ...
                    <div class="col-sm-4">
                        <div class="input-group">
                            <form:input path="birthRegDto.brDob" 
                                cssClass="form-control mandColorClass required-control" id="brDob"
                                readonly=""  />
						...
						<table class="table table-striped table-bordered"
							...
							<thead>
								<tr>
									...
									<th width="10%" align="center"><spring:message
											code="BirthRegistrationDTO.pdFathername" text="Father Name" /></th>
									<th width="10%" align="center"><spring:message
											code="BirthRegistrationDTO.pdMothername" text="Mother Name" /></th>
