...
<div class="fade-black">
	...
	<%-- <div class="get-in-touch-main">
		<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
			<div class="heading"><spring:message code="theme4.portal.get.in.touch" text="Get In Touch"/></div>
		</div>
		<div class="cont-us col-xs-6 col-sm-2 col-md-2 col-lg-2">
			 <div class="contents">
				 <a href='CitizenContactUs.html'>
					<div class="img">
						<img src="images/ASCL-images/ascl-contact-us-icon.png" class="img-responsive" alt="Contact Us">
					</div>
					<div class="icon-text">
						<h3><spring:message code="eip.citizen.footer.contactUs" text="Contact Us" /></h3>
					</div>
				</a>
		   </div>
		</div>
		<div class="faq col-xs-6 col-sm-2 col-md-2 col-lg-2">
			<div class="contents">
				<a href='CitizenFAQ.html?getFAQ'>
					<div class="img">
						<img src="images/ASCL-images/ascl-faq-icon.png" class="img-responsive" alt="Faq">
					</div>
					<div class="icon-text">
						<h3><spring:message code="top.faq" text="Faqs"/></h3>
					</div>
				</a>
			</div>
		</div>
	...
	<footer class="clearfix">
		<div class="container">
			<div class="row">
				...
				<div class="footer-links col-sm-12 col-md-6 col-lg-6">
				   <ul>
				      <li>
				...
				<div class="footer-link1 col-sm-12 col-lg-12">
					<ul>
						...
						<li><a href='CitizenFAQ.html?getFAQ' title="Faqs"
							target="_blank"> <spring:message code="top.faq" text="Faqs" />
						</a>
						</li>
					</ul>
				</div>
