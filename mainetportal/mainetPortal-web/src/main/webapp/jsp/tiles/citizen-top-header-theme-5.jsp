										...
										<c:if test="${userSession.employee.emploginname ne 'NOUSER'}" var="user">
											<div class="btn-group">
												<button class="btn-xs dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								                    ...
								                    <strong><spring:message code="eip.citizen.home.welcome" text="Welcome"/>,
								                    	<span>${userSession.employee.empname}&nbsp;${userSession.employee.empLName}</span>
								                    	<%-- <c:set var="profileImageNames" value="<%=request.getSession().getAttribute("profileImageName")%>"/>
								                    	<c:set var = "themeMapVar" value ="<%=com.abm.mainet.common.ui.model.AbstractModel.themeMap%>"/> --%>
								                    	<c:choose>
								                    	<c:when test="${ not empty  profileImageName }">
								                    	<span class="profile-img"><img src="./${profileImageName}" alt="Default Male"/></span>
								                    		
								                    	</c:when>
								                  
								                    	<c:otherwise>
								                    		<!-- <span class="profile-img"><img src="./assets/img/default-male.png" alt="Default Male"/></span> -->
								                    	   <c:choose>
															<c:when
																test="${(not empty userSession.employee.empGender ) and  userSession.employee.empGender eq 'F'}">
...
<header class="site-header after-login">
<nav class="navbar">
				...
				<div class="header-after-login">
				 	<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 "> 
						<div class="brand wow fadeInLeft animated animated" data-wow-duration="1.5s" data-wow-offset="10" style="visibility: visible;-webkit-animation-duration: 1.5s; -moz-animation-duration: 1.5s; animation-duration: 1.5s;">
							...
							<c:if test="${parts[1] eq '1'}">
								<img src="./${parts[0]}" height="56" class="logo-img" alt="Organisation Logo"
					...
					<div class="col-md-3 col-sm-3 col-lg-3 hidden-xs">
						<div class="brand wow fadeInRight animated animated pull-right" data-wow-duration="1.5s" data-wow-offset="10" style="visibility: visible;-webkit-animation-duration: 1.5s; -moz-animation-duration: 1.5s; animation-duration: 1.5s;">
							<%-- <img src="assets/img/national_emblem.png" class="pull-right nat-emblem" alt="National emblem" style="height:56px;"> --%>
							<a href="https://www.uk.gov.in/" target="_blank" class="img-right">
								<img src="images/DSCL-images/Uttarakhand_logo.png" class="img-responsive" alt="Uttarakhand Government Portal">
							</a>
						</div>
					</div>
			 	</div>
