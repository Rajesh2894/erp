...
<c:when test="${ cookie['accessibilityCol'].value =='B' and cookie['accessibility'].value =='Y'}">
	<link href="assets/css/style-accessibility-theme-4.css" rel="stylesheet" type="text/css"  />
	<link href="assets/css/dashboard-theme-4.css" rel="stylesheet" type="text/css"  />
</c:when>
