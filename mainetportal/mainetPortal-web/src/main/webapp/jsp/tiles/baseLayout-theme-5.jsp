...
<link rel="shortcut icon" href="images/DSCL-images/dscl_favicon.ico">
...
<link href="assets/libs/icofont/css/icofont.min.css" rel="stylesheet" type="text/css"/>
<link href="assets/libs/jquery-flipster/css/jquery.flipster.min.css" rel="stylesheet" type="text/css"/>
...
<script src="assets/libs/jquery-flipster/js/jquery.flipster.min.js"></script>
...
<c:when test="${ cookie['accessibilityCol'].value =='B' and cookie['accessibility'].value =='Y'}">
	<link href="assets/css/style-accessibility-theme-5.css" rel="stylesheet" type="text/css"  />
	<link href="assets/css/dashboard-theme-5.css" rel="stylesheet" type="text/css"  />
</c:when>
...
<c:when test="${ cookie['accessibility'].value =='M' or empty cookie['accessibility'].value }">
	...
	<link href="assets/css/dashboard-theme-5.css" rel="stylesheet" type="text/css"  />
	<link href="assets/css/print-theme-5.css" media="print" rel="stylesheet" type="text/css"/>
...
<body provider-email="info@smartcitydehradun.uk.gov.in">
	<div id="text-resize">
...
<!-- JS File For Progress Bar starts -->
<script src="assets/libs/progressbar/progressbar.min.js"></script>
<!-- JS File For Progress Bar ends -->

<!-- JS For Progress Bar starts -->
<%-- <script>
var bar1 = new ProgressBar.Circle('.circle-progress-bar1', {
	strokeWidth: 6,
	easing: 'easeInOut',
	duration: 1400,
	color: '#6ba3ba',
...
var bar2 = new ProgressBar.Circle('.circle-progress-bar2', {
	strokeWidth: 6,
	easing: 'easeInOut',
	duration: 1400,
	color: '#6ba3ba',
...
var bar3 = new ProgressBar.Circle('.circle-progress-bar3', {
	strokeWidth: 6,
	easing: 'easeInOut',
	duration: 1400,
	color: '#6ba3ba',
...
var bar4 = new ProgressBar.Circle('.circle-progress-bar4', {
	strokeWidth: 6,
	easing: 'easeInOut',
	duration: 1400,
	color: '#6ba3ba',
...
bar2.animate(0.95);  // Number from 0.0 to 1.0
bar3.animate(0.95);  // Number from 0.0 to 1.0
bar4.animate(0.95);  // Number from 0.0 to 1.0
