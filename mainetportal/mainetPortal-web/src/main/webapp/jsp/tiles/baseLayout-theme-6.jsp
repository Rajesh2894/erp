...
<c:choose>
	...
	<c:otherwise>
		<title><tiles:insertAttribute name="page-title-reg"/></title>
	</c:otherwise>
</c:choose>
...
<link rel="shortcut icon" href="images/KDMC-images/favicon_kdmc.ico">
...
<link href="assets/libs/rc-brand-slider/css/rc-brand-style.css" rel="stylesheet" type="text/css"/>
<link href="assets/css/style-responsiveLoader.css" rel="stylesheet" />
...
<link href="assets/libs/marquee/css/simple.min.css" rel="stylesheet" type="text/css" />
...
<c:choose>
	<c:when test="${ cookie['accessibilitytextsize'].value =='LGT' }">
		<style media="screen">
			html, body{font-size:99% !important;}
...
<script src="assets/libs/rc-brand-slider/js/jquery.rcbrand.js" ></script>
<script type="text/javascript" src="assets/libs/canvas/jquery.canvasjs.min.js"></script>
...
<script src="assets/libs/marquee/js/jquery.marquee.min.js"></script>
...
<%-- <c:when test="${org_code eq 'KDMC'}">
	...
	<c:choose>
	<c:when test="${ cookie['accessibilityCol'].value =='DG' and cookie['accessibility'].value =='Y'}">
		<link href="assets/css/style-accessibility-theme-6.css" rel="stylesheet" type="text/css"  />
		<link href="assets/css/dashboard-theme-6.css" rel="stylesheet" type="text/css"  />
	</c:when>
	...
	<c:when test="${cookie['accessibilityCol'].value =='DG' and cookie['accessibility'].value =='M'}">
		<link href="assets/css/style-dark-green-theme-6.css" rel="stylesheet" type="text/css"  />
		<link href="assets/css/dashboard-theme-6.css" rel="stylesheet" type="text/css"  />
	</c:when>
	<c:when test="${cookie['accessibilityCol'].value =='G' and cookie['accessibility'].value =='M'}">
		<link href="assets/css/style-green-theme-6.css" rel="stylesheet" type="text/css"  />
		<link href="assets/css/dashboard-theme-6.css" rel="stylesheet" type="text/css"  />
	</c:when>
...
<c:when test="${org_code eq 'SKDCL'}">
	...
	<c:choose>
	<c:when test="${ cookie['accessibilityCol'].value =='B' and cookie['accessibility'].value =='Y'}">
		<link href="assets/css/style-accessibility-theme-2.css" rel="stylesheet" type="text/css"  />
		<link href="assets/css/dashboard-theme-6.css" rel="stylesheet" type="text/css"  />
	</c:when>
	<c:when test="${cookie['accessibilityCol'].value =='O' and cookie['accessibility'].value =='Y'}">
		<link href="assets/css/style-accessibility-theme-2.css" rel="stylesheet" type="text/css"  />
		<link href="assets/css/style-blue-theme-8.css" rel="stylesheet" type="text/css"  />
		<link href="assets/css/dashboard-theme-6.css" rel="stylesheet" type="text/css"  />
	</c:when>
	<c:when test="${cookie['accessibilityCol'].value =='G' and cookie['accessibility'].value =='Y'}">
		<link href="assets/css/style-accessibility-theme-2.css" rel="stylesheet" type="text/css"  />
...
<link href="assets/css/print-theme-6.css" rel="stylesheet" type="text/css"  />
<!-- Leaflet JS Plugin  -->
<link href="assets/libs/esrileaflet/css/leaflet.css" rel="stylesheet" type="text/css"  />
<script src="assets/libs/esrileaflet/js/leaflet.js" ></script>
 <!-- Load Esri Leaflet from CDN -->
  <script src="assets/libs/esrileaflet/js/esri-leaflet.js"></script>
  <script src="assets/libs/esrileaflet/js/esri-leaflet-vector.js"></script>
<!-- End of Leaflet JS Plugin -->
</head>
<noscript>	
...
<body>
	...
	<c:choose>
		<c:when test="${userSession.getCurrent().getOrganisation().getOrgShortNm() eq 'SKDCL'}">			
		...
		<c:otherwise>
			<tiles:insertAttribute name="app-header"/>
			<div class="main-content content-page mainContent container" id="main"><tiles:insertAttribute name="app-body"/> </div> 
			<tiles:insertAttribute name="app-footer"/>
		</c:otherwise>
	</c:choose>
...
<c:choose>
	<c:when test="${org_code eq 'SKDCL' }">
		<script  src="js/eip/citizen/guest-home-skdcl.js"></script> <!-- SKDCL JS -->
	</c:when>
</c:choose>
...
<c:choose>
	...
	<c:otherwise>
		<script src="assets/libs/jquery-datatables/js/jquery.dataTables.mr.min.js"></script>
	</c:otherwise>
</c:choose>
