...
<c:when test="${ cookie['accessibilityCol'].value =='B' and cookie['accessibility'].value =='Y'}">
	<link href="assets/css/style-accessibility.css" rel="stylesheet" type="text/css"  id=""/>
</c:when>
<c:when test="${cookie['accessibilityCol'].value =='O' and cookie['accessibility'].value =='Y'}">
	<link href="assets/css/style-accessibility.css" rel="stylesheet" type="text/css"  id=""/>
</c:when>
...
<%-- 	<div class="col-sm-2 bg-white-1 hidden-sm hidden-md hidden-xs hidden-xs"><div class="row"><tiles:insertAttribute name="side-menu"/></div></div>
 --%>	<!-- <div class="col-sm-12 col-md-12 col-xs-12 col-lg-10"><div class="row"> --><div id="wrapper"><div class="content-page"><tiles:insertAttribute name="app-body"/></div></div><!-- </div></div> -->
