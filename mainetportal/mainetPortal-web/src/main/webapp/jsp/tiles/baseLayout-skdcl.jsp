...
<c:when test="${ cookie['accessibility'].value =='M' or empty cookie['accessibility'].value }">
	...
	<link href="assets/css/dashboard-theme-8.css" rel="stylesheet" type="text/css"  />
...
<body>
	...
	<a tabindex="-1" id="MainContent"></a>
	 ...
	 <div class="main-content content-page"><tiles:insertAttribute name="app-body"/> </div>
...
$(window).on('load', function(){
	...
	$('.cont-us-main .panel-body').slimScroll({
		height: '43.5rem'
	});
	$('.imp-notices-main .panel-body').slimScroll({
		height: '11.5rem'
	});
	$('.press-release-main .panel-body').slimScroll({
		height: '11.5rem'
	});
	$('.tenders-main .panel-body').slimScroll({
		height: '11.5rem'
	});
	$('.ogp-main .panel-body').slimScroll({
		height: '11.5rem'
	});
	$('.quotations-main .panel-body').slimScroll({
		height: '11.5rem'
	});
	$('.eserv-main .panel-body').slimScroll({
		height: '32.3rem'
	});
