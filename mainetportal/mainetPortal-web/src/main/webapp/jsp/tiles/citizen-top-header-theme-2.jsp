...
<nav class="navbar navbar-default">
	<div class="top-line navbar-fixed-top">
			...
			<div class="col-md-10 col-sm-12 col-xs-9 text-right">
			<div class="last">
<%--           	<span class="hidden-xs"><a href="#MainContent" title="<spring:message code="Skip" text="Skip to Main Content"/>"><i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i> <spring:message code="Skip" text="Skip to Main Content"/></a></span>
 --%>
 		  <span class="hidden-xs"><a href="CitizenHome.html" title="Go back to <spring:message code="top.home" text="Home" />"><i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i> <spring:message code="top.home" text="Home" /></a></span>	
          ...
          <span class="hidden-xs"><a href="AccessibilityLanding.html" style="font-size: 17px;top: 1px;position: relative;"title="<spring:message code="Accessibility" text="Accessibility Options"/>" title="Accessibility Options"><i class="fa fa-adjust fa-lg" aria-hidden="true"><span class="hidden"><spring:message code="Accessibility" text="Accessibility Options"/>" title="Accessibility Options"></span></i> </a></span>          
 ...
 <div class="col-md-10">
	...
	<div class="brand wow fadeInLeft animated animated" data-wow-duration="1.5s" data-wow-offset="10" style="visibility: visible;-webkit-animation-duration: 1.5s; -moz-animation-duration: 1.5s; animation-duration: 1.5s;">
					...
					<c:if test="${parts[1] eq '1'}">
						<img src="./${parts[0]}" height="56" alt="Organisation Logo"
		...
		<div class="col-md-3 col-sm-3 col-lg-3 hidden-xs"><div class="brand wow fadeInRight animated animated pull-right" data-wow-duration="1.5s" data-wow-offset="10" style="visibility: visible;-webkit-animation-duration: 1.5s; -moz-animation-duration: 1.5s; animation-duration: 1.5s;"><img src="assets/img/national_emblem.png" class="pull-right" alt="National emblem" style="height:56px;"></div></div>
 	</div>	
