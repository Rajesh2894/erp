   ...
   <nav class="navbar navbar-default">
	                  ...
	                  <a href="CitizenHome.html">
	                     <c:forEach
	                        ...
	                        <c:if test="${parts[1] eq '1'}">
	                           ...
	                           alt="
	                           <c:if test="${userSession.languageId eq 2}">${userSession.organisation.ONlsOrgname}</c:if>
	                           <c:if test="${userSession.languageId eq 1}">${userSession.organisation.ONlsOrgnameMar}</c:if>
	                           ">
	                        </c:if>
	                        <img src="images/SKDCL-images/SKDCL LOGO.png" class="pull-left hidden-xs img-responsive" alt="skdcl-logo" />
	                     </c:forEach>
	           ...
	           <%--  <c:if test="${command.userSession.socialMediaMap.size() gt 0}">
	            ...
	            <!--  End of code by ABM2144 for Social Media Section on 21-05-2019 -->
		         ...
		         <div id="navbar" class="container">
		            <nav class="navbar navbar-default hidden-lg"> <!-- hidden-sm -->
	...
	<header class="header hidden-xs hidden-sm fixed">
		<div class="header-2">
			<div class="container">
				<div class="row">
					<div class="logo col-sm-4 col-md-6 col-lg-4">
						<a href="CitizenHome.html">
						<c:forEach
								items="${userSession.logoImagesList}" var="logo" varStatus="status">
								<c:set var="parts" value="${fn:split(logo, '*')}" />
								<c:if test="${parts[1] eq '1'}">
									<img style="height: auto; width: 70%;" src="${parts[0]}" class="pull-left hidden-xs img-responsive"
							...
							<!-- <img src="./assets/img/SKDCL-LOGO.png" class="pull-left hidden-xs img-responsive" alt="skdcl-logo" style="height: auto; width: 25rem;"/> -->
							<%-- <span class="website-name">
								<c:if test="${userSession.languageId eq 2}">
									<h3>${userSession.organisation.ONlsOrgnameMar}</h3>
								</c:if><c:if test="${userSession.languageId eq 1}">
								<h1>${userSession.organisation.ONlsOrgname}</h1>
								</c:if>
							</span>  --%>
							 <%-- <span class="website-name">
					...
					<div class="logo-right col-sm-8 col-md-6 col-lg-8">
						 <div class="header-3">
							<div class="container">
								<div class="row">
									<nav class="menu-header-menu-container">
										<ul class="main-navigation sm sm-blue hidden-md" id="main-menu">
											<%-- <li>
												<!-- <a href="javascript:void(0)" role="link" class="internal"> -->
											...
											<li><a href="#"><spring:message code="Login" text="Login"/></a>			
												<ul>
													<%-- <li><a href='javascript:void(0);' onclick="getCitizenLoginForm('N')"><span><spring:message code="CitizenLogin" text="Citizen Login"/></span></a></li> --%>
													<li><a href='javascript:void(0);' onclick="getAdminLoginForm()"><span><spring:message code="PortalAdmininstratorLogin" text="Portal Admininstrator Login"/></span></a></li>
													<li><a href='<spring:message code="service.admin.home.url"/>'  target="_blank" class="dept-login"><span><spring:message code="DepartmentEmployeeLogin" text="Department Employee Login"/></span></a></li>
												</ul>
											</li>
										</ul>
