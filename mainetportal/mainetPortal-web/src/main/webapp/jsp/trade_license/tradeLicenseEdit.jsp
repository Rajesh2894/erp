										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<div class="input-group">
													<form:input
														class="form-control mandColorClass fromDateClass"
														id="trdLictoDate" path="tradeMasterDetailDTO.trdLictoDate"></form:input>
													<span class="input-group-addon"><i
														class="fa fa-calendar"></i></span>
												</div>
											</div>
									...
									<c:choose>
										...
										<c:when test="${command.propertyActiveStatus eq 'Y'}">
											<div class="form-group">
												...
												<div id="flatNoSelectId">
													<label class="col-sm-2 control-label"> <spring:message
															code="license.details.flatNo" text="Flat/Shop Number" />
													</label>
													<div class="col-sm-4">
														<form:select path="tradeMasterDetailDTO.trdFlatNo"
															id="flatNo" onchange="getPropertyDetails(this);"
															class="form-control chosen-select-no-results mandColorClass">
															<form:option value="">
																<spring:message code='master.selectDropDwn' />
															</form:option>
															<c:forEach items="${command.flatNoList}" var="list">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<label class="radio-inline margin-top-5"> <form:radiobutton
												...
												<spring:message code='' text="Yes" /></label> <label
