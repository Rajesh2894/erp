...
<div class="widget login">
 ...
 <%--  <c:forEach items="${command.tradeMasterDetailDTO.tradeLicenseItemDetailDTO}" var="charge" varStatus="lk">
  	 <tr>
  ...
  <tr>
    ...
    <th><p class="text-right">${command.offlineDTO.amountToShow}</p></th>
  </tr>
</table>
  </div>
</div>