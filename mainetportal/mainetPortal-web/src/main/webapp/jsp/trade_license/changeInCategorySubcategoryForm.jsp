...
<script src="js/trade_license/changeInCategorySubcategoryForm.js"></script>
				...
				<form:form action="ChangeInCategorySubcategoryForm.html"
					...
					<div class="panel-group accordion-toggle"
								...
								<div id="a3" class="panel-collapse collapse in">
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<form:input path="tradeDTO.trdBusadd"
						...
						<c:if
								...
								<div class="panel-heading">
									<h4 class="panel-title table" id="">
										...
										<small> <spring:message
												code="trade.checklist.validationUpload"
												text="(Upload File upto 1MB and only pdf, doc, docx, xls, xlsx extension(s) file(s) are allowed)" />
										</small>
									</h4>
								</div>
							...
							<apptags:payment></apptags:payment></c:if>
						...
						<c:if test="${command.licenseBtnFlag eq 'Y'}">
							<div class="padding-top-10 text-center">
								...
								<button type="Reset" class="btn btn-warning" 
									onclick="resetCategoryForm(this);">
