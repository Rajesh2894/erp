...
<script src="js/trade_license/duplicateLicenseForm.js"></script>
	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<h2>
					<b><spring:message code="trade.license.header.duplicate"></spring:message></b>
				</h2>

				<apptags:helpDoc url="DuplicateLicenseForm.html"></apptags:helpDoc>
			</div>

			<div class="widget-content padding">

				<form:form action="DuplicateLicenseForm.html"
					class="form-horizontal" id="duplicateLicenseForm"
					name="duplicateLicenseForm">
							...
							<h4 class="panel-title table" id="">
								<a data-toggle="collapse" class=""
									data-parent="#accordion_single_collapse" href="#a3"> <spring:message
										code="trade.license.duplicate" /></a>
							</h4>
							<div id="a3" class="panel-collapse collapse in">
								<div class="panel-body">
									...
									<div class="form-group" id="otpdetails" style="display: none;">
										<label class="col-sm-2 control-label required-control"
											for="userOtp"><spring:message code="trade.otp"
												text="Enter Otp" /></label>
										<div class="col-sm-4">
	                ...
	                <c:if test="${command.checkListApplFlag ne null && command.checkListApplFlag eq 'Y'  && command.paymentCheck ne null}">
							...
							test="${command.paymentCheck ne null && command.paymentCheck eq 'Y'}">
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<a
												class="fancybox fancybox.ajax text-small text-info internal"
												href="DuplicateLicenseForm.html?showChargeDetailsMarket">
												<spring:message code="water.lable.name.chargedetail" /> <i
