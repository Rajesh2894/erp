...
<title>Easypay Payment Gateway</title>
</head>
		...
		<div class="col-xs-12">
			...
			<div class="row">
				...
				<div class="form-div"
					...
					<p>
						We are redirecting to Easypay Payment Gateway in few secs. <br> Please do
           ...
           <form:form action="${command.pgUrl}" id="pay" name="pay" method="post">
				...
				<input type="hidden" name="i" id="i" value="${command.payRequestMsg}"/>
