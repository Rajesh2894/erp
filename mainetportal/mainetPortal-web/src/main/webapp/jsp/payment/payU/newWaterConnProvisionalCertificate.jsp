...
<link href="assets/css/print-theme-2.css" rel="stylesheet"
	type="text/css" id="" />
<link href="assets/css/print-theme-2.css" media="print" rel="stylesheet" type="text/css"/>
				...
				<form:form action="" name="" id="provisional" class="form-horizontal">
					<div>
						<div class="text-center">
							<h2 class="text-bold">
								<img alt="nwc_header3" src=".\assets\img\nwc_header3.png" style="width:95%;">
							 </h2>	
						</div>
					</div>
					<!-- <div class="clear"></div> -->
					<h3 class="text-center">
					 	<spring:message code="" text="${userSession.organisation.ONlsOrgname}" /> 
					</h3>
					
					<%-- <div class="text-bold margin-top-30 margin-bottom-30">
						 <div class="col-xs-4 col-sm-6">
							...
							<div class="">	
								<spring:message code="nwc.certi.from.content2" text="Raipur Municipal Corporation" />
							</div>
						  </div>
					 </div> --%>
					 ...
					 <div class="text-bold margin-bottom-10 ">
						<div  class="col-xs-12 col-sm-12 text-right">
								<div><span class="text-right margin-bottom-10">
									<spring:message code="nwc.certi.application.no" text="Application No.:" />${command.provisional.applicationNo}
									</span>
								<span class="col-xs-8 col-sm-6">          </span>
								</div>
								<div>
									<span class="text-right margin-bottom-10">
										<spring:message code="nwc.certi.date" text="Date:" />${command.provisional.provApplicationDate}
									</span>
		 				...
		 				<div class="col-xs-12 col-sm-12">
		 					 <p> 
		 						...
		 						<span class=""> ${command.provisional.fullName}</span>
		 					 </p>
							 <p>
							    <spring:message code="nwc.certi.address1" text="Address : " /> 
							    <span class=""> ${command.provisional.address1} </span>
							 </p>
							 <p>
								<span class=""> ${command.provisional.address2} </span>
		 					 </p>
		 				 </div>
		 			</div>
		 			</div>
	 				...
	 				<div>
		 				...
		 				<p class="margin-left-50 text-bold">
		 					<span><spring:message code="nwc.certi.subject" text="Subject:" /></span>
		 					<span><b> <spring:message code="nwc.certi.subject.desc" text="NEW TAP CONNECTION RECEIPT" />  </b>  </span>
		 				</p>
		 				<p class="margin-left-50">
		 					...
		 					<span><spring:message code="nwc.certi.ref.content2" text=" Application number:" />${command.provisional.applicationNo}</span>
		 					<span>                  </span>
		 					<span><spring:message code="nwc.certi.ref.content3" text="and Application Date:" />${command.provisional.provApplicationDate}</span>
		 					<span>                  </span>
						...
						<div class="col-xs-12 col-sm-12">
							...
							<table class="table table table-bordered ">
								<tr>
									...
									<td class="">${command.provisional.fullName}</td>
									<td width="30%"><spring:message code="nwc.certi.father/husbandname" text="Father/Husband Name"/></td>
									<td class="">${command.provisional.fatherHusbandName}</td>
								</tr>
								<tr>
									<td class=""><spring:message code="nwc.certi.tablea.content2" text="House No."/></td>
									<td class="">${command.provisional.consumerHouseNumber}</td>
									<td class=""><spring:message code="nwc.certi.tablea.content4" text="Landmark"/></td>
									<td class="">${command.provisional.consumerLandmark}</td>
								</tr>
								<tr>
									<td class=""><spring:message code="nwc.certi.tablea.content3" text="Address"/></td>
									<td class="">${command.provisional.address1}</td>
									<td class=""><spring:message code="nwc.certi.tablea.content5" text="Ward No."/></td>
									<td class="">${command.provisional.ward}</td>
								</tr>
								<tr>
									<td class=""><spring:message code="nwc.certi.tablea.content6" text="Mobile No."/></td>
									<td class="">${command.provisional.consumerMobile}</td>
									<td class=""><spring:message code="nwc.certi.tablea.content7" text="Email ID"/></td>
									<td class="">${command.provisional.consumerEmail}</td>
								</tr>
							</table>
						</div>
						...
						<p class="text-bold">
							...
							<table class="table table table-bordered table-condensed">
								...
								<tr>
									...
									<td class=""> ${command.provisional.paymentMode}</td>
								</tr>
								<tr>
									<td class=""><spring:message code="nwc.certi.tableb.content5" text="Date of Payment"/></td>
									<td class="">${command.provisional.provPaymentDate}</td>
								</tr>
						...
						<div class="col-xs-12 col-sm-12">
	 					...
	 					<div class="col-xs-12 col-sm-12">
		 					<p class="text-bold">
	 					 	...
	 					 	<p class="text-bold margin-bottom-10"><spring:message code="nwc.certi.note.contect" text="This is computer generated receipt and does not require physical signature This receipt does not prove the ownership of property or land. For details please visit https://urbanecg.gov.in" /></p>
	 					 </div>
	 			 
	 			</div>
	 			</div>
	 			<div class="col-xs-12 col-sm-12">
	 			<div id="footer" class="text-center"><spring:message code="nwc.certi.footer.content" text="https://urbanecg.gov.in"/>
	 			</div>
				</div>
				<!-- <div class="clear"></div> -->
				</form:form>
		  ...
		  <div class="text-center clear padding-top-20">
						<button onclick="printCertificate('printDiv')"
							...
							<i class="icon-print-2"></i>
								<spring:message code="loi.print" text="Print"></spring:message>
						</button>
						
						<button type="button" class="btn btn-danger hidden-print"
							onclick="window.location.href='CitizenHome.html'">
							<spring:message code="loi.back" text="Back"></spring:message>
