...
<script src="js/social_security/renewalFormView.js"></script>
		 	...
		 	<jsp:include page="/jsp/tiles/validationerror.jsp" />
				...
				<div class="form-group">
					...
					<apptags:input labelCode="Scheme Name"
						path="renewalFormDto.selectSchemeName" isReadonly="true"></apptags:input>
				</div>
				<div class="form-group">
					<apptags:input labelCode="Last date of Life certificate"
						path="renewalFormDto.lastDateofLifeCerti" isReadonly="true"></apptags:input>
	                                    ...
	                                    <table class="table table-bordered table-striped"
											...
											<tr>
											<th><spring:message code="scheme.document.name" text="Life Certificate" /></th>
											<th><spring:message code="scheme.view.document" text="Life Certificate" /></th>
											</tr>
