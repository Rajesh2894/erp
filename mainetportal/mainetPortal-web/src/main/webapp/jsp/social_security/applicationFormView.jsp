								...
								<div class="panel-body padding-top-0">
									...
									<div class="form-group">
										...
										<apptags:input labelCode="social.sec.nameapplicant"
											path="applicationformdto.nameofApplicant" isMandatory="true" cssClass="hasCharacter" maxlegnth="50" isDisabled="true"></apptags:input>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<form:input class="form-control datepicker"
													...
													path="applicationformdto.applicationDob" isMandatory="true" onchange="dobdetails();" isDisabled="true"></form:input>
										...
										<apptags:input labelCode="social.sec.ageason"
											path="applicationformdto.ageason" isMandatory="true" cssClass="text-right" isDisabled="true"></apptags:input>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label required-control"><spring:message
										...
										<apptags:textArea labelCode="social.sec.appaddress"
											path="applicationformdto.applicantAdress" isMandatory="true" cssClass="hasAddressClass" maxlegnth="200" isDisabled="true"></apptags:textArea>
									</div>
									...
									<div class="form-group">
										<apptags:input labelCode="social.sec.pincode"
											path="applicationformdto.pinCode" cssClass="hasPincode text-right"  isMandatory="true" maxlegnth="6" isDisabled="true"></apptags:input>

										<apptags:input labelCode="social.sec.mobnum"
											path="applicationformdto.mobNum" cssClass="hasMobileNo text-right" isMandatory="true" maxlegnth="10" isDisabled="true"></apptags:input>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<form:select path="applicationformdto.educationId"
												class="form-control" disabled="true" onchange="geteducationdetails();">
												<form:option value="">
													<spring:message text="Select" />
												</form:option>
										...
										<apptags:input labelCode="social.sec.class"
											path="applicationformdto.classs" isMandatory="true" cssClass="alphaNumeric text-right" isDisabled="true"></apptags:input>
									</div>
									...
									<div class="form-group">
										...
										<apptags:input labelCode="social.sec.annualincome"
											path="applicationformdto.annualIncome"  isMandatory="true" cssClass="text-right" maxlegnth="20"  isDisabled="true"></apptags:input>
										...
										<div class="col-sm-4">
											<form:select path="applicationformdto.typeofDisId"
												class="form-control" disabled="true" onchange="disabilitydetails();">
												<form:option value="">
													<spring:message text="Select" />
												</form:option>
									...
									<div class="form-group">
										<apptags:input labelCode="social.sec.percentofdis"
											path="applicationformdto.percenrofDis"  isMandatory="true"  cssClass="hasNumber text-right" maxlegnth="2" isDisabled="true"></apptags:input>
										...
										<div class="col-sm-4">
											<form:select path="applicationformdto.bplid" 
												cssClass="form-control" disabled="true" onchange="bpldetails();">
												<form:option value="">
													<spring:message text="Select" />
												</form:option>
											...
											<form:hidden path="applicationformdto.isBplApplicable" id="isBplApplicableId" />
										</div>
									</div>

									<div class="form-group">
										<apptags:input labelCode="social.sec.bplinspectionyr"
											path="applicationformdto.bplinspectyr" isMandatory="true" cssClass="hasNumber text-right" maxlegnth="4" isDisabled="true" ></apptags:input>


										<div class="form-group">
											<apptags:input labelCode="social.sec.bplfamilyid"
												path="applicationformdto.bplfamily" isMandatory="true" cssClass="hasNumber text-right" maxlegnth="8" isDisabled="true"></apptags:input>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="panel-body padding-top-0">
									...
									<div class="form-group">
										...
										<apptags:input labelCode="social.sec.accountnum"
											path="applicationformdto.accountNumber" isMandatory="true" cssClass="alphaNumeric text-right" maxlegnth="20" isDisabled="true"></apptags:input>
									</div>


									<div class="form-group">

										<%-- <apptags:input labelCode="social.sec.branchname"
											path="applicationformdto.branchname" isMandatory="true" cssClass="hasCharacter" maxlegnth="20"></apptags:input>
 --%>
										<apptags:input labelCode="social.sec.ifsccode"
											path="applicationformdto.ifsccode" isMandatory="true" cssClass="text-right" isDisabled="true"></apptags:input>
								...
								<div class="panel-body padding-top-0">
									<div class="form-group">
										...
										<apptags:input labelCode="social.sec.nameoffather/spouse"
											path="applicationformdto.nameofFather" isMandatory="true" cssClass="hasCharacter" maxlegnth="20" isDisabled="true"></apptags:input>

										<apptags:input labelCode="social.sec.nameofmother"
											path="applicationformdto.nameofMother" isMandatory="true" cssClass="hasCharacter" maxlegnth="20" isDisabled="true"></apptags:input>
									...
									<div class="form-group">
										...
										<apptags:input labelCode="social.sec.contactnum"
											path="applicationformdto.contactNumber" maxlegnth="10" isMandatory="true" cssClass="hasNumber text-right" isDisabled="true" ></apptags:input>


										<apptags:input labelCode="social.sec.detailsfamilyincome"
											path="applicationformdto.detailsoffamIncomeSource" isMandatory="true" cssClass="hasCharacter text-right" maxlegnth="20" isDisabled="true"></apptags:input>
									...
									<div class="form-group">
										...
										<apptags:input labelCode="social.sec.familyannualincome"
											path="applicationformdto.annualIncomeoffam" isMandatory="true" cssClass="hasNumber text-right" maxlegnth="20" isDisabled="true"></apptags:input>
