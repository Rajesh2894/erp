		...
		<div class="widget-content padding">
			<form action="" method="get">
				<div class="row">
					...
					<div class="col-xs-6 col-sm-6 text-center">
						<c:choose>
							...
							<c:otherwise>
								<h2 class="margin-bottom-0">${userSession.organisation.ONlsOrgnameMar}<h2>
							</c:otherwise>
						</c:choose>
					</div>
					<div class="col-xs-3 col-sm-3">
				...
				<div class="row margin-top-30">
					...
					<div class="col-xs-3 text-right">
						<spring:message code="rti.receipt.dateAndTiem"
							text="Date & Time :" />
					</div>
				...
				<div class="row margin-top-10">
					...
					<div class="col-xs-3 text-right">
						<spring:message code="rti.applicationNumber"
				...
				<div class="row margin-top-10">
					...
					<div class="col-xs-3"><spring:message code="rti.RePrint.deptName" text=" Right To Information" /></div>
					<div class="col-xs-3 text-right">
						<spring:message code="rti.applicantNo"
							text="Applicant Mobile No :" />
					</div>
					<div class="col-xs-3">${command.reqDTO.mobileNo}</div>
				</div>
				<div class="row margin-top-10">
					<div class="col-xs-3 text-right">
					...
					<div class="col-xs-3">
						...
						<span class="text-orange-5"> <spring:message
								code="care.status.pending" text="Pending" /></span>
					</div>
					<div class="col-xs-3 text-right">
						<spring:message code="rti.address" text="Address :" />
					</div>
					<div class="col-xs-3">${command.reqDTO.areaName}</div>
				</div>
				<%-- <div class="row margin-top-10">
