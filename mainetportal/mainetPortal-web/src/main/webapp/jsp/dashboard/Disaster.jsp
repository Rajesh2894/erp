...
<li class="breadcrumb-item"><a href="administration.html" title="Administration">Administration</a></li>
<li class="breadcrumb-item active">Disater Management</li>
</ol>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							  ...
							  <div id="schemes">
							  <h3 class="text-center">Disater Management</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-university" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Assistance to Disaster Affected Families</h1></div>
