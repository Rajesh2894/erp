...
<li class="breadcrumb-item active">Rural Works </li>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							  ...
							  <h3 class="text-center">Rural Development</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-user-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Mahatma Gandhi National Rural Employment Guarantee Act</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-user-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">National Rural Livelihood Mission (NRLM)</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-user-o" aria-hidden="true"></i></div>
                         <div class="header"><h1>Bihar Livelihood Scheme</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-user-o" aria-hidden="true"></i></div>
                         <div class="header"><h1>Indira Awas Yojana</h1></div>
						 <div class="progressbar">
