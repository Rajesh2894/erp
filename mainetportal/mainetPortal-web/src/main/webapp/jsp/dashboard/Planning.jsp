...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							  ...
							  <div id="schemes">
							  <h3 class="text-center">Planning and Development</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-university" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Border Area Development Program (BADP)</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-university" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Mukhyamantree Kshetra Vikas Yojna</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-university" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">MP Local Area Development Scheme</h1></div>
						 <div class="progressbar">
					   ...
					   <div class="col-sm-3">
                <div class="item">
                     <a href="DashBoard.html?report&reportname=R_SH_ALLOWANCE_DASH.rptdesign"> 
					 <div class="box lightblue-nischay">
					 <div align="center"><i class="fa fa-question-circle" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Self Help Allowance - Determination</h1></div>
						 <div class="progressbar">
