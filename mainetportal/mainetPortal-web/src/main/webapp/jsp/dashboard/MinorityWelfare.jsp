...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							 ...
							 <h3 class="text-center">Minority Welfare</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-university" aria-hidden="true"></i></div>
                         <div class="header"><h1>Minority hostel plan</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Mukhyamantree Vidyarthi Protsahan Yojana</h1></div>
						 <div class="progressbar">
...
Mukhyamantree Alpasankhyak Shiksha Ruon Yojana</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Mukhyamantree Alpasankhyak Rojagaar Ruon Yojana</h1></div>
						 <div class="progressbar">
