...
<li class="breadcrumb-item active">Sugarcane</li>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							  ...
							  <h3 class="text-center">Sugarcane</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-user-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Mukhyamantree Ganna Vikaas Kaaryakram</h1></div>
