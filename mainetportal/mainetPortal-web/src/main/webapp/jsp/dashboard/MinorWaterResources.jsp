...
<li class="breadcrumb-item active">Water Resource</li>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							  ...
							  <h3 class="text-center">Water Resource</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-user-o" aria-hidden="true"></i></div>
                         <div class="header"><h1>Development of irrigation potential</h1></div>
						 <div class="progressbar">
					   
					   
  					   <div class="row">
					   <div class="col-sm-6">
					   <span data-count="10%">9</span>
					   <h1>Physical</h1></div>
					   <div class="col-sm-6">
					   <span data-count="30%">29</span>
					   <h1>Financial</h1></div>
					   </div>
					   </div>
						 </div></a>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-user-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Canal restoration / modern lining work</h1></div>
						 <div class="progressbar">
