...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation" class="active"><a href="HumanResource.html" title="Human Resource Department">HRD</a></li>
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-book" aria-hidden="true"></i></div>
                         <div class="header"><h1>Janani Child Protection Scheme</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-medkit" aria-hidden="true"></i></div>
                         <div class="header"><h1>Regular immunization</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-child" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Facilities to be provided in health centers</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-medkit" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">The availability of medicines / therapists / other personnel</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
                     <a href="javascript:void(0);"> 
					 <div class="box darkgreen-nischay">
					 <div align="center"> <i class="fa fa-cutlery" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Primary Health Centers 24 x 7 Operations</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-child" aria-hidden="true"></i></div>
                         <div class="header"><h1>Black eradication program</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-female" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Establishment of new ANM / GNM / Nursing College and Paramendical</h1></div>
						 <div class="progressbar">
