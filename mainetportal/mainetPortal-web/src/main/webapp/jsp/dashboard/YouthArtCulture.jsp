...
<li class="breadcrumb-item"><a href="art.html" title="Art Culture and Tourism">Art Culture and Tourism</a></li>
<li class="breadcrumb-item active">Art, Culture & Youth</li>
</ol>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation" class="active"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
 </ul>
</div>
							  ...
							  <h3 class="text-center">Art, Culture & Youth</h3>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-camera-retro" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Construction of stadium under CM Sports Development Plan</h1></div>
...
">
					 <div align="center"> <i class="fa fa-snowflake-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Preservation, maintenance and beautification of archaeological sites</h1></div>
						 <div class="progressbar">
