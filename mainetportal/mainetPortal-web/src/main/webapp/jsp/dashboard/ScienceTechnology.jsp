...
<li class="breadcrumb-item active">Science and Technology</li>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							  ...
							  <h3 class="text-center">Science and Technology</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-building-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Government opening and accepting new institutions</h1></div>
