...
<li class="breadcrumb-item ">Agriculture & Allied </li>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation" class="active"><a href="Agriculture.html" title="Agriculture &amp; Allied"> Agriculture &amp; Allied </a></li>
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
                ...
                <div class="item">
					 ...
					 <div align="center"><i class="fa fa-road" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Schemes related to Agriculture Road Map</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-user-o" aria-hidden="true"></i></div>
                         <div class="header"><h1>Diesel subsidy</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"><i class="fa fa-tree" aria-hidden="true"></i></div>
                         <div class="header"><h1>Agricultural mechanization</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"><i class="fa fa-bullseye" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">National and State Horticulture Mission</h1></div>
						 <div class="progressbar">
