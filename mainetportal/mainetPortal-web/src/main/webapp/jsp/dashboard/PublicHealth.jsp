...
<li class="breadcrumb-item active">Public Health Engineering</li>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							  ...
							  <h3 class="text-center">Public Health &amp; Engineering</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-building-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Rural Water Supply Scheme - Determination Water Supply Scheme</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-building-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Small Pipe Water Supply Scheme - Decision Pipe Water Scheme</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-building-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;"> Construction of toilets for B.P.L.familys - decision plan</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-building-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;"> Construction of toilets for A.P.L. familys - decision plan</h1></div>
						 <div class="progressbar">
