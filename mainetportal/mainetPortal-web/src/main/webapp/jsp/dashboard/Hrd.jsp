...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item active">Human Resource Department</li>
			...
			<div id="schemes">
				<div class="container">
					...
					<div class="row ">
						...
						<div class="col-sm-3">
							<div class="item">
								<a href="HumanResource.html?page&scheme=EducationDepartment">
						...
						<div class="col-sm-3">
							<div class="item">
								<a href="HumanResource.html?page&scheme=HealthDepartment">
