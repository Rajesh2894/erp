...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							 ...
							 <h3 class="text-center">Labour Resources</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-university" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">New I.T.I. establishment</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-building" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">New ITI for Women establishment</h1></div>
						 <div class="progressbar">
					  ...
					  <div class="col-sm-3">
                <div class="item">
                     <a href="DashBoard.html?report&reportname=R_YOUTH_DASH.rptdesign"> 
					 <div class="box lightblue-nischay">
					 <div align="center"> <i class="fa fa-user-secret" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Bihar Skill Development Mission</h1></div>
						 <div class="progressbar">
