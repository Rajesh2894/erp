...
<li class="breadcrumb-item active">Food and Consumer Protection</li>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							  ...
							  <h3 class="text-center">Food and Consumer Protection</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-user-o" aria-hidden="true"></i></div>
                         <div class="header"><h1>Warehouse construction</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-tint" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Supply of foodgrains / kerosene oil by public distribution system vendors</h1></div>
						 <div class="progressbar">
