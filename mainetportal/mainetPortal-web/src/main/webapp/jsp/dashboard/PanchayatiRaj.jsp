...
<li class="breadcrumb-item active">Panchayati Raj</li>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							  ...
							  <h3 class="text-center">Panchayati Raj</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-user-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Related to 14th Central Finance Commission</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-user-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Related to the fourth and fifth finance commission</h1></div>
						 <div class="progressbar">
