...
<li class="breadcrumb-item active">Environment &amp; Forest</li>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							  ...
							  <h3 class="text-center">Environment &amp; Forest</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-pagelines" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">All other plans related to agriculture forestry and forestry</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-tint" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">National Forestry Program (National Green India Mission)</h1></div>
						 <div class="progressbar">
