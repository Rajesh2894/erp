...
<li class="breadcrumb-item active">Urban Development Housing</li>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							  ...
							  <h3 class="text-center">Urban Development Housing </h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-building-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Deendayal Antyodaya Yojana - Rashtreey Shaharee Aajeevika Mission</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-building-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Atal Mission for Urban Resuscitation and Transformation (AMRUT)</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-building-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Housing for all (HFA)</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-building-o" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Regarding drinking water, toilets and street drain schemes in the city area</h1></div>
						 <div class="progressbar">
