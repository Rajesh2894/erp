...
<li class="breadcrumb-item active">Rural Work</li>
...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							  ...
							  <h3 class="text-center">Rural Work</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-road" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">
Mukhyamantree Graam Sadak Yojana- Nishchay Yojana</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"><i class="fa fa-road" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">
NABARD / RIDF State-funded schemes by state (construction of roads and bridges)
</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"><i class="fa fa-mobile" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Mukhyamantree Graam Sampark Yojana</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-road" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Pradhan Mantri Graam Sadak Yojana (PMGSY)</h1></div>
						 <div class="progressbar">
