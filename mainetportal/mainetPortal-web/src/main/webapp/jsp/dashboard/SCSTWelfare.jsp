...
<ul class="nav nav-pills" role="tablist">
  ...
  <li role="presentation" class="active"><a href="Welfare.html" title="Welfare">Welfare</a></li>
  <li role="presentation"><a href="ArtCulture.html" title="Art Culture and Tourism"> Art Culture and Tourism</a></li>
							 ...
							 <h3 class="text-center">SC &amp; ST Welfare</h3>
							  <div class="container">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-university" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Schedule Caste and Tribe residential university scheme</h1></div>
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-building" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Plans run by Bihar Mahadalit Vikas Mission</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-user-secret" aria-hidden="true"></i></div>
                         <div class="header"><h1 style="line-height:17px;">Tremor area development scheme</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-home" aria-hidden="true"></i></div>
                         <div class="header"><h1>Child hostel building</h1></div>
						 <div class="progressbar">
                ...
                <div class="item">
					 ...
					 <div align="center"> <i class="fa fa-balance-scale" aria-hidden="true"></i></div>
                         <div class="header"><h1>Construction of girl hostel</h1></div>
						 <div class="progressbar">
