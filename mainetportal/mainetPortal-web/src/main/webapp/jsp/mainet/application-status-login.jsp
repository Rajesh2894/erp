		...
		<div class="widget-content padding">
			...
			<form:form action="CitizenHome.html" method="get" class="form-horizontal">
				...
				<div class="form-group margin-top-10" >
					...
					<img alt="CMImage" src="assets/img/CMImage.jpg"></img>
					</div>
				...
				<div class="panel panel-default about-ward" style="background: white !important;">
					...
					<div class="embed-responsive embed-responsive-16by9 col-sm-8">
 					 <iframe class="embed-responsive-item" id="frame1" src="<spring:message code="care.dashboard.report.url"></spring:message>RP_CARE.rptdesign&__toolbar=false" ></iframe>
					</div>
					
					<div class="col-sm-4">
					<div class="panel panel-default about-ward" style="margin: 20px 0px;">
