			...
			<div class="mkpay">
				<div class="panel-heading">
					<h3><div class="image">
						...
						<spring:message code="complaint.status" text="Complaint Status" />
						...
						<div class="content-tab">
							...
							<form class="form">
								<div class="form-group">
									<div class="col-sm-12 propertyNo" id="application_no"><spring:message code="eg" var="searchString" />
									<label for="billNumber" id="billdetailtext"><spring:message code="Complaint.no" text="Complaint Number" /> </label> <input
										type="text" class="form-control" name="referral"
										id="searchString" placeholder="${searchString}">
									</div> 
								</div>
								<div class=" col-sm-12 text-right">
									<br />
									<button type="button" onclick="displayComplaintStatus(this)"
