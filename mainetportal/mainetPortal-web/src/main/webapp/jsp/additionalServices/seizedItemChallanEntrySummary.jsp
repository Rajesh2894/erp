				...
				<form:form action="SeizedItemChallanEntry.html" method="POST" class="form-horizontal" 
					...
					<div class="form-group">
						...
						<div class="col-sm-4 margin-top-5">
							...
							<form:input type="text" class="form-control" name="raidNo" id="raidNo" 
					...
					<div class="form-group">
						<%-- <label for="fromdate" class="col-sm-2 control-label ">
							<spring:message code="EChallan.fromDate" text="From Date" />
						</label>
						<div class="col-sm-4">
							<div class="input-group">
							<form:input type="text"
										class="form-control mandColorClass hideElement required-control dateValidation"
										id="challanFromDate" path="challanMasterDto.challanFromDate"
										placeholder="Enter from Date" />
							<label class="input-group-addon" for="challanFromDate"><i
										class="fa fa-calendar"></i></label>
							</div>
						</div> --%>
						<apptags:date fieldclass="datepicker"
							labelCode="EChallan.fromDate" readonly="true"
							datePath="challanMasterDto.challanFromDate" isMandatory="true">
						</apptags:date>
						<%-- <label for="todate" class="col-sm-2 control-label">
							<spring:message code="EChallan.toDate" text="To Date" />
						</label>
						<div class="col-sm-4">
							<div class="input-group">
							<form:input type="text"
										class="form-control mandColorClass hideElement required-control dateValidation"
										id="challanToDate" path="challanMasterDto.challanToDate"
										placeholder="Enter to Date" />
							<label class="input-group-addon" for="challanToDate"><i
										class="fa fa-calendar"></i></label>
							</div>
						</div> --%>
						<apptags:date fieldclass="datepicker"
							labelCode="EChallan.toDate" readonly="true"
							datePath="challanMasterDto.challanToDate" isMandatory="true">
						</apptags:date>
					</div>
					...
					<div class="text-center">
						...
						<button type="button" onclick="window.location.href='SeizedItemChallanEntry.html'" 
          ...
          <table class="table table-bordered myTable" id="datatables">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">${data.challanDate}</td>
				...
				<button type="button" class="btn btn-blue-2 btn-sm btn-sm"
						  title="<spring:message code="" text="Print" />"
						  onclick="printContent(${data.challanId})">
