...
<div id="heading_wrapper">
	...
	<div id="heading_bredcrum">
		<ul>
			...
			<li><spring:message code="eip.zone.title" /></li>
		</ul>
	</div>
...
<div class="clearfix" id="home_content">
	<div class="col-xs-12">
		<div class="row">
			<div class="form-div">
				<form:form action="ZoneInformation.html" name="frmrightToInformation" id="rightToInformation">
				
				<jsp:include page="/jsp/tiles/validationerror.jsp" />
					<div class="form-elements">
						<span class="otherlink">
						 <a href="javascript:void(0);"
							class="btn btn-primary" onclick="openForm('ZoneForm.html')">Add</a>
						</span>
						</div>
				</form:form>
				<div class="grid-class" id="ZoneInfoGrid">
					<apptags:jQgrid id="zoneInformation"
						url="ZoneInformation.html?ZONE_LIST" mtype="post"
						gridid="gridZoneForm"
						colHeader="eip.zone.NameEN,eip.zone.NameMR"
						colModel="[
