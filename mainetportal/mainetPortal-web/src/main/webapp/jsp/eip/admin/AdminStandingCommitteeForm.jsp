...
<div class="popup-form-div">
	<form:form method="post" action="AdminStandingCommitteeForm.html"
		name="frmAdminStandingCommitteeForm"
		id="frmAdminStandingCommitteeForm">

		<jsp:include page="/jsp/tiles/validationerror.jsp" />
		<!-- 	<div class="header-title">Update Standing Committee</div> -->
		...
		<div class="buttons btn-fld" align="center">
			<apptags:submitButton entityLabelCode="Admin Standing Committee Form"
				isChildButton="false" successUrl="AdminStandingCommittee.html" />
			<apptags:resetButton />
			<apptags:backButton url="AdminStandingCommittee.html" />
		</div>
	</form:form>
</div>