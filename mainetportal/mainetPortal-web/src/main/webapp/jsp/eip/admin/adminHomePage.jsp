		...
		<div class="clearfix"></div>
			...
			<select id="selectedTask" data-content="" class="form-control chosen-select-no-results" aria-label="Search Task">
				...
				<c:forEach var="masters" items="${menuRoleEntitlement.parentList}">
					...
					<optgroup label="${(langId eq 1) ?  masters.entitle.smfname_eng : masters.entitle.smfname_mar}">
			    	<option value="${data.entitle.smfid}">${(langId eq 1) ? data.entitle.smfname_eng : data.entitle.smfname_mar}</option>
			    	...
			    	<option value="${data1.entitle.smfid}">${(langId eq 1) ? data1.entitle.smfname_eng :  data1.entitle.smfname_mar}</option>
					...
					<option value="${data2.entitle.smfid}">${(langId eq 1)  ? data2.entitle.smfname_eng : data2.entitle.smfname_mar}</option>
					...
					<option value="${data3.entitle.smfid}">${(langId eq 1) ? data3.entitle.smfname_eng : data3.entitle.smfname_mar }</option>
					</c:if></c:forEach>
					</c:if></c:forEach>
			    	</c:if></c:forEach>
			    	</optgroup> 
			...
			<div id="sidebar-menu">
				<ul id="nav" class="has_sub">
						...
						<a role="link" title="${(langId eq 1) ? masters.entitle.smfname_eng : masters.entitle.smfname_mar}" id="go${masters.entitle.smfid}" name="go${masters.entitle.smfid}"  href="${masters.entitle.smfaction}" 
						<%-- onclick="dodajAktywne(this);breadcrumb('${masters.entitle.smfname_eng}+${data.entitle.smfname_eng}',${masters.entitle.smfid});"><span>${masters.entitle.smfname_eng}</span> </a> --%>
						onclick="dodajAktywne(this);breadcrumbMultiLang('${masters.entitle.smfname_eng}+${data.entitle.smfname_eng}','${masters.entitle.smfname_mar}+${data.entitle.smfname_mar}',${masters.entitle.smfid});"><span>${(langId eq 1) ? masters.entitle.smfname_eng : masters.entitle.smfname_mar}</span> </a>	
							<ul class="scroll-menu">
								<c:forEach items="${menuRoleEntitlement.childList}" var="data">
								   <c:if test="${masters.entitle.smfid eq  data.parentId}">
										...
										<a role="link" title="${(langId eq 1) ? data.entitle.smfname_eng : data.entitle.smfname_mar }"  <c:choose> <c:when test="${fn:containsIgnoreCase(action0 , '.html')}">onclick="openRelatedForm('${action0}','this','${data.entitle.smfdescription}');
										...
										breadcrumbMultiLang('${masters.entitle.smfname_eng}+${data.entitle.smfname_eng}','${masters.entitle.smfname_mar}+${data.entitle.smfname_mar}',${masters.entitle.smfid});" href="#"</c:when><c:otherwise> href="${action0}" </c:otherwise></c:choose> > ${(langId eq 1) ? data.entitle.smfname_eng : data.entitle.smfname_mar} </a> 
											<ul class="scroll-menu1">
												...
												<li class="folder " id="${data1.entitle.smfid}"><a title="${(langId eq 1) ? data1.entitle.smfname_eng : data1.entitle.smfname_mar}"  <c:choose><c:when test="${fn:containsIgnoreCase(action1 , '.html')}">onclick="openRelatedForm('${action1}');
												<%-- breadcrumb('${masters.entitle.smfname_eng}+${data.entitle.smfname_eng}+${data1.entitle.smfname_eng}',${masters.entitle.smfid});" href="#"</c:when><c:otherwise>href="${action1}"</c:otherwise></c:choose>>${data1.entitle.smfname_eng}</a> --%>
												breadcrumbMultiLang('${masters.entitle.smfname_eng}+${data.entitle.smfname_eng}+${data1.entitle.smfname_eng}','${masters.entitle.smfname_mar}+${data.entitle.smfname_mar}+${data1.entitle.smfname_mar}',${masters.entitle.smfid});" href="#"</c:when><c:otherwise>href="${action1}"</c:otherwise></c:choose>>${(langId eq 1) ? data1.entitle.smfname_eng : smfname_mar}</a>
															<ul>
																<c:forEach items="${menuRoleEntitlement.childList}" var="data2">
																	<c:if test="${data1.entitle.smfid eq  data2.parentId}">
																	
																		<c:set var="action2" value="${data2.entitle.smfaction}" />
																		<li class="folder" id="${data2.entitle.smfid}"><a role="link" title="${(langId eq 1) ? data2.entitle.smfname_eng : data2.entitle.smfname_mar}"  <c:choose><c:when test="${fn:containsIgnoreCase(action2 , '.html')}">onclick="openRelatedForm('${action2}');
																		...
																		breadcrumbMultiLang('${masters.entitle.smfname_eng}+${data.entitle.smfname_eng}+${data1.entitle.smfname_eng}+${data2.entitle.smfname_eng}','${masters.entitle.smfname_mar}+${data.entitle.smfname_mar}+${data1.entitle.smfname_mar}+${data2.entitle.smfname_mar}',${masters.entitle.smfid});" href="#"</c:when><c:otherwise>href="${action2}"</c:otherwise></c:choose>>${(langId eq 1) ? data2.entitle.smfname_eng : data2.entitle.smfname_mar}</a>
																			<ul>
																				<c:forEach items="${menuRoleEntitlement.childList}"	var="data3">
																					<c:if test="${data2.entitle.smfid eq  data3.parentId}">	
																							<c:set var="action3" value="${data3.entitle.smfaction}" />
																						<li class="folder" id="${data3.entitle.smfid}"><a role="link" title="${(langId eq 1) ? data3.entitle.smfname_eng :  data3.entitle.smfname_mar}" <c:choose><c:when test="${fn:containsIgnoreCase(action3 , '.html')}">onclick="openRelatedForm('${action3}');
