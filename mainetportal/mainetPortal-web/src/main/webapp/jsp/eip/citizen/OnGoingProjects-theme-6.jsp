...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item active"><spring:message code="theme6.portal.on.going.projects" text="On-Going Projects" /></li>
</ol>
				...
				<table class="table table-bordered table-striped dataTableNormal">
					...
					<tbody>
						...
						<fmt:formatDate value="${lookUp.validityDate}" pattern="yyyy-MM-dd HH:mm:ss" var="vDate"/>
							<c:if test="${lookUp.isUsefullLink eq 'P' &&  iDate le myDate &&  myDate le vDate}">
