...
<ol class="breadcrumb">
	...
	<li class="active"><spring:message code="theme4.portal.balance.sheet" text="Balance Sheet"/></li>
</ol>
...
<div class="content animated">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="theme4.portal.balance.sheet" text="Balance Sheet"/>
			</h2>
		</div>
