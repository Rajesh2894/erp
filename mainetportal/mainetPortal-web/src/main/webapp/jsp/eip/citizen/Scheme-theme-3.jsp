...
<ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><spring:message code="theme3.portal.new.links" text="New Links"/></li>
</ol>
	...
	<div class="col-sm-12" id="nischay">
		<div class="widget">
			<div class="widget-header">
				<h2><spring:message code="theme3.portal.new.links" text="New Links"/></h2>
			</div>
