...
<form:form method="post" action="CitizenFeedBack.html" name="frmCitizenFeedBack" id="frmCitizenFeedBack">
  <div class="container padding-40" id="CitizenService">
   <div class="col-md-12">
      <div class="feedback-panel share-ideas-section">
         <div class="widget margin-bottom-0 si-content">
            <div class="widget  margin-bottom-0" id="content">
               <div class="widget-header">
                  <h2>
                     <strong>
                        <spring:message code="feedback.published" />
                     </strong>
                  </h2>
               </div>
