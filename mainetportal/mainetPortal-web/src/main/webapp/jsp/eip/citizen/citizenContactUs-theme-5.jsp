					...
					<div class="row">
	                    ...
	                    <jsp:include page="/jsp/tiles/validationerror.jsp" />
							<form:form method="post" action="CitizenContactUs.html"
								...
								class="form-horizontal contact-us-form" role="form">
								<div class="form-group">
									<label class="col-xs-4 col-sm-4 control-label required-control" for="phoneno"><spring:message code="MobileNo" text="Mobile No"/> </label>
									<div class="col-xs-8 col-sm-8">
										<form:input type="text"
											class="input2 hasMobileNo form-control" id="phoneno" name=""
											path="eipUserContactUs.phoneNo"
											placeholder="" maxlength="10"></form:input>
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-4 col-sm-4 control-label required-control" for="Fname"><spring:message code="FirstName" text="First Name"/></label>
									<div class="col-xs-8 col-sm-8">
										<form:input type="text"
								...
								<div class="form-group">
									<label class="col-xs-4 col-sm-4 control-label required-control" for="Lname"><spring:message code="LastName" text="Last Name"/></label>
									<div class="col-xs-8 col-sm-8">
										<form:input type="text"
								...
								<div class="form-group">
									<label class="col-xs-4 col-sm-4 control-label required-control" for="emailId"><spring:message code="Email" text="Email"/></label>
									<div class="col-xs-8 col-sm-8">
								...
								<div class="form-group">
									<label class="col-xs-4 col-sm-4 control-label required-control" for="DescQuery"><spring:message code="Description" text="Description"/></label>
									<div class="col-xs-8 col-sm-8">
								...
								<%-- <div class="form-group">
									<label class="col-xs-4 col-sm-4 control-label required-control" for="contactUs"><spring:message code="ContactUs" text="ContactUs"/></label>
									<div class="col-xs-8 col-sm-8">
										<form:select
										cssClass=" form-control mandClassColor subsize"
										path="" id="eipUserContactUs-contactUs" onchange="contactUsAction(this);" aria-label="Select Section">
										<form:option value="0"><spring:message code="Select"  text="Select"/></form:option>
										<c:forEach items="${command.contactOptionList}" var="contactOption"
											varStatus="lktype">
											<form:option value="${contactOption}">${contactOption}</form:option>
										</c:forEach>
									</form:select>
									</div>
								</div> --%>
								 ...
								 <%-- <div class="form-group">
									...
									<label class="col-xs-4 col-sm-4 control-label" for="eipUserContactUs.attPath"><spring:message
