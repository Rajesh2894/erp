					...
					<div class="content tab-boxed">
						<div class="accesform">
							<div>
								...
								<form:form method="post" action="AccessibilityLanding.html" id="frmchangetextsize1" cssClass="form-horizontal" modelAttribute="command">
								...
								<div class="text-center padding-bottom-20">
									<c:if
										...
										<input type="submit" name="applyoptions" value="<spring:message code="apply" text="Apply" />"
											...
											<input type="submit" class="btn btn-primary" value="<spring:message code="reset.default" text="Reset Default" />"  onclick="setTextContrast2()">
									</c:if>
									<c:if
										test="${empty userSession.employee.emploginname or userSession.employee.emploginname eq'NOUSER' }"
										var="user">
										<input type="submit" name="applyoptions" value="Apply"
											class="btn btn-primary " onclick="setcontrast2()">
											<input type="submit" class="btn btn-primary" value="<spring:message code="reset.default" text="Reset Default" />"  onclick="setTextContrast2()">
									</c:if>
								</div>
