	...
	$(document).ready(function() {
		...
		$('#quote-carousel').carousel({ interval: 4000, cycle: true });
	  	...
	  	$('.addFeedBackBtn').on('click', function() {
	 		window.location.href = 'CitizenFeedBack.html';
		});
	});
</script>
	...
	<div class="feedback">
		<div class="dashboard-page" id="CitizenService">
	         ...
	         <div class="traverse-buttons">
				<a class="btn btn-success addFeedBackBtn" href='javascript:void(0);'>
				    <span><spring:message code="feedback.Sendfeedback2"/></span>
				</a>
