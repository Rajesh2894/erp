         ...
         <div class="widget margin-bottom-0">
            <div class="widget  margin-bottom-0" id="content">
               <div class="widget-header">
                  <h2>
                     <strong>
                        <spring:message code="feedback.formTitle" />
                     </strong>
                  </h2>
               </div>
               ...
               <div class="widget-content padding">
                  ...
                  <form:form method="post" action="CitizenFeedBack.html?sendfeedback"
                     name="frmCitizenFeedBack" id="frmCitizenFeedBack">
                     <div class="form-group">
                        <label for="fdUserName">
                           <spring:message code="feedback.name" />
                           <span
                              class="mand">*</span> 
                        </label>
                        <apptags:inputField fieldPath="feedback.fdUserName"
                           cssClass="form-control hasSpecialChara mandClassColor " hasId="true" />
                     </div>
                     <div class="form-group">
                        <label for="mobileNo">
                        ...
                        <apptags:inputField fieldPath="feedback.mobileNo"
                           cssClass=" hasMobileNo  form-control mandClassColor " hasId="true" />
                     </div>
                     <div class="form-group">
                        <label for="emailId">
                        ...
                        <apptags:inputField fieldPath="feedback.emailId" hasId="true"
                           cssClass=" form-control mandClassColor " isDisabled="" />
                     </div>
                     <div class="form-group">
                        <label for="feedback.feedBackDetails">
                           <spring:message
                              code="feedback.comments" />
                           <span class="mand">*</span>
                        </label>
                        <form:textarea path="feedback.feedBackDetails"
                           cssClass="form-control mandClassColor" onkeyup="countChar(this)" onclick="countChar(this)" onblur="spanHide()"/>
                     ...
                     <div class="row">
                        <div class="col-xs-4">
                           <input type="button" class="btn btn-primary btn-block"
                              onclick="dofeedback(this);"
                              value="<spring:message code="feedback.Sendfeedback1"/>" />
                        </div>
                        <div class="col-xs-4">
