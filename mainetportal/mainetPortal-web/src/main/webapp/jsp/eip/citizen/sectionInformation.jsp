                           ...
                           <tr>
                              ...
                              <c:forEach items="${lookUps}" var="lookUp">
                                 ...
                                 <c:if
                                    ...
                                    <c:set var="fileInfo" value="${fn:split(lookUp.lookUpDesc, '/')}" />
										<c:set var="lastUpdated" value="${fn:trim(fn:split(fileInfo[1], '-')[1])}" />
										<fmt:formatDate var="updatedDate" value="${lastUpdated}" pattern="MMM-yyyy" />
                                       <c:forEach items="${links}" var="download"
                                          ...
                                          <div class="uploaded-file">
	                                          ...
	                                          <div style="clear:both;"></div>
												...
												<td> <span class="uploaded-file-name">${link}</span> </td>
												<td> <strong style="display: block;text-align: center; ">
														<spring:message code="theme6.file.size" text="File Size" />
														 : ${fileSize}
													</strong> 
												</td>
												</tr>
												<tr>
												<td colspan="3"> <h7 style="display: block; text-align: center;"><spring:message code="important.notice.updated.date" text="Last Updated Date" />&nbsp;${fileInfo[1]}</h7> </td>
												</tr> 
												</tbody>
												</table>
                                          </div>
