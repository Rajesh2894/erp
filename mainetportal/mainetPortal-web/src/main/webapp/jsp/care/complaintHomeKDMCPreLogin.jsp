	...
	<div class="widget">
		...
		<div class="widget-content padding">
			...
			<form:form id="care" name="care" class="form-horizontal"
				...
				<form:hidden path="userSession.employee.emploginname" id="currentUser" />
						...
						<div class="panel panel-default">
							...
							<div id="Complaint_Location_Details"
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<label class="col-sm-2 control-label required-control"
											for="departmentComplaint"><spring:message
												code="care.skdclCompType" text="Complaint Type" /></label>
										<div class="col-sm-4">
										...
										<label class="col-sm-2 control-label required-control"
											for="complaintType"><spring:message
												code="care.skdclCompSubType" text="Complaint Sub Type" /></label>
										<div class="col-sm-4">
											<form:select class="form-control chosen-select-no-results"
												...
												<c:forEach var="comp" items="${command.complaintTypes}">
													<form:option value="${comp.lookUpId}">${comp.descLangFirst}</form:option>
												</c:forEach>
											</form:select>
										</div>
									...
									<div class="form-group" id="kdmcWardZoneDiv">
										<apptags:lookupFieldSet cssClass="form-control required-control"
										baseLookupCode="${command.careRequestDto.prefixName}" hasId="true" pathPrefix="careRequestDto.ward"
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<form:textarea name="" cols="" rows="" class="form-control"
												id="ComplaintDescription" path="careRequestDto.description"
										...
										<%-- <div class="form-group">
											...
											for="location"><spring:message
												code="care.skdclLocation" text="Location" /></label>
											<div class="col-sm-4">
												<form:select class="form-control chosen-select-no-results"
									...
									<label class="col-sm-2 control-label required-control" for="Landmark"><spring:message
												code="care.skdcllandmarkLoc" text="Landmark/Location"/></label>
										<div class="col-sm-4">
									...
									<%-- <div class="form-group">
										<c:if test="${command.saveMode eq 'V' ? true : false }">
											<label
												class="col-sm-2 control-label required-control datePicker"><spring:message
													code="" text ="Reference Date" /></label>
											<div class="col-sm-4">
										...
										<c:if test="${command.saveMode eq 'V' ? false : true }">
											<apptags:date labelCode="care.referencedate"
												...
												datePath="careRequestDto.referenceDate" isMandatory="false"></apptags:date>
										</c:if>
										<label class="col-sm-2 control-label" for="refNo"><spring:message
												code="" text="Reference Number" /></label>
										<div class="col-sm-4">
											<form:input name="" type="text" id="Landmark"
												class="form-control" path="careRequestDto.landmark"
												disabled="${command.saveMode eq 'V' ? true : false }"></form:input>
									...
									<c:if test="${command.saveMode eq 'V' ? false : true }">
										<div class="form-group" >
											...
											<label class="col-sm-2 control-label" id="careDocLbl"><spring:message
