		...
		<div class="widget">
			...
			<div class="widget-content padding">
				<form:form id="RoadCuttingId" action="RoadCutting.html"
					...
					<div
						class="warning-div error-div alert alert-danger alert-dismissible hide"
						id="errorDiv"></div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label"> <spring:message
								code="" text="Upload Start Point Image" />
						</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<form:input
								...
								class="form-control" maxlength="500" placeholder="Latitude" id="sLatitude"/>
								</div>
						<div class="col-sm-2">
							<form:input
								path="roadCuttingDto.roadList[${index}].rcdStartlogitude"
								class="form-control" maxlength="500" placeholder="Longitude" id="sLongitude"/>
						</div>
						<label class="col-sm-2 control-label"><spring:message
						...
						<div class="col-sm-2">
							<form:input
								...
								class="form-control" maxlength="500" placeholder="Latitude"  id="eLatitude"/>
							</div>
							<div class="col-sm-2">	
							<form:input
								path="roadCuttingDto.roadList[${index}].rcdEndlogitude"
								class="form-control" maxlength="500" placeholder="Longitude" id="eLongitude"/>
						</div>
					</div>
