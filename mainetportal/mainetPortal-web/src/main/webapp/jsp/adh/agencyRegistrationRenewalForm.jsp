	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				...
				<h2>
					<spring:message code="agency.registration.renewal.form.title"
						text="Renewal Of Agency License" />
				</h2>
			</div>
			<div class="widget-content padding">
				...
				<form:form action="AgencyRegistrationRenewalForm.html"
					name="AgencyRegistrationRenewalForm"
					id="AgencyRegistrationRenewalForm" class="form-horizontal">
						...
						<div class="form-group margin-top-10">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control"
									...
									href="AgencyRegistrationRenewalForm.html?showChargeDetails"> <spring:message
					...
					<c:if test="${command.formDisplayFlag eq 'N' && command.saveMode ne 'VIEW' }">
						<div class="text-center margin-bottom-10">
							...
							<button type="button" class="btn btn-warning" title="Reset"
								onclick="window.location.href='AgencyRegistrationRenewalForm.html'">
					...
					<c:if test="${command.formDisplayFlag eq 'Y'}">
						<div class="text-center margin-bottom-10">
							...
							<c:set var = "backUrl" scope = "session" value = "AgencyRegistrationRenewalForm.html"/>
