...
<script type="text/javascript"
	src="js/adh/renewalOfAdvertisementLicense.js"></script>
...
<div class="content">
	<div class="widget">
		...
		<div class="widget-content padding">
			...
			<form:form method="POST" action="RenewalOfAdvertisementLicense.html"
				class="form-horizontal" id="renewalAdvertisementLicenseView"
				name="renewalAdvertisementLicenseView">
