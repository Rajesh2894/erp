									...
									<div class="col-sm-4">
										<div class="input-group">
											<form:input
												...
												id="licenseFromDate"
												class="form-control mandColorClass fromDatePicker"
									...
									<div class="col-sm-4">
										<div class="input-group">
											<form:input
												...
												class="form-control mandColorClass toDatePicker"
												maxlength="10" />
							...
							<h4 class="panel-title">
								<a data-toggle="collapse"
									data-parent="#accordion_single_collapse" href="#a3"> <spring:message
										code="adh.new.hoarding.applicant.details"
