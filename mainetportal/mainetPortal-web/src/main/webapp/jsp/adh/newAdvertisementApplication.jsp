	...
	<div class="widget">
		...
		<div class="widget-content padding">
			...
			<form:form method="POST" action="NewAdvertisementApplication.html"
				class="form-horizontal" id="newAdvertisementApplication"
				name="newAdvertisementApplication">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<%-- <c:if test="${ command.saveMode ne 'VIEW' }"> --%>
										...
										<div class="input-group">
											<form:input
												path="advertisementReqDto.advertisementDto.licenseFromDateStr"
												id="licenseFromDateStr"
												class="form-control mandColorClass datePicker"
												maxlength="10" />
											<label class="input-group-addon" for="licenseFromDate"><i
												class="fa fa-calendar"></i><span class="hide"> <spring:message
									...
									<%-- <c:if test="${ command.saveMode ne 'VIEW' }"> --%>
										...
										<div class="input-group">
											<form:input
												path="advertisementReqDto.advertisementDto.licenseToDateStr"
												id="licenseToDateStr"
												class="form-control mandColorClass datePicker"
												maxlength="10" />
											<label class="input-group-addon" for="licenseToDate"><i
								...
								<div class="form-group">
								<%-- <apptags:input labelCode="adh.new.advertisement.property.no"
						         path="advertisementReqDto.advertisementDto.propNumber" onblur ="getPropertyDetails(this)"></apptags:input> --%>
									<label class="col-sm-2 control-label"><spring:message
											code="adh.new.advertisement.property.no"
											text="Property number" /></label>
									<div class="col-sm-4">
										<form:input type="text" class="form-control"
											onblur="getPropertyDetails(this)"
											path="advertisementReqDto.advertisementDto.propNumber"
											id="propNumber" readonly="" data-rule-required="false"></form:input>
									</div>

									<label class="col-sm-2 control-label"><spring:message
											code="adh.new.advertisement.property.owner"
											text="Property owner" /></label>
									<div class="col-sm-4">
										<form:input type="text" class="form-control"
											path="advertisementReqDto.advertisementDto.propOwnerName"
											id="propOwnerName" readonly="true" data-rule-required="false"></form:input>
									</div>
									<%-- <apptags:input labelCode="adh.new.advertisement.property.owner"
										path="advertisementReqDto.advertisementDto.propOwnerName" isDisabled="true"></apptags:input> --%>
								</div>
								
								<div class="form-group">
									<label class="col-sm-2 control-label"><spring:message
											code="adh.new.advertisement.property.address"
											text="Property address" /></label>
									<div class="col-sm-4">
										<form:input type="text" class="form-control"
											path="advertisementReqDto.advertisementDto.propAddress"
											id="propAddress" readonly="true" data-rule-required="false"></form:input>
									</div>
									<%-- <apptags:input
										labelCode="adh.new.advertisement.property.address"
										path="advertisementReqDto.advertisementDto.propAddress" isDisabled="true"></apptags:input> --%>
										<label class="col-sm-2 control-label"><spring:message
											code="adh.new.advertisement.property.outstanding.amount"
											text="Property outstanding amount" /></label>
									<div class="col-sm-4">
										<form:input type="text" class="form-control"
											path="advertisementReqDto.advertisementDto.propOutstandingAmt"
											id="propOutstandingAmt" readonly="true" data-rule-required="false"></form:input>
									</div>
									<%-- <apptags:input
										labelCode="adh.new.advertisement.property.outstanding.amount"
										path="advertisementReqDto.advertisementDto.propOutstandingAmt" isDisabled="true"></apptags:input> --%>
								</div>
							 </div>
						</div> 
							...
							<div class="form-group margin-top-10">
								...
								<div class="col-sm-4">
									...
									<a class="fancybox fancybox.ajax text-small text-info" 
										href="NewAdvertisementApplication.html?showChargeDetails"><spring:message
						...
						<div class="text-center margin-top-15">
							<c:if
								...
								<button type="button" class="btn btn-success"
									onclick="getApplicableChecklistAndCharges(this)">
								...
								<button type="button" class="btn btn-warning"
									onclick="resetAdvApplication(this);">
							...
							<c:if test="${command.enableSubmit eq 'Y' && command.saveMode ne 'VIEW' }">
								<button type="button" class="btn btn-success"
									onclick="saveNewAdvApplication(this);">
									<i class="fa fa-floppy-o padding-right-5" aria-hidden="true"></i>
