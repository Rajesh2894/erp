...
<div class="content"> 
	<div class="widget ">
		<div class="widget-header">
			<h2>
				<strong><spring:message code="" text="SMS And Email" /></strong>
			</h2>
		</div>
...
<div class="widget-content padding">
	...
	<jsp:include page="/jsp/tiles/validationerror.jsp" />
	  ...
	  <div class="form-group">							
		<label class="col-sm-2 control-label" for="entity.dpDeptid.dpDeptid"><spring:message code="rti.depName" text="Department Name"/> <span class="mand">*</span></label>
			<div class="col-sm-4"> 
			...
			<input type="hidden" value="${command.entity.serviceId.serviceId}" id="selectedSmId"/>
			 <label class="col-sm-2 control-label" for="smId"><spring:message code="rti.serviceName" text="Service Name"/><span class="mand">*</span></label>
				<div class="col-sm-4">
				<select class="form-control mandColorClass serviceList" name="entity.serviceId.serviceId" id="smId" disabled="disabled">
			...
			<div class="form-group">
			  ...
			  <div class="col-xs-8">
				...
				<div class="text-center">
					<input type="submit" class="btn btn-success" id="submitButton" onclick="return saveForm(this);" value="<spring:message code="saveBtn" />" /> 
					<%-- <input type="reset" class="btn btn-warning" id="resetButton" value="<spring:message code="eip.commons.resetBT"/>"> --%>
			       <input type="button" class="btn btn-danger"  onclick="window.location.href='SMSAndEmail.html?complete'" value="<spring:message code="bckBtn" text="Back"/>" id="backBtn"> 
					<!-- </span> -->
				</div>
			 </c:if>
</form:form>
