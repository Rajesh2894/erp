...
<script type="text/javascript" src="js/rts/rtsFirstAppeal.js"></script>
	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<h2>
					<b><spring:message code="" text="RTS First Appeal Form"></spring:message></b>
				</h2>
			...
			<div class="widget-content padding">
				...
				<form:form method="POST" action="FirstAppeal.html"
					class="form-horizontal" id="FirstAppeal" name="FirstAppeal">
					...
					<table class="table table-bordered table-striped" id="firstAppeal">
						<tr>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<label class="radio-inline "> <form:radiobutton
									id="reasonForAppeal" path="firstAppealDto.reasonForAppeal" value="INR"  checked="true" /> <spring:message
