...
<script src="js/water/plumberRenewal.js"></script>
<style>
select#applicantTitle[readonly="readonly"] {
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="" text="Plumber Renewal" />
			</h2>
		...
		<div class="widget-content padding">
			...
			<form:form action="PlumberLicenseRenewal.html"
				...
				<form:hidden path="" id="plumIdFlag" value="${command.flag}" />
				...
				<div class="form-group" id="searchTab">
					<div class="text-center padding-bottom-10">
						...
						<button type="button" id="searchButt" class="btn btn-info"
							onclick="viewLicenseDetails(this)">
							<i class="fa fa-search"></i> View Details
						</button>
						<button type="button" id="backButt" class="btn btn-danger"
							onclick="window.location.href='CitizenHome.html'" value="Back"><spring:message code="water.btn.Back" />
						</button>
						<button type="button" id="resetBtn" class="btn btn-warning"
							onclick="window.location.href='PlumberLicenseRenewal.html'" value="Reset"><spring:message code="rstBtn" />
						</button>				
					</div>
				...
				<div class="panel-group accordion-toggle"
					...
					<%--<div class="form-group">
					 ...
					 <div class="col-sm-4">
							<apptags:formField fieldType="7"
								fieldPath="plumberLicenseReqDTO.plumImage" labelCode=""
					...
					<div class="padding-top-10 text-center hideConfirmBtn">
						...
						<button type="button" class="btn btn-danger"
							onclick="window.location.href='PlumberLicenseRenewal.html'" value="Back"><spring:message code="water.btn.Back" /> </button>
					...
					<c:if test="${command.checkListNCharges eq 'Y'}">
						...
						<div class="text-center padding-bottom-20" id="divSubmit">
							...
							<input type="button" class="btn btn-danger"
								onclick="window.location.href='CitizenHome.html'" value="Cancel" />
						</div>
					</c:if>
				</div>
			</form:form>
