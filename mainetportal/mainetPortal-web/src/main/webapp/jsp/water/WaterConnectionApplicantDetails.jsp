...
<div id="Applicant" class="panel-collapse collapse in">
 <div class="panel-body">
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<form:input name="" type="text" class="form-control"
				path="applicantDetailDto.villageTownSub" id="villTownCity" data-rule-required="true"/> 
		</div>
	...
	<%-- <div class="form-group" id="bpldiv">
		...
		<div class="col-sm-4">
			...
			<form:input  type="text" class="form-control"
				path="applicantDetailDto.bplNo" id="bplNo" maxlength="16" data-rule-required="true"/>
