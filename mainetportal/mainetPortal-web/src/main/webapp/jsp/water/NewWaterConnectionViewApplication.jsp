...
<div id="validationDiv">
	...
	<div class="content">
	 ...
	 --%>
							...
							<div class="panel-group accordion-toggle hidden-print"
										...
										<div class="form-group margin-top-10">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control"
													...
													href="NewWaterConnectionForm.html?showChargeDetails" target="_blank"><spring:message
							...
							<div class="form-group padding-top-10 hidden-print">
								<div class="col-sm-12">
