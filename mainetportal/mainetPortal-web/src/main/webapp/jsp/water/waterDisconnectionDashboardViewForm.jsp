						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" class=""
									...
									href="#Disconnection_Details"> <spring:message
							...
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<form:input path="connectionNo" id="csIdn"
											class="form-control" data-rule-required="true" disabled="true"></form:input>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<form:input path="consumerName" cssClass="form-control"
											id="consumerName" readonly="true" disabled="true"/>
									...
									<div class="col-sm-4">
										<form:input path="areaName" cssClass="form-control"
											id="consumerAreaName" readonly="true" disabled="true"/>
								...
								<div class="form-group">
									...
									<apptags:lookupField
										...
										selectOptionLabelCode="water.select" isMandatory="true" disabled="true"/>
									...
									<div class="col-sm-4">
										<form:textarea path="disconnectionEntity.discReason"
											...
											data-rule-required="true" maxlength="500" disabled="true"></form:textarea>
									</div>
								</div>
										...
										<div class="col-sm-4">
											<div class="input-group">
												<form:input path="disconnectionEntity.disconnectFromDate"
													cssClass="form-control disDate" id="fromDate" disabled="true"/>
										...
										<div class="col-sm-4">
											<div class="input-group">
												<form:input path="disconnectionEntity.disconnectToDate"
													cssClass="form-control distDate" id="toDate" disabled="true"/>
								...
								<div class="form-group">
									...
									<div class="radio col-sm-2">
										<label><form:radiobutton path="ulbPlumber" value="Y"
												onclick="notUlbPlumber()" id="Yes" disabled="true"/> <spring:message
												code="water.plumber.reg" text="ULB Registered" /></label>
									</div>
									<div class="radio col-sm-2">
										<label><form:radiobutton path="ulbPlumber" value="N"
												onclick="notUlbPlumber()" id="No" disabled="true"/> <spring:message
