 ...
 <%--  <apptags:breadcrumb></apptags:breadcrumb> --%>
    ...
    <div class="content"> 
      ...
      <div class="widget" id="receipt">
        ...
        <div id="now">
          <div class="row">
            <div class="col-xs-3 text-left"><img alt="logo" src="../../assets/img/logo.png"></div>
            ...
            <div class="col-xs-3 text-right"><img alt="logo" src="../../assets/img/logo.png"></div>
          </div>
          ...
          <div class="row clearfix margin-top-10">
            ...
            <div class="col-xs-9 col-xs-push-3">
            	<p><spring:message code="water.ward.div" /></p>
                <p><spring:message code="water.block.div" /></p>
                <p><spring:message code="water.zone.div" /></p>
            </div>
          </div>
