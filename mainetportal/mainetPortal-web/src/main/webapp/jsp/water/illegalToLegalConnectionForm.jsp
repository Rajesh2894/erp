...
<script>
	$(document).ready(function() {
		...
		{
		$("#isConsumer").attr("checked","checked");
		}
		else
			{
			$("#isConsumer").attr("checked","");
			}
	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<h2>
					<spring:message code="" text="Illegal To Legal Water Connection"/>
				</h2>
							...
							<div id="waterpropertydetails">
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<form:input type="text" class="form-control"
												...
												readonly="" data-rule-required="true"></form:input>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<form:input type="text" class="form-control"
												path="reqDTO.propertyNo" id="propertyNo" readonly="true"
