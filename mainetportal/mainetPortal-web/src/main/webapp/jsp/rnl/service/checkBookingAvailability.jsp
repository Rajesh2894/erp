...
<div class="content animated slideInDown">
	<div class="widget">
		...
		<div class="widget-content padding">
			...
			<%-- <c:if test="${command.checkBookingFlag ne 'Y'}">
				...
				<div class="text-center padding-10">
				<button type="button" class="btn btn-blue-2" data-dismiss="modal" onclick="getLogin('${command.serviceURL}')"><spring:message code="bookButton"/></button>
				<input type="button" class="btn btn-danger" id="backBtnId" onclick="window.location.href='CitizenHome.html'" value=<spring:message code="backButton"/> />					
					</div>
			</div>
		</div>
	</div>
