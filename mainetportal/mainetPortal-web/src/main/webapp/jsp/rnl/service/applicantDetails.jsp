...
<script type="text/javascript" src="js/rnl/service/estateBookingForm.js"></script>
	...
	<div class="panel-body">
		...
		<apptags:lookupField items="${command.getLevelData(baseLookupCode)}"
			path="bookingReqDTO.applicantDetailDto.applicantTitle" cssClass="form-control"
		...
		<div class="col-sm-4">
			<form:input  type="text" class="form-control"
				path="bookingReqDTO.applicantDetailDto.applicantFirstName" id="firstName" data-rule-required="true"></form:input>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-4">
			<form:input  type="text" class="form-control"
				path="bookingReqDTO.applicantDetailDto.applicantMiddleName" id="middleName"></form:input>
		</div>
		<label class="col-sm-2 control-label required-control" for="lastName"><spring:message code="applicantinfo.label.lastname"/></label>
		<div class="col-sm-4">
			<form:input  type="text" class="form-control"
				path="bookingReqDTO.applicantDetailDto.applicantLastName" id="lastName" data-rule-required="true"></form:input>
		</div>
	</div>
	<div class="form-group">
		...
		<apptags:lookupField items="${command.getLevelData(baseLookupCode)}"
			path="bookingReqDTO.applicantDetailDto.gender" cssClass="form-control"
			hasChildLookup="false" hasId="true" showAll="false"
			selectOptionLabelCode="applicantinfo.label.select" isMandatory="true" />
		<label class="col-sm-2 control-label required-control" for="mobileNo"><spring:message code="applicantinfo.label.mobile"/></label>
		<div class="col-sm-4">
			<form:input  type="text" class="form-control"
				 path="bookingReqDTO.applicantDetailDto.mobileNo" id="mobileNo" data-rule-required="true" data-rule-digits="true" data-rule-minlength="10" data-rule-maxlength="10"></form:input>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-4">
			<form:input  type="text" class="form-control"
				path="bookingReqDTO.applicantDetailDto.emailId" id="emailId" data-rule-email="true"></form:input>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<form:input  type="text" class="form-control"
				path="bookingReqDTO.applicantDetailDto.buildingName" id="buildingName"></form:input>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<form:input  type="text" class="form-control"
				path="bookingReqDTO.applicantDetailDto.blockName" id="blockName" maxlength="10"></form:input>
		</div>
		<label class="col-sm-2 control-label required-control" for="areaName"><spring:message code="applicantinfo.label.areaname"/></label>
		<div class="col-sm-4">
			<form:input  type="text" class="form-control"
				path="bookingReqDTO.applicantDetailDto.areaName" id="areaName" data-rule-required="true"></form:input>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-4">
			<form:input  type="text" class="form-control"
				path="bookingReqDTO.applicantDetailDto.villageTownSub" id="villTownCity" data-rule-required="true"></form:input>
		</div>
		<label class="col-sm-2 control-label required-control" for="pinCode"><spring:message code="applicantinfo.label.pincode"/></label>
		<div class="col-sm-4">
			<form:input  type="text" class="form-control "
				path="bookingReqDTO.applicantDetailDto.pinCode" id="pinCode"  data-rule-required="true" data-rule-maxlength="6" data-rule-digits="true"></form:input>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-4">
       <form:input  type="text" class="form-control"
				path="bookingReqDTO.applicantDetailDto.aadharNo" id="aadharNo" data-mask="9999 9999 9999"/>

		</div>
		<label class="col-sm-2 control-label" for="panId">PAN No.</label>
		<div class="col-sm-4">
			<form:input  type="text" class="form-control"
				path="bookingReqDTO.applicantDetailDto.panNo" id="panId" data-rule-maxlength="12" />
		</div>
	</div>
