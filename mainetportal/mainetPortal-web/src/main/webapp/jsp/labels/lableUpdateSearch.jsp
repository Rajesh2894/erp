...
<script src="js/lableUpdate.js"></script>
	     ...
	     <apptags:helpDoc url="LableUpdateSearch.html"></apptags:helpDoc>
			<div class="widget-content padding ">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label required-control"><spring:message code="select.property" text="Select Property File"/></label>
					<div class="col-sm-6">				
