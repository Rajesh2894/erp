...
%>
<script src="js/menu/dataEntitle.js"></script>
...
<div class="text-center margin-top-10">
	<input type="button" id="dataEntitleSubmit" class="btn btn-success"
		value='${saveRole}'> <input type="button"
		id="addDataBackButton" class="btn btn-danger" value="${backBtn}"
		onclick="back();">
