...
<div id="Applicant" class="panel-collapse collapse in">
 <div class="panel-body">
	<div class="form-group">
		...
		<div class="col-sm-4">
			<form:input name="" type="text" class="form-control hasCharacter" maxlength="100"
				path="applicantDetailDto.applicantFirstName" id="firstName" data-rule-required="true" readonly="${disabled}" data-msg-required="${validationMessage}"></form:input>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<form:input name="" type="text" class="form-control hasCharacter" maxlength="100"
				path="applicantDetailDto.applicantLastName" id="lastName" data-rule-required="true" readonly="${disabled}" data-msg-required="${validationMessage}"></form:input>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<form:input name="" type="text" class="form-control hasNumber" readonly="${disabled}" 
				maxlength="10" path="applicantDetailDto.mobileNo" id="mobileNo" data-rule-minlength="10" data-rule-required="true" data-msg-required="${validationMessage}"></form:input>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<form:input name="" type="text" class="form-control" maxlength="100" readonly="${disabled}"
				path="applicantDetailDto.areaName" id="areaName" data-rule-required="true" data-msg-required="${validationMessage}"></form:input>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<form:input name="" type="text" class="form-control hasNumber required" readonly="${disabled}" 
				path="applicantDetailDto.pinCode"  id="pinCode" maxlength="6" data-rule-required="true" data-msg-required="${validationMessage}"></form:input>
