    ...
    c.extend(h, {
        ...
        defaults: {
            ...
            tpl: {
                ...
                image: '<img class="fancybox-image" src="{href}" alt="Fancy Box Images" />',
                iframe:
        ...
        _afterZoomIn: function () {
            ...
            a &&
                ...
                a.arrows && h.group.length > 1 && ((a.loop || a.index > 0) && c(a.tpl.prev).appendTo(h.outer).bind("click.fb", h.prev), (a.loop || a.index < h.group.length - 1) && c(a.tpl.next).appendTo(h.outer).bind("click.fb", h.next)),
                h.trigger("afterShow"),
        ...
        (h.helpers.overlay = {
            ...
            onReady: function (a, b) {
                var d = this.overlay;
                c(".fancybox-overlay").stop(!0, !0), d || this.create(a), !0 === a.showEarly && this.beforeShow.apply(this, arguments);
            },
        ...
        g.ready(function () {
            ...
            c.scrollbarWidth === d &&
                ...
                c("<style>.fancybox-margin{margin-right:" + (f - b) + "px;}</style>").appendTo("head");
        });
