                ...
                if ("TABLE" !== this.tagName.toUpperCase()) alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var n = function(a, b) {
                            ...
                            la = function(c, d) {
                                var e = "",
                                    f = "<table style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",
                                    i = "",
                                ...
                                m = c + "_center";
                                l = c + "_right";
                                b("#" + b.jgrid.jqID(c)).append("<div id='" + j + "' class='ui-pager-control' role='group'><table  class='ui-pg-table' style='width:100%; table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='" + k + "'  style='white-space:pre;'></td><td id='" + l + "'></td><td id='" + m + "'></td></tr></tbody></table></div>").attr("dir",
                                    "ltr");
                                if (a.p.rowList.length > 0) {
                                	var gridList=[5,10,15,20,25,30,50,100,500,1000,2000];
                                    i = "<td dir='" + g + "'>";
                                    i = i + "<select class='ui-pg-selbox' role='listbox' aria-label='list size'>";
                                    for (k = 0; k < gridList.length; k++) i = i + ('<option role="option" value="' + gridList[k] + '"' + (a.p.rowNum === gridList[k] ? ' selected="selected"' : "") + ">" + gridList[k] + "</option>");
                                    i = i + "</select></td>"
                                }
                                g === "rtl" && (f = f + i);
                                a.p.pginput === true && (e = "<td dir='" + g + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox' aria-label='page number'/>", "<span id='sp_1_" +
                        ...
                        var x = b("thead:first", a).get(0),
                            N = "";
                        a.p.footerrow && (N += "<table role='grid' style='width:" + a.p.tblwidth + "px' class='ui-jqgrid-ftable'><tbody><tr role='row' class='ui-widget-content footrow footrow-" +
                            g + "'>");
                        var j = b("tr:first", x),
                ...
                if (!this.ftoolbar) {
                    var e = function() {
                        ...
                        d = function(k, g, f) {
                            ...
                            for (d = 0; d < j.sopt.length; d++) m = a.inArray(j.sopt[d], h), -1 !== m && (i = f === b.odata[m].oper ? "ui-state-highlight" : "", g += '<li class="ui-menu-item ' + i +
                                '" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="' + b.odata[m].oper + '" oper="' + b.operands[b.odata[m].oper] + '"><table><tr><td width="25px">' + b.operands[b.odata[m].oper] + "</td><td>" + b.odata[m].text + "</td></tr></table></a></li>");
                            a("body").append(g + "</ul>");
                    ...
                    a.each(c.p.colModel, function(k) {
                        ...
                        var t = "=",
                            ...
                            l = a("<table class='ui-search-table'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear'></td></tr></table>");
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(+e.p.id)));
                        ...
                        a("#" + h + "_search").bind("click", function() {
                            ...
                            if (b.stringResult) {
                                ...
                                if (typeof k === "string") {
                                    d[b.sFilter] = k;
                                    a.each([b.sField, $.trim(b.sValue), b.sOper],
                                        function() {
                                            d[this] = ""
                                        })
                                }
                                ...
                                d[b.sFilter] = g;
                                a.each([b.sField, $.trim(b.sValue), b.sOper], function() {
                                    d[this] = ""
                                })
                            } else {
                                d[b.sField] = g.rules[0].field;
                                d[b.sValue] = $.trim(g.rules[0].data);
                ...
                if (d.grid && s) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(n.themodal))[0]) {
                        ...
                        var E = isNaN(c.dataheight) ? c.dataheight : c.dataheight + "px",
                            ...
                            E = a("<form name='FormPost' id='" + g + "' class='FormGrid' onSubmit='return false;' style='width:" + k + ";overflow:auto;position:relative;height:" + E + ";'></form>").data("disabled",
                                !1),
                            C = a("<table id='" + m + "' class='EditTable'><tbody></tbody></table>"),
                        ...
                        var k = "<a id='" + k + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
                            ...
                            m = "<table class='EditTable' id='" + m + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (y ? D + k : k + D) + "</td><td class='EditButton'>" + H + I + "</td></tr>" + ("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>" + b[d.p.id].bottominfo + "</td></tr>"),
                            m = m + "</tbody></table>";
                        if (0 < F) {
                            var J = [];
                ...
                if (o.grid && s) {
                    ...
                    if (void 0 !==
                        ...
                        var x = isNaN(c.dataheight) ? c.dataheight : c.dataheight + "px",
                            ...
                            y = a("<table id='" + d + "' class='EditTable' style='table-layout:fixed'><tbody></tbody></table>");
                        g && (m = g.call(o, a("#" + i)), void 0 === m && (m = !0));
                        if (!1 === m) return;
                ...
                if (e.grid &&
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(m.themodal))[0]) {
                        ...
                        var l = isNaN(b[e.p.id].dataheight) ? b[e.p.id].dataheight : b[e.p.id].dataheight + "px",
                            ...
                            g = g + "</tbody></table></div>" + ("<table class='EditTable' id='" + i + "_2'><tbody><tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" +
            ...
            return this.each(function() {
                if (!this.nav) {
                    ...
                    if (f.grid && "string" === typeof b) {
                        ...
                        for (v = 0; v < t; v++) {
                            var g = a("<table  class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
                                m, l;
            ...
            if (!this.filter) {
                ...
                if (l) {
                    ...
                    this.createTableRowForRule = function(g, j) {
                        ...
                        for (e = 0; e < h.length; e++) o = a.inArray(h[e], q), -1 !== o && (p = 'cn' === b.p.ops[o].oper ? " selected='selected'" : "", d += "<option value='" + b.p.ops[o].oper + "'" + p + ">" + b.p.ops[o].text + "</option>");
                        s.append(d);
            ...
            return this.each(function() {
                ...
                if (a.grid) {
                    var m = function(c, d, h) {
                        ...
                        l = function(c, d) {
                            var h, f, e, g = b("<table ><tbody></tbody></table>"),
                                i = b("<tr></tr>");
                        ...
                        o = function(c, d) {
                            var h,
                                f, e, g, i, k = b("<table><tbody></tbody></table>"),
                                j = b("<tr></tr>");
