...
function saveAsDraft(obj,draftFlag){
	
	var data = {"draftFlag":draftFlag};
	var URL = 'SelfAssessmentForm.html?saveFormOnDraft';
	var returnData = __doAjaxRequest(URL, 'POST', data, false);
	return saveOrUpdateForm(obj,"Self Assessment save successfully!", 'CitizenHome.html', 'saveform');
}
