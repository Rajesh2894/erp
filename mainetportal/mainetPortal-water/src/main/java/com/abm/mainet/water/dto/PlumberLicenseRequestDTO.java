...
public class PlumberLicenseRequestDTO implements Serializable {
	...
	/**
	 * @param licFromDate the licFromDate to set
	 */
	...
	/**
	 * @param licToDate the licToDate to set
	 */
	...
	/**
	 * @param plumRenewFromDate the plumRenewFromDate to set
	 */
	...
	/**
	 * @param plumRenewToDate the plumRenewToDate to set
	 */
