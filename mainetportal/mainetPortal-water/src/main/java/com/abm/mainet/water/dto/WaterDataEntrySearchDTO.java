...
public class WaterDataEntrySearchDTO implements Serializable {
    ...
    public String toString() {
        return "WaterDataEntrySearchDTO [csCcn=" + csCcn + ", csOldccn=" + csOldccn + ", propertyNo=" + propertyNo + ", csName="
                + csName + ", csAdd=" + csAdd + ", csContactno=" + csContactno + ", codDwzid1=" + codDwzid1 + ", codDwzid2="
                + codDwzid2 + ", codDwzid3=" + codDwzid3 + ", codDwzid4=" + codDwzid4 + ", codDwzid5=" + codDwzid5 + ", rowId="
                + rowId + ", locId=" + locId + ", orgId=" + orgId + ", gardianOwnerName=" + gardianOwnerName + ", errorMsg="
