...
public class WasteCollectorValidator extends BaseEntityValidator<WasteCollectorModel> {
    ...
    protected void performValidations(final WasteCollectorModel model,
        ...
        if ((collectorDTO.getLocAddress() == null) || collectorDTO.getLocAddress() == "") {
            entityValidationContext.addOptionConstraint(session.getMessage("Address Of Construction Site can not be empty"));
        }
