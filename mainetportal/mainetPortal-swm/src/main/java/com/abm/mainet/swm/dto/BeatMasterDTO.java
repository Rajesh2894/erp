...
public class BeatMasterDTO implements Serializable {
	...
	public Long getBeatDistDes() {
		return beatDistDes;
	}

	public void setBeatDistDes(Long beatDistDes) {
	...
	public RouteDetailsDTO addTbSwRootDet(RouteDetailsDTO tbSwRootDet) {
		getTbSwRootDets().add(tbSwRootDet);
		tbSwRootDet.setTbSwRootMast(this);

		return tbSwRootDet;
	}

	public RouteDetailsDTO removeTbSwRootDet(RouteDetailsDTO tbSwRootDet) {
		getTbSwRootDets().remove(tbSwRootDet);
		tbSwRootDet.setTbSwRootMast(null);
