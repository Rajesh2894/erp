 ...
 */
@Entity
@Table(name = "tb_dm_occurance_book")
public class DisasterOccuranceBookEntity implements Serializable {
	...
	@Column(name = "incident_desc", length = 3000)
	private String incidentDesc;


	@Column(name = "operator_remarks", length = 1000)
	...
	public String[] getPkValues() {
		return new String[] { "FM", "tb_dm_occurance_book", "occ_id" };
	}
