...
@Entity
@Table(name = "TB_MRM_WITNESS_DET_HIST")
public class WitnessDetailsHistory implements Serializable {
    ...
    @Column(name = "WITNESS_ID_H")
    private Long witnessHistId;
    ...
    @Column(name = "REL_WITH_COUPLE", length = 100, nullable = false)
    ...
    public Long getWitnessHistId() {
        return witnessHistId;
    }

    public void setWitnessHistId(Long witnessHistId) {
        this.witnessHistId = witnessHistId;
    }
    ...
    public static String[] getPkValues() {
        return new String[] { "MRM", "TB_MRM_WITNESS_DET_HIST", "WITNESS_ID_H" };
    }
}
