...
@Entity
@Table(name = "TB_MRM_WIFE_HIST")
public class WifeHistory implements Serializable {

    private static final long serialVersionUID = -6285410052603712194L;

    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
    @GeneratedValue(generator = "MyCustomGenerator")
    @Column(name = "WIFE_ID_H", nullable = false)
    private Long wifeHistId;
    ...
    public Long getWifeHistId() {
        return wifeHistId;
    }

    public void setWifeHistId(Long wifeHistId) {
        this.wifeHistId = wifeHistId;
    }
    ...
    public static String[] getPkValues() {
        return new String[] { "MRM", "TB_MRM_WIFE_HIST", "WIFE_ID_H" };
    }
}
