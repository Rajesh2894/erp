...
@Entity
@Table(name = "TB_MRM_HUSBAND_HIST")
public class HusbandHistory implements Serializable {

    private static final long serialVersionUID = -6928422658245768319L;

    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
    @GeneratedValue(generator = "MyCustomGenerator")
    @Column(name = "HUSBAND_ID_H")
    private Long husbandHistId;
    ...
    public Long getHusbandHistId() {
        return husbandHistId;
    }

    public void setHusbandHistId(Long husbandHistId) {
        this.husbandHistId = husbandHistId;
    }
    ...
    public static String[] getPkValues() {
        return new String[] { "MRM", "TB_MRM_HUSBAND_HIST", "HUSBAND_ID_H" };
    }
