...
public class HusbandDTO implements Serializable {
    ...
    public String toString() {
        return "HusbandDTO [husbandId=" + husbandId + ", marId=" + marId + ", firstNameEng=" + firstNameEng + ", firstNameReg="
                + firstNameReg + ", middleNameEng=" + middleNameEng + ", middleNameReg=" + middleNameReg + ", lastNameEng="
                + lastNameEng + ", lastNameReg=" + lastNameReg + ", otherName=" + otherName + ", uidNo=" + uidNo + ", dob=" + dob
                + ", year=" + year + ", month=" + month + ", religionBirth=" + religionBirth + ", religionAdopt=" + religionAdopt
                + ", occupation=" + occupation + ", statusMarTime=" + statusMarTime + ", fullAddrEng=" + fullAddrEng
                + ", fullAddrReg=" + fullAddrReg + ", capturePhotoName=" + capturePhotoName + ", capturePhotoPath="
                + capturePhotoPath + ", captureFingerprintName=" + captureFingerprintName + ", captureFingerprintPath="
                + captureFingerprintPath + ", orgId=" + orgId + ", createdBy=" + createdBy + ", createdDate=" + createdDate
                + ", updatedBy=" + updatedBy + ", updatedDate=" + updatedDate + ", lgIpMac=" + lgIpMac + ", lgIpMacUpd="
                + lgIpMacUpd + ", caste1=" + caste1 + ", caste2=" + caste2 + ", caste3=" + caste3 + ", caste4=" + caste4
                + ", caste5=" + caste5 + "]";
    }
