...
public class DrainageConnectionDto implements Serializable {
	...
	private Map<Long, Double> chargesMap = new HashMap<>();
	 ...
	 private List<DrainageConnectionRoadDetDTO> roadDetDto= new ArrayList<>();
	...
	public String getApplTypeDesc() {
		return applTypeDesc;
	}

	public void setApplTypeDesc(String applTypeDesc) {
		this.applTypeDesc = applTypeDesc;
	}

	public List<DrainageConnectionRoadDetDTO> getRoadDetDto() {
		return roadDetDto;
	}

	public void setRoadDetDto(List<DrainageConnectionRoadDetDTO> roadDetDto) {
		this.roadDetDto = roadDetDto;
	}
