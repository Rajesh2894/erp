...
--changeset Anil:V20190911111153__CR_tb_adh_hoarding_mas_hist_11092019.sql
rename table tb_hoarding_mas to tb_adh_hoarding_mas;
--liquibase formatted sql
--changeset Anil:V20190911111153__CR_tb_adh_hoarding_mas_hist_110920191.sql
drop table if exists tb_adh_hoarding_mas_hist;
--liquibase formatted sql
--changeset Anil:V20190911111153__CR_tb_adh_hoarding_mas_hist_110920192.sql
CREATE TABLE tb_adh_hoarding_mas_hist(
