...
--changeset Anil:V20190805123148__CR_TB_ADH_MAS_05082019.sql
drop table if exists TB_ADH_MAS;
--liquibase formatted sql
--changeset Anil:V20190805123148__CR_TB_ADH_MAS_050820191.sql
CREATE TABLE TB_ADH_MAS(
ADH_ID bigint(12) NOT NULL COMMENT 'Primary key',
