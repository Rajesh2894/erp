...
@Entity
@Table(name = "TB_ADH_MAS_HIST")
public class NewAdvertisementApplicationHistory implements Serializable {

    private static final long serialVersionUID = 1234831421378162964L;

    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
    @GeneratedValue(generator = "MyCustomGenerator")
    @Column(name = "ADH_ID_H")
    private Long adhHistId;
    ...
    public Long getAdhHistId() {
        return adhHistId;
    }

    public void setAdhHistId(Long adhHistId) {
        this.adhHistId = adhHistId;
    }
    ...
    public String[] getPkValues() {
        return new String[] { "ADH", "TB_ADH_MAST_HIST", "ADH_ID_H" };
    }
}
