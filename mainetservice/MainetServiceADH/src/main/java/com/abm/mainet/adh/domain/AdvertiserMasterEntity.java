 ...
 */
@Entity
@Table(name = "TB_ADH_AGENCYMASTER")
public class AdvertiserMasterEntity implements Serializable {

    private static final long serialVersionUID = -3126533098318301556L;
	...
	return new String[] { "ADH", "TB_ADH_AGENCYMASTER", "AGN_ID" };
    }
}
