 ...
 */
@Entity
@Table(name = "TB_ADH_HOARDING_MAS_HIST")
public class HoardingMasterHistoryEntity implements Serializable {
    ...
    @Column(name = "HRD_ID_H", length = 12, nullable = false)
    private Long hoardingHistId;
    ...
    public Long getHoardingHistId() {
        return hoardingHistId;
    }

    public void setHoardingHistId(Long hoardingHistId) {
        this.hoardingHistId = hoardingHistId;
    }
    ...
    public String[] getPkValues() {
        return new String[] { "ADH", "TB_ADH_HOARDING_MAS_HIST", "HRD_ID_H" };
    }
