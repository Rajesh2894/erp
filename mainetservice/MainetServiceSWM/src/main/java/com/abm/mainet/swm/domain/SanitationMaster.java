...
/**
 * The persistent class for the tb_sw_sanitation_mast database table.
 * 
 * @author Lalit.Prusti
 *
 ...
 */
@Entity
@Table(name = "TB_SW_SANITATION_MAST")
public class SanitationMaster implements Serializable {

    private static final long serialVersionUID = 6597840859637620588L;
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_SW_SANITATION_MAST", "SAN_ID" };
    }
}