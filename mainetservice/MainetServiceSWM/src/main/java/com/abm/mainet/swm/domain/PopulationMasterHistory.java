 ...
 */
@Entity
@Table(name = "TB_SW_POPULATION_MAST_HIST")
public class PopulationMasterHistory implements Serializable {

    private static final long serialVersionUID = 971783281062023532L;

    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
    @GeneratedValue(generator = "MyCustomGenerator")
    @Column(name = "POP_ID_H")
    private Long popIdHist;
    ...
    public PopulationMasterHistory() {
    }
    ...
    public Long getPopIdHist() {
        return popIdHist;
    }

    public void setPopIdHist(Long popIdHist) {
        this.popIdHist = popIdHist;
    }
