...
/**
 * The persistent class for the tb_sw_root_det database table.
 * @author Lalit.Prusti
 *
 * Created Date : 07-May-2018
 */
@Entity
@Table(name = "TB_SW_ROUTE_DET")
public class RouteDetails implements Serializable {
    ...
    // bi-directional many-to-one association to TbSwRootMast
    @ManyToOne
    @JoinColumn(name = "RO_ID")
    private BeatMaster tbSwRootMast;
    ...
    public BeatMaster getTbSwRootMast() {
        return tbSwRootMast;
    }

    public void setTbSwRootMast(BeatMaster tbSwRootMast) {
        this.tbSwRootMast = tbSwRootMast;
    }
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_SW_ROUTE_DET", "ROD_ID" };
    }
}