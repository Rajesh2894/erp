 ...
 */
@Entity
@Table(name = "TB_SW_MRF_MAST_HIST")
public class MRFMasterHistory implements Serializable {
    private static final long serialVersionUID = -3699871943376437933L;
    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
    @GeneratedValue(generator = "MyCustomGenerator")
    @Column(name = "MRF_ID_H", unique = true, nullable = false)
    private Long mrfIdh;
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_SW_MRF_MAST_HIST", "MRF_ID_H" };
    }

    public Long getMrfIdh() {
        return mrfIdh;
    }

    public void setMrfIdh(Long mrfIdh) {
        this.mrfIdh = mrfIdh;
    }
