 ...
 */
@Controller
@RequestMapping("/Scheduling.html")
public class SchedulingController extends AbstractFormController<SanitaryStaffSchedulingModel> {
    ...
    public ModelAndView index(final HttpServletRequest httpServletRequest) {
        ...
        this.getModel().setCommonHelpDocs("Scheduling.html");
    ...
    public ModelAndView getsant(@RequestParam("actionParam") final String action, final HttpServletRequest request) {
        ...
        this.getModel().setEmployeeBeanList(
                employeeService.searchEmployeeList(null, null, null, UserSession.getCurrent().getOrganisation().getOrgid()));
        ...
        this.getModel().setVehicleTypeList(CommonMasterUtility.getLookUps("VCH", UserSession.getCurrent().getOrganisation()));
        this.getModel().setShiftTypeList(CommonMasterUtility.getLookUps("SHT", UserSession.getCurrent().getOrganisation()));
        return new ModelAndView("SchedulingFormGrid", MainetConstants.FORM_NAME, this.getModel());
    }
    ...
    public ModelAndView editSanitaryStaff(final HttpServletRequest request, @RequestParam Long emsId) {
        ...
        this.getModel().setRouteMasterList(routeMasterService.serchRouteByRouteTypeAndRouteNo(null, null,
                UserSession.getCurrent().getOrganisation().getOrgid()));
        this.getModel().setEmsdCollTypeList(CommonMasterUtility.getLookUps("COT", UserSession.getCurrent().getOrganisation()));
        this.getModel().setVehicleTypeList(CommonMasterUtility.getLookUps("VCH", UserSession.getCurrent().getOrganisation()));
        this.getModel().setShiftTypeList(CommonMasterUtility.getLookUps("SHT", UserSession.getCurrent().getOrganisation()));
        return new ModelAndView("schedulingDisplay", MainetConstants.FORM_NAME, this.getModel());
    }
    ...
    public ModelAndView deleteSanitaryStaff(final HttpServletRequest request, @RequestParam Long emsId) {
        ...
        defaultLoad(request);
        return new ModelAndView("SchedulingSummary", MainetConstants.FORM_NAME, this.getModel());
    }
    ...
    public ModelAndView searchSanitaryStaff(@RequestParam(value = "empid") final Long empid,
        ...
        this.getModel().setEmployeeScheduleList(emplist);
        return new ModelAndView("SchedulingGrid", MainetConstants.FORM_NAME, this.getModel());
    }
