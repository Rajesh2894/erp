...
public class VehicleScheduleDTO implements Serializable {
    ...
    private Set<Long> employeeUIdList;
    ...
    public List<VehicleMaintenanceMaster> searchVehicleScheduleByVehicleTypeAndVehicleNo(Long veVetype2, Long vesId2,
            Long orgid2) {
    ...
    public Set<Long> getEmployeeUIdList() {
        return employeeUIdList;
    }

    public void setEmployeeUIdList(Set<Long> employeeUIdList) {
