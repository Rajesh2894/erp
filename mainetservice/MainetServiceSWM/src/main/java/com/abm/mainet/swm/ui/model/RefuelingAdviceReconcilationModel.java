...
import com.abm.mainet.swm.ui.validator.RefuelingAdviceReconcilationValidator;
...
@Component
@Scope("session")
public class RefuelingAdviceReconcilationModel extends AbstractFormModel {
    ...
    public boolean saveForm() {
        ...
        validateBean(vehicleFuelReconciationDTO, RefuelingAdviceReconcilationValidator.class);
        if (hasValidationErrors()) {
            ...
            if (vehicleFuelReconciationDTO.getInrecId() == null) {  // vefId
                ...
                setSuccessMessage(ApplicationSession.getInstance().getMessage("fuelling.advice.add.success"));
            } else {
                ...
                setSuccessMessage(ApplicationSession.getInstance().getMessage("fuelling.advice.edit.success"));
            }
