...
/**
 * The persistent class for the tb_sw_wasteseg_det database table.
 * 
 * @author Lalit.Prusti
 *
 ...
 */
@Entity
@Table(name = "TB_SW_WASTESEG_DET")
public class WastageSegregationDetails implements Serializable {

    private static final long serialVersionUID = -8298164062378857245L;
    ...
    // bi-directional many-to-one association to TbSwWasteseg
    @ManyToOne
    @JoinColumn(name = "GR_ID", nullable = false)
    private WastageSegregation tbSwWasteseg;

    public WastageSegregationDetails() {
    }
    ...
    public WastageSegregation getTbSwWasteseg() {
        return this.tbSwWasteseg;
    }

    public void setTbSwWasteseg(WastageSegregation tbSwWasteseg) {
        this.tbSwWasteseg = tbSwWasteseg;
    }

    public String[] getPkValues() {

        return new String[] { "SWM", "TB_SW_WASTESEG_DET", "GRD_ID" };
    }
}