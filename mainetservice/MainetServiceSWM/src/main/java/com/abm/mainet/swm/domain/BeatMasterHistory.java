...
/**
 * The persistent class for the tb_sw_root_mast_hist database table.
 * 
 * @author Lalit.Prusti
 *
 ...
 */
@Entity
@Table(name = "TB_SW_BEAT_MAST_HIST")
public class BeatMasterHistory implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
    @GeneratedValue(generator = "MyCustomGenerator")
    @Column(name = "BEAT_ID_H")
    private Long beatIdH;
    ...
    public Long getBeatIdH() {
        return beatIdH;
    }

    public void setBeatIdH(Long beatIdH) {
        this.beatIdH = beatIdH;
    }
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_SW_BEAT_MAST_HIST", "BEAT_ID_H" };
    }
