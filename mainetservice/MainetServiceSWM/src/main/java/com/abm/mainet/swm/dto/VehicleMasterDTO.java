...
public class VehicleMasterDTO implements Serializable {
    ...
    private List<VehicleMasterDetDTO> tbSwVehicleMasterdets;
    ...
    public List<VehicleMasterDetDTO> getTbSwVehicleMasterdets() {
        return tbSwVehicleMasterdets;
    }

    public void setTbSwVehicleMasterdets(List<VehicleMasterDetDTO> tbSwVehicleMasterdets) {
