...
@Entity
@Table(name = "TB_SW_SURVEY_MAST")
public class SurveyFormMaster implements Serializable {
    ...
    @Column(name = "COD_WARD1" , nullable = false)
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_SW_SURVEY_MAST", "SU_ID" };
    }
