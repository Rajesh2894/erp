...
/**
 * The persistent class for the tb_sw_vehiclefuel_inrec_det_hist database table.
 * 
 * @author Lalit.Prusti
 *
 ...
 */
@Entity
@Table(name = "TB_SW_VEHICLEFUEL_INREC_DET_HIST")
public class VehicleFuelReconciationDetHistory implements Serializable {
    ...
    public VehicleFuelReconciationDetHistory() {
    }
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_SW_VEHICLEFUEL_INREC_DET_HIST", "INRECD_ID_H" };
    }
