 ...
 */
@Repository
public interface VendorContractMappingRepository extends JpaRepository<VendorContractMapping, Long> {
     ...
     * @return
     */
    List<VendorContractMapping> findByContIdAndOrgid(Long contId, Long orgid);
    ...
    /**
     * get getContractMappedByOrgId
     * @param orgId
     * @return
     */
	@Query("SELECT c FROM ContractMastEntity c WHERE c.orgId =?1  ")
	List<ContractMastEntity> getContractMappedByOrgId(Long orgId);
}
