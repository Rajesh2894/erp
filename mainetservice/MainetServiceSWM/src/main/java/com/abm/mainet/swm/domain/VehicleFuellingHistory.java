...
/**
 * The persistent class for the tb_sw_vehiclefuel_mast_hist database table.
 *
 * @author Lalit.Prusti
 *
 ...
 */
@Entity
@Table(name = "TB_SW_VEHICLEFUEL_MAST_HIST")
public class VehicleFuellingHistory implements Serializable {
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_SW_VEHICLEFUEL_MAST_HIST", "VEF_ID_H" };
    }
