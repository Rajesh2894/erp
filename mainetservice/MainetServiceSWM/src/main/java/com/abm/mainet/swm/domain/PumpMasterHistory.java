 ...
 */
@Entity
@Table(name = "TB_SW_PUMP_MAST_HIST")
public class PumpMasterHistory implements Serializable {
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_SW_PUMP_MAST_HIST", "PU_ID_H" };
    }
}