...
public class VehicleMasterDetDTO implements Serializable {
    ...
    @JsonIgnore
    private VehicleMasterDTO tbSwVehicleMaster;
    ...
    public VehicleMasterDTO getTbSwVehicleMaster() {
        return tbSwVehicleMaster;
    }

    public void setTbSwVehicleMaster(VehicleMasterDTO tbSwVehicleMaster) {
