 ...
 */
@Entity
@Table(name = "TB_SW_VEHICLE_MAINTENANCE")
public class VehicleMaintenanceMaster implements Serializable {
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_SW_VEHICLE_MAINTENANCE", "VE_MEID" };
    }
}
