...
--changeset nilima:V20180921192016__CR_TB_SW_BEAT_MAST_HIST.sql
CREATE TABLE TB_SW_BEAT_MAST_HIST (
  ...
  BEAT_START_POINT bigint(12) NOT NULL COMMENT 'Starting Point',
  BEAT_END_POINT bigint(12) NOT NULL COMMENT 'End Point',
  BEAT_DISTANCE decimal(12,2) NOT NULL COMMENT 'Total BEAT Distance',
  BEAT_DISTANCE_UNIT bigint(12) NOT NULL COMMENT 'Total BEAT Distance Unit',
  BEAT_AREATYPE bigint(12) DEFAULT NULL COMMENT 'Area Type',
  BEAT_VE_TYPE bigint(12) NOT NULL COMMENT 'Vechicle Type',
  DE_ID bigint(12) NOT NULL COMMENT 'FK TB_SW_DESPOSAL_MAST',
  BEAT_DIST_DES decimal(12,2) NOT NULL COMMENT 'Distance from Disposal Site',
