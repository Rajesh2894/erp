...
CREATE TABLE TB_SW_DISPOSAL_DET_HIST (
  DED_ID_H bigint(12)  COMMENT 'Primary Key',
  DED_ID bigint(12)  COMMENT 'Primary Key',
  DE_ID bigint(12)  COMMENT 'foregin key TB_SW_DEPOSAL_MAST',
  DE_WEST_TYPE bigint(12)  COMMENT 'Desposal Waste Details',
