...
/**
 * The persistent class for the tb_lgl_legalreference_hist database table.
 * 
 */
@Entity
@Table(name = "TB_LGL_LEGALREFERENCE_HIST")
public class LegalreferenceHistory implements Serializable {

    private static final long serialVersionUID = -5338963030601529425L;

    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
    @GeneratedValue(generator = "MyCustomGenerator")
    @Column(name = "LO_REFERENCEID_H")
    private Long loReferenceidH;
    ...
    public Long getLoReferenceidH() {
        return this.loReferenceidH;
    }

    public void setLoReferenceidH(Long loReferenceidH) {
        this.loReferenceidH = loReferenceidH;
    }
    ...
    public String[] getPkValues() {
        return new String[] { "LGL", "TB_LGL_LEGALREFERENCE_HIST", "LO_REFERENCEID_H" };
    }
