...
@Entity
@Table(name = "TB_LGL_HEARINGATTENDEE_DETAILS")
public class CaseHearingAttendeeDetails implements Serializable {
    ...
    public String[] getPkValues() {
        return new String[] { "LGL", "TB_LGL_HEARINGATTENDEE_DETAILS", "HRA_ID" };
    }
}