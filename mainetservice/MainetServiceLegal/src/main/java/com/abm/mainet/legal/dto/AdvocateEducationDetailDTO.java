...
public class AdvocateEducationDetailDTO implements Serializable{
	...
	@JsonIgnore
    private AdvocateMasterDTO tbLglAdvMas;
	...
	public AdvocateMasterDTO getTbLglAdvMas() {
		return tbLglAdvMas;
	}

	public void setTbLglAdvMas(AdvocateMasterDTO tbLglAdvMas) {
		this.tbLglAdvMas = tbLglAdvMas;
	}
