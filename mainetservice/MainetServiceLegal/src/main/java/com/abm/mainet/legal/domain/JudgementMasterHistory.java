...
@Entity
@Table(name = "TB_LGL_JUDGEMENT_MAST_HIST")
public class JudgementMasterHistory implements Serializable {

    private static final long serialVersionUID = 5811468021066888328L;

    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
    @GeneratedValue(generator = "MyCustomGenerator")
    @Column(name = "JUD_ID_H")
    private Long judIdH;
    ...
    public Long getJudIdH() {
        return judIdH;
    }

    public void setJudIdH(Long judIdH) {
        this.judIdH = judIdH;
    }
    ...
    public String[] getPkValues() {
        return new String[] { "LGL", "TB_LGL_JUDGEMENT_MAST_HIST", "JUD_ID_H" };
    }
}
