...
import com.abm.mainet.legal.ui.validator.JudgementImplementationValidator;
...
@Component
@Scope("session")
public class JudgementImplementationmodel extends AbstractFormModel {

    private static final long serialVersionUID = 1829574617168988270L;
	...
	return departmentService.getDepartments(UserSession.getCurrent().getOrganisation().getOrgid(),MainetConstants.FlagA); // Active
	...
	judgeDetailDto.setOrgid(UserSession.getCurrent().getOrganisation().getOrgid());
	 validateBean(judgeDetailDto, JudgementImplementationValidator.class);
	...
	private void sendSMSAndEmail() {
			...
			String menuUrl = "JudgementImplementation.html";
