 ...
 */
@Entity
@Table(name = "TB_WT_EXCESS_AMT")
public class TbWtExcessAmt implements Serializable {
    private static final long serialVersionUID = -3638573404613043120L;
    ...
    public String[] getPkValues() {
        return new String[] { "WT", "TB_WT_EXCESS_AMT",
                "EXCESS_ID" };
    }
