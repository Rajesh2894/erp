 ...
 */
@Entity
@Table(name = "TB_TAX_MAS_HIST")
// Define named queries here
public class TbTaxMasEntityHistory implements Serializable {
	...
	@Column(name = "H_TAXID", nullable = false)
	...
	public String[] getPkValues() {
		return new String[] { "COM", "TB_TAX_MAS_HIST", "H_TAXID" };
	}
