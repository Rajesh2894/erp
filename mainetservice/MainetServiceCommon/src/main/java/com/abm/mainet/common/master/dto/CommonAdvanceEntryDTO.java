...
public class CommonAdvanceEntryDTO implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -9158028834063658765L;
	...
	private List<CommonAdvanceEntryDTO> advanceLedgerList;
	...
	public List<CommonAdvanceEntryDTO> getAdvanceLedgerList() {
		return advanceLedgerList;
	}

	public void setAdvanceLedgerList(List<CommonAdvanceEntryDTO> advanceLedgerList) {
	...
	public String toString() {
		return "AdvanceEntryDTO [alreadyExists=" + alreadyExists + ", prAdvEntryId=" + prAdvEntryId + ", pacHeadId="
				+ pacHeadId + ", advanceTypeId=" + advanceTypeId + ", advanceTypeDesc=" + advanceTypeDesc
				+ ", vendorId=" + vendorId + ", advanceNumber=" + advanceNumber + ", advanceDate=" + advanceDate
				+ ", advanceAmount=" + advanceAmount + ", balanceAmount=" + balanceAmount + ", partOfAdvance="
				+ partOfAdvance + ", prAdvEntryDate=" + prAdvEntryDate + ", prAdvEntryNo=" + prAdvEntryNo
				+ ", paymentOrderNo=" + paymentOrderNo + ", paymentOrderDate=" + paymentOrderDate
				+ ", paymentOrderDateDup=" + paymentOrderDateDup + ", paymentNumber=" + paymentNumber + ", paymentDate="
				+ paymentDate + ", paymentDateDup=" + paymentDateDup + ", paymentAmount=" + paymentAmount
				+ ", payAdvParticulars=" + payAdvParticulars + ", payAdvSettlementNumber=" + payAdvSettlementNumber
				+ ", seas_Deas=" + seas_Deas + ", advanceLedgerList=" + advanceLedgerList + ", categoryTypeId="
				+ categoryTypeId + ", paymentReferenceId=" + paymentReferenceId + ", receiptRepaymentDate="
				+ receiptRepaymentDate + ", receiptAdjustmentNo=" + receiptAdjustmentNo + ", voucherDate=" + voucherDate
				+ ", voucherNo=" + voucherNo + ", orgid=" + orgid + ", createdBy=" + createdBy + ", langId=" + langId
				+ ", createdDate=" + createdDate + ", updatedBy=" + updatedBy + ", updatedDate=" + updatedDate
				+ ", lgIpMac=" + lgIpMac + ", lgIpMacUpd=" + lgIpMacUpd + ", fi04N1=" + fi04N1 + ", fi04V1=" + fi04V1
				+ ", fi04D1=" + fi04D1 + ", fi04Lo1=" + fi04Lo1 + ", hasError=" + hasError + ", cpdIdStatus="
				+ cpdIdStatus + ", cpdIdStatusDup=" + cpdIdStatusDup + ", deptId=" + deptId + ", vendorName="
				+ vendorName + ", adv_Flg=" + adv_Flg + ", liveModeDate=" + liveModeDate + ", liveModeDateDup="
				+ liveModeDateDup + ", sliStatusFlag=" + sliStatusFlag + ", billDate=" + billDate + ", billPaidAmount="
				+ billPaidAmount + ", natureOfbill=" + natureOfbill + "]";
	}
	...
	public void setAdv_posting_date(Date adv_posting_date) {
	...
	public void setAdv_order_no(String adv_order_no) {
