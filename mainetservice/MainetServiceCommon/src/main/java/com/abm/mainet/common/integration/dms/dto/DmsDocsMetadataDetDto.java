...
public class DmsDocsMetadataDetDto implements Serializable {

	private static final long serialVersionUID = 1L;

	private Long dmsDetId;

	private DmsDocsMetadataDto dmsDocsMetadataDto;
	...
	public DmsDocsMetadataDto getDmsDocsMetadataDto() {
		return dmsDocsMetadataDto;
	}

	public void setDmsDocsMetadataDto(DmsDocsMetadataDto dmsDocsMetadataDto) {
