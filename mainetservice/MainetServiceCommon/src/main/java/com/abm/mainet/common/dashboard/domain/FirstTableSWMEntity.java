...
@Entity
public class FirstTableSWMEntity {
	@Id
	@Column(name = "num")
	private int id;
	...
	public String toString() {
		return "FirstTableSWMEntity [id=" + id + ", orgCpdIdDiv=" + orgCpdIdDiv + ", division=" + division
				+ ", divisionReg=" + divisionReg + ", dry=" + dry + ", wate=" + wate + ", haz=" + haz + "]";
	}
