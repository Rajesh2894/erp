...
public class DmsManagementDto implements Serializable {

	private static final long serialVersionUID = 1L;

	private Long dmsId;

	private List<DmsManagementDetDto> dmsDocsMetadataDetList;
	...
	public List<DmsManagementDetDto> getDmsDocsMetadataDetList() {
		return dmsDocsMetadataDetList;
	}

	public void setDmsDocsMetadataDetList(List<DmsManagementDetDto> dmsDocsMetadataDetList) {
