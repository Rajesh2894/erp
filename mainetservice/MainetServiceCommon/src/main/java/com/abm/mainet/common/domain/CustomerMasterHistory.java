...
@Entity
@Table(name = "TB_CUSTMAST_HIST")
public class CustomerMasterHistory implements Serializable {
    ...
    @Column(name = "CM_CUSTID_H", nullable = false)
    private Long custIdH;

    @Column(name = "CM_CUSTID")
    private Long custId;
    ...
    public Long getCustIdH() {
        return custIdH;
    }

    public void setCustIdH(Long custIdH) {
        this.custIdH = custIdH;
    }
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "AC", "TB_CUSTMAST_HIST", "CM_CUSTID_H" };
    }
