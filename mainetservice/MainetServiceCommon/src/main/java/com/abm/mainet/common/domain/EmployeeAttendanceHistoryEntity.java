...
@Entity
@Table(name = "EMPLOYEE_ATTENDANCE_HIST")
public class EmployeeAttendanceHistoryEntity implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1135534468376353036L;

	@Id
	@GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
	@GeneratedValue(generator = "MyCustomGenerator")
	@Column(name = "EMP_ATTND_HIST_ID", unique = true, nullable = false)
	private Long empAttndHistId;
	@Column(name = "EMP_ATTND_ID", nullable = false)
	...
	public String[] getPkValues() {
        return new String[] { "COM", "EMPLOYEE_ATTENDANCE_HIST", "EMP_ATTND_HIST_ID" };
    }

	public Long getEmpAttndHistId() {
		return empAttndHistId;
	}

	public void setEmpAttndHistId(Long empAttndHistId) {
		this.empAttndHistId = empAttndHistId;
	}
}
