...
@Entity
public class DrillDownWasteTypeWiseEntity {
	...
	public int getTripVolume() {
		return tripVolume;
	}

	public void setTripVolume(int tripVolume) {
	...
	public String toString() {
		return "DrillDownWasteTypeWiseEntity [id=" + id + ", state=" + state + ", orgName=" + orgName + ", hCity="
				...
				+ orgLongitude + ", codDesc=" + codDesc + ", codDescMar=" + codDescMar + ", tripVolume=" + tripVolume
