...
public class DmsRetentionDto implements Serializable {

	private static final long serialVersionUID = 1L;

	private Long dmsId;

	private List<DmsRetentionDetDto> dmsRetentionDetDtoList;
	...
	public List<DmsRetentionDetDto> getDmsRetentionDetDtoList() {
		return dmsRetentionDetDtoList;
	}

	public void setDmsRetentionDetDtoList(List<DmsRetentionDetDto> dmsRetentionDetDtoList) {
		this.dmsRetentionDetDtoList = dmsRetentionDetDtoList;
	}
