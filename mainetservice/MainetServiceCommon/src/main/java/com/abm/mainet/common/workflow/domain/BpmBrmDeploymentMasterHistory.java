...
@Entity
@Table(name = "TB_BPM_DEPLOYMENT_HIST")
public class BpmBrmDeploymentMasterHistory implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -8411974219892418258L;

    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
    @GeneratedValue(generator = "MyCustomGenerator")
    @Column(name = "DP_STID_H")
    private Long histId;
    ...
    public String[] getPkValues() {
        return new String[] { "COM", "TB_BPM_DEPLOYMENT_HIST", "DP_STID_H" };
    }
