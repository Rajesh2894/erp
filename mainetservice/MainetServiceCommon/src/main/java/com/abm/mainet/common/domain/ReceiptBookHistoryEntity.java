...
@Entity
@Table(name = "TB_RECEIPTBOOKLEAF_MAS_HIS")
public class ReceiptBookHistoryEntity implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = 3388025133320502855L;

    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
    @GeneratedValue(generator = "MyCustomGenerator")
    @Column(name = "RB_ID_H", precision = 12, scale = 0, nullable = false, columnDefinition = "Long default 100")
    private Long hrbId;
    ...
    public Long getHrbId() {
        return hrbId;
    }

    public void setHrbId(Long hrbId) {
        this.hrbId = hrbId;
    }
    ...
    public String[] getPkValues() {
        return new String[] { MainetConstants.CommonConstants.COM, "TB_RECEIPTBOOKLEAF_MAS_HIS", "RB_ID_H" };
