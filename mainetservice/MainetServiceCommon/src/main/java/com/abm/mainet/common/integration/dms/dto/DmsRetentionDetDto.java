...
public class DmsRetentionDetDto implements Serializable {

	private static final long serialVersionUID = 1L;

	private Long dmsDetId;

	private DmsRetentionDto dmsRetentionDto;
	...
	public DmsRetentionDto getDmsRetentionDto() {
		return dmsRetentionDto;
	}

	public void setDmsRetentionDto(DmsRetentionDto dmsRetentionDto) {
		this.dmsRetentionDto = dmsRetentionDto;
	}
