...
@XmlRootElement(name = "Account_Head")
public class AccountHead {
    ...
    @XmlElement(name = "SAC_LED_TYPE")
    protected double sacledtype;
    @XmlElement(name = "STATUS_CPD_ID")
    protected double statuscpdid;
    /**
    ...
    /**
     * Gets the value of the sacledtype property.
     * 
     */
    public double getSACLEDTYPE() {
        return sacledtype;
    }

    /**
     * Sets the value of the sacledtype property.
     * 
     */
    public void setSACLEDTYPE(double value) {
        this.sacledtype = value;
    }
    
    /**
     * Gets the value of the statuscpdid property.
     * 
     */
    public double getSTATUSCPDID() {
        return statuscpdid;
    }

    /**
     * Sets the value of the statuscpdid property.
     * 
     */
    public void setSTATUSCPDID(double value) {
        this.statuscpdid = value;
    }
