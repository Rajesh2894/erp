...
values (fn_java_sq_generation('AUT','TB_COMPARAM_MAS','CPM_ID',NULL,NULL),'SLD','Flat or Slab Dependant','A',
1,now(),'WT','Y',
'N','Y','N',
'N','N','Y','N',
'N','Y',1);
...
cpd_desc_mar,cpd_others,lg_ip_mac)
values
(fn_java_sq_generation('AUT','TB_COMPARAM_DET','CPD_ID',NULL,NULL),(select orgid from TB_ORGANISATION where default_status='Y'),'Road Type','RDT','A',
(select CPM_ID from TB_COMPARAM_MAS where CPM_PREFIX='SLD'),
...
cpd_desc_mar,cpd_others,lg_ip_mac)
values
(fn_java_sq_generation('AUT','TB_COMPARAM_DET','CPD_ID',NULL,NULL),(select orgid from TB_ORGANISATION where default_status='Y'),'NA','NA','A',
(select CPM_ID from TB_COMPARAM_MAS where CPM_PREFIX='SLD'),
