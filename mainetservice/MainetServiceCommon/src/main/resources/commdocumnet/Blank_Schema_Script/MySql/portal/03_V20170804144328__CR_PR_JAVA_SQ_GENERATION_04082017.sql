...
--changeset nilima:V20170804144328__CR_PR_JAVA_SQ_GENERATION_04082017.sql
DROP PROCEDURE IF EXISTS PR_JAVA_SQ_GENERATION;
CREATE PROCEDURE PR_JAVA_SQ_GENERATION(v_mod VARCHAR(10),v_tbl  VARCHAR(100),v_fld  VARCHAR(100),v_rst  VARCHAR(1),v_ctr_id  VARCHAR(100),OUT v_nxtnum  INT)
BEGIN
 DECLARE n_sqno          INT;           
