	...
	fetch cu_pg into n_orgid;
		...
		if v_finished=1 then
			...
			commit;
				...
				VALUES (fn_java_sq_generation('COM','TB_PG_BANK_PARAMETER_DETAIL','PG_PRAM_DET_ID',NULL,NULL),
				n_pgid,
				'schemeCode','AVBC02FI26AM72CBMA','A',n_orgid,1,now(),1,null,null,null,null,null,null,null,null);

				INSERT INTO tb_pg_bank_parameter_detail(PG_PRAM_DET_ID,PG_ID,PAR_NAME,
				PAR_VALUE,PAR_STATUS,ORGID,CREATED_BY,CREATED_DATE,LANG_ID) 
				VALUES (fn_java_sq_generation('COM','TB_PG_BANK_PARAMETER_DETAIL','PG_PRAM_DET_ID',NULL,NULL),
				n_pgid,
				'key','EF410F7DFD2623B0C6CF8D3E895852C8','A',n_orgid,1,now(),1);

				INSERT INTO tb_pg_bank_parameter_detail(PG_PRAM_DET_ID,PG_ID,PAR_NAME,
				PAR_VALUE,PAR_STATUS,ORGID,CREATED_BY,CREATED_DATE,LANG_ID) 
				VALUES (fn_java_sq_generation('COM','TB_PG_BANK_PARAMETER_DETAIL','PG_PRAM_DET_ID',NULL,NULL),
				n_pgid,
				'salt','EF410F7DFD2623B0C6CF8D3E895852C8','A',n_orgid,1,now(),1);
				...
				VALUES (fn_java_sq_generation('COM','TB_PG_BANK_PARAMETER_DETAIL','PG_PRAM_DET_ID',NULL,NULL),
				n_pgid,
				'surl','http://192.168.100.157:8090/PaymentController.html?hdfcCCARedirect','A',n_orgid,1,now(),1);

				INSERT INTO tb_pg_bank_parameter_detail (PG_PRAM_DET_ID,PG_ID,PAR_NAME,PAR_VALUE,PAR_STATUS,
				ORGID,CREATED_BY,CREATED_DATE,LANG_ID) 
				VALUES (fn_java_sq_generation('COM','TB_PG_BANK_PARAMETER_DETAIL','PG_PRAM_DET_ID',NULL,NULL),
				n_pgid,'curl','http://192.168.100.157:8090/PaymentController.html?hdfcCCAcancel','A',n_orgid,1,now(),1);

				INSERT INTO tb_pg_bank_parameter_detail (PG_PRAM_DET_ID,PG_ID,PAR_NAME,PAR_VALUE,PAR_STATUS,
				ORGID,CREATED_BY,CREATED_DATE,LANG_ID) 
				VALUES (fn_java_sq_generation('COM','TB_PG_BANK_PARAMETER_DETAIL','PG_PRAM_DET_ID',NULL,NULL),
				n_pgid,'furl','http://192.168.100.157:8090/PaymentController.html?hdfcCCARedirect','A',n_orgid,1,now(),1);
				commit;
