DELIMITER $$
CREATE PROCEDURE INPGDETAIL246()
BEGIN
	...
	fetch cu_pg into n_orgid;
		...
		if v_finished=1 then
			...
			commit;
				...
				VALUES (fn_java_sq_generation('COM','TB_PG_BANK_PARAMETER_DETAIL','PG_PRAM_DET_ID',NULL,NULL),
				n_pgid,
				'schemeCode','AVGM78FF41AH34MGHA','A',n_orgid,1,now(),1,null,null,null,null,null,null,null,null);

				INSERT INTO tb_pg_bank_parameter_detail(PG_PRAM_DET_ID,PG_ID,PAR_NAME,
				PAR_VALUE,PAR_STATUS,ORGID,CREATED_BY,CREATED_DATE,LANG_ID) 
				VALUES (fn_java_sq_generation('COM','TB_PG_BANK_PARAMETER_DETAIL','PG_PRAM_DET_ID',NULL,NULL),
				n_pgid,
				'key','C7B733ACAF157D95F1855C68D25E2997','A',n_orgid,1,now(),1);

				INSERT INTO tb_pg_bank_parameter_detail(PG_PRAM_DET_ID,PG_ID,PAR_NAME,
				PAR_VALUE,PAR_STATUS,ORGID,CREATED_BY,CREATED_DATE,LANG_ID) 
				VALUES (fn_java_sq_generation('COM','TB_PG_BANK_PARAMETER_DETAIL','PG_PRAM_DET_ID',NULL,NULL),
				n_pgid,
				'salt','C7B733ACAF157D95F1855C68D25E2997','A',n_orgid,1,now(),1);
				...
				VALUES (fn_java_sq_generation('COM','TB_PG_BANK_PARAMETER_DETAIL','PG_PRAM_DET_ID',NULL,NULL),
				n_pgid,
				'surl','http://182.18.168.246/PaymentController.html?hdfcCCARedirect','A',n_orgid,1,now(),1);

				INSERT INTO tb_pg_bank_parameter_detail (PG_PRAM_DET_ID,PG_ID,PAR_NAME,PAR_VALUE,PAR_STATUS,
				ORGID,CREATED_BY,CREATED_DATE,LANG_ID) 
				VALUES (fn_java_sq_generation('COM','TB_PG_BANK_PARAMETER_DETAIL','PG_PRAM_DET_ID',NULL,NULL),
				n_pgid,'curl','http://182.18.168.246/PaymentController.html?hdfcCCAcancel','A',n_orgid,1,now(),1);

				INSERT INTO tb_pg_bank_parameter_detail (PG_PRAM_DET_ID,PG_ID,PAR_NAME,PAR_VALUE,PAR_STATUS,
				ORGID,CREATED_BY,CREATED_DATE,LANG_ID) 
				VALUES (fn_java_sq_generation('COM','TB_PG_BANK_PARAMETER_DETAIL','PG_PRAM_DET_ID',NULL,NULL),
				n_pgid,'furl','http://182.18.168.246/PaymentController.html?hdfcCCARedirect','A',n_orgid,1,now(),1);
