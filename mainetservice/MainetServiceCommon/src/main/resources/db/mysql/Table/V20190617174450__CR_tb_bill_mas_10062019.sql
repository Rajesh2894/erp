...
--changeset Anil:V20190617174450__CR_tb_bill_mas_10062019.sql
drop table if exists tb_bill_mas;
--liquibase formatted sql
--changeset Anil:V20190617174450__CR_tb_bill_mas_100620191.sql
CREATE TABLE `tb_bill_mas` (
  `BM_ID` bigint(12) NOT NULL COMMENT 'Primary Key',
