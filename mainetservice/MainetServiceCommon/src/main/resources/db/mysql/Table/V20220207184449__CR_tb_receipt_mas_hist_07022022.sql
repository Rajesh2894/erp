...
--changeset Kanchan:V20220207184449__CR_tb_receipt_mas_hist_07022022.sql
drop table tb_receipt_mas_hist;
--liquibase formatted sql
--changeset Kanchan:V20220207184449__CR_tb_receipt_mas_hist_070220221.sql
CREATE TABLE tb_receipt_mas_hist (
 rm_rcpthistid bigint(12) primary Key NOT NULL,
