...
--changeset Anil:V20200116180305__VW_complaintregister_16012020.sql
drop view if exists complaintregister;
--liquibase formatted sql
--changeset Anil:V20200116180305__VW_complaintregister_160120201.sql
    ...
    SELECT
        ...
        (SELECT
            ...
            WHERE
                ...
                (COD_ID = a.CARE_WARD_NO)) AS CARE_WARD_NO_ENG,
        ...
        (SELECT
            ...
            WHERE
                ...
                (COD_ID = a.CARE_WARD_NO)) AS CARE_WARD_NO_REG,
        ...
        (SELECT
            ...
            WHERE
                ...
                (COD_ID = a.CARE_WARD_NO1)) AS CARE_WARD_NO1_ENG,
        ...
        (SELECT
            ...
            WHERE
                ...
                (COD_ID = a.CARE_WARD_NO1)) AS CARE_WARD_NO1_REG,
        ...
        (SELECT
            ...
            WHERE
                ...
                (CPD_ID = h.ORG_CPD_ID_STATE)) AS STATE_ENG,
        ...
        (SELECT
            ...
            WHERE
                ...
                (CPD_ID = h.ORG_CPD_ID_STATE)) AS STATE_REG,
        ...
        (SELECT
            ...
            WHERE
                ...
                (APM_APPLICATION_ID = a.APM_APPLICATION_ID)) AS APA_MOBILNO,
        ...
        (SELECT
            ...
            WHERE
                ...
                (APM_APPLICATION_ID = a.APM_APPLICATION_ID)) AS APPLICANT_NAME,
        ...
        (SELECT
           ...
           FROM
            ...
            WHERE
                ...
                (LOC_ID = a.LOC_ID)) AS LOCATIONNAME_ENG,
        ...
        (SELECT
            ...
            WHERE
                ...
                (LOC_ID = a.LOC_ID)) AS LOCATIONNAME_REG,
