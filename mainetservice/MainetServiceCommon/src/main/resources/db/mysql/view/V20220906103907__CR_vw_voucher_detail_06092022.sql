...
--changeset Kanchan:V20220906103907__CR_vw_voucher_detail_06092022.sql
drop view if exists vw_voucher_detail;
--liquibase formatted sql
--changeset Kanchan:V20220906103907__CR_vw_voucher_detail_060920221.sql
CREATE
    ALGORITHM = UNDEFINED
