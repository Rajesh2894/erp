...
--changeset nilima:vw_citizen_dashboard_23012019.sql
CREATE VIEW or replace vw_citizen_dashboard AS
    SELECT 
    ...
    WHERE
        ((s.SM_SERVICE_ID = c.SM_SERVICE_ID)
            ...
            AND (NOT (c.APM_APPLICATION_ID IN (SELECT APM_APPLICATION_ID
