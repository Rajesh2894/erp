...
--changeset Anil:V20191007154924__CR_vw_citizen_dashboard_07102019.sql
drop view vw_citizen_dashboard;
--liquibase formatted sql
--changeset Anil:V20191007154924__CR_vw_citizen_dashboard_071020191.sql
CREATE VIEW vw_citizen_dashboard AS
SELECT
(case when ref_no is not null then
c.ref_no
else
c.APM_APPLICATION_ID
