...
@XmlRootElement(namespace = "http://bhuiyan.cg.nic.in/", name = "DiversionPlotDetails")
@XmlAccessorType(XmlAccessType.FIELD)
@JsonAutoDetect
@JsonSerialize
@JsonDeserialize
@JsonIgnoreProperties(ignoreUnknown = true)
public class DiversionPlotDetails {
    ...
    @XmlElement
    private List<DiversionOwnerDetails> diversionOwnerDetails = new ArrayList<>(0);
    ...
    public List<DiversionOwnerDetails> getDiversionOwnerDetails() {
        return diversionOwnerDetails;
    }

    public void setDiversionOwnerDetails(List<DiversionOwnerDetails> diversionOwnerDetails) {
