...
@Controller
@RequestMapping("/UsageWiseReport.html")
public class UsageWisePropertyReportController extends AbstractFormController<AssessmentRegisterReportModel> {
	@Autowired
	...
	@RequestMapping(params = "GetUsageWiseReport", method = { RequestMethod.POST, RequestMethod.GET })
	public @ResponseBody String viewUsageReport(@RequestParam("wardZone1") Long wardZone1,
			...
			@RequestParam("proertyNo") String proertyNo, @RequestParam("usageType1") String usageType1,
		...
		if (error == null) {
			return ServiceEndpoints.PROPERTY_BIRT_REPORT_URL + "=UsageTypePropertyReport.rptdesign&OrgId="
					+ currentOrgId + "&WZoneB1=" + wardZone1 + "&WZoneB2=" + wardZone2 + "&WZoneB3=" + wardZone3
					+ "&WZoneB4=" + wardZone4 + "&WZoneB5=" + wardZone5 + "&FromDate=" + fromdt + "&ToDate=" + todt
					+ "&PropertyNumber=" + proertyNo + "&Usagetype=" + usageType1;
		}
		return error;
