...
@Component
public class BillPaymentValidator extends BaseEntityValidator<BillPaymentDetailDto> {
    ...
    protected void performValidations(BillPaymentDetailDto billPayDto,
        ...
        if (billPayDto.getTotalPaidAmt() <= 0) {
            entityValidationContext.addOptionConstraint(session.getMessage("property.billPayment.amount"));
        }
