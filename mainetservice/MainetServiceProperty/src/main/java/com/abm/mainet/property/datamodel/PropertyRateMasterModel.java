...
public class PropertyRateMasterModel extends CommonModel implements Serializable {
    ...
    private double totalArv;// #26577-- superset changes By Apeksha
    ...
    /**
     * to prevent object initialization. in order to get instance of this {@code PropertyRateMasterModel} class use Rest call as
     * like below RestClient.exchange(WSRequestDTO, "/brms/getInitializedModel");
     */
