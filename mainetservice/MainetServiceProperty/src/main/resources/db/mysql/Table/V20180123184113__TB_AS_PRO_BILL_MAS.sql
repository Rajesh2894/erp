...
--changeset nilima:V20180123184113__TB_AS_PRO_BILL_MAS1.sql
DROP TABLE IF EXISTS TB_AS_PRO_BILL_MAS;
--liquibase formatted sql
--changeset nilima:V20180123184113__TB_AS_PRO_BILL_MAS2.sql
...
--liquibase formatted sql
--changeset nilima:V20180123184113__TB_AS_PRO_BILL_MAS3.sql
