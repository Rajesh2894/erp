...
--changeset nilima:V20171227130645__ALL_TB_AS_PRO_ASSESMENT_DETAIL1.sql
Drop table IF EXISTS TB_AS_PRO_ASSESMENT_DETAIL;
--liquibase formatted sql
--changeset nilima:V20171227130645__ALL_TB_AS_PRO_ASSESMENT_DETAIL2.sql
create table TB_AS_PRO_ASSESMENT_DETAIL (
pro_assd_id	bigint(20)	 NOT NULL	  COMMENT '	primary key	',
pro_ass_id	bigint(20)	 NOT NULL	  COMMENT '	foregin key Foregin Key(TB_AS_PRO_ASSESMENT_MAST)	',
pro_assd_unit_type_id	bigint(20)	 NOT NULL	  COMMENT '	Unit Type	',
pro_assd_floor_no	bigint(20)	 NOT NULL	  COMMENT '	Floor No (Prefix ''IDE'')	',
pro_assd_buildup_area	decimal(15,2)	 NOT NULL	  COMMENT '	Floorwise Build Up Area	',
pro_assd_usagetype1	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	Usage Type (Prefix ''USA'')	',
pro_assd_usagetype2	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	Usage SubType (Prefix ''USA'')	',
pro_assd_usagetype3	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	Usage SubType (Prefix ''USA'')	',
pro_assd_usagetype4	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	Usage SubType (Prefix ''USA'')	',
pro_assd_usagetype5	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	Usage SubType (Prefix ''USA'')	',
pro_assd_constru_type	bigint(20)	 NOT NULL	  COMMENT '	Construction Type (Prefix ''CSC'')	',
pro_assd_year_construction	datetime	 NOT NULL	  COMMENT '	Construction complection date	',
pro_assd_occupancy_type	bigint(20)	 NOT NULL	  COMMENT '	Occupancy Type (Prefix ''OCS'')	',
...
updated_by	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	user id who update the data	',
...
pro_FA_YEARID	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	Latest Yearid	');

--liquibase formatted sql
--changeset nilima:V20171227130645__ALL_TB_AS_PRO_ASSESMENT_DETAIL3.sql
alter table TB_AS_PRO_ASSESMENT_DETAIL add constraint PK_PRO_ASSD_ID primary key (PRO_ASSD_ID);
--liquibase formatted sql
--changeset nilima:V20171227130645__ALL_TB_AS_PRO_ASSESMENT_DETAIL4.sql
