...
--changeset nilima:V20180405180108__TB_AS_ASSESMENT_FACTOR_DTL1.sql
drop table IF EXISTS TB_AS_ASSESMENT_FACTOR_DTL;

--liquibase formatted sql
--changeset nilima:V20180405180108__TB_AS_ASSESMENT_FACTOR_DTL2.sql
...
--liquibase formatted sql
--changeset nilima:V20180405180108__TB_AS_ASSESMENT_FACTOR_DTL3.sql
  alter table TB_AS_ASSESMENT_FACTOR_DTL  add constraint PK_MN_assf_id primary key (MN_assf_id);

--liquibase formatted sql
--changeset nilima:V20180405180108__TB_AS_ASSESMENT_FACTOR_DTL4.sql
...
--liquibase formatted sql
--changeset nilima:V20180405180108__TB_AS_ASSESMENT_FACTOR_DTL5.sql
