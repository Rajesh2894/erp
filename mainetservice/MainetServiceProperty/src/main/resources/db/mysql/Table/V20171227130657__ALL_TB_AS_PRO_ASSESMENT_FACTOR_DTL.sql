...
--changeset nilima:V20171227130657__ALL_TB_AS_PRO_ASSESMENT_FACTOR_DTL1.sql
drop table  IF EXISTS TB_AS_PRO_ASSESMENT_FACTOR_DTL;
--liquibase formatted sql
--changeset nilima:V20171227130657__ALL_TB_AS_PRO_ASSESMENT_FACTOR_DTL2.sql
...
--liquibase formatted sql
--changeset nilima:V20171227130657__ALL_TB_AS_PRO_ASSESMENT_FACTOR_DTL3.sql 
alter table TB_AS_PRO_ASSESMENT_FACTOR_DTL add constraint PK_PRO_ASSF_ID primary key (PRO_ASSF_ID);
--liquibase formatted sql
--changeset nilima:V20171227130657__ALL_TB_AS_PRO_ASSESMENT_FACTOR_DTL4.sql
...
--liquibase formatted sql
--changeset nilima:V20171227130657__ALL_TB_AS_PRO_ASSESMENT_FACTOR_DTL5.sql
