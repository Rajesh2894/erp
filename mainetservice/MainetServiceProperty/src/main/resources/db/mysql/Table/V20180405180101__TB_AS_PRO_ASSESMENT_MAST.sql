...
--changeset nilima:V20180405180101__TB_AS_PRO_ASSESMENT_MAST1.sql
drop table IF EXISTS TB_AS_PRO_ASSESMENT_MAST;

--liquibase formatted sql
--changeset nilima:V20180405180101__TB_AS_PRO_ASSESMENT_MAST2.sql
...
--liquibase formatted sql
--changeset nilima:V20180405180101__TB_AS_PRO_ASSESMENT_MAST3.sql
alter table TB_AS_PRO_ASSESMENT_MAST add constraint PK_PRO_ASS_ID primary key (PRO_ASS_ID);
--liquibase formatted sql
--changeset nilima:V20180405180101__TB_AS_PRO_ASSESMENT_MAST4.sql
