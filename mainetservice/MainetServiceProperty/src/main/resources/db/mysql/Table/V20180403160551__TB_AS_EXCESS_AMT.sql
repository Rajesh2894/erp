...
--changeset shamik:V20180403160551__TB_AS_EXCESS_AMT1.sql
DROP TABLE IF EXISTS TB_AS_EXCESS_AMT;



--liquibase formatted sql
--changeset shamik:V20180403160551__TB_AS_EXCESS_AMT2.sql
...
--liquibase formatted sql
--changeset shamik:V20180403160551__TB_AS_EXCESS_AMT3.sql
ALTER TABLE TB_AS_EXCESS_AMT ADD CONSTRAINT PK_TB_AS_EXCESS_AMT PRIMARY KEY (EXCESS_ID);

--liquibase formatted sql
--changeset shamik:V20180403160551__TB_AS_EXCESS_AMT4.sql
