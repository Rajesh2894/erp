...
--changeset nilima:V20180123184028__TB_AS_ASSESMENT_DETAIL1.sql
drop table IF EXISTS  TB_AS_ASSESMENT_DETAIL;

--liquibase formatted sql
--changeset nilima:V20180123184028__TB_AS_ASSESMENT_DETAIL2.sql
...
--liquibase formatted sql
--changeset nilima:V20180123184028__TB_AS_ASSESMENT_DETAIL3.sql
alter table TB_AS_ASSESMENT_DETAIL   add constraint PK_MN_assd_id primary key (MN_assd_id) ;

--liquibase formatted sql
--changeset nilima:V20180123184028__TB_AS_ASSESMENT_DETAIL4.sql
