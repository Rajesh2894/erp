...
--changeset nilima:V20171227130736__ALL_TB_AS_PRO_BILL_DET1.sql
DROP TABLE IF EXISTS TB_AS_PRO_BILL_DET;
--liquibase formatted sql
--changeset nilima:V20171227130736__ALL_TB_AS_PRO_BILL_DET2.sql
create table TB_AS_PRO_BILL_DET (
pro_bd_billdetid	bigint(20)	 NOT NULL	  COMMENT '	Primary Id of this table	',
bm_idno	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	Bill id of TB_AS_PRO_BILL_MAS	',
tax_id	bigint(20)	 NOT NULL	  COMMENT '	tax_id	',
rebate_id	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	rebate_id	',
adjustment_id	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	adjustment_id	',
...
pro_bd_cur_arramt	decimal(15,2)	 NULL DEFAULT NULL 	  COMMENT '	Arrear amount present in the current year if present	',
pro_bd_prv_arramt	decimal(15,2)	 NULL DEFAULT NULL 	  COMMENT '	Arrear amount present in the previous billing  year if present	',
pro_bd_cur_bal_arramt	decimal(15,2)	 NULL DEFAULT NULL 	  COMMENT '	Current year arrear tax amount to be paid 	',
...
orgid	bigint(20)	 NOT NULL	  COMMENT '	Org ID	',
...
tax_category	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	TAX Category	',
coll_seq	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	Collection sequence 	');

--liquibase formatted sql
--changeset nilima:V20171227130736__ALL_TB_AS_PRO_BILL_DET3.sql
alter table TB_AS_PRO_BILL_DET add constraint PK_bd_billdetid primary key (pro_bd_billdetid);
--liquibase formatted sql
--changeset nilima:V20171227130736__ALL_TB_AS_PRO_BILL_DET4.sql
alter table TB_AS_PRO_BILL_DET add constraint FK_pro_bm_idno foreign key (bm_idno) references  TB_AS_PRO_BILL_MAS (pro_bm_idno);