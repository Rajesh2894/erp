...
--changeset nilima:V20171227130708__ALL_TB_AS_PRO_ASSESMENT_OWNER_DTL1.sql
drop table IF EXISTS TB_AS_PRO_ASSESMENT_OWNER_DTL;
--liquibase formatted sql
--changeset nilima:V20171227130708__ALL_TB_AS_PRO_ASSESMENT_OWNER_DTL2.sql
create table TB_AS_PRO_ASSESMENT_OWNER_DTL (
pro_asso_id	bigint(20)	 NOT NULL	  COMMENT '	primary key	',
pro_ass_id	bigint(20)	 NOT NULL	  COMMENT '	foregin key Foregin Key(TB_AS_ASSESMENT_MAST)	',
pro_asso_owner_name	varchar(500)	 NOT NULL	  COMMENT '	Owner Name/Company Trust Name	',
pro_gender_id	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	Owner Gender (prefix ''GEN'')	',
pro_relation_id	bigint(20)	 NULL DEFAULT NULL 	  COMMENT '	Owner Husband Father Name/Contact Person Name	',
...
pro_asso_addharno	bigint(20)	 NOT NULL	  COMMENT '	Owner Addhar  No	',
...
updated_date	date	 NULL DEFAULT NULL 	  COMMENT '	date on which data is going to update	',
...
--liquibase formatted sql
--changeset nilima:V20171227130708__ALL_TB_AS_PRO_ASSESMENT_OWNER_DTL3.sql
alter table TB_AS_PRO_ASSESMENT_OWNER_DTL add constraint PK_pro_asso_ID primary key (pro_asso_ID);
--liquibase formatted sql
--changeset nilima:V20171227130708__ALL_TB_AS_PRO_ASSESMENT_OWNER_DTL4.sql
alter table TB_AS_PRO_ASSESMENT_OWNER_DTL add constraint FK_pro_asso_ASS_ID foreign key (PRO_ASS_ID) references TB_AS_PRO_ASSESMENT_MAST (PRO_ASS_ID);