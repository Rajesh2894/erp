...
--changeset nilima:V20180123183850__TB_AS_PRO_ASSESMENT_OWNER_DTL1.sql
...
--liquibase formatted sql
--changeset nilima:V20180123183850__TB_AS_PRO_ASSESMENT_OWNER_DTL3.sql
alter table TB_AS_PRO_ASSESMENT_OWNER_DTL add constraint PK_pro_asso_ID primary key (pro_asso_ID);

--liquibase formatted sql
--changeset nilima:V20180123183850__TB_AS_PRO_ASSESMENT_OWNER_DTL4.sql
