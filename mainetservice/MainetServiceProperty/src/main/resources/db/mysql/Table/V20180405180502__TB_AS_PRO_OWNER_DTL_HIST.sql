...
--changeset nilima:V20180405180502__TB_AS_PRO_OWNER_DTL_HIST1.sql
drop table IF EXISTS TB_AS_PRO_OWNER_DTL_HIST;

--liquibase formatted sql
--changeset nilima:V20180405180502__TB_AS_PRO_OWNER_DTL_HIST2.sql
create table TB_AS_PRO_OWNER_DTL_HIST (
`pro_asso_HIST_ID` BIGINT(12),
...
--liquibase formatted sql
--changeset nilima:V20180405180502__TB_AS_PRO_OWNER_DTL_HIST3.sql
alter table TB_AS_PRO_OWNER_DTL_HIST add constraint PK_pro_asso_HIST_ID primary key (pro_asso_HIST_ID);
