...
--changeset nilima:V20180123184058__TB_AS_PRO_BILL_DET1.sql
DROP TABLE IF EXISTS TB_AS_PRO_BILL_DET;

--liquibase formatted sql
--changeset nilima:V20180123184058__TB_AS_PRO_BILL_DET2.sql
...
--liquibase formatted sql
--changeset nilima:V20180123184058__TB_AS_PRO_BILL_DET3.sql
alter table TB_AS_PRO_BILL_DET add constraint PK_bd_billdetid primary key (pro_bd_billdetid);
--liquibase formatted sql
--changeset nilima:V20180123184058__TB_AS_PRO_BILL_DET4.sql
