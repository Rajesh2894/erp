...
--changeset nilima:V20180405180107__TB_AS_ASSESMENT_OWNER_DTL1.sql 
drop table IF EXISTS TB_AS_ASSESMENT_OWNER_DTL;
--liquibase formatted sql
--changeset nilima:V20180405180107__TB_AS_ASSESMENT_OWNER_DTL2.sql 
...
--liquibase formatted sql
--changeset nilima:V20180405180107__TB_AS_ASSESMENT_OWNER_DTL3.sql 
  alter table TB_AS_ASSESMENT_OWNER_DTL add constraint PK_owner_MN_asso_id primary key (MN_asso_id);
  
--liquibase formatted sql
--changeset nilima:V20180405180107__TB_AS_ASSESMENT_OWNER_DTL4.sql
