...
--changeset nilima:V20180405180510__TB_AS_PRO_BILL_MAS_HIST1.sql
DROP TABLE IF EXISTS TB_AS_PRO_BILL_MAS_HIST;
--liquibase formatted sql
--changeset nilima:V20180405180510__TB_AS_PRO_BILL_MAS_HIST2.sql
create table TB_AS_PRO_BILL_MAS_HIST (
`pro_bm_idno_HIST_ID` BIGINT(12),
`pro_bm_idno`	bigint(12)	 NOT NULL	  COMMENT '	Primary Id	',
`pro_ass_id`	bigint(12)	 NOT NULL	  COMMENT '	Assesment Id  of tb_as_assessment_mast	',
`pro_prop_no`	varchar(20)	 NOT NULL	  COMMENT '	Assesment No  of tb_as_assessment_mast	',
`pro_bm_year`	bigint(20)	 NOT NULL	  COMMENT '	Bill Year	',
...
PRO_bm_AUT_BY BIGINT(12) NULL DEFAULT NULL COMMENT '	AUTHORISATION BY (EMPID)	',
PRO_bm_AUT_DATE DATETIME NULL DEFAULT NULL COMMENT '	AUTHORISATION DATE	',
PRO_bm_TASK_ID BIGINT(12) NULL DEFAULT NULL COMMENT '	AUTHORISATION TASK ID',
...
`pro_auth_bm_idno`	bigint(12)	 NULL DEFAULT NULL 	  COMMENT '	Auth bm_idno no	',
`H_STATUS` char(1)  NULL DEFAULT NULL 	  COMMENT '	X	');

--liquibase formatted sql
--changeset nilima:V20180405180510__TB_AS_PRO_BILL_MAS_HIST3.sql
alter table TB_AS_PRO_BILL_MAS_HIST add constraint PK_pro_bm_idno_HIST_ID primary key (pro_bm_idno_HIST_ID);