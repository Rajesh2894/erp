 ...
 */
@Repository
public class AssetLeasingCompanyRevRepoImpl implements AssetLeasingCompanyRevCustomRepo {
   ...
   /* @Override
    ...
    public void updateLeasingComp(final AssetLeasingCompany entity) {
        final Query query = entityManager.createQuery(buildUpdateDataQuery());
