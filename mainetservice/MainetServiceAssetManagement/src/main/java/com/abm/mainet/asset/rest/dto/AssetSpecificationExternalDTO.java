 ...
 *
 */
public class AssetSpecificationExternalDTO implements Serializable {
    ...
    *//**
	...
	public String toString() {
		return "AssetSpecificationExternalDTO [assetId=" + assetId + ", length=" + length + ", lengthValue="
				+ lengthValue + ", breadth=" + breadth + ", breadthValue=" + breadthValue + ", height=" + height
				+ ", heightValue=" + heightValue + ", width=" + width + ", widthValue=" + widthValue + ", weight="
				+ weight + ", weightValue=" + weightValue + ", area=" + area + ", areaValue=" + areaValue + ", volume="
				+ volume + ", volumeValue=" + volumeValue + ", carpet=" + carpet + ", carpetValue=" + carpetValue
				+ ", noOfFloor=" + noOfFloor + "]";
	}
