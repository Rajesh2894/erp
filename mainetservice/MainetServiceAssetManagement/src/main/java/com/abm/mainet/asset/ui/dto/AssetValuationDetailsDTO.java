 ...
 *
 */
public class AssetValuationDetailsDTO implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -6832821044285265560L;
    ...
    private BigDecimal totDeprValueInYear;
    ...
    /**
     * @param valuationDetId the valuationDetId to set
     */
    ...
    /**
     * @return the totDeprValueInYear
     */
    public BigDecimal getTotDeprValueInYear() {
        return totDeprValueInYear;
    }

    /**
     * @param totDeprValueInYear the totDeprValueInYear to set
     */
    public void setTotDeprValueInYear(BigDecimal totDeprValueInYear) {
        this.totDeprValueInYear = totDeprValueInYear;
    }
    ...
    public String toString() {
        return "AssetValuationDetailsDTO [valuationDetId=" + valuationDetId + ", assetId=" + assetId + ", groupId="
                + groupId + ", assetClass=" + assetClass + ", method=" + method + ", accountCode=" + accountCode
                ...
                + ", deprValue=" + deprValue + ", totDeprValueInYear=" + totDeprValueInYear + ", changetype="
                + changetype + ", orgId=" + orgId + ", creationDate=" + creationDate + ", createdBy=" + createdBy
