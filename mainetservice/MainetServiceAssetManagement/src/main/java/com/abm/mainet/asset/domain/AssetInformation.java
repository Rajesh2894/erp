...
public class AssetInformation implements Serializable {
    ...
    @Column(name = "AST_AVL_STATUS", nullable = true)
	...
	public static String[] getPkValues() {
        return new String[] { MainetConstants.AssetManagement.ASSET_MANAGEMENT, "TB_AST_INFO_MST", "ASSET_ID" };
    }
