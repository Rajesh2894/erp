...
import com.abm.mainet.asset.dao.IAssetMetadataDao;
...
public class AssetMetadataServiceImpl implements DepartmentalMetadetaService {

	@Autowired
	private IAssetMetadataDao assetDao;
	...
	public List<DmsDocsMetadataDto> getDepartmentalMetadeta(String colname, String Colvalue, Long orgId, Long deptId,
		...
		List<AssetInformation> auditList = assetDao.getAssetDetails(colname, Colvalue, orgId, deptId, argumentsMap);
		if (CollectionUtils.isNotEmpty(auditList)) {
			auditList.forEach(entity -> {
				...
				String strings = MainetConstants.AssetManagement.ASSETCODE + MainetConstants.WINDOWS_SLASH
						+ entity.getAssetId();
