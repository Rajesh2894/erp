 ...
 */
@Repository
public class AssetServiceInformationRepoImpl extends AbstractDAO<Long> implements AssetServiceInformationRepoCustom {

    @Override
    public void updateByAssetId(final Long assetServiceId, final AssetServiceInformation entity) {
        final Query query = createQuery(buildUpdateDataQuery(assetServiceId, entity.getServiceNo(),
                ...
                entity.getMunicipalityName(), entity.getManCatId(), entity.getManTypeId(), entity.getManDate(),
        ...
        query.setParameter("manTypeId", entity.getManTypeId());
        query.setParameter("manCatId", entity.getManCatId());
        query.setParameter("manDate", entity.getManDate());
     ...
     */
    private String buildUpdateDataQuery(Long assetServiceId, String serviceNo, String serviceProvider,
            Date serviceStartDate, Date serviceExpiryDate, BigDecimal serviceAmount, Long warrenty, String costCenter,
            String serviceContent, String serviceDescription, Long assessmentNo, Long propertyRegistrationNo,
            Long taxCode, BigDecimal realEstateAmount, String taxZoneLocation, String municipalityName, Long manTypeId,
            Long manCatId, Date manDate, Long updatedBy,
        ...
        builder.append(",asi.manTypeId=:manTypeId");
        builder.append(",asi.manCatId=:manCatId");
        builder.append(",asi.manDate=:manDate");
