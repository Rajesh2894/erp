 ...
 *
 */
public class AssetInventoryInformationExternalDTO implements Serializable {
...
*/
	...
	public String toString() {
		return "AssetInventoryInformationExternalDTO [assetId=" + assetId + ", inventoryNo=" + inventoryNo
				+ ", lastInventoryOn=" + lastInventoryOn + ", inventoryNote=" + inventoryNote
				+ ", includeAssetInventoryLst=" + includeAssetInventoryLst + "]";
	}
