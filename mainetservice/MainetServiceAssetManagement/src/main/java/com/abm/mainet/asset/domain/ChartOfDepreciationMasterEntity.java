 ...
 *
 * Entity Class for Chart of Depreciation Master
 */
@Entity
@Table(name = "TB_AST_CHAOFDEP_MAS")
public class ChartOfDepreciationMasterEntity implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = 7914263921571475664L;
    ...
    public static String[] getPkValues() {
        return new String[] { MainetConstants.AssetManagement.ASSET_MANAGEMENT, "TB_AST_CHAOFDEP_MAS", "GROUP_ID" };
    }
