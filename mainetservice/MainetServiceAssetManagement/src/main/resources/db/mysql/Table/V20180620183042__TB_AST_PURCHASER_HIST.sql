...
--changeset shamik:V20180620183042__TB_AST_PURCHASER_HIST1.sql
DROP TABLE IF EXISTS TB_AST_PURCHASER_HIST;


--liquibase formatted sql
--changeset shamik:V20180620183042__TB_AST_PURCHASER_HIST2.sql
...
VENDOR BIGINT(20) NULL COMMENT '	X	',
MANUFACTURER VARCHAR(100) NOT NULL COMMENT '	X	',
PURCHASE_ORDER_NO BIGINT(20) NULL COMMENT '	X	',
...
--liquibase formatted sql
--changeset shamik:V20180620183042__TB_AST_PURCHASER_HIST3.sql
