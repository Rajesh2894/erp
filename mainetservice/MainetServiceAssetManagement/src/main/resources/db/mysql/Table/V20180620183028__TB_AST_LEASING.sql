...
--changeset shamik:V20180620183028__TB_AST_LEASING1.sql
DROP TABLE IF EXISTS TB_AST_LEASING;

--liquibase formatted sql
--changeset shamik:V20180620183028__TB_AST_LEASING2.sql
...
--liquibase formatted sql
--changeset shamik:V20180620183028__TB_AST_LEASING3.sql
ALTER TABLE TB_AST_LEASING ADD CONSTRAINT PK_TB_AST_LEASING PRIMARY KEY (ASSET_LEASING_ID);

--liquibase formatted sql
--changeset shamik:V20180620183028__TB_AST_LEASING4.sql
