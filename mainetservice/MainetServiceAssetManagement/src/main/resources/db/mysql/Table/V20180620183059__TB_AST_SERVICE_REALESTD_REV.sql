...
--changeset shamik:V20180620183059__TB_AST_SERVICE_REALESTD_REV1.sql
DROP TABLE IF EXISTS TB_AST_SERVICE_REALESTD_REV;

--liquibase formatted sql
--changeset shamik:V20180620183059__TB_AST_SERVICE_REALESTD_REV2.sql
CREATE TABLE TB_AST_SERVICE_REALESTD_REV (
ASSET_SERVICE_REV_ID BIGINT(12)  NOT NULL COMMENT '	Primary Key	',
...
--liquibase formatted sql
--changeset shamik:V20180620183059__TB_AST_SERVICE_REALESTD_REV3.sql
ALTER TABLE TB_AST_SERVICE_REALESTD_REV ADD CONSTRAINT PK_TB_AST_SERVICE_REALESTD_REV PRIMARY KEY (ASSET_SERVICE_REV_ID);
