...
--changeset shamik:V20180605183046__TB_AST_CHART_OF_DEPRETN_HIST1.sql
DROP TABLE IF EXISTS TB_AST_CHART_OF_DEPRETN_HIST;



--liquibase formatted sql
--changeset shamik:V20180605183046__TB_AST_CHART_OF_DEPRETN_HIST2.sql
...
--liquibase formatted sql
--changeset shamik:V20180605183046__TB_AST_CHART_OF_DEPRETN_HIST3.sql
