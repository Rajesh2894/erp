...
--changeset shamik:V20180316183045__TB_AST_LEASING_HIST1.sql
DROP TABLE IF EXISTS TB_AST_LEASING_HIST;

--liquibase formatted sql
--changeset shamik:V20180316183045__TB_AST_LEASING_HIST2.sql
...
--liquibase formatted sql
--changeset shamik:V20180316183045__TB_AST_LEASING_HIST3.sql
