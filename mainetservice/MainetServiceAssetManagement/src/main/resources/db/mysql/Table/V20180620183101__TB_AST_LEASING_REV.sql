...
--changeset shamik:V20180620183101__TB_AST_LEASING_REV1.sql
DROP TABLE IF EXISTS TB_AST_LEASING_REV;

--liquibase formatted sql
--changeset shamik:V20180620183101__TB_AST_LEASING_REV2.sql
CREATE TABLE TB_AST_LEASING_REV (
ASSET_LEASING_REV_ID BIGINT(12),
...
--liquibase formatted sql
--changeset shamik:V20180620183101__TB_AST_LEASING_REV3.sql
ALTER TABLE TB_AST_LEASING_REV ADD CONSTRAINT PK_TB_AST_LEASING_REV PRIMARY KEY (ASSET_LEASING_REV_ID);
