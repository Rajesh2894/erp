...
--changeset shamik:V20180620183103__TB_AST_LINEAR_REV1.sql
DROP TABLE IF EXISTS TB_AST_LINEAR_REV;

--liquibase formatted sql
--changeset shamik:V20180620183103__TB_AST_LINEAR_REV2.sql
CREATE TABLE TB_AST_LINEAR_REV (
ASSET_LINEAR_REV_ID BIGINT(12),
...
--liquibase formatted sql
--changeset shamik:V20180620183103__TB_AST_LINEAR_REV3.sql
ALTER TABLE TB_AST_LINEAR_REV ADD CONSTRAINT PK_TB_AST_LINEAR_REV PRIMARY KEY (ASSET_LINEAR_REV_ID);
