...
--changeset shamik:V20180627183049__TB_AST_FUNC_LOCATION_MAS_HIST1.sql
DROP TABLE IF EXISTS TB_AST_FUNC_LOCATION_MAS_HIST;


--liquibase formatted sql
--changeset shamik:V20180627183049__TB_AST_FUNC_LOCATION_MAS_HIST2.sql
...
--liquibase formatted sql
--changeset shamik:V20180627183049__TB_AST_FUNC_LOCATION_MAS_HIST3.sql
