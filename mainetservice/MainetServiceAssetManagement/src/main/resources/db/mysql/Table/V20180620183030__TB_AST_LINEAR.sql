...
--changeset shamik:V20180620183030__TB_AST_LINEAR1.sql
DROP TABLE IF EXISTS TB_AST_LINEAR;

--liquibase formatted sql
--changeset shamik:V20180620183030__TB_AST_LINEAR2.sql
...
--liquibase formatted sql
--changeset shamik:V20180620183030__TB_AST_LINEAR3.sql
ALTER TABLE TB_AST_LINEAR ADD CONSTRAINT PK_TB_AST_LINEAR PRIMARY KEY (ASSET_LINEAR_ID);

--liquibase formatted sql
--changeset shamik:V20180620183030__TB_AST_LINEAR4.sql
