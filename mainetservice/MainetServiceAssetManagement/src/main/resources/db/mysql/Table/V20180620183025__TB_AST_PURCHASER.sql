...
--changeset shamik:V20180620183025__TB_AST_PURCHASER1.sql
DROP TABLE IF EXISTS TB_AST_PURCHASER;


--liquibase formatted sql
--changeset shamik:V20180620183025__TB_AST_PURCHASER2.sql
...
--liquibase formatted sql
--changeset shamik:V20180620183025__TB_AST_PURCHASER3.sql
ALTER TABLE TB_AST_PURCHASER ADD CONSTRAINT PK_TB_AST_PURCHASER PRIMARY KEY (ASSET_PURCHASER_ID);

--liquibase formatted sql
--changeset shamik:V20180620183025__TB_AST_PURCHASER4.sql
