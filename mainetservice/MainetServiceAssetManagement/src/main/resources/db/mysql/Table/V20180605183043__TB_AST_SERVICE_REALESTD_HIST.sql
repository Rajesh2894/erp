...
--changeset shamik:V20180605183043__TB_AST_SERVICE_REALESTD_HIST1.sql
DROP TABLE IF EXISTS TB_AST_SERVICE_REALESTD_HIST;

--liquibase formatted sql
--changeset shamik:V20180605183043__TB_AST_SERVICE_REALESTD_HIST2.sql
...
--liquibase formatted sql
--changeset shamik:V20180605183043__TB_AST_SERVICE_REALESTD_HIST3.sql
