...
--changeset shamik:V20180627183032__TB_AST_FUNC_LOCATION_MAS1.sql
DROP TABLE IF EXISTS TB_AST_FUNC_LOCATION_MAS;


--liquibase formatted sql
--changeset shamik:V20180627183032__TB_AST_FUNC_LOCATION_MAS2.sql
...
--liquibase formatted sql
--changeset shamik:V20180627183032__TB_AST_FUNC_LOCATION_MAS3.sql
ALTER TABLE TB_AST_FUNC_LOCATION_MAS ADD CONSTRAINT PK_TB_AST_FUNC_LOCATION_MAS PRIMARY KEY (FUNC_LOCATION_ID);

--liquibase formatted sql
--changeset shamik:V20180627183032__TB_AST_FUNC_LOCATION_MAS4.sql
