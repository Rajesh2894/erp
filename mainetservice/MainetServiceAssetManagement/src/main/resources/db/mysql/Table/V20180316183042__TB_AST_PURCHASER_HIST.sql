...
--changeset shamik:V20180316183042__TB_AST_PURCHASER_HIST1.sql
DROP TABLE IF EXISTS TB_AST_PURCHASER_HIST;


--liquibase formatted sql
--changeset shamik:V20180316183042__TB_AST_PURCHASER_HIST2.sql
...
VENDOR VARCHAR(100) NOT NULL COMMENT '	X	',
...
PURCHASE_COST BIGINT(20) NOT NULL COMMENT '	X	',
BOOK_VALUE BIGINT(20) NOT NULL COMMENT '	X	',
LIFE_IN_YEARS VARCHAR(100) NULL DEFAULT NULL 	  COMMENT '	X	',
MODE_OF_PAYMENT VARCHAR(100) NULL DEFAULT NULL 	  COMMENT '	X	',
COUNTRY_OF_ORIGIN VARCHAR(100) NULL DEFAULT NULL 	  COMMENT '	X	',
...
--liquibase formatted sql
--changeset shamik:V20180316183042__TB_AST_PURCHASER_HIST3.sql
