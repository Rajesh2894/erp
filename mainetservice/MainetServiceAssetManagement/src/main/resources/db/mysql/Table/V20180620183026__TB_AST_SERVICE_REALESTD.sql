...
--changeset shamik:V20180620183026__TB_AST_SERVICE_REALESTD1.sql
DROP TABLE IF EXISTS TB_AST_SERVICE_REALESTD;

--liquibase formatted sql
--changeset shamik:V20180620183026__TB_AST_SERVICE_REALESTD2.sql
...
--liquibase formatted sql
--changeset shamik:V20180620183026__TB_AST_SERVICE_REALESTD3.sql
ALTER TABLE TB_AST_SERVICE_REALESTD ADD CONSTRAINT PK_TB_AST_SERVICE_REALESTD PRIMARY KEY (ASSET_SERVICE_ID);


--liquibase formatted sql
--changeset shamik:V20180620183026__TB_AST_SERVICE_REALESTD4.sql
