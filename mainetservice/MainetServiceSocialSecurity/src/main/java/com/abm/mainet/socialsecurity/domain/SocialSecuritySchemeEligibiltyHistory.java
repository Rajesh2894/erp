 ...
 */
@Entity
@Table(name = "TB_SWD_SCHEME_ELIGIBILITY_HIST")
public class SocialSecuritySchemeEligibiltyHistory implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = 4067373188690910391L;

    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
    @GeneratedValue(generator = "MyCustomGenerator")
    @Column(name = "SDSCHE_HIST_ID", nullable = false)
    private Long schmeEligibiltyHisId;
    ...
    public static String[] getPkValues() {
        return new String[] { "SWD", "TB_SWD_SCHEME_ELIGIBILITY_HIST", "SDSCHE_HIST_ID" };
    }

    public Long getSchmeEligibiltyHisId() {
        return schmeEligibiltyHisId;
    }

    public void setSchmeEligibiltyHisId(Long schmeEligibiltyHisId) {
        this.schmeEligibiltyHisId = schmeEligibiltyHisId;
    }
