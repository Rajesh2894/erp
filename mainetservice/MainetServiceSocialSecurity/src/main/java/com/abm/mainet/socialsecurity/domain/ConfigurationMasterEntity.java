...
@Entity
@Table(name = "TB_SWD_SCHEME_CONFIGURATION")
public class ConfigurationMasterEntity implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4146768012497926496L;
	...
	@Column(name = "BENF_CNT", nullable = true)
	...
	@Column(name = "TYPE_OF_SCH", nullable = true)
	...
	public static String[] getPkValues() {
		return new String[] { "SWD", "TB_SWD_SCHEME_CONFIGURATION", "CONFID" };
	}
