package com.abm.mainet.socialsecurity.datamodel;
...
public class WaterRateMaster extends CommonModel {
	...
	public String toString() {
		return "WaterRateMaster [taxType=" + taxType + ", taxCode=" + taxCode + ", taxCategory=" + taxCategory
				...
				+ ", transferMode=" + transferMode + ", chargeDescEng=" + chargeDescEng + ", chargeDescReg="
				+ chargeDescReg + ", dependsOnFactorList=" + dependsOnFactorList + ", taxId=" + taxId + ", taxPayer="
				+ taxPayer + ", noOfRoomsORTabel=" + noOfRoomsORTabel + ", noOfMonthsSurcharge=" + noOfMonthsSurcharge
				+ ", noOfMonthsRebate=" + noOfMonthsRebate + ", occupancyType=" + occupancyType + ", arv=" + arv
