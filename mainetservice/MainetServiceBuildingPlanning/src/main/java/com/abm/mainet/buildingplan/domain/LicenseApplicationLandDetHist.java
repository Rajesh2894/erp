...
@Entity
@Table(name = "TB_BPMS_APP_LAND_DET_HIST")
public class LicenseApplicationLandDetHist implements Serializable {
	...
	@Column(name = "H_LAND_DET_ID", nullable = false)
	private Long landDetHistId;
	
	@Column(name = "LAND_DET_ID")
	private Long landDetId;

	@ManyToOne
	@JoinColumn(name = "TCP_LIC_MSTR_ID")
	private LicenseApplicationMasterHist licenseApplicationMaster;
	...
	public Long getLandDetHistId() {
		return landDetHistId;
	}

	public void setLandDetHistId(Long landDetHistId) {
		this.landDetHistId = landDetHistId;
	}

	public LicenseApplicationMasterHist getLicenseApplicationMaster() {
		return licenseApplicationMaster;
	}

	public void setLicenseApplicationMaster(LicenseApplicationMasterHist licenseApplicationMaster) {
	...
	public String[] getPkValues() {
		return new String[] { "NL", "TB_BPMS_APP_LAND_DET_HIST", "H_LAND_DET_ID" };
	}
