...
@Entity
@Table(name = "TB_BPMS_LIC_AQU_DET")
public class LicenseApplicationLandAcquisitionDetEntity implements Serializable {
	...
	@Column(name = "LIC_AQU_DET_ID", nullable = false)
	...
	public String[] getPkValues() {
		return new String[] { "NL", "TB_BPMS_LIC_AQU_DET", "LIC_AQU_DET_ID" };
	}
