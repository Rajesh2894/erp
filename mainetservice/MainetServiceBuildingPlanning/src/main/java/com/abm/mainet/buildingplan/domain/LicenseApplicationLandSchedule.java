...
@Entity
@Table(name = "TB_BPMS_LAND_SCH")
public class LicenseApplicationLandSchedule implements Serializable {
	...
	@OneToMany(mappedBy = "landSchId", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	private List<LicenseApplicationLandSurroundingsEntity> licenseApplicationLandSurroundingsEntity;
	...
	public List<LicenseApplicationLandSurroundingsEntity> getLicenseApplicationLandSurroundingsEntity() {
		return licenseApplicationLandSurroundingsEntity;
	}

	public void setLicenseApplicationLandSurroundingsEntity(
			List<LicenseApplicationLandSurroundingsEntity> licenseApplicationLandSurroundingsEntity) {
		this.licenseApplicationLandSurroundingsEntity = licenseApplicationLandSurroundingsEntity;
	}
	...
	public String[] getPkValues() {
		return new String[] { "NL", "TB_BPMS_LAND_SCH", "LAND_SCH_ID" };
	}
}
