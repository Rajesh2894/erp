...
@Controller
@RequestMapping("/AuthorizationAdditionalSupplemental.html")
public class AuthorizationAdditionalSupplementalController extends AbstractController {

    private static final String MAIN_ENTITY_NAME = "tbAcAdditionalSuppAuthorization";
    private static final String MAIN_LIST_NAME = "list";
    private static final String JSP_FORM = "tbAcAdditionalSuppAuthorization/form";
    private static final String JSP_VIEW = "tbAcAdditionalSuppAuthorization/view";
    private static final String JSP_LIST = "tbAcAdditionalSuppAuthorization/list";
    ...
    public AuthorizationAdditionalSupplementalController() {
        super(AuthorizationAdditionalSupplementalController.class, MAIN_ENTITY_NAME);
    ...
    public @ResponseBody List<?> getjqGridSearchData(final HttpServletRequest request, final Model model,
        ...
        log("AuthorizationAdditionalSupplemental-'getjqGridSearchData' : 'get jqGrid search data'");
        ...
        if ((status != null) && !status.isEmpty()) {
            ...
            if (statusReapp.equals(MainetConstants.STATUS.INACTIVE)) {
        ...
        chList = accountBudgetAdditionalSupplementalService.findByAuthorizationGridData(frmDate, todate, cpdBugtypeId, statusRRA,
    ...
    public @ResponseBody Map<String, String> findBudgetAdditionalSupplementalAmountData(
        ...
        if (!orgEsmtAmount.isEmpty()) {
            ...
            opBalMap.put(MainetConstants.BUDGET_ALLOCATION_MASTER.REV_ORG_ESMT_VALUE, MainetConstants.ZERO);
        }
        return opBalMap;
    }
    ...
    public @ResponseBody Map<String, String> findBudgetReappropriationExpAmountData(
        ...
        if (!orgEsmtAmount.isEmpty()) {
            ...
            opnExpBalMap.put(MainetConstants.BUDGET_ALLOCATION_MASTER.EXP_ORG_ESMT_VALUE, MainetConstants.ZERO);
        }
        return opnExpBalMap;
    }
    ...
    private void populateModel(final Model model, final AccountBudgetAdditionalSupplementalBean bean, final FormMode formMode) {
        ...
        final List<LookUp> bugSubTypelevelMap = CommonMasterUtility.getListLookup(PrefixConstants.BUG_SUB_PREFIX,
                UserSession.getCurrent().getOrganisation());
        model.addAttribute(MainetConstants.BUDGET_ADDITIONALSUPPLEMENTAL.BUG_SUB_TYPE_LEVEL_MAP, bugSubTypelevelMap);
