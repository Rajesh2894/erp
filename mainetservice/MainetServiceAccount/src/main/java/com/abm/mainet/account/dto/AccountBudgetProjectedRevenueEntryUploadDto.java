...
public class AccountBudgetProjectedRevenueEntryUploadDto {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        AccountBudgetProjectedRevenueEntryUploadDto other = (AccountBudgetProjectedRevenueEntryUploadDto) obj;
        if (budgetHead == null) {
