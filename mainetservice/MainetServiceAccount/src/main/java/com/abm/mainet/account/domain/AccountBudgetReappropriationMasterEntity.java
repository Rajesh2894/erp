...
public class AccountBudgetReappropriationMasterEntity implements Serializable {
     ...
     * @Column(name = "PA_ENTRYDATE", nullable = false) private Date paEntrydate;
     */
    ...
    // CONSTRUCTOR(S)
    // ----------------------------------------------------------------------
    public AccountBudgetReappropriationMasterEntity() {
        super();
    }
