...
@Entity
@Table(name = "TB_AC_PROJECTEDREVENUE_HIST")

public class AccountBudgetProjectedRevenueEntryHistEntity implements Serializable {
    ...
    @Column(name = "PR_PROJECTIONID_HIST_ID", nullable = false)
    private Long prProjectionHistId;
    ...
    public static String[] getPkValues() {
        return new String[] { "AC", "TB_AC_PROJECTEDREVENUE_HIST", "PR_PROJECTIONID_HIST_ID" };
    }

    public AccountBudgetProjectedRevenueEntryHistEntity() {
        super();
    }
    ...
    public Long getPrProjectionHistId() {
        return prProjectionHistId;
    }

    public void setPrProjectionHistId(Long prProjectionHistId) {
        this.prProjectionHistId = prProjectionHistId;
    }
    ...
    public void setPrProjectionid(Long prProjectionid) {
    ...
    public void setPrRevBudgetCode(String prRevBudgetCode) {
    ...
    public void setPrProjected(BigDecimal prProjected) {
    ...
    public void setNxtYrOe(String nxtYrOe) {
    ...
    public void setPrCollected(BigDecimal prCollected) {
    ...
    public String toString() {
        return "AccountBudgetProjectedRevenueEntryHistEntity [prProjectionHistId=" + prProjectionHistId
                + ", prProjectionid=" + prProjectionid + ", prRevBudgetCode=" + prRevBudgetCode + ", orginalEstamt="
                + orginalEstamt + ", prProjected=" + prProjected + ", revisedEstamt=" + revisedEstamt + ", nxtYrOe="
                + nxtYrOe + ", prCollected=" + prCollected + ", orgid=" + orgid + ", userId=" + userId + ", langId="
                + langId + ", lmoddate=" + lmoddate + ", updatedBy=" + updatedBy + ", updatedDate=" + updatedDate
                + ", lgIpMac=" + lgIpMac + ", lgIpMacUpd=" + lgIpMacUpd + ", fi04N1=" + fieldId + ", fi04V1=" + fi04V1
                + ", fi04D1=" + fi04D1 + ", fi04Lo1=" + fi04Lo1 + ", tbAcBudgetCodeMaster=" + tbAcBudgetCodeMaster
                + ", tbDepartment=" + tbDepartment + ", cpdBugsubtypeId=" + cpdBugsubtypeId + ", hStatus=" + hStatus
                + ", faYearid=" + faYearid + "]";
    }
