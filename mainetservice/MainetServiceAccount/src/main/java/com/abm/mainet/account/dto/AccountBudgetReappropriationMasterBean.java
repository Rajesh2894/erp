...
public class AccountBudgetReappropriationMasterBean implements Serializable {
	...
	public String toString() {
		return "AccountBudgetReappropriationMasterBean [alreadyExists=" + alreadyExists + ", paAdjid=" + paAdjid
				...
				+ ", budgetIdentifyFlag=" + budgetIdentifyFlag + ", orgid=" + orgid + ", orgShortName=" + orgShortName
				+ ", userId=" + userId + ", langId=" + langId + ", lmoddate=" + lmoddate + ", updatedBy=" + updatedBy
				+ ", updatedDate=" + updatedDate + ", fieldId=" + fieldId + ", lgIpMac=" + lgIpMac + ", lgIpMacUpd="
				+ lgIpMacUpd + ", fi04N1=" + fi04N1 + ", fi04V1=" + fi04V1 + ", fi04D1=" + fi04D1 + ", authFlag="
				+ authFlag + ", fundCode=" + fundCode + ", fieldCode=" + fieldCode + ", functionCode=" + functionCode
				+ ", primaryAcHeadCode=" + primaryAcHeadCode + ", sacHeadCode=" + sacHeadCode + ", hasError=" + hasError
				+ ", secondaryId=" + secondaryId + ", headDesc=" + headDesc + ", formattedCurrency=" + formattedCurrency
				...
				+ ", cpdBugsubtypeDesc=" + cpdBugsubtypeDesc + ", status=" + status + ", cpdBugtypeIdHidden="
				+ cpdBugtypeIdHidden + ", budgetTranRefNo=" + budgetTranRefNo + ", actualTaskId=" + actualTaskId
				+ ", workFlowLevel1=" + workFlowLevel1 + ", workFlowLevel2=" + workFlowLevel2 + ", workFlowLevel3="
				+ workFlowLevel3 + ", workFlowLevel4=" + workFlowLevel4 + ", workFlowLevel5=" + workFlowLevel5
				+ ", createdDate=" + createdDate + ", bugReappMasterDtoList=" + bugReappMasterDtoList
				+ ", bugprojRevBeanList=" + bugprojRevBeanList + ", bugprojRevBeanList1=" + bugprojRevBeanList1
				+ ", bugprojExpBeanList=" + bugprojExpBeanList + ", bugprojExpBeanList1=" + bugprojExpBeanList1
				+ ", attachments=" + attachments + ", attachDocsList=" + attachDocsList + ", removeFileById="
				+ removeFileById + "]";
	}
}
