...
public class ChequeIssueanceDTO implements Serializable {
    ...
    private List<ChequeIssueanceDTO> bankReconciliationDTO = new ArrayList<>();

    private List<ChequeIssueanceDTO> listofStatusId = new ArrayList<>();
    ...
    public List<ChequeIssueanceDTO> getBankReconciliationDTO() {
        return bankReconciliationDTO;
    }

    public void setBankReconciliationDTO(final List<ChequeIssueanceDTO> bankReconciliationDTO) {
    ...
    public List<ChequeIssueanceDTO> getListofStatusId() {
        return listofStatusId;
    }

    public void setListofStatusId(List<ChequeIssueanceDTO> listofStatusId) {
	...
	public String getIssueanceDate() {
		return IssueanceDate;
	}

	public void setIssueanceDate(String issueanceDate) {
		IssueanceDate = issueanceDate;
	}

	@Override
	public String toString() {
		return "ChequeIssueanceDTO [id=" + id + ", chequebookDetid=" + chequebookDetid + ", bankReconciliationId="
				+ bankReconciliationId + ", receiptModeId=" + receiptModeId + ", bankReconIds=" + bankReconIds
				+ ", clearanceDateIds=" + clearanceDateIds + ", transactionMode=" + transactionMode
				+ ", transactionDate=" + transactionDate + ", transactionNo=" + transactionNo + ", IssueanceDate="
				+ IssueanceDate + ", type=" + type + ", index=" + index + ", hasError=" + hasError + ", alreadyExists="
				+ alreadyExists + ", number=" + number + ", date=" + date + ", amount=" + amount + ", serchType="
				+ serchType + ", bankAccount=" + bankAccount + ", chequeddno=" + chequeddno + ", chequedddate="
				+ chequedddate + ", remarks=" + remarks + ", flag=" + flag + ", formDate=" + formDate + ", toDate="
				+ toDate + ", orgid=" + orgid + ", userId=" + userId + ", langId=" + langId + ", lmoddate=" + lmoddate
				+ ", updatedBy=" + updatedBy + ", updatedDate=" + updatedDate + ", statusId=" + statusId
				+ ", previousDate=" + previousDate + ", balanceAsUlb=" + balanceAsUlb + ", bankBalanceAsperStatement="
				+ bankBalanceAsperStatement + ", totalReceiptAmount=" + totalReceiptAmount + ", totalPaymentAmount="
				+ totalPaymentAmount + ", depositSlipId=" + depositSlipId + ", transMode=" + transMode + ", transType="
				+ transType + ", lgIpMac=" + lgIpMac + ", bankReconciliationDTO=" + bankReconciliationDTO
				+ ", listofStatusId=" + listofStatusId + ", bankReconMap=" + bankReconMap + ", categoryId=" + categoryId
				+ ", paymentCategoryId=" + paymentCategoryId + ", successfulFlag=" + successfulFlag + "]";
	}
