...
/**
 * Persistent class for entity stored in table "TB_AC_BANK_TDS_DETAILS_HIST"
 *
...
@Entity
@Table(name = "TB_AC_BANK_TDS_DETAILS_HIST")
// Define named queries here
@NamedQueries({
        @NamedQuery(name = "TbAcPayToBankHistoryEntity.countAll", query = "SELECT COUNT(x) FROM TbAcPayToBankHistoryEntity x") })
public class TbAcPayToBankHistoryEntity implements Serializable {
    ...
    @Column(name = "HPTB_ID", nullable = false)
    private Long hptbId;
    ...
    // CONSTRUCTOR(S)
    // ----------------------------------------------------------------------
    public TbAcPayToBankHistoryEntity() {
        super();
    }
    ...
    public Long getHptbId() {
        return hptbId;
    }

    public void setHptbId(final Long hptbId) {
        this.hptbId = hptbId;
    }
    ...
    public String toString() {
        return "TbAcPayToBankHistoryEntity [hptbId=" + hptbId + ", ptbId=" + ptbId + ", orgid=" + orgid + ", userId="
                + userId + ", lmoddate=" + lmoddate + ", updatedBy=" + updatedBy + ", updatedDate=" + updatedDate
                + ", ptbBsrcode=" + ptbBsrcode + ", lgIpMac=" + lgIpMac + ", lgIpMacUpd=" + lgIpMacUpd + ", bankMaster="
                + bankMaster + ", tbAcVendormaster=" + tbAcVendormaster + ", secondaryAccountCodeMaster="
                + secondaryAccountCodeMaster + ", ptbTdsType=" + ptbTdsType + ", ptbStatus=" + ptbStatus
                + ", ptbBankAcNo=" + ptbBankAcNo + "]";
    }

    public String[] getPkValues() {
        return new String[] { "AC", "TB_AC_BANK_TDS_DETAILS_HIST",
                "HPTB_ID" };
    }
