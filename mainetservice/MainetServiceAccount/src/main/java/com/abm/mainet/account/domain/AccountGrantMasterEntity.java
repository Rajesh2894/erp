...
@Entity
@Table(name = "TB_AC_GRNTMST")
public class AccountGrantMasterEntity implements Serializable {
	private static final long serialVersionUID = 1258299064291174204L;
	@Id
	...
	@Column(name = "OPENING_BALANCE_AMT", precision = 12, scale = 2, nullable = true)
	...
	public static String[] getPkValues() {
        return new String[] { "AC", "TB_AC_GRNTMST", "GRT_ID" };
    }
	...
	public String toString() {
		return "AccountGrantMasterEntity [grntId=" + grntId + ", grtNo=" + grtNo + ", grtDate=" + grtDate + ", grtName="
				+ grtName + ", grtType=" + grtType + ", fromPerd=" + fromPerd + ", toPerd=" + toPerd + ", sactNo="
				+ sactNo + ", sanctionAuth=" + sanctionAuth + ", sanctionDate=" + sanctionDate + ", santionAmt="
				+ santionAmt + ", receivedAmt=" + receivedAmt + ", grtNature=" + grtNature + ", fundId=" + fundId
				+ ", usStatus=" + usStatus + ", langId=" + langId + ", orgId=" + orgId + ", createdBy=" + createdBy
