...
@Entity
@Table(name = "TB_RTI_APPLICATION")
public class TbRtiApplicationDetails implements Serializable {
	...
	// US#34043 for forwrad organisationId
	...
	@Column(name = "POSTAL_CARD_NO")
	private String postalCardNo;
	@Column(name = "POSTAL_AMT")
	private Double postalAmt;
		
	@Column(name = "RTI_APPLICANT_TYPYE")
	private Double applicationType;

	// added regarding D#129188
	@Column(name = "district_id")
	private Long district;
	
	@Column(name = "RTI_SCND_APEAL_STATUS")
	...
	public Double getApplicationType() {
		return applicationType;
	}

	public void setApplicationType(Double applicationType) {
