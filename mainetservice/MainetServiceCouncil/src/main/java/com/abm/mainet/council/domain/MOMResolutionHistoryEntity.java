...
@Entity
@Table(name = "TB_CMT_COUNCIL_RESOLUTION_HIST")
public class MOMResolutionHistoryEntity implements Serializable {

    private static final long serialVersionUID = 1930776158378935878L;

    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
    @GeneratedValue(generator = "MyCustomGenerator")
    @Column(name = "RESO_ID_H")
    private Long resoIdH;

    @Column(name = "RESO_ID", nullable = false)
    private Long resoId;
    ...
    public Long getResoIdH() {
        return resoIdH;
    }

    public void setResoIdH(Long resoIdH) {
        this.resoIdH = resoIdH;
    }
    ...
    public static String[] getPkValues() {
        return new String[] { "CMT", "TB_CMT_COUNCIL_RESOLUTION_HIST", "RESO_ID_H" };
    }
