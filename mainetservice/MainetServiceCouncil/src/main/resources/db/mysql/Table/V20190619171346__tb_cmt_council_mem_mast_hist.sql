...
--changeset Anil:V20190619171346__tb_cmt_council_mem_mast_hist.sql
DROP TABLE IF EXISTS `tb_cmt_council_mem_mast_hist`;

--liquibase formatted sql
--changeset Anil:V20190619171346__tb_cmt_council_mem_mast_hist1.sql
CREATE TABLE `tb_cmt_council_mem_mast_hist` (
  `COU_HIST_ID` bigint(12) NOT NULL,
