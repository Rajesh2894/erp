 ...
 */
@Entity
@Table(name = "TB_SFAC_BLOCK_ALLOCATION_DET_HIST")
public class BlockAllocationDetailHist implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name = "BLCK_ID_H", referencedColumnName = "BLCK_ID_H")
	private BlockAllocationHist blockAllocationHist;
	...
	/**
	 * @return the blockAllocationHist
	 */
	public BlockAllocationHist getBlockAllocationHist() {
		return blockAllocationHist;
	}

	/**
	 * @param blockAllocationHist the blockAllocationHist to set
	 */
	public void setBlockAllocationHist(BlockAllocationHist blockAllocationHist) {
		this.blockAllocationHist = blockAllocationHist;
	}
	 ...
	 * @return the bdIdH
	 */
	public Long getBdIdH() {
		return bdIdH;
	}

	/**
	 * @param bdIdH the bdIdH to set
	 */
	public void setBdIdH(Long bdIdH) {
		this.bdIdH = bdIdH;
	}
	...
	public String[] getPkValues() {
		return new String[] { "SFAC", "TB_SFAC_BLOCK_ALLOCATION_DET_HIST ", "BD_ID_H" };
	}
