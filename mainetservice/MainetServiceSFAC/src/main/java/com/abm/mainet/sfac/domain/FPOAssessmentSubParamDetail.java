 ...
 */
@Entity
@Table(name = "TB_SFAC_FPO_ASS_SUB_PARAM_DET")
public class FPOAssessmentSubParamDetail implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3774991645259768704L;
	...
	FPOAssessmentSubParamEntity fpoSubParamEntity;
	...
	/**
	 * @return the fpoSubParamEntity
	 */
	public FPOAssessmentSubParamEntity getFpoSubParamEntity() {
		return fpoSubParamEntity;
	}

	/**
	 * @param fpoSubParamEntity the fpoSubParamEntity to set
	 */
	public void setFpoSubParamEntity(FPOAssessmentSubParamEntity fpoSubParamEntity) {
		this.fpoSubParamEntity = fpoSubParamEntity;
	}
	...
	public String[] getPkValues() {
		return new String[] { "SFAC", "TB_SFAC_FPO_ASS_SUB_PARAM_DET", "ASS_SP_ID" };
	}
