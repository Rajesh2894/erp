 ...
 */
@Entity
@Table(name = "TB_SFAC_COMMITTEE_MEMBER_MASTER")
public class CommitteeMemberMasterEntity implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1994215082002124546L;

	@Id
	@GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
	@GeneratedValue(generator = "MyCustomGenerator")
	@Column(name = "COM_MEM_ID", unique = true, nullable = false)
	...
	public static String[] getPkValues() {
		return new String[] { "SFAC", "TB_SFAC_COMMITTEE_MEMBER_MASTER", "COM_MEM_ID" };
	}
