 ...
 */
@Entity
@Table(name = "TB_SFAC_BLOCK_TARGET_HIST")
public class BlockTargetDetHist implements Serializable {
	 ...
	 * @return the btIdH
	 */
	public Long getBtIdH() {
		return btIdH;
	}

	/**
	 * @param btIdH the btIdH to set
	 */
	public void setBtIdH(Long btIdH) {
		this.btIdH = btIdH;
	}
	...
	public String[] getPkValues() {
		return new String[] { "SFAC", "TB_SFAC_BLOCK_TARGET_HIST", "BT_ID_H" };
	}
