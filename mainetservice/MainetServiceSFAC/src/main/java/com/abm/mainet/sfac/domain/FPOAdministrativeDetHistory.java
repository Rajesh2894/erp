 ...
 */
@Entity
@Table(name = "TB_SFAC_FPO_ADMINISTRATIVE_DET_HIST")
public class FPOAdministrativeDetHistory implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 9219133643796596451L;

	@Id
	@GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
	@GeneratedValue(generator = "MyCustomGenerator")
	@Column(name = "AD_ID_H", unique = true, nullable = false)
	private Long adIdH;
	 ...
	 * @return the adIdH
	 */
	public Long getAdIdH() {
		return adIdH;
	}

	/**
	 * @param adIdH the adIdH to set
	 */
	public void setAdIdH(Long adIdH) {
		this.adIdH = adIdH;
	}
	...
	public String[] getPkValues() {
		return new String[] { "SFAC", "TB_SFAC_FPO_ADMINISTRATIVE_DET_HIST", "AD_ID_H" };
	}
}
