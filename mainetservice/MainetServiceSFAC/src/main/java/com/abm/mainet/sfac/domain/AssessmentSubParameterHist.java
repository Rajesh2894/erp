 ...
 */
@Entity
@Table(name = "TB_SFAC_ASSESSMENT_SUB_PARAM_HIST")
public class AssessmentSubParameterHist implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 781500233694600303L;
	@Id
	...
	private AssessmentKeyParameterHist masterKeyParamHistEntity;
	...
	/**
	 * @return the masterKeyParamHistEntity
	 */
	public AssessmentKeyParameterHist getMasterKeyParamHistEntity() {
		return masterKeyParamHistEntity;
	}

	/**
	 * @param masterKeyParamHistEntity the masterKeyParamHistEntity to set
	 */
	public void setMasterKeyParamHistEntity(AssessmentKeyParameterHist masterKeyParamHistEntity) {
		this.masterKeyParamHistEntity = masterKeyParamHistEntity;
	}
	...
	public String[] getPkValues() {
		return new String[] { "SFAC", "TB_SFAC_ASSESSMENT_SUB_PARAM_HIST", "ASS_SID_H" };
	}
