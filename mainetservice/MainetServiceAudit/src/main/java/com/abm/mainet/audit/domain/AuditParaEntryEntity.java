...
@Entity
@Table(name = IAuditConstants.AUDIT_TABLE)
public class AuditParaEntryEntity {
	

    @Id
    @GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
	@GeneratedValue(generator = "MyCustomGenerator")
	@Column(name = "AUDIT_PARA_ID", unique = true, nullable = false)
	...
	@Column(name="SUB_UNIT_COMP_PENDING")
	private String subUnitCompPending;
	
	@Column(name=" SUB_UNIT_COMP_DONE")
	...
	public static String[] getPkValues() {
        return new String[] { "AUD", IAuditConstants.AUDIT_TABLE, IAuditConstants.AUDIT_PRIMARY_KEY };
    }
