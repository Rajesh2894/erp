...
@NamedQuery(name = "DeathCertEntity.findAll", query = "SELECT t FROM DeathCertEntity t")
public class DeathCertEntity implements Serializable {
	...
	@Column(name = "APPLICANT_HWNAME", length = 100)
