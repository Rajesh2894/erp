...
@Entity
@Table(name="TB_RTS_BIRTHREGCERT")
public class BirthCertificateEntity {
	...
	@Column(name="BR_R_ID", nullable=false)
	private Long brRId;
	...
	@Temporal(TemporalType.DATE)
	@Column(name="BR_ACERT_GEN_DTE")
	private Date brAcgd;
	
	@Column(name="BIRTH_PTINNO")
	...
	public String[] getPkValues() {
		return new String[] { "HD", "TB_RTS_BIRTHREGCERT", "BR_R_ID" };
	}
