...
@Entity
@Table(name = "TB_BD_BIRTHREG_CORR")
public class BirthRegistrationCorrection implements Serializable {
	...
	@Column(name = "BR_CORR_ID", precision = 0, scale = 0, nullable = false)
	private long brCorrId;
	...
	public long getBrCorrId() {
		return brCorrId;
	}

	public void setBrCorrId(long brCorrId) {
		this.brCorrId = brCorrId;
	}
	...
	public String[] getPkValues() {
		return new String[] { "HD", "TB_BD_BIRTHREG_CORR", "BR_CORR_ID" };
	}
