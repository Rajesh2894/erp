...
@Entity
@Table(name = "tb_medicalcert_corr_history")
public class MedicalMasterCorrectionHistory implements Serializable{
	...
	public String[] getPkValues() {
        return new String[] { "HD", "tb_medicalcert_corr_history", "mc_hi_id" };
    }
