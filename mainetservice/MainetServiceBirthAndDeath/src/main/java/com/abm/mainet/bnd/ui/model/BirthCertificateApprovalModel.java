...
@Component("bndBirthCertificateApprovalModel")
...
public class BirthCertificateApprovalModel extends AbstractFormModel{
	...
	private List<AttachDocs> attDocsList = new ArrayList<>();
	...
	public List<AttachDocs> getAttDocsList() {
		return attDocsList;
	}

	public void setAttDocsList(List<AttachDocs> attDocsList) {
		this.attDocsList = attDocsList;
	}
	...
	public boolean saveBirthApprovalDetails(String ApplicationId, Long orgId, String task)
	{
		...
		prepareContractDocumentsData(birthCertificateDto);
		}
        ...
        List<Long> attacheMentIds = ApplicationContextProvider.getApplicationContext()
				...
				.fetchAttachmentIdByAppid(Long.valueOf(ApplicationId), orgId);
        ...
        ServiceMaster service = ApplicationContextProvider.getApplicationContext().getBean(ServiceMasterService.class)
                .getServiceMasterByShortCode(BndConstants.RBC,UserSession.getCurrent().getOrganisation().getOrgid());
	...
	public void prepareContractDocumentsData(BirthCertificateDTO entity) {
		...
		requestDTO.setApplicationId(entity.getApmApplicationId());
