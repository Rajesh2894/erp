...
@Entity
@Table(name = "tb_deathreg_draft")
@NamedQuery(name = "TbDeathRegdraft.findAll", query = "SELECT t FROM TbDeathRegdraft t")
public class TbDeathRegdraft implements Serializable{
	...
	@Column(name = "DR_DRAFT_ID", nullable = false)
	...
	public String[] getPkValues() {
		return new String[] { "HD", "tb_deathreg_draft", "DR_DRAFT_ID" };
	}
