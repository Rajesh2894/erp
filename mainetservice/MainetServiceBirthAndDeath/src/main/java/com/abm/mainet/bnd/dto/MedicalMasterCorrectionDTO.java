...
@JsonSerialize
@JsonDeserialize
@NamedQuery(name = "MedicalMasterCorrection.findAll", query = "SELECT b FROM tb_medicalcert_corr b")
public class MedicalMasterCorrectionDTO implements Serializable {
