...
public class BirthRegistrationApprovalModel extends AbstractFormModel {
	...
	public boolean saveForm() {
		...
		try {
			...
			if (hasValidationErrors()) {
				...
				iBirthRegSevice.saveBirthRegDet(birthRegDto);
				this.setSuccessMessage(getAppSession().getMessage("BirthRegDto.SuccessMsgBrApproval") + birthRegDto.getApmApplicationId());
			}
		} catch (Exception ex) {
			throw new FrameworkException("Some Problem Occured While Saving Birth Registration Details");
		}
		return true;
