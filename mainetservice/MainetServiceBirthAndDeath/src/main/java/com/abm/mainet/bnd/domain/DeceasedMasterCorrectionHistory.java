...
@Entity
@Table(name="tb_deceased_corr_history")
public class DeceasedMasterCorrectionHistory implements Serializable{
	...
	public String[] getPkValues() {
        return new String[] { "HD", "tb_deceased_corr_history", "DEC_Hi_ID" };
    }
}
