...
public class DeathRegApprovalModel extends AbstractFormModel {
	...
	public boolean saveDeathApprovalDetails(String ApplicationId, Long orgId, String task)
	{
        ...
        getWorkflowActionDto().setComments(tbDeathregDTO.getDeathRegremark());
        ...
        ServiceMaster service = ApplicationContextProvider.getApplicationContext().getBean(ServiceMasterService.class)
                .getServiceMasterByShortCode(BndConstants.DR,UserSession.getCurrent().getOrganisation().getOrgid());
		...
		{     
    		...
    		iDeathRegistrationService.updateDeathWorkFlowStatus(tbDeathregDTO.getDrId(), workflowRequest.getLastDecision(), orgId,tbDeathregDTO.getDrStatus());
