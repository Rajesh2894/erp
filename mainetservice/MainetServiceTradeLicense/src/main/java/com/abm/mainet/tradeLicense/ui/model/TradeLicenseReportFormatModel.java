...
@Component
@Scope("session")
public class TradeLicenseReportFormatModel extends AbstractFormModel {
	/**
	 * 
	 */
	...
	/*private List<TradeLicensePrintReportDTO> tradeLicensePrintReportDTO = new ArrayList<>();*/
	...
	public void setTradeLicensePrintReportDTO(List<TradeLicensePrintReportDTO> tradeLicensePrintReportDTO) {
		this.tradeLicensePrintReportDTO = tradeLicensePrintReportDTO;
	}*/
	...
	public String getLoidetFlag() {
		return loidetFlag;
	}

	public void setLoidetFlag(String loidetFlag) {
		this.loidetFlag = loidetFlag;
	}
