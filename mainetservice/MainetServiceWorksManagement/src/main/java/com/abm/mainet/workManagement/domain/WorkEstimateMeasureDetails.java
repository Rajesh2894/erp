 ...
 */
@Entity
@Table(name = "TB_WMS_MEASUREMENT_DETAIL")
public class WorkEstimateMeasureDetails implements Serializable {
	...
	@Column(name = "ME_NO_UTL", nullable = true)
	private Long meNoUtl;
	
	@Column(name = "ME_LENGTH_FORMULA", nullable = true)
	private String meMentLengthFormula;
	
	@Column(name = "ME_BREADTH_FORMULA", nullable = true)
	private String meMentBreadthFormula;
	
	@Column(name = "ME_HEIGHT_FORMULA", nullable = true)
	...
	public String[] getPkValues() {
		return new String[] { "WMS", "TB_WMS_MEASUREMENT_DETAIL", "ME_ID" };
	}
