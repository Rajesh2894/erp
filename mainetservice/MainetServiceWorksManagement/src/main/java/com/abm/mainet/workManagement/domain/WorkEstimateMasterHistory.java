...
@Entity
@Table(name = "TB_WMS_WORKESTIMATE_MAS_HIST")
public class WorkEstimateMasterHistory implements Serializable {

	private static final long serialVersionUID = -4930806819696223477L;

	@Id
	@GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
	@GeneratedValue(generator = "MyCustomGenerator")
	@Column(name = "WORKE_ID_H", nullable = false)
	private Long workEstemateIdHist;
	...
	@Column(name = "WORK_EST_STATUS ", nullable = false)
	private String workEstimStatus;

	public Long getWorkEstemateIdHist() {
		return workEstemateIdHist;
	}

	public void setWorkEstemateIdHist(Long workEstemateIdHist) {
		this.workEstemateIdHist = workEstemateIdHist;
	}
	...
	public String getWorkEstimStatus() {
		return workEstimStatus;
	}

	public void setWorkEstimStatus(String workEstimStatus) {
		this.workEstimStatus = workEstimStatus;
	}

	public String[] getPkValues() {
		return new String[] { "WMS", "TB_WMS_WORKESTIMATE_MAS_HIST", "WORKE_ID_H" };
	}
