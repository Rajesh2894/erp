...
public class RoadCuttingDto extends RequestDTO implements Serializable {
	...
	List<RoadRouteDetailsDto> scrutinyPerformList = new ArrayList<>();
	List<RoadRouteDetailsDto> disableDetailsList = new ArrayList<>();
	...
	@Transient
    private List<TbApprejMas> loaRemarklist = new ArrayList<>(0);
	
	/**
     * @return the workOrderRemarklist
     */
    public List<TbApprejMas> getLoaRemarklist() {
        return loaRemarklist;
    }

    /**
     * @param workOrderRemarklist the workOrderRemarklist to set
     */
    public void setLoaRemarklist(final List<TbApprejMas> loaRemarklist) {
        this.loaRemarklist = loaRemarklist;
    }
	...
	public List<RoadRouteDetailsDto> getScrutinyPerformList() {
		return scrutinyPerformList;
	}

	public void setScrutinyPerformList(List<RoadRouteDetailsDto> scrutinyPerformList) {
		this.scrutinyPerformList = scrutinyPerformList;
	}

	public List<RoadRouteDetailsDto> getDisableDetailsList() {
		return disableDetailsList;
	}

	public void setDisableDetailsList(List<RoadRouteDetailsDto> disableDetailsList) {
		this.disableDetailsList = disableDetailsList;
	}
	...
	public void setWoServiceId(Long woServiceId) {
	...
	public void setWoApplicationId(Long woApplicationId) {
	...
	public void setWoApplicationDate(Date woApplicationDate) {
	...
	public void setWoApplicationDateS(String woApplicationDateS) {
	...
	public void setWoDeptId(Long woDeptId) {
	...
	public void setWoOrderDate(Date woOrderDate) {
