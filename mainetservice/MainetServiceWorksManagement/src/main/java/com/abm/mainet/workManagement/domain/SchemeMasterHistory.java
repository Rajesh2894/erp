...
@Entity
@Table(name = "TB_WMS_SCHEME_MAST_HIST")
public class SchemeMasterHistory implements Serializable {
	...
	@Column(name = "SCH_ID_H", nullable = false)
	private Long wmSchHistId;
	...
	@Column(name = "SCH_DESCRIPTION", nullable = false)
	...
	public Long getWmSchHistId() {
		return wmSchHistId;
	}

	public void setWmSchHistId(Long wmSchHistId) {
		this.wmSchHistId = wmSchHistId;
	}
	...
	public String[] getPkValues() {
		return new String[] { "WMS", "TB_WMS_SCHEME_MAST_HIST", "SCH_ID_H" };
	}
