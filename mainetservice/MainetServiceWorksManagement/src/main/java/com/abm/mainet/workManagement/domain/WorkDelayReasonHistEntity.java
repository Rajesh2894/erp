 ...
 */
@Entity
@Table(name = "tb_wms_delay_res_hist")
public class WorkDelayReasonHistEntity implements Serializable {

	private static final long serialVersionUID = -1666608633312781438L;

	@Id
	@GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
	@GeneratedValue(generator = "MyCustomGenerator")
	@Column(name = "DEL_RESID_H", nullable = false)
	private Long delResHistId;
	...
	public Long getDelResHistId() {
		return delResHistId;
	}

	public void setDelResHistId(Long delResHistId) {
		this.delResHistId = delResHistId;
	}
	...
	public static String[] getPkValues() {
		return new String[] { "WMS", "tb_wms_delay_res_hist", "DEL_RESID_H" };
	}
}
