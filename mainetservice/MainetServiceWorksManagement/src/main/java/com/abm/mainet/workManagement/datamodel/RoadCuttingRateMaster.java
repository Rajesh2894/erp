package com.abm.mainet.workManagement.datamodel;
...
public class RoadCuttingRateMaster extends CommonModel {
	...
	public RoadCuttingRateMaster() {
		...
		roadCuttingTechnique = MainetConstants.CommonConstants.NA;
		percentageRate = 0.0D;
		...
		organisationType = MainetConstants.CommonConstants.NA;
		taxId = 0L;
		roadLength = 1.0D;
		roadBreadth = 1.0D;
		roadHeight = 1.0D;
		...
		purposeType = MainetConstants.CommonConstants.NA;
