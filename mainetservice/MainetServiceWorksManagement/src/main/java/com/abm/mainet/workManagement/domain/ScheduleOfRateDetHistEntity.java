 ...
 */
@Entity
@Table(name = "TB_WMS_SOR_DET_HIST")
public class ScheduleOfRateDetHistEntity implements Serializable {
    ...
    @Column(name = "SORD_ID_H", nullable = false)
    private Long sordIdH;
    ...
    public Long getSordIdH() {
        return sordIdH;
    }

    public void setSordIdH(Long sordIdH) {
        this.sordIdH = sordIdH;
    }
    ...
    public String[] getPkValues() {
        return new String[] { "WMS", "TB_WMS_SOR_DET_HIST", "SORD_ID_H" };
    }
