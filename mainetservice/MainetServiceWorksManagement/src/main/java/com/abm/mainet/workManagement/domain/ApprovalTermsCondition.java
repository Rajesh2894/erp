 ...
 */
@Entity
@Table(name = "TB_WMS_TERMSCONDITION")
public class ApprovalTermsCondition implements Serializable {

	private static final long serialVersionUID = -7298445561916398702L;

	@Id
	@GenericGenerator(name = "MyCustomGenerator", strategy = "com.abm.mainet.common.utility.SequenceIdGenerator")
	@GeneratedValue(generator = "MyCustomGenerator")
	@Column(name = "TM_TEID", nullable = false)
	private Long teId;

	@Column(name = "WORK_ID", nullable = false)
	private Long workId;

	@Column(name = "TM_TERMDESC", nullable = false)
	private String termDesc;

	@Column(name = "TM_TERMACTIVE", nullable = false)
	...
	public String[] getPkValues() {
		return new String[] { "WMS", "TB_WMS_TERMSCONDITION", "TM_TEID" };
	}
