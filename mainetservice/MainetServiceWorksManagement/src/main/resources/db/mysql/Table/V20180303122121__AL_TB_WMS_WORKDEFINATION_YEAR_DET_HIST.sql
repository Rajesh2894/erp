...
--changeset priya:V20180303122121__AL_TB_WMS_WORKDEFINATION_YEAR_DET_HIST.sql
DROP TABLE IF EXISTS TB_WMS_WORKDEFINATION_YEAR_DET_HIST;
--liquibase formatted sql
--changeset priya:V20180303122121__AL_TB_WMS_WORKDEFINATION_YEAR_DET_HIST1.sql
CREATE TABLE TB_WMS_WORKDEFINATION_YEAR_DET_HIST(
  ...
  H_STATUS char(1) COMMENT 'Active/Inactive',
  ...
  PRIMARY KEY (YE_ID_H)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Work defination year detail';
