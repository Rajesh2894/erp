...
function saveObjForm(obj) {
	...
	if (objType == 0 || objType == "" || objType == undefined) {
		errorList
				.push(getLocalMessage("property.obj.hearing.report.objectiontype"));
	}
	...
	if (errorList.length > 0) {
		...
		var URL = 'ObjectionHearingReport.html?GetObjectionHearing';
