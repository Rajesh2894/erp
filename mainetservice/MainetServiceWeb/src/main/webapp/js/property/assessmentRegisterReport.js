 ...
 * 
 * if (radiovalue == 'SM') { $('#Single_Multiple').show(); $('#AllType').hide(); }
 * else { $('#AllType').show(); $('#Single_Multiple').hide(); } }
 */
...
function saveForm(obj) {
	...
	if (errorList.length > 0) {
		...
		var URL = 'AssessmentRegister.html?GetAssessmentRegister';
...
function resetForm() {
	...
	$('input[type=text]').val('');
	$(".alert-danger").hide();
	$("#AssessmentReport").validate().resetForm();
}
