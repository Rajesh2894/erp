var UPLOADURL = "LocationMas.html"
...
function displayMessageOnSubmitExcel(Message) {
	...
	message += '<div class=\'text-center\'><input type=\'button\' class= "btn btn-success" value=\''
			+ cls
			+ '\'  id=\'btnNo\' onclick="redirectToLocationHomePage()"/></div>';
...
function redirectToLocationHomePage() {
	// $.fancybox.close();
	window.location.href = "javascript:openRelatedForm('LocationMas.html');";
}
