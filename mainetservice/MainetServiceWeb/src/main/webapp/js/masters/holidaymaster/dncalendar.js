		...
		*/
		var draw = function() {
          ...
          if (settings.showNotes) {
                ...
                if (notesLength > 0) {
                      notesGroup = $("<table id='holiday' class='hidden-xs hidden-sm hidden-md hidden-lg hidden-sm table table-bordered table-condensed'><tr><th>Holiday Date</th><th>Holiday Description</th></tr></table>");
                      ...
                      for (var i = 0; i < notesLength; i++) {
                            ...
                            list +=  "<tr><td>"+date+"</td><td>"+noteList+"</td></tr>";
