...
function saveIssuanceBirthCertificateApprovalData(element) {
	...
	if($("#authRemark").val()==""){
	 ...
	 var object = __doAjaxRequest($(theForm).attr('action')+ '?saveIssuanceBirthCertificateApproval', 'POST',requestData, false,'json');		
