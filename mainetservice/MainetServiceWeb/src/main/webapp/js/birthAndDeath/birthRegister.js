function confirmToProceed(element) {
	...
	if(registrationUnit== null || registrationUnit== 0)
	{
	...
	{
	errorList.push(getLocalMessage("Report Type cannot be empty"));
	}
	...
	if (errorList.length > 0) {
		...
		var URL='BirthRegister.html?GetBirthRegister';
...
function resetForm() {
	window.open('BirthRegister.html', '_self');
}
