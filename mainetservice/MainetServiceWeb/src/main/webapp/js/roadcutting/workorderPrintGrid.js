$(function () {
    $("#grid").jqGrid({
        url: "RoadCuttingWorkOrderPrinting.html?getGridData",
        datatype: "json",
        mtype: "GET",
        colNames: [getLocalMessage("master.Application"), getLocalMessage("master.ConsumerName"), getLocalMessage("master.PRINT"),getLocalMessage("view.msg")],
        colModel: [            
            { name: "applicationId", width: 10, align: 'center', sortable: true,search : true },
...
$(function() {
	...
	$(document).on('click', '.editClass', function() {
		...
		var url = "RoadCuttingWorkOrderPrinting.html?print";
...
function searchServiceMst2(obj) {
	...
	$('.error-div').hide();
	var url = "RoadCuttingWorkOrderPrinting.html?searchServiceMst";
...
function printContent2(el) {
	...
	var url = "RoadCuttingWorkOrderPrinting.html?update";
