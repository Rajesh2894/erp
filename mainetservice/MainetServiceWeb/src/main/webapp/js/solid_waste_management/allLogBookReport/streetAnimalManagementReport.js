function streetAnimalManagementReportPrint(formUrl) {
		...
		var ajaxResponse = doAjaxLoading(formUrl + '?' + "streetanimalManagementLogReport", data,'html', divName);
...
function back() {
	...
	$("#postMethodForm").prop('action', '');
	$("#postMethodForm").prop('action', 'StreetAnimalManagementReport.html');
