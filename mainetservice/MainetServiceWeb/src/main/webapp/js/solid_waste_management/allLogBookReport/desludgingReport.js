function desludgingReportPrint(formUrl) {
		...
		var ajaxResponse = doAjaxLoading(formUrl + '?' + "desludgingReport", data,'html', divName);
...
function back() {
	...
	$("#postMethodForm").prop('action', '');
	$("#postMethodForm").prop('action', 'DesludgingReport.html');
