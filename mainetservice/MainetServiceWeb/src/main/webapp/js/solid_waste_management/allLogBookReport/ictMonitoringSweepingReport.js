function ictMonitoringSweepingReportPrint(formUrl) {
		...
		var ajaxResponse = doAjaxLoading(formUrl + '?' + "ictsweeping", data,'html', divName);
...
function back() {
	...
	$("#postMethodForm").prop('action', '');
	$("#postMethodForm").prop('action', 'ICTSweepingReport.html');
