function DoorToDoorCollectionReportPrint(formUrl) {
		...
		var ajaxResponse = doAjaxLoading(formUrl + '?' + "doorTodoor", data,'html', divName);
...
function back() {
	...
	$("#postMethodForm").prop('action', '');
	$("#postMethodForm").prop('action', 'DoorToDoorCollectionReport.html');
