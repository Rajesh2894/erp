function AllFineChargeReportPrint(formUrl) {
		...
		var ajaxResponse = doAjaxLoading(formUrl + '?' + "allFine", data,'html', divName);
...
function back() {
	...
	$("#postMethodForm").prop('action', '');
	$("#postMethodForm").prop('action', 'AllFineReport.html');
