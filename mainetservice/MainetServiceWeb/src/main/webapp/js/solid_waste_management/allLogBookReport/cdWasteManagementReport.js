function cdWasteManagementReport(formUrl) {
		...
		var ajaxResponse = doAjaxLoading(formUrl + '?' + "cdWasteManagement", data,'html', divName);
...
function back() {
	...
	$("#postMethodForm").prop('action', '');
	$("#postMethodForm").prop('action', 'CDWasteManagementReport.html');
