function VehicleLogBookMainPageReportPrint(formUrl) {
	...
	var errorList=[];
		  ...
		  if(monthNo=="0" || monthNo==null){
			...
			if (veId == "0" || veId == "" ) {
				errorList.push("Vehicle No Must be Selected");
			}
		...
		var ajaxResponse = doAjaxLoading(formUrl + '?' + "vehicleLogBookMainPage", data,'html', divName);
