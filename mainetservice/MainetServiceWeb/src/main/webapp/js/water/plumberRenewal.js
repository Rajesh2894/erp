...
/*
 * function updateRenewApproval(element) { var result =
 * saveOrUpdateForm(element, "License Generated Sucessfully successfully!",
 * 'AdminHome.html', 'updateRenewal'); return result; }
 */
...
/*
 * function updateRenewApproval(element) { var result =
 * saveOrUpdateForm(element, "License Generated Sucessfully!", 'AdminHome.html',
 * 'updateRenewal'); return result; }
 */
function savePlRenwData(element) {
	...
	if ($("input:radio[name='offlineDTO.onlineOfflineCheck']").filter(
		...
		return saveOrUpdateForm(element,
				"Your application for License Renewal saved successfully!",
				'AdminHome.html', 'saveLicRenewal');
	}

	/*
	 * var result = saveOrUpdateForm(element, "License Generated Sucessfully!",
	 * 'AdminHome.html', 'saveLicRenewal');
	 */
	return result;
}
...
function updateRenewApproval(obj) {

	var divName = '.content-page';
	var url = "PlumberRenewalApproval.html?updateRenewal";
	var formName = findClosestElementId(obj, 'form');
	var theForm = '#' + formName;
	var request = __serializeForm(theForm);
...
function showConfirmBoxForPlumber(ajaxResponse) {
	...
	var cls = '';
	var sMsg = '';
	var Proceed = getLocalMessage("wms.Proceed");
	if (ajaxResponse.checkStausApproval == "Y") {
		sMsg = getLocalMessage("water.plumberLic.renew.approve"
				+ ajaxResponse.licNo);
		...
		sMsg = getLocalMessage("water.plumberLic.already.renew");
	} else {
		sMsg = getLocalMessage("work.estimate.approval.contact.administration");
...
function proceed() {
	$.fancybox.close();
	var url = "PlumberRenewalApproval.html?printPlumberLicense";
