(function (factory) {
    ...
    Rating.prototype = {
        ...
        _getContainerCss: function () {
            ...
            return 'rating-container' +
                ...
                getCss(self.animate, 'rating-animate margin-top-15-minus') +
    ...
    $.fn.ratingLocales.en = {
        ...
        starCaptions: {
            1: getLocalMessage('care.Dissatisfied'),
            2: getLocalMessage('care.Dislike'),
            3: getLocalMessage('care.Its.Ok'),
            4: getLocalMessage('care.Liked.It'),
            5: getLocalMessage('care.Satisfied')
        },
        clearCaption: ''
    };
