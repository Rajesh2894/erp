    ...
    var t = e.HTMLCanvasElement && e.HTMLCanvasElement.prototype,
        ...
        a =
            ...
            function (e) {
                ...
                l = e.split(",")[0].split(":")[1].split(";")[0];
                if (n) {
                    return new Blob([r ? s : a], { type: l });
                }
                f = new i();
                f.append(a);
                return f.getBlob(l);
...
(function (e, t) {
    ...
    var c = ["href", "protocol", "origin", "userInfo", "username", "password", "hostname", "port", "relative", "pathname", "directory", "file", "search", "hash"],
        ...
        v;
    g = function (e) {
        var t = { toString: p, join: m, update: v },
            n = h.exec(e || ""),
            i = 14;
        while (i--) t[c[i]] = n[i] || "";
        var a = (t[u[0]] = {}),
    ...
    m = function (e, t) {
        ...
        for (l = 0; l < 14; l++) {
            if (l == 9) continue;
            if (l == 12 && !t.query) continue;
            if (l == 13 && !t.hash) continue;
            if (a[c[l]]) n[c[l]] = a[c[l]];
        }
        if (t.query && a[c[12]]) {
            n[u[0]] = a[u[0]];
            n[u[1]] = a[u[1]];
    ...
    v = function (e, t) {
        ...
        if (t) {
            t = "" + t;
            if (t.match(/[&=]/)) o = g("?" + t).searchKey;
            else for (f in e) o[f] = t;
        }
        for (f in e) {
            c = e[f];
            if (c === null) {
    ...
    n.styles = function (t) {
        ...
        for (var a = 0, s; (s = n[a]); a++)
            for (var o = 0, l; (l = s.cssRules[o]); o++) {
                var f = l.selectorText;
                if (f && (i ? f == t : f.match(t))) r.push(l);
            }
        return r;
    };
    function y(e, t) {
    ...
    function x(e) {
        ...
        if (!e.hasAttributeNS(a, "xmlns:xlink")) e.setAttributeNS(a, "xmlns:xlink", o);
        return e;
    }
        ...
        if (t.svg) {
            ...
            if (!i) {
                ...
                if (!t.nostyle) {
                    ...
                    o = s.length;
                    a = -1;
                    while (++a < o) if (s[a]) y(s[a], l);
                    if (l.length) i = i.replace(/>/, "><defs><style><![CDATA[" + l.join("\n") + "]]></style></defs>");
                }
                i = '<?xml version="1.0" standalone="no"?>' + i;
            }
            b(new Blob([i], { type: r }), t);
        } else if (t.png) {
            r = r || "image/png";
            h = x(w(t.png).get(0));
            ...
            c = new Image();
            i = new XMLSerializer().serializeToString(h);
            u = new Blob([i], { type: "image/svg+xml;charset=utf-8" });
            d = f.createObjectURL(u);
            c.onload = function () {
                g = h.getBoundingClientRect();
                p = w("<canvas></canvas>")
                    .attr("width", t.width || g.width)
                    .attr("height", t.height || g.height)
                    .appendTo("body")
                    .css("display", "none")
                    .get(0);
                m = p.getContext("2d");
    ...
    n.wrap = function (t) {
        var n = t.textContent,
            ...
            o = t.getAttributeNS(null, "y") || 0,
            l = t.getAttributeNS(null, "dx"),
        ...
        function m() {
            ...
            n.setAttributeNS(null, "y", o);
            if (l) n.setAttributeNS(null, "dx", l);
    ...
    n.zoom = function (e) {
        ...
        var o = {
            ...
            to: function (e) {
                ...
                for (; (i = e[n]); n++) {
                    a = i.getBBox();
                    l = (i.getAttribute("transform") || "").match(/translate\(([\+\-\d\.]+),([\+\-\d\.]+)\)/);
                    if (l) {
                        a.x += +l[1];
                        a.y += +l[2];
                    }
                ...
                t.width = t.x2 - t.x;
                t.height = t.y2 - t.y;
                f = Math.min(width / t.width, height / t.height) * 0.7;
                s.translate([(-t.x - t.width / 2) * f + width / 2, (-t.y - t.height / 2) * f + height / 2])
                    .scale(f)
                    .event(r);
                return o;
            },
    ...
    if (w) {
        ...
        w.fn.addClass = function (e) {
            ...
            if (c) {
                ...
                for (; l < f; l++) {
                    ...
                    o = s ? n.className.baseVal : n.className;
                    r = n.nodeType === 1 && (o ? (" " + o + " ").replace(N, " ") : " ");
                    if (r) {
                        a = 0;
                        while ((i = t[a++])) {
                            if (r.indexOf(" " + i + " ") < 0) {
        ...
        w.fn.dispatch = function (e, t) {
            return this.each(function () {
                this.dispatchEvent(B(e, w.extend({ bubbles: true, cancelable: true }, t)));
            });
        };
        w.fn.urlfilter = function (e) {
            ...
            var t = this,
                ...
                s = t[0].ownerDocument,
                o = (s.defaultView || s.parentWindow).location,
                l = (s.defaultView || s.parentWindow).history,
                f = e.toggle,
                c = e.target;
            ...
            return t.on("click.urlfilter", i, function (e) {
                ...
                var t = w(this),
                    ...
                    h = t.attr(r),
                    d = n.url.parse(h)[u[0]],
                    g = { type: "loaded.g.urlfilter", q: d },
                    p,
                    m;
                if (a) for (m in d) if (d[m] === "") d[m] = null;
                function v(e) {
                    return n.url.parse(e).join(h, { query: false, hash: false }).update(d, i);
                }
                if (!s) {
                    o.href = v(o.href);
                    t.trigger(g);
                } else if (s == "#") {
                    o.hash = v(o.href.split("#")[1] || "");
                    t.trigger(g);
                } else if (s.match(/^pushstate$/i)) {
                    l.pushState({}, "", v(o.href));
                    t.trigger(g);
                } else {
                    w(s).each(function () {
                        var e = w(this);
        ...
        w.fn.highlight = function (e) {
            ...
            function l(i, a) {
                var s = w(a),
                    o = w(s.data("target") || e.target || r),
                    l = s.data("hide-class") || e.hideClass || "fade",
                    ...
                    d = h;
                if (h) {
                    while (d--) c = c.add(k(o, w(i[d]).attr(n)));
                    u = o.not(c);
                    if (f) {
                        A(c, "." + f).addClass(f);
                        k(u, "." + f).removeClass(f);
                    ...
                    if (f) k(o, "." + f).removeClass(f);
                    if (l) k(o, "." + l).removeClass(l);
                }
                t.trigger({ type: "shown.g.highlight", selected: w(i), matches: (h ? c : o).length, highlighted: c, unhighlighted: u });
            }
            t.on("mouseenter.g.highlight", r, function (e) {
                if (s) s = clearTimeout(s);
                if (!o.length) l([e.target], this);
            })
        ...
        w.fn.panzoom = function (t) {
            ...
            n.on("click", i, function (t) {
                ...
                function u() {
                    c.each(function () {
                        var t = w(this).data(o);
                        if (e.d3) d3.select(this).transition().duration(100).attr(o, t);
                        else this.setAttribute(o, t);
                    });
                }
                function h(t) {
                    c.each(function () {
                        ...
                        } else if (!n.data(l)) this.setAttribute(o, d);
                    });
                }
                if (n.is(".active")) {
                    u();
                    ...
                    c.each(function () {
                        w(this).data(o, (this.getAttribute(o) || "").split(/,|\s+/));
        ...
        w.fn.reveal = function (e) {
            ...
            w(r).each(function () {
                ...
                if (!i[n]) {
                    ...
                    l = t.data("hide-class") || e.hideClass || "fade";
                    o = t.data("type") || e.type || "overlay";
                    f = "." + l;
                    s = w(n);
                    if (o == "overlay") {
                        s.eq(a).filter(f).removeClass(l);
                        s.slice(a + 1)
                            .not(f)
                            .addClass(l);
                    } else if (o == "single") {
                        s.eq(a).filter(f).removeClass(l);
                        s.not(s.eq(a)).not(f).addClass(l);
                    }
                    i[n] = 1;
                }
            });
            return t.on("click.g.reveal", r, function () {
                ...
                if (s == "overlay") {
                    ...
                    h = i.eq(d);
                    h.filter(l).removeClass(a);
                    i.not(h).not(l).addClass(a);
                }
                t.trigger({ type: "shown.g.reveal", slide: d });
            });
        };
        var z = function (e) {
        ...
        w.fn.search = function (e) {
            ...
            l = function (t) {
                var r = w(t.target),
                    a = [],
                    s = e.text || r.attr(n),
                    o = w(r.data("target") || e.target || (typeof s == "string" ? "[" + s + "]" : "*"));
                o.each(
                    typeof s == "function"
                        ? function () {
                              var e = s(this);
                              a.push({ el: w(this), original: e, text: i(e), hide: false });
                          }
                        : s == "@text"
                        ? function () {
            ...
            f = function (e) {
                ...
                t.trigger({ type: "shown.g.search", searchText: n, search: r, matches: p, results: m });
            };
            return t
                .on("keyup.g.search", r, f)
                .on("change.g.search", r, f)
                .on("refresh.g.search", l)
        ...
        w.fn.doodle = function (t) {
            ...
            var n = 0,
                ...
                C,
                k;
            o.off("stop.g.doodle start.g.doodle")
                .on("stop.g.doodle", function (t, n) {
                    if (!C) return;
                ...
                .on("start.g.doodle", function (e, o) {
                    if (C) return;
                    if (typeof o != "undefined") {
                        h = o;
                        p = u(o);
                        for (y = 0; y < b; y++) l[y][n].attr("stroke-dashoffset", p < l[y][i] ? l[y][a] : 0);
                        if (t.fill) for (y = 0; y < b; y++) l[y][n].css("fill", p < l[y][i] ? "none" : l[y][s]);
                    }
                    y = 0;
                    x = l[y];
                    m = x[r];
                ...
                .each(function () {
                    ...
                    if (!t.absolute) n *= r;
                    f += n;
                    l.push([e, n, f, r, e.css("fill") || null]);
                    e.attr({ "stroke-dasharray": r + " " + r, "stroke-dashoffset": r });
            ...
            function A() {
                ...
                if (y >= b || p >= l[y][i]) {
                    while (y < b && p >= l[y][i]) {
                        l[y][n].attr("stroke-dashoffset", 0);
                        if (t.fill) l[y][n].css("fill", l[y][s]);
                        y++;
                    }
                    if (y >= b) {
                        if (typeof t.loop != "undefined")
                            k = setTimeout(function () {
                                o.last().trigger("stop").trigger("start", [0]);
                            }, t.loop * 1e3);
                        o.last().trigger("end.g.doodle");
                        return false;
                    }
                    x = l[y];
                    m = x[r] + l[y - 1][i];
            ...
            if (typeof t.start === "undefined" || t.start) o.last().trigger("start.g.doodle", [0]);
            return o;
        };
    }
    n.unpack = function () {
        ...
        function i(i) {
            ...
            e.size([t, r])
                .nodes(a)
                .on("tick", function c(e) {
                    i.each(l(e.alpha * 0.1));
                    var t = d3.geom.quadtree(a),
                        n = 0;
                    while (++n < o) t.visit(f(a[n]));
        ...
        return i.force(d3.layout.force().charge(0).gravity(0.01));
    };
    n.map = function () {
        var e,
            t,
        ...
        function c() {
            ...
            var n = a.bounds(e),
                s = 0.95 / Math.max((n[1][0] - n[0][0]) / t, (n[1][1] - n[0][1]) / r),
                o = [(t - s * (n[1][0] + n[0][0])) / 2, (r - s * (n[1][1] + n[0][1])) / 2];
            i.scale(s).translate(o);
        }
        function u(t) {
            if (!o) return;
        ...
        f.dorling = function (i) {
            ...
            var o = function (e) {
                ...
                f = e.features.map(function (e, t) {
                    ...
                    return typeof n === "undefined" ? { x: 0, y: 0 } : { x: n[0], y: n[1], r: l(e, t), properties: e.properties };
                }),
                h = i.selectAll("path.map").data(f);
            h.attr("d", o);
            h.enter().append("path").attr("class", "map").attr("d", o);
            h.exit().remove();
            if (!s) {
        ...
        return f.projection(d3.geo.mercator()).force(d3.layout.force().charge(0).gravity(0.01));
    };
    var q = (n.network = {});
    q.kpartite = function () {
        var e = [],
        ...
        function c(t, r, i) {
            ...
            if (a in f) n[f[a]].rows.push(i);
                ...
                f[a] = n.length;
                n.push({ source: e[t], target: e[r], id: a, rows: [i] });
            }
        }
        function u(t) {
            var r = o[t].aggregator,
                a = o[t].accessor;
            ...
            for (t = 0; (r = i[t]); t++) {
                ...
                for (p in a) {
                    ...
                    for (f = 0, h = b.length; f < h; f++) {
                        y = b[f];
                        x = p + "	" + y;
                        if (x in l) e[l[x]].rows.push(t);
                        else {
                            l[x] = e.length;
                            e.push({ key: p, value: y, id: x, rows: [t] });
                        }
                        C.push(l[x]);
                    }
                }
                for (m in a) {
                    ...
                    for (v in a)
                        if (v > m) {
                            A = w[v];
                            g = A.length;
                            for (f = 0; f < h; f++) for (d = 0; d < g; d++) c(k[f], A[d], t);
                        }
                }
                if (s[p])
                    for (p in a) {
                        C = w[p];
                        for (f = 0, h = C.length; f < h; f++) for (d = 0; d < h; d++) if (f < d) c(C[f], C[d], t);
                    }
            }
            for (var N in o) u(N);
        }
        ...
        r.val = function (e, t, n) {
            if (!arguments.length) return o;
            if (arguments.length == 1) return o[e];
            if (!t) delete o[e];
            else o[e] = { aggregator: t, accessor: n };
            h();
            return r;
        };
        return r;
            ...
            for (o = 0; o < r; o++) {
                ...
                for (f = 0; f < i; f++) {
                    ...
                    if (h in a) t[a[h]].count++;
                        ...
                        a[h] = t.length;
                        t.push({ source: c, target: u, id: h, count: 1 });
                    }
                }
            }
        };
    ...
    q.force = function () {
        ...
        function p() {
            ...
            if (s.length) {
                for (; (f = s[a]); a++) {
                    o = typeof f.source == "object" ? f.source : r[f.source];
                    l = typeof f.target == "object" ? f.target : r[f.target];
                    if (o.id in i && l.id in i) t.push(f);
                }
        ...
        f.draw = function (e) {
            ...
            if (d) {
                p = f.circles.enter().append("circle").attr("class", "node").on("dblclick.release", c).call(l.drag);
                d(f.circles);
            }
            ...
            if (g) {
                p = f.labels.enter().append("text").attr("class", "node").on("dblclick.release", c).call(l.drag);
                g(f.labels);
            }
            if (!e.on("dblclick.release"))
                e.on("dblclick.release", function () {
            ...
            o.x(d3.scale.identity().domain([0, s]))
                .y(d3.scale.identity().domain([0, u]))
        ...
        circle: function (e, t) {
            ...
            return function (n) {
                ...
                return function (r, l, f, c, u) {
                    ...
                    return l > a || c < i || f > o || u < s;
                };
            };
        },
    };
    n.url = { parse: g, unparse: p };
})(this);
