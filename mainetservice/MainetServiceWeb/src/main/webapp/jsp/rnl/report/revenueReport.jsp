...
<div class="content">
	...
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="land.Revenue.report" text="Revenue report" />
			</h2>
		</div>
								...
								<h4 class="panel-title">
									<a data-target="#a1" data-toggle="collapse" class="collapsed"
										data-parent="#accordion_single_collapse" href="#a1"><spring:message
											code="rnl.revenue.reportDetails" text="Revenue Details" /> </a>
								</h4>
							</div>
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label for="fromDateId"
											class="col-sm-2 control-label required-control"><spring:message
												code="rnl.revenue.fromeDate" text="From Date" /></label>
										<div class="col-sm-4">
										...
										<label for="toDateId"
											class="col-sm-2 control-label required-control"><spring:message
												code="rnl.revenue.toDate" text="To Date" /></label>
										<div class="col-sm-4">
											<div class="input-group">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label required-control"><spring:message
												code="rnl.revenue.occupancyType" text="Occupancy Type" /></label>
										<div class="radio col-sm-4 margin-top-5">
											<label> <form:radiobutton
													path="reportDTO.occupancyType" value="RE" id="type" checked="true"
													class="type" /> <spring:message code="rnl.revenue.rent" /></label>
											<label> <form:radiobutton
													path="reportDTO.occupancyType" value="LE" id="type"
													class="type" /> <spring:message code="rnl.revenue.lease" />
											</label>
										</div>
									</div>
									...
									<div class="text-center clear padding-10">
										<button type="button" class="btn btn-blue-2"
											onclick="viewReport(this)" title="Search">
