					...
					<form:form action="LeaseDemandNoticeGeneration.html" commandName="command" method="POST" class="form-horizontal" 
						...
						<div class="form-group">
							<label for="text-1" class="col-sm-2 control-label required-control"> 
								<spring:message code="rnl.notice.type" text="Type" />
							</label>
							<div class="col-sm-4 margin-top-5">
								<label for="noticeSingle" class="radio-inline"> 				
									 <form:radiobutton class="radio-group margin-right-5 noticeType" onclick="payModefields();" 
									  id="single" path="dto.noticeTypeDesc" value="S" checked="true" />
								...
								<label for="noticeMultiple" class="radio-inline"> 								
								    <form:radiobutton class="radio-group noticeType" onclick="payModefields();"
								      id="multiple" path="dto.noticeTypeDesc" value="M"  />
						...
						<div class="form-group">
							...
							<apptags:lookupField
								...
								path="dto.notTyp" cssClass="form-control nType"
								hasChildLookup="false" hasId="true" showAll="false"
								selectOptionLabelCode="applicantinfo.label.select" />

							<div class="propNo">
								<label for="text-1" class="col-sm-2 control-label propNo">
									<spring:message code="rnl.notice.propNo" text="Property Number" />
								</label>
								<div class="col-sm-4">
									<spring:message code="rnl.enterPropNo"
										text="Enter the Property Number" var="enterPropertyNo" />
									<form:input type="text" class="form-control propNo" id="propNo"
										path="dto.refNo" placeholder="${enterPropertyNo}" />
							...
							<div class="location">
								...
								<div class="col-sm-4 location">
									<form:select path="dto.locationId" id="locationId"
