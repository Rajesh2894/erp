...
<script type="text/javascript" src="js/rnl/service/waterTankerBookingForm.js"></script>
...
<div class="widget">
	<div class="widget-header">
		<h2>
			<spring:message code="rnl.water.tanker.booking" text="Water Tanker Booking" />
		</h2>
				...
				<div class="panel panel-default">
					...
					<div id="Booking_Details" class="panel-collapse collapse">
						<div class="panel-body">
							...
							<div class="form-group">
								<label class="control-label col-sm-2 required-control"
									for="Shift"> <%-- Defect #157984 --%> <spring:message
										code='rnl.master.shift' text="Shift" />
								</label>
								<div class="col-sm-4">
							...
							<div class="form-group" id="displayOrNot">
								<div class="col-xs-10 col-xs-push-2 ">
									<label class="checkbox-inline"> <form:checkbox
											...
											onclick="downloadFile('${command.docName}','waterTankerBookingForm?Download')">
			...
			<c:if test="${command.enableCheckList eq true}">
				<div class="padding-top-10 text-center" id="chekListChargeId">
					...
					<input type="button" id="backBtn" class="btn btn-danger"
						title='<spring:message code="bt.backBtn"/>' onclick="back()"
