...
<div class="content">
	...
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="rnl.amenities.and.facilities" text="Amenities And Facilities" />
			</h2>
		...
		<div class="widget-content padding">
			...
			<form:form action="" class="form-horizontal" name=""
				id=" vieAminities">
				<div
					...
					<div class="panel panel-default">
						...
						<div id="a2" class="panel-collapse collapse in">
							<div class="panel-body">
								...
								<table class="table table-striped table-bordered">
									<thead>
										<tr>
											...
											<th width="" align="center"><spring:message code="rnl.estate.booking.description.of.amenities"
								...
								<h5 style="color: navy; font-size: medium;">
									<spring:message code='rnl.estate.booking.view.facilities.detials'
								...
								<table class="table table-striped table-bordered">
									<thead>
										<tr>
											<th width="70px" align="center"><spring:message
													code="ser.no" text="Sr.No" /></th>
											<th width="" align="center"><spring:message code="rnl.estate.booking.description.of.facilities"
													text="Description Of Facilities" /></th>
											<th width="" align="center"><spring:message code="rnl.estate.booking.quantity"
