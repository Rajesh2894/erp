...
<script type="text/javascript"
	src="js/rts/applyDeathCertificateApproval.js"></script>
	...
	<div class="widget">
		...
		<div class="widget-content padding">
			<form:form id="frmDeathCertificateForm"
				action="ApplyDeathCertificateLevel.html" method="POST"
				...
				<div class="panel panel-default">
					...
					<div id="deathRegCor-1" class="panel-collapse collapse in">
						<div class="panel-body">
							...
							<div class="form-group">
								<apptags:input labelCode="Demanded copies" isReadonly="true"
											...
											<c:forEach items="${command.fetchDocumentList}" var="lookUp">
												<tr>
													...
													<td align="center"><apptags:filedownload
															...
															actionUrl="ApplyDeathCertificateLevel.html?Download">
							...
							<div class="form-group">
								...
								<c:choose>
									<c:when test="${CheckFinalApp eq true}">
										<apptags:radio radioLabel="Approve,Reject"
											...
											labelCode="Status" path="deathCertificateDTO.deathRegstatus"
								...
								<apptags:textArea labelCode="Remark"
