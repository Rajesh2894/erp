	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<h2>
					<b><spring:message code="rts.rightToService" text="RTS Application form"></spring:message></b>
			...
			<div class="widget-content padding">
				...
				<form:form action="rtsService.html" method="POST" name="rtsService"
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<apptags:input labelCode="rti.firstName"
												cssClass="alphaNumeric mandColorClass hasNoSpace"
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<apptags:input labelCode="chn.lEmail"
											...
											isDisabled="${command.saveMode eq 'V' ? true : false }"
											path="requestDTO.email" isMandatory="false" maxlegnth="100"></apptags:input>
									</div>
								</div>
