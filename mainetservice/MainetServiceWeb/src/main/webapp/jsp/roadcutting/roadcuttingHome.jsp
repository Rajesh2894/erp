			...
			<div class="widget-content padding">
				<form:form id="RoadCuttingId" action="RoadCutting.html"
					...
					<div class="panel-group accordion-toggle"
							...
							<div id="Applicant" class="panel-collapse collapse in">
								...
								<div class="form-group">
									<apptags:input path="roadCuttingDto.faxNumber1"
										...
										maxlegnth="100" cssClass="form-control hasFaxNo" />
							...
							<div class="panel-body">
								...
								<div class="form-group">
									<apptags:input path="roadCuttingDto.faxNumber2"
										...
										cssClass="form-control hasFaxNo" maxlegnth="100" />
							...
							<div id="a2" class="panel-collapse collapse in">
								...
								<div class="form-group">
									...
									<apptags:input
										...
										isMandatory="true" cssClass="form-control hasMobileNo"
										maxlegnth="10">
									</apptags:input>
								</div>
								<div class="form-group">
												...
												<%--  --%>
													...
													<tr class="appendableClass">
														...
														<td><form:input
																...
																class="form-control hasAddressClass" maxlength="500" /></td>
														<td><form:input
						...
						<c:if test="${(command.checkListFlag eq 'Y' || command.appliChargeFlag eq 'Y') && command.getSaveButFlag() ne 'Y' && command.roadCuttingLevelState eq 'I'}">  
							<div class="text-center" id="checkListChargesProceedDiv">
								<input type="button" class="btn btn-warning " value="Reset" onclick="window.location.href='RoadCutting.html'" /> 
                        ...
                        <form:hidden path="chargeService" id="chargeService" value="${command.appliChargeFlag}"/>
                        <c:if test="${not empty command.charges && command.appliChargeFlag eq 'Y'}">
						...
						<c:choose>
						 <c:when test="${command.checkListFlag eq 'N' && command.appliChargeFlag eq 'N' && command.roadCuttingLevelState eq 'I'}">
							 <c:if test="${command.getSaveButFlag() eq 'Y' && command.roadCuttingLevelState eq 'I'}"> 
								<div class="text-center">
									<input type="button" class="btn btn-warning " value="Reset" onclick="window.location.href='RoadCutting.html'"> 
									<button type="button" class="button-input btn btn-success"
										name="button" value="procced"
										onclick="saveRoadCuttingNoCheckPayment(this)" id="procced">
