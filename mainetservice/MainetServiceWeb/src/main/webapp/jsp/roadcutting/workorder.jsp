...
$(document).ready(function() {
	 ...
	 $("#Submit").click(function () {
		 ...
		 if (!checkedNum) {
			...
			var url = "RoadCuttingWorkOrderPrinting.htmll?create";
      ...
      <div class="widget">
        ...
        <div class="mand-label clearfix">
		 ...
		 <div class="error-div alert alert-danger alert-dismissible"
          ...
          <form:form action="RoadCuttingWorkOrderPrinting.htmll?create" modelAttribute="tbWorkOrder" name="tbWorkOrder" method="POST" class="form-horizontal" id="workOrderForm">
