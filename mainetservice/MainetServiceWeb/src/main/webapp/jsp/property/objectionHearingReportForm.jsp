...
<script type="text/javascript"
	src="js/property/objectionHearingReportForm.js"></script>
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="property.obj.hearing.report"
					text="Objection & Hearing Register" />
			</h2>
		</div>
		<div class="widget-content padding">
			...
			<form:form action="ObjectionHearingReport.html"
				cssClass="form-horizontal" id="objectionFormReport">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label required-control"
						for="inwardType"><spring:message
							code="property.report.obj.type" text="Objection type" /></label>
					<c:set var="baseLookupCode" value="OBJ" />
					<apptags:lookupField
						items="${command.getLevelData(baseLookupCode)}"
						path="objectionDto.objectionOn" cssClass="form-control"
						hasChildLookup="false" hasId="true" showAll="true"
						selectOptionLabelCode="applicantinfo.label.select"
						isMandatory="true" showOnlyLabel="Objection type" />
				...
				<div class="padding-top-10 text-center">
					<button type="button" class="btn btn-success btn-submit" id="save"
						onclick="saveObjForm(this)">
						<spring:message code="property.report.Print" />
					</button>
					<button type="Reset" class="btn btn-warning" id="resetform"
						onclick="window.location.href='ObjectionHearingReport.html'">
