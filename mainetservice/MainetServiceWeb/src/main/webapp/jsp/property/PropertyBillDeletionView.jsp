...
<!-- Start Content here -->
	...
	<div class="widget-header">
				<h2><strong><spring:message code="" text="Owner Details"/></strong></h2>				
...
<!-- Start Widget Content -->
	<div class="widget-content padding">
	 ...
	 <form:form action="PropertyBillDeletion.html"
					class="form-horizontal form" name="PropertyBillDeletionView"
					id="PropertyBillDeletionView">	
		...
		<div class="form-group">
			...
			<spring:message code="ownerdetail.Ownername"/>
			</label>	
			<div class="col-sm-4">
		...
		<div class="form-group">
		 ...
		 <label  class="col-sm-2  required-control ">
			...
			<div class="col-sm-4">
				<form:select id="financialYear" path="schduleId" class="form-control mandColorClass" disabled="true"  data-rule-prefixValidation="true" onchange="getSchedule()">
					<form:option value="0">
		   ...
		   <%--   <label class="col-sm-2 control-label"><spring:message code="" text="Remarks"/></label> --%>
			<!--  <div class="col-sm-4"> -->
		    
	 	   <%--   <form:input path="tbBillMas.bmRemarks" class="form-control" id="remark" />  --%>

 	         <apptags:input labelCode="Remarks" path="tbBillMas.bmRemarks" isMandatory="true" cssClass="form-control">
		...
		<div id="billWiseDetail">
			<div class="widget-header">
				<h2><strong><spring:message code="" text="Bill Details"/></strong></h2>				
				<%-- <div class="additional-btn">
					<a href="#" data-toggle="tooltip" data-original-title="Help"><i
						class="fa fa-question-circle fa-lg"><span class="hide"><spring:message code="property.Help"/></span></i></a>
				</div> --%>
...
<%-- 				<c:if test="${ command.getAssType() eq 'A'}"> 
		...
		<c:when test="${not empty command.getTbBillMas().getTbWtBillDet()}"> 
			...
			<button type="button" class="btn btn-success btn-submit"
					 onclick="PropertyBillDeletion(this)" id="deleteBill"><spring:message code="property.dataEntry.delete.Bill"/></button>
					 
			<button class="btn btn-blue-2" type="button"  onclick="backToDeleteSearchPage(this)" id="back">
