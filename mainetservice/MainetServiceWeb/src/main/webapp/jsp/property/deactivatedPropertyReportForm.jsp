...
<script type="text/javascript"
	src="js/property/deactivatedPropertyReport.js"></script>
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="property.DeactivatedPropertyReport"
					text="Deactivated Property Register" />
			</h2>
		</div>
		<div class="widget-content padding">
			...
			<form:form action="DeactivatedProperty.html"
				cssClass="form-horizontal" id="DeactivatedFormReport">
