...
<%-- 			          		    <div class="col-sm-2"><form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[0].occupierName" type="text" class="form-control hasCharacter hasNoSpace" id="occupierName" /></div> --%>
