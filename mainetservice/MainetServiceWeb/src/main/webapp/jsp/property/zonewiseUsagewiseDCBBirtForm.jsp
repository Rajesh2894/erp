...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="property.zoneWiseUsage.report" text="" />
			</h2>
		</div>
				...
				<div class="form-group">
					...
					<div class="radio col-sm-4 margin-top-5">
						<label> <form:radiobutton path="propertyDto.reportType"
								...
								code="property.zoneWiseUsageTypeWise.report" text="Zone Wise Usage Type Wise" />
								</label> 
