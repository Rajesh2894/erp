...
<script type="text/javascript" src="js/property/detailDemandRegister.js"></script>
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="property.DetailDemandRegister"
					text=" Detail Demand Register " />
			</h2>
		</div>
		<div class="widget-content padding">
			...
			<form:form action="DetailDemandRegister.html"
				cssClass="form-horizontal" id="DetailDemandRegisterFormReport">
				...
				<div class="form-group">
					...
					<div class="radio col-sm-4 margin-top-5">
						<label> <form:radiobutton path="propertydto.reportType"
								...
								code="property.detail.demand.report" /></label> <label> <form:radiobutton
								path="propertydto.reportType" value="S" id="Summary"
								onclick="getReportType()" /> <spring:message
								code="property.summary.demand.report" /></label>
					</div>
				</div>
