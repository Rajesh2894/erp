...
<!-- Start Widget Content -->
	<div class="widget-content padding">
		...
		<form:form action="MutationAuthorization.html"
			...
			<div class="accordion-toggle mutationLoiGeneration">
...
<br>
					...
					<p4><spring:message code="loi.message"/></p4>
...
<tr>
<th class="text-left" width="160" colspan="1"><span><spring:message code="" text="Applicant Name:"/></span></th>
