...
<!-- <script type="text/javascript"
	src="js/property/extractPropertyCertificate.js"></script>
	 -->
<script type="text/javascript"
...
<div class="content">
	...
	<div class="widget">
		<div class="widget-header">
			<h2>
				<strong><spring:message code="property.extraction"
						text="Extract Of Property" /></strong>
			</h2>
			<apptags:helpDoc url="ExtractProperty.html"></apptags:helpDoc>
		</div>
		...
		<div class="widget-content padding">
			...
			<!-- Start Form -->
			<form:form action="ExtractProperty.html"
				class="form-horizontal form" name="ExtractProperty"
										...
										<c:forEach
											...
											<tr id="propDet${status.count-1}"
												...
												<td><form:input
														...
														class="form-control read" type="text"
														id="ownerName${status.count-1}" maxlength="100" /></td>
												<td><form:input
														path="noDuesCertificateDto.propertyDetails[${status.count-1}].ownerAddress"
														class="form-control read" type="text"
														id="address${status.count-1}" maxlength="100" /></td>
												<%-- <td class="text-center" style="white-space: nowrap"><a
													data-placement="top" title="Delete"
													class="btn btn-danger btn-sm"
													data-original-title="<spring:message code="water.delete"/>"
					...
					<c:if
						...
						<div class="text-center padding-10">
							<button type="button" class="btn btn-submit"
								onclick="getCheckListAndCharges(this,'ExtractProperty.html')" id="checkListCharge">
								<spring:message code="unit.proceed" />
							</button>
							
							<button type="button" class="btn btn-warning"
								onclick="ResetForm('ExtractProperty.html')"
								id="btndelete">
				...
				<c:if
					...
					<div class="text-center padding-top-10">
						...
						<button type="button" class="btn btn-success btn-submit"
							onclick="savePropertyFrom(this,'ExtractProperty.html')" id="saveNoDue">
							<spring:message code=""
