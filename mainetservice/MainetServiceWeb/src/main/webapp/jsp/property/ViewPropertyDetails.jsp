...
<div class="content">
	...
	<div class="widget-content padding">
		...
		<form:form action="ViewPropertyDetail.html"
			...
			<div class="warning-div error-div alert alert-danger alert-dismissible" id="errorDiv"></div>
				...
				<div class="form-group ">
					...
					<div id="searchData col-sm-4">
						<label for="SinMul" class="radio-inline "> <form:radiobutton
								path="searchDto.specNotSearchType" value="IV" class="SinMul"
								onchange="showSingleMultiple()" checked="true"/> <spring:message
								code="property.individual" /></label> <label for="group"
							class="radio-inline "> <form:radiobutton
								path="searchDto.specNotSearchType" value="GP" class="group"
								onchange="showSingleMultiple()" /> <spring:message
				...
				<div class="form-group parentPropNos">
					<apptags:lookupFieldSet baseLookupCode="GPI" hasId="true"
						showOnlyLabel="false" pathPrefix="searchDto.parentGrp"
				...
				<div class="form-group individualProp">
			...
			<strong><p class="text-center text-small padding-bottom-10 text-red-1 individualProp"><spring:message code="property.OR"></spring:message></p></strong>
			...
			<div class="form-group individualProp" >
				...
				<apptags:input labelCode="ownersdetail.mobileno" path="searchDto.mobileno" cssClass="preventSpace hasMobileNo" maxlegnth="10" placeholder="${mobileNo}"></apptags:input>
			
			</div>
			
			<strong><p class="text-center text-small padding-bottom-10 text-red-1 individualProp"><spring:message code="property.OR"></spring:message></p></strong>
			
			<div class="form-group wardZone individualProp">
			...
			<div class="form-group Loc individualProp">
			...
			<label for="road-type" class="col-sm-2 control-label"><spring:message code="unitdetails.RoadType"/> </label>
				...
				<c:if test="${otherField eq 'Y' }">
					<div class="form-group usageType individualProp">
			...
			<apptags:jQgrid id="ViewPropertyDetails"
					url="ViewPropertyDetail.html?SEARCH_GRID_RESULTS" mtype="post"
					gridid="gridViewPropertyDetail"
					colHeader="propertydetails.PropertyNo.,propertydetails.oldpropertyno,property.OwnerName,Mobile Number,Flat No"
					colModel="[
