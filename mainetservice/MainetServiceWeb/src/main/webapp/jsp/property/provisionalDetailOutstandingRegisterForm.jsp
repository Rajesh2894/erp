...
<script type="text/javascript" src="js/property/provisionalDetailOutstandingRegister.js"></script>    
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="property.provisional.DetailOutstandingRegister"
		...
		<div class="widget-content padding">
			...
			<form:form action="ProvisionalDetailOutstanding.html"
				cssClass="form-horizontal" id="OutstandingFormReport">
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label required-control"> <spring:message
			code="property.provisional.outstanding.fromDate" text="From Date" /></label>
					<div class="col-sm-4">
				...
				<label class="col-sm-2 control-label required-control"> <spring:message
							code="property.provisional.outstanding.toDate" text="To Date" /></label>
					<div class="col-sm-4">
						<div class="input-group">
					...
					<spring:message code="" text="icon" /></span><input type="hidden" id=mnTodt></label>
						</div>
					</div>
				</div> 
