...
<!-- End JSP Necessary Tags -->
 ...
 <div class="content">
	...
	<div class="widget-header">
				<h2><b><spring:message code="property.TaxDetails" text="Tax Details"/></b></h2>				
  ...
  <!--------------------------------------------Tax Calculation-------------------------------------------------------------- -->     
    <div class="accordion-toggle ">
		   ...
		   <a data-toggle="collapse" href="#TaxCalculation" class="contentRemove"><spring:message code="property.TaxDetails" text="Tax Details"/></a>
		   </h4>         
		                  ...
		                  <tbody>
			                ...
			                <c:forEach var="tax" items="${command.authComBillList}"  varStatus="status">
			                 ...
			                 <c:set var="total" value="${taxdet.bdPrvArramt+taxdet.bdCurTaxamt+total}">
			                  ...
			                  <td class="text-right"><fmt:formatNumber type = "number" minFractionDigits="2"  value = "${taxdet.bdPrvArramt}" /></td>
			                  <td class="text-right"><fmt:formatNumber type = "number" minFractionDigits="2"  value = "${taxdet.bdCurTaxamt}" /></td>
			                  <%-- <td class="text-right">${taxdet.bdPrvArramt+taxdet.bdCurTaxamt}</td> --%>
			                  <td class="text-right"><fmt:formatNumber type = "number" minFractionDigits="2"  value = "${taxdet.bdPrvArramt+taxdet.bdCurTaxamt}" /></td>
			                </tr>
			                </c:forEach>
			                </c:forEach>
		                </tbody>
		  ...
		  <div class="table-responsive margin-top-10">
              <table class="table table-striped table-bordered">
                <tr>
                  ...
                  <th class="text-right"><fmt:formatNumber type = "number" minFractionDigits="2"  value = "${total}" /></th>
                </tr>
              </table>
            </div>
