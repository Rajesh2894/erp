...
<div class="text-center padding-15 clear" id="searchBtn">
							<button type="button" class="btn btn-warning"
								onclick="getMutationDetailForApproval(this)">
...
<!----------------------------------------------------------Tax-Zone details------------------------------------------------------ --> 
			...
			<div class="panel-body">
				...
				<apptags:input labelCode="unitdetails.RoadType" path="provisionalAssesmentMstDto.proAssdRoadfactorDesc" isDisabled="true"></apptags:input>
					...
					<div class="form-group parshadWardZone">

									<apptags:lookupFieldSet baseLookupCode="PWZ" hasId="true"
										showOnlyLabel="false"
										pathPrefix="provisionalAssesmentMstDto.assParshadWard" isMandatory="true"
										hasLookupAlphaNumericSort="true"
										hasSubLookupAlphaNumericSort="true"
										cssClass="form-control required-control " showAll="false" disabled="true"
										showData="true" />
								</div>
