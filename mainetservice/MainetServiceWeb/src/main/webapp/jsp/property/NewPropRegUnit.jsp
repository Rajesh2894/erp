...
<script src="js/property/newPropRegUnitSpec.js" type="text/javascript"></script>
<script type="text/javascript" src="js/property/newPropRegOwner.js"></script>

<%-- Code added by ABM2144 for Property Data entry suite Edit form - datepicker reset--%>
<c:choose>
<c:when test="${not empty command.getProvisionalAssesmentMstDto().getProvisionalAssesmentDetailDtoList()}">
<script>
$(function(){	
	$("body").attr("onmouseover", "refreshDates()");	
});
function refreshDates(){
	$("body").removeAttr("onmouseover");
...
<%-- < %--                             <th width="9%" class="required-control"><spring:message code="unitdetails.unittype"/></th> --%> 
                    	...
                    	<tr class="firstUnitRow">
                      		 ...
                      		 <td>                                       	
                        	    <form:select path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].faYearId" id="year${status.count-1}" onchange="unitCount(${status.count-1})" class="form-control text-center mandColorClass displayYearList grpPropertyClass">
		 						...
		 						<form:hidden path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].faYearId" id="hiddenYear0"/>		 						    
		 					</td>
                        	 
                        	 <td>
              					<form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].assdUnitNo" type="text" class="form-control mandColorClass text-center unit required-control grpPropertyClass" id="unitNo${status.count-1}" data-rule-required="true" readonly="true" />
              				</td>
							...
							<td>
								...
								<apptags:lookupField
										items="${command.getLevelData(baseLookupCode)}"
										path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].assdFloorNo" cssClass="form-control changeParameterClass mandColorClass grpPropertyClass"
										hasChildLookup="false" hasId="true" showAll="false"
							...
							<td>
								...
								<form:input type="text" path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].assdYearConstruction" class="form-control datepicker2 mandColorClass dateClass addColor grpPropertyClass" id="yearOfConstruc0" data-rule-required="true" placeholder="DD/MM/YYYY" autocomplete="off" readonly="true" />									
								<span class="input-group-addon"><i class="fa fa-calendar"></i></span></div>
							</td>
							<td>
		 						<div class="input-group successErrorCheck"> 
								<form:input type="text" path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].firstAssesmentDate" class="form-control lessthancurrdate mandColorClass dateClass addColor grpPropertyClass" id="firstAssesmentDate0" data-rule-required="true" placeholder="DD/MM/YYYY" autocomplete="off" readonly="true"/>									
								<span class="input-group-addon"><i class="fa fa-calendar"></i></span></div>
                            ...
                            <td> 
								...
								<apptags:lookupField
									items="${command.getLevelData(baseLookupCode)}"
									path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].assdConstruType" cssClass="form-control changeParameterClass mandColorClass grpPropertyClass"
									hasChildLookup="false" hasId="true" showAll="false"
							...
							isMandatory="true" hasLookupAlphaNumericSort="true"
							hasSubLookupAlphaNumericSort="true"
							cssClass="form-control required-control grpPropertyClass" showAll="false" hasTableForm="true" showData="true" columnWidth="10%"/>
					
							<td width="150">
							<spring:message code="property.Area.PlaceHolder" text="999999.99 sq.ft" var="area"/>
							
							<form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].assdBuildupArea" type="text" class="form-control has2Decimal mandColorClass text-right grpPropertyClass" id="taxableArea${status.count-1}" data-rule-required="true" onkeypress="return hasAmount(event, this, 15, 2)" onchange="getAmountFormatInDynamic((this),'proAssdBuildupArea')" placeholder="${area}"/></td>
                           
	                         <td class="text-center"><a class="clickable btn btn-success btn-xs click_advance" data-toggle="collapse" data-target="#group-of-rows-0" aria-expanded="false" aria-controls="group-of-rows-0"><i class="fa fa-caret-down grpPropertyClass" aria-hidden="true"></i></a></td>	                           
			      		...
			      		<tr class="secondUnitRow collapse in" id="group-of-rows-0">
				             	...
				             	<div class="form-group" >   
				            		...
				            		<div class="col-sm-2">    		
				               		...
				               		<div class="col-sm-4">	
				 						...
				 						<apptags:lookupField
													items="${command.getLevelData(baseLookupCode)}" 
													path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].assdOccupancyType" cssClass="form-control changeParameterClass grpPropertyClass" 
													hasChildLookup="false" hasId="true" showAll="false"
									...
									<label for="occupierName${status.count-1}" class="col-sm-2 control-label"><spring:message code="unitdetails.OccupierName"/></label> 
 			          		   		<div class="col-sm-4"><form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].occupierName"  class="form-control hasCharacter preventSpace grpPropertyClass" id="occupierName${status.count-1}" /></div>
								</div>
								<%-- <div class="form-group">
 			          				<label for="occupierName${status.count-1}" class="col-sm-2 control-label"><spring:message code="unitdetails.OccupierName"/></label> 
 			          		   		<div class="col-sm-2"><form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].occupierName"  class="form-control hasCharacter preventSpace" id="occupierName${status.count-1}" /></div>
			          			</div> --%>	
			          			<div class="form-group">
							...
							isMandatory="true" hasLookupAlphaNumericSort="true"
							hasSubLookupAlphaNumericSort="true"
							cssClass="form-control required-control grpPropertyClass" showAll="false"  columnWidth="10%"/>
			          			
			          			
								<%-- <label class="col-sm-2 control-label required-control"
									for="natureOfProperty"><spring:message
										code="property.selectNatureOfProperty"/></label>
									<div class="col-sm-2">---------------------------------
									<c:set var="baseLookupCode" value="PTP" /> <form:select path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[${status.count-1}].assdNatureOfproperty1"
											onchange="" class="form-control mandColorClass" id="natureOfProperty" data-rule-required="true">
												<form:option value="">
	 	 ...
	 	 <c:if test="${command.getAssType() ne 'DES'  && command.getAssType() ne 'E'  && command.getAssType() ne 'A'}">   
		       <div class="form-group">
					<div class="col-sm-6">
...
<%--                             <th width="9%" class="required-control"><spring:message code="unitdetails.unittype"/></th> --%>
                    	...
                    	<tr class="firstUnitRow">
                      		 ...
                      		 <td>                                       	
                        	    <form:select path="" id="year0" class="form-control text-center mandColorClass displayYearList" data-rule-required="true" onchange="unitCount(0)">
		  						<form:option value=""><spring:message code="prop.selectSelectYear"/></form:option>
		  						<c:forEach items="${command.financialYearMap}" var="yearMap">
		  						<form:option value="${yearMap.key}" label="${yearMap.value}"></form:option>
		  						</c:forEach>
...
<%-- 		 					<form:hidden path="leastFinYear" id="minYear"/>	 --%>
							...
							<td>
		 						<div class="input-group successErrorCheck1"> 
				             ...
				             <div class="addunitdetails0 col-xs-6 col-xs-offset-0 col-md-12">
				             	<div class="form-group" >   
									...
									<label for="occupier-name" class="col-sm-2 control-label"><spring:message code="unitdetails.OccupierName"/></label>
				          		    <div class="col-sm-4"><form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[0].occupierName" type="text" class="form-control hasCharacter preventSpace" id="occupierName" /></div>
								</div>
				
								<%-- <div class="form-group">
						    
				          		    <label for="occupier-name" class="col-sm-2 control-label"><spring:message code="unitdetails.OccupierName"/></label>
				          		    <div class="col-sm-2"><form:input path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[0].occupierName" type="text" class="form-control hasCharacter preventSpace" id="occupierName" /></div>
							...
							cssClass="form-control required-control" showAll="false"  columnWidth="10%"/>
								...
								<%-- <label class="col-sm-2 control-label required-control"
									for="natureOfProperty"><spring:message
										code="property.selectNatureOfProperty" /></label>
									<div class="col-sm-2">+++++++++++++++++++++++
									<c:set var="baseLookupCode" value="PTP" /> <form:select path="provisionalAssesmentMstDto.provisionalAssesmentDetailDtoList[0].assdNatureOfproperty1"
											onchange="" class="form-control mandColorClass" id="natureOfProperty" data-rule-required="true">
												<form:option value="">
													<spring:message code="property.sel.optn" />
												</form:option>
...
<div class="panel-collapse collapse in" id="unitSpecificInfo">      
            ...
            <c:forEach items="${command.getLevelData(baseLookupCode)}" var="factor" varStatus="status"><!--Question loop  -->
				...
				<form:radiobutton class="factorSet grpPropertyClass"  path="provisionalAssesmentMstDto.proAssfactor[${status.count-1}]" value="Y"  id="Yes" onchange="showAddInfo('${facCode}','${status.count-1}')"/>
				<spring:message code="unitdetails.Yes"></spring:message></label>
				<label for="No" class="radio-inline">
				<form:radiobutton class="factorStatus grpPropertyClass" path="provisionalAssesmentMstDto.proAssfactor[${status.count-1}]" value="N"  id="No" onchange="showAddInfo('${facCode}','${status.count-1}')"/>
				            ...
				            <c:if test="${details.assfFactorId  eq factId}">
		                        ...
		                        <tr class="specFact">  
		                        	...
		                        	<td class="col-sm-5 ">
		                        		...
		                        		<form:hidden path="provAsseFactDtlDto[${status.count-1}].proAssfId" id="proAssfId"/>	
 ...
 --%>		                        </tr>
			...
			<c:otherwise>					
	            ...
	            <!-- if check  lookUpCode is NA then ignore -->
					...
					<label for="Yes" class="radio-inline">	
					<form:radiobutton class="factorSet selectFactor grpPropertyClass" path="provisionalAssesmentMstDto.proAssfactor[${d}]" value="Y"  id="Yes"  onchange="showAddInfo('${facCode}','${d}')"/>
					<spring:message code="unitdetails.Yes"></spring:message></label>
					<label for="No_" class="radio-inline">
					<form:radiobutton class="factorStatus selectFactor grpPropertyClass" path="provisionalAssesmentMstDto.proAssfactor[${d}]" value="N"  id="No_"  onchange="showAddInfo('${facCode}','${d}')"/>
					<spring:message code="Unitdetails.No"></spring:message></label>
					</div>  
