...
<script type="text/javascript" src="js/property/dcbBirtReport.js"></script>
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="property.propertyUsage.report" text="" />
			</h2>
		</div>
		<div class="widget-content padding">
			...
			<form:form action="dcbBirtReport.html" cssClass="form-horizontal"
				id="DCBFormReport">
				...
				<div class="form-group">
					...
					<div class="radio col-sm-4 margin-top-5">
						<label> <form:radiobutton path="propertyDto.reportType"
								...
								code="property.propertyUsagetypeWise.report"
								text="Property Usage type Wise" /></label>
					</div>
				</div>
				...
				<div class="padding-top-10 text-center">
					<button type="button" class="btn btn-success btn-submit" id="save"
						onclick="savePropertyDcbForm(this)">
