...
<div class="accordion-toggle">
	...
	<div class="panel-collapse collapse in" id="propertyAddress">
		<div class="form-group">
			...
			<apptags:textArea isMandatory="true" labelCode="property.propertyaddress" path="provisionalAssesmentMstDto.assAddress" maxlegnth="500" cssClass="preventSpace grpPropertyClass"></apptags:textArea>
			<apptags:select cssClass="chosen-select-no-results grpPropertyClass" labelCode="property.location" items="${command.location}" path="provisionalAssesmentMstDto.locId" isMandatory="true" isLookUpItem="true" selectOptionLabelCode="property.selectLocation">
			</apptags:select>		
		</div>
		...
		<div class="col-sm-4">
			<form:input  type="text" class="form-control hasPincode grpPropertyClass"
		...
		<div class="col-sm-4">
			<form:input  type="text" class="form-control grpPropertyClass"
...
<div class="accordion-toggle">
	...
	<div class="panel-collapse collapse in" id="correspondenceAddress">
		...
		<div class="form-group">
			<apptags:textArea labelCode="property.correspondenceaddress" path="provisionalAssesmentMstDto.assCorrAddress" maxlegnth="500" cssClass="preventSpace grpPropertyClass"></apptags:textArea>			
...
<!-- 			</div> -->
			<apptags:input labelCode="property.pincode" path="provisionalAssesmentMstDto.assCorrPincode" cssClass="hasPincode grpPropertyClass" maxlegnth="6"></apptags:input>	
		</div>
		<%-- <div class="form-group">
