...
<div class="content">
	<div class="widget">
		...
		<div class="widget-content padding">
			...
			<form:form action="VehicleLogBook.html" id="frmVehicleLogBook"
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label required-control"
						for="vehicle"><spring:message code="vehicle.master.vehicle.reg.no" text="Vehicle Reg No" /></label>
					<div class="col-sm-4">
					...
					<label class="col-sm-2 control-label required-control"
						for="employee"><spring:message code="vehicle.driver" text="Driver" /></label>
					<div class="col-sm-4">
						<form:select id="driverName" path="vehicleLogBookDTO.driverId"
							...
							<c:forEach items="${employees}" var="employee">
								<form:option value="${employee[0]}" label="${employee[1]} ${employee[2]}"></form:option>
							</c:forEach>
						</form:select>
					</div>
				</div>
				...
				<div class="form-group">
					<apptags:textArea labelCode="FireCallRegisterDTO.form.remark"
