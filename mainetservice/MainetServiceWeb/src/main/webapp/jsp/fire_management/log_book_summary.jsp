...
<script type="text/javascript" src="js/fire_management/logBook.js"></script>
...
<div class="content">
	<div class="widget">
		...
		<div class="widget-content padding">
			<form:form action="VehicleLogBook.html"
		...
		<%-- 		<apptags:input labelCode="VehicleLogBookDTO.veNo"
					...
					<label class="col-sm-2 control-label" for="vehicle"><spring:message code="VehicleLogBookDTO.veNo" text="Vehicle No" /></label>
					<div class="col-sm-4">
				 ...
				 <div class="text-center clear padding-10">
					...
					<button type="button" id="reset"
						onclick="window.location.href='VehicleLogBook.html'"
					...
					<button type="button" id="add" class="btn btn-blue-2"
						onclick="openForm('VehicleLogBook.html','logBook')"
						title="Add">
						<i class="fa fa-plus-circle padding-right-5" aria-hidden="true"></i>
						<spring:message code="bt.add"
							text="Add" />
					</button>
				</div>
								...
								<tr>
									...
									<td class="text-center">
										<button type="button" class="btn btn-blue-2 btn-sm"
											title="<spring:message  code="VehicleLogBookDTO.viewVehLog" text="View Vehicle Log Book"/>"
											onclick="modifyLogBook('${book.veID}','VehicleLogBook.html','viewVLB','V')">
											<i class="fa fa-eye"></i>
										</button>
										<button type="button" class="btn btn-warning btn-sm"
											title="<spring:message  code="VehicleLogBookDTO.editVehLog" text="Edit Vehicle Log Book"/>"
											onclick="modifyLogBook('${book.veID}','VehicleLogBook.html','editVLB','E')">
