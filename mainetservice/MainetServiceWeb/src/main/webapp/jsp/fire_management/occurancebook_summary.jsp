...
<div class="content">
	<div class="widget">
		<%-- <div class="widget-header">
			<h2>
				<strong><spring:message code="OccuranceBookDTO.form.name"
						text="Occurance Book" /></strong>
		...
		<div class="widget-content padding">
			<form:form action="OccuranceBook.html" name="frmOccuranceBook"
				id="frmOccuranceBook" method="POST" commandName="command"
				...
				<div class="form-group">
					...
					<apptags:date fieldclass="datepicker"
						labelCode="OccuranceBookDTO.toDate"
				...
				<div class="text-center clear padding-10">
					...
					<button type="button" id="search" class="btn btn-blue-2"
						onclick="SearchOccuranceBookDetail()" title='<spring:message code="OccuranceBookDTO.form.search" text="Search" />'>
				...
				<div class="table-responsive clear">
					<table class="table table-striped table-bordered"
						...
						<thead>
							<tr>
								...
								<th width="10%" align="center"><spring:message
										code="OccuranceBookDTO.date" text="Call Date" />
								<spring:message
										code="OccuranceBookDTO.form.time" text="And Time" /></th>
								<th width="15%" align="center"><spring:message
									code="FireCallRegisterDTO.cmplntNo"
										text="Call Number" /></th>
								<th width="45%" align="center"><spring:message
										code="FireCallRegisterDTO.incidentDesc"
										text="Incident Description" /></th>
								<th width="10%" align="center"><spring:message
										code="FireCallRegisterDTO.cpdFireStation" text="Fire Station" /></th>
								<th width="5%" align="center"><spring:message
						...
						<tbody>
							<%-- <c:set value="${command.shakal}" var="cpdDesc"></c:set> --%>
							<c:forEach items="${occbooks}" var="occbook" varStatus="item">
								...
								<tr>
									...
									<td><fmt:formatDate pattern="dd/MM/yyyy"
											value="${occbook.date}" />
									${occbook.time}</td>
									<td>${occbook.cmplntNo}</td>
									<td>${occbook.incidentDesc}</td>
									<td>${occbook.fsDesc}</td>

									<td class="text-center">
										<button type="button" class="btn btn-warning btn-sm"
											title="<spring:message  code="FireCallRegister.form.add" text="Add"/>"
											onclick="openFormOcc('${occbook.cmplntId}','OccuranceBook.html','occuranceBook','A','cmplntNo')">
											<i class="fa fa-plus-circle padding-right-5"></i>
										</button> <input id="cmplntNo" name="cmplntNo" type="hidden"
										value="${occbook.cmplntNo}">
