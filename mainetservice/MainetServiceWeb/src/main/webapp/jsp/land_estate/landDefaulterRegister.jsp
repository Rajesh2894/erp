...
<div class="content">
	...
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="land.defaulter.title" text="Defaulter Register" />
			</h2>
				...
				<div class="panel-group accordion-toggle"
							...
							<h4 class="panel-title">
								<a data-target="#a1" data-toggle="collapse" class="collapsed"
									data-parent="#accordion_single_collapse" href="#a1"><spring:message
										code="land.defaulter.register.Details" text="Defaulter Register Details" /> </a>
							</h4>
						</div>
					...
					<%-- 		<label class="col-sm-2 control-label" for="location"> <spring:message
						...
						<label class="col-sm-2 control-label" for="location"> <spring:message
							...
							<apptags:input labelCode="land.outstanding.amt"
