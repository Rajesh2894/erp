...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="" text="Major Account Head Wise Budget"></spring:message>
		  </h2>
		...
		<div class="widget-content padding">
			<form:form action="" class="form-horizontal">
				...
				<div class="text-center padding-top-10">
					<button type="button" class="btn btn-blue-2" onClick="budgetReport('majorAccountHeadWiseBudget.html','report')" title="View Report">
					<spring:message code="" text="View Report"></spring:message>
					</button>
					<button type="button" class="btn btn-warning" onClick="budgetReset(this)" title="Reset"> <spring:message code="" text="Reset" />
					</button>
