		...
		<div class="widget-content padding">
			...
			<form:form action="ReceivableDemandEntry.html" commandName="command" class="form-horizontal form" name="ReceivableDemandEntry" id="id_ReceivableDemandEntry">
				...
				<div class="form-group ">
					...
					<div class="col-sm-4">
						<form:input path="receivableDemandEntryDto.caseNo" onchange="" readonly="" cssClass="form-control  mandColorClass " autocomplete="off" id="caseNo" disabled="true" maxlength="20" />
					</div>
					...
					<div id="a1" class="panel-collapse collapse in">
						<div class="panel-body">
							<div class="form-group padding-top-20">
								...
								<div class="col-sm-4">
									<form:input path="receivableDemandEntryDto.customerDetails.fName" onchange="" cssClass="form-control  mandColorClass required-control" autocomplete="off" id="custName"
										readonly="${command.receivableDemandEntryDto.newIdn ne 'N' ? true : false }" maxlength="100"
									/>
								</div>
								...
								<div class="col-sm-4">
									<form:textarea path="receivableDemandEntryDto.customerDetails.areaName" cssClass="form-control  required-control text-left" id="custAddress"
										readonly="${command.receivableDemandEntryDto.newIdn ne 'N' ? true : false }"
									/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<form:input path="receivableDemandEntryDto.customerDetails.houseComplexName" onchange="" cssClass="form-control  mandColorClass " autocomplete="off" id="custLocation"
										readonly="${command.receivableDemandEntryDto.newIdn ne 'N' ? true : false }" maxlength="250"
									/>
								</div>
								...
								<div class="col-sm-4">
									<form:input path="receivableDemandEntryDto.customerDetails.roadName" cssClass="form-control   text-left" id="custKhasaraNo"
										readonly="${command.receivableDemandEntryDto.newIdn ne 'N' ? true : false }" maxlength="50"
									/>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">
									<form:input path="receivableDemandEntryDto.customerDetails.cityName" cssClass="form-control text-left" id="cityName"
										readonly="${command.receivableDemandEntryDto.newIdn ne 'N' ? true : false }" maxlength="40"
									/>
								</div>
								...
								<div class="col-sm-4">
									<form:input path="receivableDemandEntryDto.customerDetails.pincodeNo" onchange="" cssClass="form-control  mandColorClass hasPincode" autocomplete="off" id="pinCode"
										readonly="${command.receivableDemandEntryDto.newIdn ne 'N' ? true : false }" maxlength="6"
									/>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<form:input path="receivableDemandEntryDto.customerDetails.mobileNo" cssClass="form-control text-left hasMobileNo" data-rule-number="10" data-rule-minLength="10" data-rule-maxLength="10"
										id="custMobile" readonly="${command.receivableDemandEntryDto.newIdn ne 'N' ? true : false }" maxlength="10"
									/>
								</div>
								<label class="col-sm-2 control-label" for=""><spring:message code="receivable.demand.entry.emailid" text="Email-ID" /></label>
								<div class="col-sm-4">
									<form:input path="receivableDemandEntryDto.customerDetails.email" cssClass="form-control hasemailclass text-left" id="custEmailId"
										readonly="${command.receivableDemandEntryDto.newIdn ne 'N' ? true : false }" maxlength="20"
									/>
								</div>
							</div>
						</div>
									...
									<c:forEach var="demandInfo" items="${command.receivableDemandEntryDto.rcvblDemandList}" varStatus="status">
										<c:if test="${demandInfo.isDeleted eq 'N'}">
											<tr class="firstUnitRow">
												...
												<td><form:select path="receivableDemandEntryDto.rcvblDemandList[${d}].sacHeadId" cssClass="form-control mandColorClass" id="accHead${d}" disabled="" data-rule-required="true">
														<form:option value="">
												...
												<td><form:input path="receivableDemandEntryDto.rcvblDemandList[${d}].billDetailsAmount" cssClass="form-control  text-right hasNumber" onkeyup="hasNumber1(${d})" onchange="sum1()"
														id="id_total${d}" disabled="" maxlength="9"
													/></td>
												...
												><i class="fa fa-plus-circle"> </i></a> <a class="btn btn-danger btn-sm delButton deleteB" title="Delete"
													onclick="deleteRow(${d});deleteEntry('id_receivableDemandEntryTbl',$(this),'sequence${d}','firstUnitRow')"
												> <i class="fa fa-minus" id="deleteRow(${d})"></i>
												</a></td>
										...
										<c:if test="${demandInfo.isDeleted eq 'N'}">
											<tr class="secondUnitRow">
												...
												<td align="center" width="10%"><a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" onclick="addEntryData('id_receivableDemandEntryTbl','secondUnitRow');"
													class=" btn btn-success btn-sm"
												><i class="fa fa-plus-circle"> </i></a> <a class="btn btn-danger btn-sm delButton deleteB" title="Delete"
													onclick="deleteRow(${d});deleteEntry('id_receivableDemandEntryTbl',$(this),'sequence${d}','secondUnitRow')"
												> <i class="fa fa-minus" id="deleteRow(${d})"></i>
												</a></td>
												<form:hidden path="receivableDemandEntryDto.rcvblDemandList[${d}].taxId" id="taxId${d }" />
											</tr>
