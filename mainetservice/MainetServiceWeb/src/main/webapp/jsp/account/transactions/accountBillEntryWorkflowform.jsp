			...
			<form:form action="AccountBillEntry.html" method="POST"
				...
				<div class="form-group">
					...
					<c:choose>
						<c:when test="${modeCheck eq 'Auth' }">
							...
							<div class="col-sm-4">
								<div class="input-group">
									<form:input path="authorizationDate123" id="authorizationDateId12"
					...
					<c:if test="${accountBillEntryBean.depositFlag ne 'Y'}">
						...
						<div class="col-sm-4">
							<form:input type="text" path="invoiceValue"
								...
								name="bmInvoicevalue" id="bmInvoicevalue" disabled="${viewMode}" />
						</div>
					</c:if>
				...
				<div class="form-group">
					<label for="Department"
						class="col-sm-2 control-label required-control"><spring:message
							code="accounts.receipt.department_name" text="Department Name" /></label>
					<div class="col-sm-4">
				...
				<div class="form-group">
                  ...
                  <div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<form:input path="dueDate" id="dueDate" cssClass="form-control" />
										...
										<thead>
											...
											<tr>
												...
												<td><div class="input-group">
														<form:input path="invoiceDate"
															...
															id="bmInvoicedate" readonly="true" disabled="${viewMode}" />
											...
											<tr>
												<td><label for="bmResolutionNumber"><spring:message
															code="bill.resolution.no" text="Resolution No." /></label></td>
								...
								<c:when test="${mode eq 'update'}">
									<c:forEach items="${editData.deductionDetailList}"
										...
										<tr class="deductionClass" id="deduction0">
											...
											<c:if test="${editData.billTypeCode eq 'ESB'}">
												<td>	<form:hidden path="deductionDetailList[${count}].bchId"
											value='${accountBillEntryBean.deductionDetailList[count].bchId}' /> <form:select id="bchId${count}"
														path="deductionDetailList[${count}].bchId"
														class="form-control" disabled="${viewMode}"
														onchange="validateDedExpenditureAccountHead(${count})">
														<form:option value="">
