...
<script>
	...
	<form:form method="POST" action="DirectPaymentEntry.html"
		...
		<div class="form-group">
			...
			<c:if test="${paymentEntryDto.modeCode ne 'C' && paymentEntryDto.modeCode ne 'A' && paymentEntryDto.modeCode ne 'PCA'}">
			...
			<c:if test="${paymentEntryDto.modeCode eq 'C' || paymentEntryDto.modeCode eq 'A' || paymentEntryDto.modeCode eq 'PCA'}">
	...
	<h4 id="">
		<spring:message code="accounts.file.upload.deatils" text="File Upload Details" />
	</h4>
	<div class="form-group">
			<div class="col-sm-12 text-left">
							<div class="table-responsive">
								<table class="table table-bordered table-striped"
									...
									<c:forEach items="${paymentEntryDto.attachDocsList}"
										var="lookUp">
										<tr>
											<td>${lookUp.attFname}</td>
											<td><apptags:filedownload filename="${lookUp.attFname}"
													filePath="${lookUp.attPath}"
													actionUrl="PaymentEntry.html?Download" /></td>
