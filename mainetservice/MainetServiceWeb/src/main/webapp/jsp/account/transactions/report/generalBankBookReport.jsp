		...
		<div class="widget">
			<div class="widget-header">
				<h2 class="excel-title">
					<spring:message code="general.bank.book" text="General Bank Book" />
				</h2>
			</div>
...
<c:if test="${userSession.languageId eq 2}">
								...
								<%-- <p>
									<spring:message code="general.cash.form.number"
										text="Form No. 10S" /> --%>
								<!-- <br> -->
								<strong class="excel-title"><spring:message code="general.bank.book"
										text="General Bank Book" /></strong>
								<%-- <br>
									<em><spring:message code="general.cash.rule.number"
											text="(See Rule No. 43)" /></em>
								</p> --%>
							...
							<div class="margin-top-10">
								<div id="export-excel">
									<table class="table table-bordered table-condensed" id="importexcel">
										<div class="excel-title" id="tlExcel" style="display:none;"><spring:message code="general.bank.book" text="General Bank Book" /></div>
										<thead>
											<tr>
												<th colspan="2" style="text-align: center;width:10%"><spring:message
														code="account.bankmaster.bankname" text="Bank Name" /></th>
												<td colspan="6" align="left">${reportData.accountCode}</td>
											</tr>
											<tr>
												<th colspan="2" style="text-align: center;width:10%"><spring:message
														code="general.cash.opening.balance"
														text="Opening balance as on" /></th>
												<td colspan="7" align="right">${reportData.openingBalance}</td>
											</tr>
											<tr>
					...
					<div class="text-center hidden-print padding-10">
						...
						<%-- <apptags:backButton url="AccountDailyReports.html"
