			...
			<div class="table-responsive" id="budgetDetTable">
					...
					<tbody>
						<tr>
							...
							<th scope="col" width="50%"><spring:message
									code="budget.allocation.master.budget" text="Budget" /></th>
				...
				<div class="text-center padding-10">
					<button type="button" class="btn btn-danger"
						onclick="setPrevBalanceAmount(${accountBillEntryBean.expenditureDetailList[0].projectedExpenditureId},${accountBillEntryBean.expenditureDetailList[0].newBalanceAmount},${accountBillEntryBean.expenditureDetailList[0].rowCount})">
