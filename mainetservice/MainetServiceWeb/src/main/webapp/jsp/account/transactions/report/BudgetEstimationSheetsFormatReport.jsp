		...
		<div class="widget-header">
			<h2 class="excel-title">
				<spring:message code="budget.estimate.sheet.format.heading"
					text="Budget Estimation Sheets Format" />
			</h2>
...
<c:if test="${userSession.languageId eq 2}">
								...
								<br>
								<u><spring:message
										code="budget.estimate.sheet.format.heading"
										text="Budget Estimation Sheets" />
					...
					<div class="col-sm-10 margin-bottom-10">
						<p>
							<span class="text-bold"><spring:message
									code="budget.estimate.sheet.functionary"
									text="Name Of The Functionary:" /></span>
							${command.accountFinancialReportDTO.deptName}
						</p>
						<p>
							<span class="text-bold"><spring:message
									code="budget.estimate.sheet.function"
									text="Name Of The Function:" /></span>
							${command.accountFinancialReportDTO.functionName}
						</p>
						<p>
							<span class="text-bold"><spring:message
									code="budget.estimate.sheet.budget.year"
									text="Budgeting Year :" /></span><u>
								${command.accountFinancialReportDTO.financialYear} </u>
						</p>
					</div>
					<div class="container">
						<div id="export-excel">
							<table class="table table-bordered table-condensed" id="importexcel">
								...
								<thead>
									<tr>
										<th class="text-center" width="8%"><spring:message
												code="budget.estimate.sheet.field" text="Field" /></th>
										<th class="text-center"><spring:message
												code="budget.estimate.sheet.head.account"
												text="Head Of Account - Description Of Item*" /></th>
										<th class="text-center"><spring:message
												code="budget.estimate.sheet.previous.year"
												text="Actual For The Previous Year Rs." /></th>
										<th class="text-center"><spring:message
												code="budget.estimate.sheet.current.year"
												text="Budget Estimates For The Current Year Rs." /></th>
										<th class="text-center"><spring:message
												code="budget.estimate.sheet.revised.year"
												text="Revised Estimates For The Current Year Rs." /></th>
										<th class="text-center"><spring:message
												code="budget.estimate.sheet.next.year"
												text="Budget Estimates For The Next Year Rs." /></th>
									</tr>
									<tr>
								...
								<tbody>
									<%-- <tr>
										<td></td>
										<td class="text-bold"><u><spring:message
													code="budget.estimate.sheet.revenues" text="REVENUES" /></u></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
									...
									<c:forEach items="${command.accountFinancialReportDTO.listOfIncome}" var="data"
										...
										<tr>
											...
											<td align="right">${data.revisedofCurrentYrAmount}</td>
								...
								<thead>
									<tr>
										...
										<th><spring:message code=""
												text="Total :" /></th>  <!-- Sub-total (Tax Revenues) E7E5E5-->
			...
			<div class="text-center hidden-print padding-10">
				<button onClick="printdiv('receipt');"
					class="btn btn-primary hidden-print" title='<spring:message code="account.budgetestimationpreparation.print"
						text="Print" />'>
				...
				<button id="btnExport1" type="button"
					...
					<spring:message code="acounts.download" text="Download" />
				</button>
