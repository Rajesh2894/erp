...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="direct.payment.entry.title" text="Direct Payment Entry" />
			</h2>
	<apptags:helpDoc url="DirectPaymentEntry.html" helpDocRefURL="DirectPaymentEntry.html"></apptags:helpDoc>		
		</div>
		<div class="widget-content padding" id="directPaymentDiv">
			<form:form action="" id="directPaymentEntry" modelAttribute="paymentEntryDto"
