			...
			<div class="table-responsive" id="budgetDetTable">
				...
				<div class="text-center padding-10">
					<button type="button" class="btn btn-danger"
						onclick="setPrevBalanceAmount(${RTGSPaymentEntryDto.expenditureDetailList[0].projectedExpenditureId},${RTGSPaymentEntryDto.expenditureDetailList[0].newBalanceAmount},${RTGSPaymentEntryDto.expenditureDetailList[0].rowCount})">
