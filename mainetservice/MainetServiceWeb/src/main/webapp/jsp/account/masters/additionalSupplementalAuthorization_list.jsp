...
<script src="js/account/additionalSupplementalAuthorization.js"></script>
<script>
$(function() {
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message
					code="budget.additionalsupplemental.authorization.title" text=""></spring:message>
			</h2>
		...
		<div class="widget-content padding">
			...
			<form:form action="" modelAttribute="tbAcAdditionalSuppAuthorization"
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label required-control"><spring:message
							code="budget.additionalsupplemental.authorization.todate" text="" /></label>
					<div class="col-sm-4">
						<div class="input-group">
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label"><spring:message
							code="budget.additionalsupplemental.authorization.status" text="" />
					</label>
					<div class="col-sm-4">
						...
						<form:select path="status" class="form-control" id="status"
							...
							<form:option value="">
								<spring:message
									code="budget.additionalsupplemental.authorization.selectstatus"
									text="" />
							</form:option>
				...
				<div class="text-center padding-bottom-10">
					<button type="button" class="btn btn-success searchData"
						onclick="searchAdditionalSuppAuthorizationFormData()">
