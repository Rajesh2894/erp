...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="budget.allocation.master.title" text=""></spring:message>
			</h2>
			<apptags:helpDoc url="AccountBudgetAllocation.html" helpDocRefURL="AccountBudgetAllocation.html"></apptags:helpDoc>
		</div>
		<div class="widget-content padding">

			<form:form action="" modelAttribute="tbAcBudgetAllocation"
				...
				<div class="form-group">
					<label class="col-sm-2 control-label required-control"> <spring:message
							code="budget.allocation.master.financialyear" text=""></spring:message>
					</label>
					<div class="col-sm-4">
					...
					<label class="col-sm-2 control-label"> <spring:message
							code="budget.allocation.master.budgettype" text=""></spring:message>
					</label>
					<div class="col-sm-4">
						...
						<form:select path="cpdBugtypeId" class="form-control"
							...
							<form:option value="">
								<spring:message code="budget.allocation.master.selectbudgettype"
									text="" />
							</form:option>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<form:select path="dpDeptid"
							...
							disabled="${viewMode}">
							<form:option value="">
								<spring:message code="budget.allocation.master.departmentttype"
									text="" />
							</form:option>
					...
					<label class="col-sm-2 control-label" for="prBudgetCodeid"><spring:message
							code="budget.allocation.master.budgethead" text="" /></label>
					<div class="col-sm-4">
						<form:select id="prBudgetCodeid" path="prBudgetCodeid"
							cssClass="form-control chosen-select-no-results">
							<form:option value="">
								<spring:message
									code="budget.allocation.master.selectbudgetheads" text="" />
							</form:option>
				...
				<div class="text-center padding-bottom-10">
					<button type="button" class="btn btn-success searchData"
						onclick="searchBudgetAllocationData()">
