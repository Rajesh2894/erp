...
<div xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<script src="js/account/accountBudgetProjectedRevenueEntryUpload.js"></script>
	...
	<div class="widget" id="widget">
		<div class="widget-header">
			...
			<h2>
				<spring:message code="account.Account.Budget.Projected.revenue.Entry"
					text="Account Budget Projected revenue Entry" />
			</h2>
		...
		<div class="widget-content padding">
			...
			<form:form class="form-horizontal"
				id="tbAcBudgetProjectedRevenueEntry"
				modelAttribute="tbAcBudgetProjectedRevenueEntry"
				cssClass=" form-horizontal" method="POST"
				action="AccountBudgetProjectedRevenueEntry.html">
				...
				<spring:hasBindErrors name="tbAcBudgetProjectedRevenueEntry">
				...
				<div class="form-group text-center" id="reload">
					...
					<div class="col-sm-3 text-left">
						...
						<small class="text-blue-2"> <spring:message code="vendormaster.excel.filesize" text="(Upload Excel upto 5MB )"></spring:message></small>
					</div>
				...
				<div class="text-center padding-top-20" id="savebutton">
					...
					<input type="button" id="Reset"  
						...
						onclick="exportTemplate()" value="<spring:message code="accounts.stop.payment.reset" text="Reset"></spring:message>" >  </input>
					<button type="button" class="btn btn-danger back"
						onclick="window.location.href = 'AccountBudgetProjectedRevenueEntry.html'">
