...
<div class="widget">
	<div class="widget-header">
		...
		<apptags:helpDoc url="AccountFundMaster.html"
			helpDocRefURL="AccountFundMaster.html"></apptags:helpDoc>
	</div>
		...
		<form:form id="frmMaster" class="form-horizontal"
			...
			<c:if test="${!viewMode}">
							...
							<div class="panel-body">
								...
								<div class="form-group" id="2">
									...
									<label class="control-label col-sm-2"><spring:message
											code="fund.master.fund.finalcode" text="Final Code" /></label>
									<div class="col-sm-4">
								...
								<div class="panel-body">
									...
									<div class="form-group" id="3">
										...
										<div class="col-sm-4">
											...
											<label class="required-control"><spring:message
													code="acc.master.fundMasterCode" text="Fund Code" /></label>
									...
									<div class="form-group" id="4">
										...
										<div class="col-sm-4">
											<label class="control-label"><spring:message code="field.master.parent.code"
													text="Parent Code" /></label>
				...
				<c:if test="${!viewMode and viewmode ne 'EDIT'}">
					...
					<div class="text-center">
						<input type="button" class="btn btn-success btn-submit"
							onclick="saveLeveledDataForFundMaster(this)" value="<spring:message code="account.bankmaster.save" text="Save"/>">
						</input> <input type="button" id="Reset"
							class="btn btn-warning addFundMasterClass" value="<spring:message code="account.bankmaster.reset" text="Reset"/>"></input>
				...
				<c:if test="${viewmode eq 'EDIT'}">
					<div class="text-center">
						<input type="button" class="btn btn-success btn-submit"
							onclick="saveEditedDataForFundMaster(this)" value="<spring:message code="accounts.receipt.save" text="Save"/>">
						</input> <input type="button" class="btn btn-danger"
							onclick="window.location.href='AccountFundMaster.html'"
			...
			<c:if test="${viewMode}">
				...
				<div class="panel-body" id="editParentNode">
					<div class="form-group" id="4">
						...
						<div class="col-sm-4">
							<label class="control-label"><spring:message code=""
									text="Parent Code" /></label>
				...
				<div class="text-center">
					<input type="button" id="saveButttonOnDescChange"
						class="btn btn-success" onclick="updateDescForFundMaster(this)"
						value="<spring:message code="accounts.receipt.save" text="Save"/>"><input type="button" class="btn btn-danger"
						onclick="window.location.href='AccountFundMaster.html'"
						value="<spring:message code="account.back" text="Back"/>" id="cancelEdit" />
				</div>
			</c:if>
