		...
		<form:form class="form-horizontal"
			...
			<ul id="ulId">
				<li>
					...
					<div class="form-group">
						<label class="control-label col-sm-2 required-control"> <spring:message
								code="budget.additionalsupplemental.authorization.fieldname" text="Authorization"></spring:message></label>
						<div class="col-sm-10">
							...
							<label for="approved1" class="radio-inline mandColorClass"><form:radiobutton
								...
								for="disApproved" class="radio-inline mandColorClass"><form:radiobutton
									...
									data-rule-required="true" /> <spring:message
									code="account.viewBill.sendBack" text="Send Back" /> </label>
			...
			<div class="text-center padding-top-10">
				<c:if test="${viewMode ne 'VIEW' }">
					<input type="button" id="saveBtn" class="btn btn-success btn-submit"
						onclick="saveLeveledWorkFlowData(this)" value="<spring:message code="account.bankmaster.save" text="Save" />"> </input>
				</c:if>
