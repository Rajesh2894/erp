	...
	<div class="widget" id="widget">
		...
		<div class="widget-content padding" id="tenderDiv">
			...
			<form:form method="POST"
				...
				<form:hidden path="appNo" id="appNo" />
				...
				<div id="tender_entry1" class="panel-collapse collapse in">
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<form:input type="text" path="trTenderDate" id="trTenderDate"
									maxLength="10"
							...
							<label class="control-label col-sm-2 required-control"
								for="trTypeCpdId"><spring:message
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<form:input id="trProposalDate" path="trProposalDate"
									cssClass="datepicker cal form-control mandColorClass"
									data-rule-required="true" onchange="checkWorkOrderDate()"
									maxlength="10" />
							</div>
						...
						<div class="form-group">
							...
							<label class="control-label col-sm-2 " for="specialconditions"><spring:message
						...
						<div class="form-group">
							...
							<label class="control-label col-sm-2" for="trEmdAmt"><spring:message
				...
				<div class="form-group margin-top-10">
					...
					<div class="col-sm-10">
						...
						<label for="approved1" class="radio-inline mandColorClass">
							<form:radiobutton path="authStatus" value="Y" id="approved1"
								data-rule-required="true" /> <spring:message
								code="account.pay.tds.approved" text="Approved" />
						</label>
						
						 <label for="Forward" class="radio-inline mandColorClass">
							<form:radiobutton path="authStatus" value="N" id="disApproved"
								data-rule-required="true" /> <spring:message
								code="" text="Forward" />
								
						</label> 
						
						<label for="Send" class="radio-inline mandColorClass">
							<form:radiobutton path="authStatus" value="S" id="Send"
								data-rule-required="true" /> <spring:message
								code="" text="Reject" />
						</label>
                      
                     
                       <label for="SendBack" class="radio-inline mandColorClass">
							<form:radiobutton path="authStatus" value="SB" id="SendBack"
								data-rule-required="true" /> <spring:message
								code="" text="Send Back for Clarification" />
						</label>
				...
				<div class="text-center padding-10">
					<c:if test="${!viewMode}">
						...
						<button type="button" class="btn btn-success btn-submit"
							onclick="wokFlowAuthTenderEntryForm(this)" id="btnSave">
