...
<div xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<div class="widget" id="widget">
		<div class="widget-header">
			...
			<h2>
				<spring:message code="budget.projected.revenue.entry.master.budgetcode" text="Budget Code" />
			</h2>
			...
			<form:form class="form-horizontal" id="tbAcBudgetCode"
				...
				<div class="text-center padding-top-20" id="savebutton">
					...
					<input type="button" id="Reset"
						...
						onclick="exportTemplate()" value="<spring:message code="account.bankmaster.reset" text="Reset" />"></input>
