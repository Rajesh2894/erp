...
<div xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<script src="js/account/bankAccountMasterUpload.js"></script>
	...
	<div class="widget" id="widget">
		<div class="widget-header"
			<h2>
				<spring:message code="accounts.stop.payment.bank.account" text="Bank Account" />
			</h2>
		...
		<div class="widget-content padding">
			<form:form class="form-horizontal" id="bankAccountMaster"
				modelAttribute="bankAccountMaster" cssClass=" form-horizontal"
				method="POST" action="BankAccountMaster.html">
				...
				<spring:hasBindErrors name="bankAccountMaster">
				...
				<div class="text-center padding-top-20" id="savebutton">
					...
					<input type="button" id="Reset"
						...
						onclick="exportTemplate()" value="<spring:message code="account.bankmaster.reset" text="Reset"/>"></input> <input
						type="button" class="btn btn-danger"
						onclick="javascript:openRelatedForm('BankAccountMaster.html');"
