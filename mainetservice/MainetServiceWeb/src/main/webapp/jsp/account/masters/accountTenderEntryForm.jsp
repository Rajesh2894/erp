...
<script src="js/account/AccountTenderEntry.js"></script>
...
<div class="form-div" id="content">
	<div class="widget" id="widget">
		...
		<apptags:helpDoc url="AccountTenderEntry.html" helpDocRefURL="AccountTenderEntry.html"></apptags:helpDoc>	
		</div>
		...
		<div class="widget-content padding" id="tenderDiv">
			...
			<form:form method="POST" action="AccountTenderEntry.html"
				name="tenderEntry" id="tenderEntry" class="form-horizontal"
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<form:select id="trTypeCpdId" path="trTypeCpdId"
									class="form-control mandColorClass" disabled="${viewMode}" data-rule-required="true">
									<form:option value="">
				...
				<div class="text-center padding-10">
					...
					<input type="button" class="btn btn-danger"
							onclick="window.location.href='AccountTenderEntry.html'"
