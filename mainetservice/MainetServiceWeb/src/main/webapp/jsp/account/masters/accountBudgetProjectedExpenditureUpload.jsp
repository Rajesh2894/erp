...
<div xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<script src="js/account/accountBudgetProjectedExpenditureUpload.js"></script>
	...
	<div class="widget" id="widget">
		<div class="widget-header">
			...
			<h2>
				<spring:message code="" text="Budget Projected Expenditure" />
			</h2>
		...
		<div class="widget-content padding">
			...
			<form:form class="form-horizontal" id="frmMaster"
				modelAttribute="tbAcBudgetProjectedExpenditure" cssClass=" form-horizontal"
				...
				<spring:hasBindErrors name="tbAcBudgetProjectedExpenditure">
				...
				<div class="text-center padding-top-20" id="savebutton">
					...
					<button type="button" class="btn btn-danger back"
						onclick="window.location.href = 'AccountBudgetProjectedExpenditure.html'">
