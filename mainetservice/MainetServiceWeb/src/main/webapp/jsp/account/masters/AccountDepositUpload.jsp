...
<div xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<script src="js/account/AccountDepositUpload.js"></script>
	...
	<div class="widget" id="widget">
		<div class="widget-header">
			...
			<h2>
				<spring:message code="account.deposit.entry" text="Deposit Entry" />
			</h2>
		...
		<div class="widget-content padding">
			...
			<form:form class="form-horizontal" id="accountDepositBean"
				modelAttribute="accountDepositBean" cssClass=" form-horizontal"
				method="POST" action="AccountDeposit.html">
				...
				<spring:hasBindErrors name="accountDepositBean">
				...
				<div class="form-group text-center" id="reload">
					...
					<div class="col-sm-3 text-left">
						...
						<small class="text-blue-2"> <spring:message  code="bank.master.filesize"  text="(Upload Excel upto 5MB )"></spring:message></small>
					</div>
