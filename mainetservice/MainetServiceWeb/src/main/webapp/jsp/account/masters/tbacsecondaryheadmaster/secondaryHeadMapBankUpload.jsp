...
<div xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<script src="js/account/secondaryHeadMasterUpload.js"></script>
...
<!-- 	 <script>
	...
	<div class="widget" id="widget">
		...
		<div class="widget-content padding">
			...
			<form:form class="form-horizontal" id="secondaryheadMasterMapBankUpload"
				modelAttribute="secondaryheadMaster" cssClass=" form-horizontal"
				method="POST" action="tbAcSecondaryheadMaster.html">
				...
				<spring:hasBindErrors name="secondaryheadMaster">
				...
				<div class="form-group text-center" id="reload">
					...
					<div class="col-sm-3 text-left">
						<button type="button" class="btn btn-success save"
							name="button-Cancel" value="export" onclick="downloadTemplateForDataMap();"
							id="import">
				...
				<div class="text-center padding-top-20" id="savebutton">
					<button type="button" class="btn btn-success save"
						...
						onclick="uploadMapExcelFile(this);" id="button-save">
					...
					<button type="button" class="btn btn-danger back"
						onclick="window.location.href = 'tbAcSecondaryheadMaster.html'">
