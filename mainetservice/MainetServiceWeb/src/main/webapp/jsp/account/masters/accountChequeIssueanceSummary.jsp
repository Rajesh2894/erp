...
<div class="form-div margin-top-40" id="content">
	...
	<div class="widget">
		<div class="widget-header">
			<h2><spring:message code="account.chequeSumm.chequeIssuance" text="Cheque Issuance" /> </h2>
			...
			<form:form action="" modelAttribute="tbBankReconciliation"
				...
				<div class="text-center col-sm-12 margin-top-10 margin-bottom-10">
					...
					<button type="button" class="btn btn-blue-2 " title="Add"
						onclick="addBankReconcilationForm('AccountChequeIssue.html','AddForm');" id="addId">
						<i class="fa fa-plus-circle" aria-hidden="true"></i><spring:message code="accounts.master.add" text="Add" />
					</button>
				</div>
					...
					<table class="table table-bordered table-condensed main1"
						...
						<thead>
							<tr>
								...
								<th class="text-center"><spring:message code="accounts.stop.payment.payment.number" text="Payment No" /></th>
								...
								<th class="text-center"><spring:message code="account.chequeIssue.issuanceDate" text="Issuance Date" /></th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${tbBankReconciliation.bankReconciliationDTO}"
								...
								<tr>
									<td class="text-center">${rcltn.transactionDate}</td>
									<td>${rcltn.transactionNo}</td>
									<td class="text-center">${rcltn.transMode}</td>
									<td>${rcltn.chequeddno}</td>
									<td class="text-center">${rcltn.chequedddate}</td>
									<td class="text-right">${rcltn.amount}</td>
									<td class="text-center">${rcltn.issueanceDate}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
