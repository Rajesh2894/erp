...
<script src="js/account/accountBudgetReappropriationMaster.js"></script>
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="budget.reappropriation.master.title" text=""></spring:message>
			</h2>
		...
		<div class="widget-content padding">
			...
			<form:form action="" modelAttribute="tbAcBudgetReappropriation"
				...
				<div class="form-group">
					<label class="col-sm-2 control-label required-control"> <spring:message
							code="budget.reappropriation.master.financialyear" text=""></spring:message>
					</label>
					<div class="col-sm-4">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="dpDeptid"><spring:message
							code="budget.reappropriation.master.departmenttype" text="" /></label>
					...
					<div class="col-sm-4">
						<form:select path="dpDeptid"
							...
							<c:forEach items="${deptMapData}" varStatus="status"
								var="deptMap">
					...
					<label class="col-sm-2 control-label" for="prBudgetCodeid"><spring:message
							code="budget.reappropriation.master.budgetCode" text="" /></label>
					<div class="col-sm-4">
						<form:select id="prBudgetCodeid" path="prBudgetCodeid"
							cssClass="form-control chosen-select-no-results">
							<form:option value="">
								<spring:message
									code="budget.reappropriation.master.selectbudgetCode" text="" />
							</form:option>

							<c:forEach items="${acReappMap}" varStatus="status"
								var="acReappMap">
								<form:option value="${acReappMap.key}" code="${acReappMap.key}">${acReappMap.value}</form:option>
							</c:forEach>
						</form:select>
					</div>
				</div>
				...
				<div class="text-center padding-bottom-10">
					<button type="button" class="btn btn-success searchData"
						onclick="searchBudgetReappropriationData()">
