	...
	<form:form id="frmMaster" class="form-horizontal"
		...
		<div class="panel-group accordion-toggle"
			...
			<c:if test="${!isViewMode}">
				<div id="fieldDeptDiv">
					<div class="form-group">
						...
						<label class="col-sm-2 control-label "><spring:message
									code="account.transaction.slip.type"
									text="Deposit Slip Type" /></label>
							<div class="col-sm-4">
								<form:select path="depositSlipType"
									class="form-control" id="depositSlipType"
									disabled="${isViewMode}">
									<option value=""><spring:message code="account.select"
											text="Select" /></option>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<c:if test="${!isViewMode}">
						<form:select class="form-control" id="deptId" path="depositeType" onchange="checkDeptSlipType()">
							<option value=""><spring:message code="account.select"
									text="Select" /></option>
			...
			<c:if test="${ledgerDetailDiv}">
				...
				<div class="panel panel-default" id="ledgerDetailId2">
						...
						<h4 class="panel-title" id="">
							<a data-toggle="collapse" class=""
								data-parent="#accordion_single_collapse" href="#ledgerDetailId"><spring:message
														code="account.cheque.dishonour.total" text="Deposit
								Details" />  </a>
						</h4>
								...
								<table id="ledgerDetailsId"
									...
									<tbody>
										...
										<th scope="col" width="25%"><spring:message
											...
											<td colspan="3" align="right"><b><spring:message
														code="account.cheque.dishonour.total" text="Total :" /></b></td>
											<td align="right"><form:input
													path="listOfReceiptDetails[0].totalAmount" readonly="true"
					...
					<c:if test="${!isViewMode}">
						<div class="form-group">
							<label class="control-label col-sm-2 "><spring:message
									code="" text="Remittance Date" /> </label>
							<div class="col-sm-4">
								<div class="input-group">
				...
				<div class="text-center" id="afterSearchDiv">
					<a href="javascript:void(0);"
						...
						class="btn btn-success" id="processButton">&nbsp;<spring:message
							code="" text="Process" /></a> <input type="button"
						class="btn btn-warning Clear" id="Clear"
						onclick="resetDepositForm()" value="Reset"></input> <input
			...
			<div class="text-center" id="processBtn">
				<c:if test="${!isViewMode}">
					<input type="button" id="saveButttonOnDescChange"
						class="btn btn-success btn-submit" onclick="saveFormData(this)" value="<spring:message code="accounts.stop.payment.save" text="Save" />" />
					<input type="button" class="btn btn-warning Clear" id="Clear"
						onclick="resetDepositForm()" value="<spring:message code="accounts.stop.payment.reset" text="Reset" />"></input>
					<input type="button" class="btn btn-danger"
						onclick="window.location.href='AccountDepositSlip.html'"
