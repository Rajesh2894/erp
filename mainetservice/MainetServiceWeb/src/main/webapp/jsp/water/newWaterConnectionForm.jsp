	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<h2><spring:message code="water.connection.label" text="Water Connection" /></h2>
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<form:select path="csmrInfo.bplFlag"
													...
													<form:option value="N" >
														<spring:message code="water.normal" text="Normal" />
													</form:option>
													<form:option value="Y">
														<spring:message code="water.bhagirathi.conn" text="Bhagirathi Connection" />
													</form:option>
						...
						<div class="panel panel-default" id="propertyParentId">
							...
							<div id="waterpropertydetails">
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label"><spring:message
												code="water.property.outstandingAmt" text="Property OutStanding Amount" /></label>
										<div class="col-sm-4">
							...
							<div id="waterconnectiondetails" class="panel-collapse collapse">
								<div class="panel-body">
									...
									<apptags:lookupFieldSet baseLookupCode="CCG" hasId="true" showOnlyLabel="false"
												pathPrefix="csmrInfo.csCcncategory" isMandatory="false" hasLookupAlphaNumericSort="true" 
												hasSubLookupAlphaNumericSort="true" cssClass="form-control" showAll="true"/>
												...
												<thead>
													<tr>
														<th><spring:message code="water.ConnectionNo" /> <span
															class="mand">*</span></th>
														<th><spring:message code="water.ConnectionSize" /></th>
														<th><spring:message code="water.outStanding" text="OutStanding Amount" /></th>
										...
										<div id="ulbPlumber">
											<div class="col-sm-4">
												<form:select path="csmrInfo.plumId" class="form-control"
													id="plumber" disabled="true">
													<c:forEach items="${command.plumberList}" var="lookUp">
														<form:option selected="selected" value="${lookUp.plumId}">${lookUp.plumFname}</form:option>
													</c:forEach>
												</form:select>
											</div>
										</div>
										<div id="licensePlumber">
											<div class="col-sm-4">
												<form:select path="csmrInfo.plumId" class="form-control"
													...
													<c:forEach items="${command.plumberList}" var="lookUp">
														<form:option selected="selected" value="${lookUp.plumId}">${lookUp.plumFname} ${lookUp.plumMname} ${lookUp.plumLname}</form:option>
													</c:forEach>
												</form:select>
											</div>
										</div>
								...
								<div class="panel-body">
												...
												<c:if test="${command.sudaEnv eq 'Y'}">
													<div class="col-sm-6 text-right">
														<label class="checkbox-inline" for=""> <form:checkbox
																path="" value=""
																id="" /> <spring:message
																code="water.isBillingAddress.map" />
														</label>
													</div>
												</c:if>
										</div>
									...
									<div id="hideBillingDetails">
										...
										<div class="form-group">
											<c:if test="${command.sudaEnv eq 'Y'}">
												<label class="col-sm-2 control-label required-control"
													for="billingDistrict"><spring:message
														code="water.dataentry.district" text="District" /></label>
																		...
																		<c:when
																			...
																			<td>${lookUp.doc_DESC_ENGL}
																				<c:if test="${lookUp.doc_DESC_ENGL eq 'Affidavit' and command.sudaEnv eq 'Y'}">
																					<a href="./assets/docs/Affidavit.docx" >Click Here to Download Format</a>
																				</c:if>
																			</td>
																		</c:when>
																		<c:otherwise>
