...
<script type="text/javascript"
	src="js/water/illegalConnectionRegister.js"></script>
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="water.illegalConnectionRegister"
					text="Illegal Connection Register" />
			</h2>
		</div>
		<div class="widget-content padding">
			...
			<form:form action="llegalConnection.html" cssClass="form-horizontal"
				id="IllegalForm">
