...
<div class="content">
	...
	<div class="widget">
		<div class="widget-header">
			<h2><spring:message
							code="water.order.work.view" text="Work Order View"/></h2>
		...
		<div class="widget-content padding">
			<div class="mand-label clearfix">
				<span><spring:message
							code="water.fieldwith"/> <i class="text-red-1">*</i> <spring:message
							code="water.ismandtry"/>
				</span>
			</div>
			<div class="error-div alert alert-danger alert-dismissible"
				style="display: none;" id="serviceRuleDefMas"></div>

			<form:form action="WorkOrder.html?create"
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label"><spring:message
							code="chn.applicationNo" /> </label>
					<div class="col-sm-4">
						<input name="woApplicationId" type="text" class="form-control"
							value="${applicationId}" readonly="readonly">
					</div>
					<label class="col-sm-2 control-label"><spring:message
							code="chn.name" /> </label>
					<div class="col-sm-4">
						<input name="woServiceId" type="text" class="form-control"
							value="${ApplicantFullName}" readonly="readonly">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label"><spring:message
							code="trutirejection.applicationdate" /> </label>
					<div class="col-sm-4">
						<div class="input-group">
							<input id="datepicker2" name="woApplicationDateS" type="text"
								class="form-control" value="${ApplicarionDate}"
								readonly="readonly" /> <label for="datepicker2"
								class="input-group-addon"><i class="fa fa-calendar"></i></label>
						</div>
					</div>

					<label class="col-sm-2 control-label"><spring:message
							code="tbOrganisation.userMobiNo" /></label>
					<div class="col-sm-4">
						<input name="mobileNo" type="text" class="form-control"
							value="${mobileNo}" readonly="readonly">
					</div>
				...
				<h4><spring:message
							code="water.order.remarks" text="Remarks According To Deparment And Service"/></h4>
				<div class="mand-label clearfix">
					<span><i class="fa fa-check"></i> <spring:message
							code="water.order.select.one" /> </span>
				</div>
				<div class="table-responsive">
					<table class="table table-bordered table-condensed">
						<tr>
							<th width="100"><spring:message
							code="water.nodues.srno"/></th>
							<th><spring:message
							code="water.remark" /></th>
							<th width="50"><label
								class="padding-left-20 margin-bottom-10"><input
									type="checkbox" name="All" id="selectall" class="pull-left">All</label></th>
						</tr>
						<c:forEach var="singleDoc" items="${apprejMasList}"
							varStatus="count">
							<tr>

								<td>${count.count}</td>
								<td><textarea name="" cols="" rows="" class="form-control"
										readonly="readonly">${singleDoc.artRemarks}</textarea></td>
								<td align="center"><form:checkbox id="${count.index}"
										path="workOrderRemarklist[${count.index}].isSelected"
										class="case" name="case" value="${singleDoc.artId}" /></td>
				...
				<div class="text-center margin-top-10">
					<input type="button" value="<spring:message code="bt.save"/>"
						class="btn btn-success" id="Submit"> <input type="button"
