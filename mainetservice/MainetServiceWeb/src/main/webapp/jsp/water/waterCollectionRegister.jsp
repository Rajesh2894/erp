...
<script type="text/javascript" src="js/water/waterCollectionRegister.js"></script>
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="water.collectionRegister"
		...
		<div class="widget-content padding">
			...
			<form:form action="waterCollectionRegister.html"
				cssClass="form-horizontal" id="CollectionRegister">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label required-control"><spring:message
							code="water.report.fromdate" text="From Date" /></label>
					<div class="col-sm-4">
					...
					<label class="col-sm-2 control-label required-control"> <spring:message
							code="water.report.todate" text="To Date" /></label>
					<div class="col-sm-4">
						<div class="input-group">
							...
							<label class="input-group-addon" for="mnTodt"><i
								class="fa fa-calendar"></i><span class="hide"> <spring:message
										code="" text="icon" /></span><input type="hidden" id=csTodt></label>
						</div>
					</div>
