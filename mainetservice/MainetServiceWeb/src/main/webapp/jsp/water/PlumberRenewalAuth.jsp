...
<div class="content">
	<div class="widget">
		...
		<div class="widget-content padding">
			...
			<form:form action="PlumberRenewalAuth.html" method="post"
				class="form-horizontal" name="licRenewal" id="licRenewal">
							...
							<h4 class="panel-title">
								<a data-toggle="collapse" class="collapsed"
									data-parent="#accordion_single_collapse" href="#child-level1"><spring:message
										code="water.plumberLicense.licenseDetails" /></a>
							</h4>
						</div>
							...
							<div class="panel-body">
								<div class="table-responsive" id="licenseId">
									<table class="table table-bordered table-striped"
										...
										<tr>
											<th><spring:message code="water.plum.licno"
													text="License No." /></th>
											<th><spring:message code="water.plum.validFrom"
													text="From Period" /></th>
											<th><spring:message code="water.plum.validTo"
													text="To Period" /></th>
										</tr>
										<tr class="licenseInfo">
											<td><form:input
													path="plumberLicenseReqDTO.plumberLicenceNo" name=""
													class="form-control text-center" id="licNo" value=""
													readonly="true" data-rule-required="true" /></td>
											<td><form:input
													path="plumberLicenseReqDTO.plumLicFromDate" name=""
													class="form-control lessthancurrdate text-center"
													id="validFrom" value="" readonly="true"
													data-rule-required="true" /></td>
											<td><form:input
													path="plumberLicenseReqDTO.plumLicToDate" name=""
													class="form-control lessthancurrdate text-center"
													id="validTo" value="" readonly="true"
													data-rule-required="true" /></td>
										</tr>
									</table>
								</div>
				...
				<div class="text-center padding-bottom-20" id="divSubmit">
					<button type="button" class="btn btn-success"
						onclick="saveRenewAuthData(this)" id="submit">
