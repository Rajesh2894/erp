		...
		<div class="widget-content padding">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-xs-3 col-sm-2 margin-top-10">
						<p>
					...
					<div class="col-xs-4 col-sm-2 margin-top-10">
						<p>:${command.plumberLicenseReqDTO.plumberLicenceNo}</p>
						<p>:${command.plumberLicenseReqDTO.plumberFullName}</p>
						<p>:${command.plumberLicenseReqDTO.plumAddress}</p>
						<p>:${command.plumberLicenseReqDTO.licFromDate}
						<spring:message code="water.plumberLicense.to" />
						${command.plumberLicenseReqDTO.licToDate}</p>
					</div>
				</div>
			</div>
