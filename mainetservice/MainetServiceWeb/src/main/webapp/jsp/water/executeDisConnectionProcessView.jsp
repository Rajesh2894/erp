			...
			<form:form action="ExecuteDisConnectionProcess.html"
				...
				<div class="form-group">
					<label class="col-sm-6 checkbox-inline"><form:checkbox
							...
							code="water.disconet.execute" text="Execute Disconnection" /></label> <label
					...
					<div class="col-sm-4">
						<div class="input-group">
							<form:input path="commonDto.discExecdate"
								cssClass="form-control datepicker" id="datepicker3" readonly="true"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						<form:input path="" cssClass="form-control" value="${fullName}" readonly="true"/>
					</div>
					<label class="col-sm-2 control-label"><spring:message
