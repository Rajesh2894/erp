...
<script type="text/javascript">
	function executeDisconnectionProcess(element) {
		...
		var response = __doAjaxRequest(
				'ExecuteDisConnectionProcess.html?saveform', 'POST',
				requestData, false);
...
<div class="content">
	...
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="water.disconet.detail"
					text="Disconnection Execution Details" />
			</h2>
		...
		<div class="widget-content padding">
			...
			<form:form action="ExecuteDisConnectionProcess.html"
				class="form-horizontal form" name="frmExecuteDisConnection"
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label"><spring:message
							code="water.application.date" text="Application Date" /></label>
					<div class="col-sm-4">
						<form:input cssClass="form-control" disabled="true"
				...
				<h4>
					<spring:message code="water.disconet.execute.detail"
						text="Execution Details" />
				</h4>
				<div class="form-group">
					<div class="col-sm-6 padding-top-7">
					<label class="checkbox-inline"><form:checkbox
							path="commonDto.discGrantFlag" value="Y" /> <spring:message
							code="water.disconet.execute" text="Execute Disconnection" /></label></div> <label
						class="col-sm-2 control-label"><spring:message
							code="water.disconet.execute.date"
							text="Disconnection Execution Date" /></label>
					<div class="col-sm-4">
						<div class="input-group">
							<form:input path="commonDto.discExecdate"
								cssClass="form-control datepicker" id="datepicker3" />
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><spring:message
							code="water.disconet.approve.by" text="Approved By" /></label>
					<div class="col-sm-4">
						<c:set var="fullName" value="${command.approveBy }" />
						<form:input path="" cssClass="form-control" value="${fullName}" />
					</div>
					<label class="col-sm-2 control-label"><spring:message
							code="water.disconet.approve.date" text="Approved Date" /></label>
					<div class="col-sm-4">
						<div class="input-group">
							<fmt:formatDate value="${command.approveDate }" var="appDate"
								pattern="dd/MM/yyyy" />
							<form:input path="" cssClass="form-control"
								id="datepicker4" value="${appDate }" readonly="true"/>

							<label class="input-group-addon" for="datepicker4"><i
								class="fa fa-calendar"></i></label>
						</div>
					</div>
				</div>
				...
				<div class="text-center padding-top-10">
					<c:if test="${command.homeGrid eq false }">
						<button type="button" class="btn btn-success"
							onclick="executeDisconnectionProcess(this)">
					...
					<c:if test="${command.homeGrid eq true }">
						<apptags:submitButton entityLabelCode="" actionParam="saveform"
							successUrl="AdminHome.html" cssClass="btn btn-success"></apptags:submitButton>
