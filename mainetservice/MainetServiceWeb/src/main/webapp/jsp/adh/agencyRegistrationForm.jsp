	...
	<div class="content">
		<div class="widget">
			...
			<div class="widget-content padding">
				...
				<form:form action="AgencyRegistration.html"
					name="AgencyRegistration" id="AgencyRegistration"
						...
						<div class="panel-collapse collapse in" id="Applicant">
							<div class="form-group">
								...
								<apptags:lookupField
									...
									showAll="false" disabled="${disabled}"
								...
								<div class="col-sm-4">
									<form:input name="" type="text"
										...
										readonly="${disabled}" maxlength="200"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<form:input name="" type="text"
										class="form-control hasMobileNo" readonly="${disabled}"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<form:input name="" type="text"
										class="form-control preventSpace" readonly="${disabled}"
					...
					<div class="padding-top-10 text-center">
						...
						<button type="button" class="btn btn-warning"
							onclick="window.location.href='AgencyRegistration.html'"
							id="reset">
