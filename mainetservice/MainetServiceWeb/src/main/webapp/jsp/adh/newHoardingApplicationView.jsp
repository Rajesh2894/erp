...
<script type="text/javascript"
	src="js/adh/newHoardingApplication.js"></script>
	...
	<div class="widget">
		<div class="widget-header">
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<form:input
								path="advertisementReqDto.advertisementDto.licenseFromDateDesc"
								id="licenseFromDate"
					...
					<div class="col-sm-4">
						<div class="input-group">
							<form:input
								path="advertisementReqDto.advertisementDto.licenseToDateDesc"
								id="licenseToDate"
								class="form-control mandColorClass datePicker" maxlength="10" />
				...
				<h4 class="margin-top-0">
					<spring:message code="adh.new.advertisement.hoarding.details"
