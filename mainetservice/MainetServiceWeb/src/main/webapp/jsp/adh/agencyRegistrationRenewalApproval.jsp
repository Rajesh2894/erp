...
<div class="content">
	<div class="widget">
		...
		<div class="widget-content padding">
			...
			<form:form action="AgencyRegistrationRenewalAuth.html"
				name="AgencyRegistrationRenewalAuth"
				id="AgencyRegistrationRenewalAuth" class="form-horizontal">
													...
													<tr>
														...
														<td>
															...
															<apptags:filedownload filename="${lookUp.attFname}"
																...
																actionUrl="AgencyRegistration.html?Download"></apptags:filedownload>
														</td>
													</tr>
												</c:forEach>
											</tbody>
				...
				<div class="padding-top-10 text-center">
					...
					<c:if test="${command.payableFlag eq 'Y' }">
						<button type="button" class="btn btn-success" id="submit"
							onclick="saveAgencyRenewalApprovalForm(this)">
