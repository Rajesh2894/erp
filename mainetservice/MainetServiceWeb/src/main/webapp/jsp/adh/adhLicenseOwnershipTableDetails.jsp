...
<%--  <c:choose>
	...
	<c:when
		test="${command.ownershipPrefix eq 'A' }">
		...
		<table class="table table-striped table-bordered" id="ownerDetail">
			<thead>
				...
				<tr>
					...
					<th width="10%"><spring:message code="agency.pan" />
					<th width="8%"><spring:message code="property.add/delete" /></th> 
				</tr>
			</thead>
			<tbody>
				<c:choose>
					<c:when test="${ empty  command.getAgencyRequestDto().getMasterDto()}">
						
						<c:forEach var="taxData"
							items="${command.agencyRequestDto.masterDto}" varStatus="status">
							<tr class="appendableClass">
								<td><form:input
										path="agencyRequestDto.masterDto.agencyOwner"
										type="text"
								...
								<td><form:input
										path="agencyRequestDto.masterDto.panNumber"
										type="text" class="form-control text-uppercase hasNoSpace"
					...
					<c:otherwise>
						<tr class="appendableClass">
							...
							<td><form:input
									path="command.agencyRequestDto.masterDto.agencyOwner"
									type="text"
									class="form-control unit required-control hasSpecialChara preventSpace"
									maxLength="100" id="agencyOwner${d}" /></td>
							</td>
							...
							<td><form:input
									path="command.agencyRequestDto.masterDto.agencyContactNo"
									type="text"
									class="form-control unit required-control hasMobileNo preventSpace"
									id="agencyContactNo${d}" data-rule-required="true" /></td>
							<td><form:input
									path="command.agencyRequestDto.masterDto.agencyEmail"
									type="text"
									class="form-control unit required-control hasemailclass preventSpace"
									id="agencyEmail${d}" data-rule-email="true" maxLength="50" /></td>
							<td><form:input
									path="command.agencyRequestDto.masterDto.uidNo" type="text"
									class="form-control unit required-control hasAadharNo preventSpace"
									data-rule-maxlength="12" data-rule-minlength="12"
									id="uidNo${d}" maxlegnth="12" /></td>

							<td><form:input
									path="command.agencyRequestDto.masterDto.panNumber" type="text"
		...
		<table class="table table-striped table-bordered" id="ownerDetail">
			<thead>
				<tr>
					...
					<c:choose>
						<c:when test="${command.ownershipPrefix eq 'P'}">
			...
			<tbody>
				<c:choose>
					<c:when test="${empty  command.agencyRequestDto.masterDto}">
						
						<c:forEach var="taxData"
							items="${command.agencyRequestDto.masterDto}"
							varStatus="status">
							<tr class="appendableClass">
								...
								<td><form:input
										...
										id="agencyEmail${d}" data-rule-email="true" maxLength="50" /></td>
								<td><form:input
										path="command.agencyRequestDto.masterDto.uidNo"
										type="text"
										...
										<td>
								 		<form:input 
								 		path="command.agencyRequestDto.masterDto.panNumber"
								 		type="text"
									
										class="form-control text-uppercase hasNoSpace" maxLength="10"
										id="panNumber${d}" autocomplete="off"/>
								 </td>	
