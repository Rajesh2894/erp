...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code=""
					text="Advertisement For Renewal Application " />
			</h2>
		</div>
		<div class="widget-content padding">
			...
			<form:form method="POST" action="RenewalAdvertisementApplication.html"
				...
				<div class="text-center margin-top-15">
					...
					<button type="button" class="btn btn-danger"
						onclick="window.location.href ='RenewalAdvertisementApplication.html'">
