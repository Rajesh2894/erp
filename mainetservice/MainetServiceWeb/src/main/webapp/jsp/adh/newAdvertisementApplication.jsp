	...
	<div class="widget">
		...
		<div class="widget-content padding">
			...
			<form:form method="POST" action="NewAdvertisementApplication.html"
				...
				<div class="form-group">
				<apptags:input labelCode="adh.new.advertisement.property.address"
						path="advertisementReqDto.advertisementDto.propAddress" isDisabled="true"></apptags:input>
				<apptags:input labelCode="adh.new.advertisement.property.outstanding.amount"
				...
				<h4 class="margin-top-0">
					<spring:message code="adh.new.advertisement.advertising.details"
						text="Advertising Details"></spring:message>
				</h4>
				...
				<c:if test="${not empty command.checkList }">
					<div id="checklistAndPaymentId">
						<h4 class="margin-top-0">
							<spring:message code="adh.upload.attachement"
								text="Upload Attachment"></spring:message>
						</h4>
				...
				<div class="text-center margin-top-15">
					<c:if
						test="${empty command.checkList && command.enableSubmit ne 'Y'}">
					...
					<c:if test="${command.enableSubmit eq 'Y' }">
						<button type="button" class="btn btn-success"
