        ...
        <table id="billTable" class="table table-bordered">
						...
						<!-- 	<td id="academicSrNoId0">1</td> -->
							...
							<form:options items="${command.appSession.customerBanks}" />
								...
								<td><form:input name=""  id="amount0"  onchange="totalMultiModeAmount();" class="totAddMultiAmount form-control hasNumber" type="text" value=""  maxlength="10" path="offlineDTO.multiModeList[0].amount"/></td>
								<td>
						...
						<%-- 		<apptags:lookupField items="${command.userSession.paymentMode}" path="offlineDTO.multiModeList[${status.index}].payModeIn" cssClass="form-control" changeHandler="disableFieldsOnCashSelection(${status.index})"
							...
							<form:options items="${command.appSession.customerBanks}" />
								...
								<td><form:input name=""  id="amount${status.index}"   class="totAddMultiAmount form-control has2Decimal" onchange="totalMultiModeAmount();" type="text" value=""  maxlength="10" path="offlineDTO.multiModeList[${status.index}].amount"/></td>
