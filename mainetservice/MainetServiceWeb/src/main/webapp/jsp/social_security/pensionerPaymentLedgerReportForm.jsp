...
<script type="text/javascript"
	src="js/social_security/pensionerPaymentLedgerReport.js"></script>
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="social.PensionerPaymentLedgerReport"
					text="Pensioner Payment Ledger Report" />
			</h2>
		</div>
		<div class="widget-content padding">
			...
			<form:form action="PensionerPayment.html"
				cssClass="form-horizontal" id="PensionerFormReport">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<form:select path="pensionSchemeDto.serviceId" id="serviceId"
							...
							<form:option value="0"><spring:message code="social.select"  text="Select"/></form:option>
							<form:option value="-1"><spring:message code="social.all"  text="All"/></form:option>
			...
			<div class="col-sm-4">
				<div class="input-group">
					<form:input path="pensionSchemeDto.createdDate" id="createdDate"
						...
						value="" readonly="false" data-rule-required="true" maxLength="10" />
		...
		<div class="padding-top-10 text-center">
			...
			onclick="window.location.href='PensionerPayment.html'" >
