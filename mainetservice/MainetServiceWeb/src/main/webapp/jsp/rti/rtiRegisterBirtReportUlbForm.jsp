...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="rti.register.pending.ulb.report"
				...
				<div class="form-group">
					...
					<div class="radio col-sm-4 margin-top-5">
						<label> <form:radiobutton path="rtiAppFormDto.reportName"
								...
								code="rti.register.report" /></label> <label><form:radiobutton
								path="rtiAppFormDto.reportName" value="P" id="Pending"
