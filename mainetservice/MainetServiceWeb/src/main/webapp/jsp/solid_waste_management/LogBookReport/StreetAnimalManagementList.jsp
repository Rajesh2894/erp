...
<script type="text/javascript"
	src="js/solid_waste_management/allLogBookReport/streetAnimalManagementReport.js"></script>
...
<div class="content">
	...
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="" text="Animal Management Log Report" />
			</h2>
		</div>
		<div class="widget-content padding">
			<form:form action="" method="get" class="form-horizontal">
				...
				<div class="form-group">
					...
					<apptags:lookupField
						items="${command.getLevelData(baseLookupCode)}" path="vehicleMasterDTO.monthNo"
						cssClass="form-control required-control" isMandatory="true"
						selectOptionLabelCode="selectdropdown" hasId="true" />
				</div>
				<div class="text-center padding-top-10">
					<button type="button" class="btn btn-success btn-submit"
						onClick="streetAnimalManagementReportPrint('StreetAnimalManagementReport.html')"
