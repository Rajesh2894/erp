...
<script type="text/javascript"
	src="js/solid_waste_management/allLogBookReport/AnimalManagementLog.js"></script>
		...
		<div class="widget-content padding">
			<form:form action="" method="get" class="form-horizontal">
				...
				<div class="form-group">
					...
					<apptags:lookupField
						items="${command.getLevelData(baseLookupCode)}" path="vehicleScheduleDTO.monthNo"
						cssClass="form-control required-control" isMandatory="true"
						selectOptionLabelCode="selectdropdown" hasId="true" />
				</div>
				<div class="text-center padding-top-10">
					<button type="button" class="btn btn-success btn-submit"
						onClick="AnimalManagementReport('AnimalManagementLogReport.html')"
