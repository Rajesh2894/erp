	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<spring:message code="" text="C&D Waste Management Report" />
			</div>
					...
					<div id="receipt">
						...
						<div class="col-xs-8 col-xs-8  text-center">
							<h2 class="text-large margin-bottom-0 margin-top-0 text-bold">
								...
								District - ${command.vehicleMasterDTO.districtName} <br>
								<spring:message code="" text="C&D Waste Management Report" />
							</h2>
						</div>
						<div class="col-xs-2">
						...
						<div id="export-excel">
							<table class="table table-bordered table-condensed">
								<thead>
									<tr>
										...
										<th class="text-center"><spring:message code=""
												text="Date" /></th>
										<th class="text-center"><spring:message code=""
												text="NameofSource" /></th>
										<th class="text-center"><spring:message code=""
												text="NameOfWork" /></th>
										<th class="text-center"><spring:message code=""
												text="TypeOfVehicle" /></th>
										<th class="text-center"><spring:message code=""
												text="VehicleNo." /></th>
										<th class="text-center"><spring:message code=""
												text="MaximumCapacity" /></th>
										<th class="text-center"><spring:message code=""
												text="TotalAmountOfWaste" /></th>
										<th class="text-center"><spring:message code=""
												text="ApprovalOfPlan (Yes/No)" /></th>
										<th class="text-center"><spring:message code=""
												text="NidaanRequestNo." /></th>
									</tr>
								</thead>
								<tfoot>
									<tr>
								...
								<tbody>
									<c:forEach
										items="${command.wasteCollectorDTO.wasteCollectorDTOList}"
										...
										<tr>
											...
											<td>${data.workName}</td>
											<td>${data.vType}</td>
											<td class="text-right">${data.vehicleNo}</td>
											<td class="text-right">${data.veCapacity}</td>
											<td class="text-right">${data.collectionAmount}</td>
											<td class="text-center">${data.bldgPermission}</td>
											<td class="text-right">${data.complainNo}</td>
