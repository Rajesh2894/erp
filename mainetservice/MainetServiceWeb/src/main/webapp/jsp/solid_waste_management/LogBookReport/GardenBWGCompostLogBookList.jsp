...
<script type="text/javascript"
	src="js/solid_waste_management/allLogBookReport/gardenBWGCompostReport.js"></script>
...
<div class="content">
	...
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="" text="Garden BWG Compost Log Book Report" />
			</h2>
		</div>
			...
			<form:form action="" method="get" class="form-horizontal">
				...
				<div class="text-center padding-top-10">
					<button type="button" class="btn btn-success btn-submit"
						onClick="gardenBWGReportPrint('GardenBWGCompostLogBookReport.html')"
