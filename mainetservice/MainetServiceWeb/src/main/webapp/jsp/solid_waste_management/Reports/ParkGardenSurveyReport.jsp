	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<spring:message code="swm.park.report" text="Park Garden Survey Report" />
			</div>
					...
					<div id="receipt">
						...
						<div id="export-excel">
							<table class="table table-bordered table-condensed">
								<thead>
									<tr>
										<th class="text-center"><spring:message code="swm.park.name"
												text="Park Name" /></th>
										<th width="310Px" class="text-center"><spring:message
												code="swm.park.address" text="Park Address" /></th>
								...
								<tbody>
									<c:forEach
										items="${command.areaWiseDto.areaWiseDtoList}"
