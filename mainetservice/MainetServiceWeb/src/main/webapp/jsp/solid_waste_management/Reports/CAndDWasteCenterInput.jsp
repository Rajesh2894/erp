	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<spring:message code="" text="Construction And Demolition Waste Report" />
			</div>
					...
					<div id="receipt">
						...
						<div class="col-xs-8 col-xs-8  text-center">
							<h2 class="text-large margin-bottom-0 margin-top-0 text-bold">
								...
								<spring:message code=""
									text="Construction And Demolition Waste Report" />
								<br>
							</h2>
						</div>
						<div class="col-xs-2">
							...
							<table class="table table-bordered table-condensed">
								<thead>
									<tr>
										...
										<th class="text-center" colspan="1" width="10%"><spring:message
												code="" text="Date" /></th>
										<th class="text-center" colspan="31" width="10%"><spring:message
												code="" text="Source Name" /></th>		
										<th class="text-center" colspan="31" width="10%"><spring:message
												code="" text="Vehicle Type" /></th>	
										<th class="text-center" colspan="31" width="10%"><spring:message
												code="" text="Vehicle No." /></th>	
										<th class="text-center" colspan="31" width="10%"><spring:message
												code="" text="Max. Capacity" /></th>	
										<th class="text-center" colspan="31" width="10%"><spring:message
												code="" text="Volume of Waste" /></th>			
										<th class="text-center" colspan="31" width="10%"><spring:message
												code="" text="Plan Approval(Yes/No)" /></th>			
										<th class="text-center" colspan="31" width="10%"><spring:message
												code="" text="Nidan No." /></th>
										<th class="text-center" colspan="31" width="10%"><spring:message
												code="" text="Building Plan Sanction No." /></th>			
