	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<spring:message code="swm.urination.report" text="Urination Spot Survey Report" />
			</div>
			<div class="widget-content padding">
				<form:form action="AreaWiseSurveyReport.html" method="post"
					...
					<div id="receipt">
						...
						<div id="export-excel">
							<table class="table table-bordered table-condensed">
								<thead>
									<tr>
										<th class="text-center"><spring:message code="swm.urination.address"
												text="Urination Spot Address" /></th>
										<th class="text-center"><spring:message code="swm.ward.no"
												text="Ward No." /></th>
										<th class="text-center"><spring:message code="vehicle.master.vehicle.remarks"
												text="Remarks" /></th>
									</tr>
								</thead>
								<tfoot>
								...
								<tbody>
									<c:forEach items="${command.areaWiseDto.areaWiseDtoList}"
										...
										<tr>
											<td width="30%">${data.locAdress}</td>
											<td width="20%">${data.wardName}</td>
											<td width="30%">${data.remarks}</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
