	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<spring:message code="swm.residential.area.report" text="Residential Area Survey Report" />
			</div>
				...
				<form:form action="" method="get" class="form-horizontal">
					<div id="receipt">
						...
						<div class="form-group">
							...
							<div class="col-xs-4">
								<p>${command.areaWiseDto.fromDate}</p>
							</div>
							<label for="select-1479372680758" class="col-xs-2 control-label"><spring:message
									code="swm.toDate" text="To Date" /></label>
							<div class="col-xs-4">
								<p>${command.areaWiseDto.toDate}</p>
							</div>
						</div>
						...
						<div id="export-excel">
							<table class="table table-bordered table-condensed">
								<thead>
									<tr>
										<th class="text-center"><spring:message code="swm.residential.area.name"
												text="Residential Community Area Name" /></th>
										<th width="310Px" class="text-center"><spring:message
												code="swm.residential.area.address" text="Residential Community Area Address" /></th>
										<th class="text-center"><spring:message code="swm.ward.no"
												text="Ward No." /></th>
										<th width="310Px" class="text-center"><spring:message
												code="swm.residential.chief.name" text="Residential Community Chief Name" /></th>
										<th class="text-center"><spring:message code="construct.demolition.applicant.mobile"
												text="Mobile No." /></th>
									</tr>
								</thead>
								<tfoot>
								...
								<tbody>
									<c:forEach items="${command.areaWiseDto.areaWiseDtoList}"
										var="data" varStatus="index">
										<tr>
											<td>${data.locName}</td>
											<td>${data.locAdress}</td>
											<td>${data.wardName}</td>
											<td>${data.chiefName}</td>
											<td class="text-right">${data.mobNo}</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
