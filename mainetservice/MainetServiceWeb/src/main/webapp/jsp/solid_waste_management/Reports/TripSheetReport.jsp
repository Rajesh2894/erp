						...
						<div class="overflow-visible">
							<div id="export-excel">
								<table class="table table-bordered table-condensed">
									<thead>
										<tr>
											<th class="text-center"><spring:message code="swm.tripdate" text="Trip Date" /></th>
											<th class="text-center"><spring:message code="swm.vehicleType"
													text="Vehicle Type" /></th>
											<th class="text-center"><spring:message code="swm.sanitary.vehicleNo"
													text="Vehicle No" /></th>
											<th class="text-center"><spring:message
													code="swm.trip.sheet.report.no.of.trip" text="No. of Trips" /></th>
											<th class="text-center"><spring:message code="swm.trip.sheet.report.dry"
													text="Dry Waste In Kg" /></th>
											<th class="text-center"><spring:message code="swm.trip.sheet.report.wet"
											...
											<th class="text-center"><spring:message code="swm.total.garbage.collection" text="Total Garbage in Kg" /></th>
										</tr>
									</thead>
									<tfoot>
										<tr>
									...
									<tbody>
										<c:forEach items="${command.tripSheetDTOList.tripSheetDTO}"
											...
											<tr>
												...
												<td class="text-right">${data.noOfTrips}</td>
										...
										<tr>
											<th class="text-right" colspan="4"><spring:message
