	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<spring:message code="swm.beautification.spot.report" text="Beautification Spot Survey Report" />
			</div>
					...
					<div id="receipt">
						...
						<div id="export-excel">
							<table class="table table-bordered table-condensed">
								<thead>
									<tr>
										<th class="text-center"><spring:message code="swm.beautification.spot"
												text="Beautification Spot Address" /></th>
