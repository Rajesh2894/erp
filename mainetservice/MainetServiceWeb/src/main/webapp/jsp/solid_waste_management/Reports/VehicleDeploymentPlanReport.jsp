	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<spring:message code="swm.vehicle.deployementplan.report"
					text="Vehicle Deployment Plan Report" />
			</div>
					...
					<div id="receipt">
						...
						<div class="form-group">
							...
							<div class="col-xs-4">
								<p>
									<fmt:formatDate
										value="${command.vehicleScheduleDTO.veScheduledate}"
										pattern="dd/MM/yyyy" />
								</p>
							</div>
						</div>
							...
							<table class="table table-bordered table-condensed">
								<thead>
									<tr>
										...
										<th class="text-center"><spring:message
												code="swm.report.cleaning.prsn.name"
												text="Cleaning Person Name" /></th>
										<th class="text-center"><spring:message
												code="swm.report.cleaning.prsn.id" text="Cleaning Person Id" /></th>
									</tr>
								</thead>
								<tfoot>
									<tr>
								...
								<tbody>
									<c:forEach
										items="${command.vehicleScheduleDTO.employeeNameList}"
										var="list" varStatus="cnt">
										<tr>
											<td class="text-center">${cnt.count}</td>
											<td>${list}</td>
											<td class="text-center">${command.empUIdList[cnt.index]}</td>
										</tr>
									</c:forEach>
