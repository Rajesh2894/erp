	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<spring:message code="swm.BWG.Report" text="Bulk Waste Generator Survey Report" />
			</div>
					...
					<div id="receipt">
						...
						<div class="col-xs-8 col-xs-8  text-center">
							<h2 class="text-large margin-bottom-0 margin-top-0 text-bold">
								...
								<spring:message code="swm.BWG.Report"
									text="Bulk Waste Generator Survey Report" />
							</h2>
						</div>
						<div class="col-xs-2">
							<p>
						...
						<div id="export-excel">
							<table class="table table-bordered table-condensed">
								<thead>
									<tr>
										<th class="text-center"><spring:message code="swm.BWG"
												text="Bulk Waste Generator Name" /></th>
										<th width="310Px" class="text-center"><spring:message
												code="swm.BWG.address" text="Bulk Waste Generator Address" /></th>
