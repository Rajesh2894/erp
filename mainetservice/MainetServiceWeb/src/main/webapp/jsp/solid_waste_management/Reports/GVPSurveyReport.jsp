	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				<spring:message code="sw.GVP.report" text="Good Vigilance Practice Survey Report" />
			</div>
					...
					<div id="receipt">
						...
						<div class="col-xs-8 col-xs-8  text-center">
							<h2 class="text-large margin-bottom-0 margin-top-0 text-bold">
								...
								<spring:message code="sw.GVP.report"
									text="Good Vigilance Practice Survey Report" />
							</h2>
						</div>
						<div class="col-xs-2">
							<p>
						...
						<div id="export-excel">
							<table class="table table-bordered table-condensed">
								<thead>
									<tr>
										<th class="text-center"><spring:message code="swm.GVP"
												text="GVP Address" /></th>
