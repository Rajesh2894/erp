			...
			<form:form action="EmployeeInspection.html"
				...
				<div class="text-center padding-bottom-10">
					<button class="btn btn-success btn-submit"
						onclick="search('EmployeeInspection.html','search');">
					...
					<button type="button" class="btn btn-success add"
						onclick="add('EmployeeInspection.html','Add');">
				...
				<div class="table-responsive">
					<table summary="Dumping Ground Data"
						class="table table-bordered table-striped EmpIns">
						<thead>
							<tr>
								<th>Sr.No.</th>
								<th>ComplaintNo</th>
						...
						<tbody>
							<tr>
								...
								<td style="width: 10%"><button type="button"
										...
										onClick="getView('EmployeeInspection.html','view')"
									...
									<button type="button" class="btn btn-warning btn-sm"
										onClick="getEdit('EmployeeInspection.html','edit')"
