							...
							<div class="panel-body">
								<div class="form-group">
									<apptags:date fieldclass="datepicker"
										...
										datePath="vehicleFuellingDTO.vefDate"
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<apptags:date fieldclass="datepicker"
										...
										datePath="vehicleFuellingDTO.vefDmdate" cssClass="custDate"
										isDisabled="true">
									</apptags:date>
								</div>
							</div>
											...
											<td align="center">
												<div class="input-group">
													<form:input
														...
														cssClass="form-control hasDecimal text-right"
														readonly="true" onchange="sum()" id="multi${status.index}"
														disabled="true" />
												</div>
											</td>
										</tr>
					...
					<div class="table-responsive">
						<table class="table table-bordered table-striped" id="deleteDoc">
							<tr>
								...
								<%-- <th width="8%"><spring:message code="scheme.action" text=""></spring:message></th> --%>
							</tr>
