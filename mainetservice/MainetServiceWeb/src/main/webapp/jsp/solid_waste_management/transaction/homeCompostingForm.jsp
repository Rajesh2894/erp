			...
			<form:form action="HomeCompostingForm.html"
							...
							<div class="panel-body">
								<div class="form-group">
									<label class="control-label col-sm-2 required-control"> <spring:message
											code="swm.home.name.citizen"></spring:message>
									</label>
									<div class="col-sm-4">
									...
									<label class="control-label col-sm-2 required-control"> <spring:message
											code="swm.home.composting.address"></spring:message>
									</label>
									<div class="col-sm-4">
								...
								<div class="form-group">
									<label class="control-label col-sm-2 required-control"> <spring:message
											code="swm.home.composting.mobile"></spring:message>
									</label>
									<div class="col-sm-4">
									...
									<label class="control-label col-sm-2 required-control"> <spring:message
											code="swm.home.composting.select.date"></spring:message>
									</label>
									<div class="col-sm-4">
										...
										<thead>
											<tr>
												...
												<th><spring:message code=""
														text="Collected Wet Waste in Kg"></spring:message>
													<!-- <i
													class="text-red-1">*</i> --></th>
												<th><spring:message
				...
				<div class="text-center padding-top-20">
					<%-- <button type="button" class="btn btn-success btn-submit"
						onclick="saveHomeComposting(this)">
