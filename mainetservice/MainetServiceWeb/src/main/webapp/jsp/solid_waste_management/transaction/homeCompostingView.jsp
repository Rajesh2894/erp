								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<form:input path="masterDto.swName" type="text"
											class="form-control mandColorClass has" id="nameOfCitizen" disabled="true"/>
									</div>
									...
									<div class="col-sm-4">
										<form:input path="masterDto.swAddress" type="text"
											class="form-control mandColorClass" id="address" disabled="true"/>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<form:input path="masterDto.swMobile" type="text"
											class="form-control mandColorClass hasMobileNo" id="mobileNo" disabled="true"/>
									</div>
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-target="#a2" data-toggle="collapse" class="collapsed"
									...
									<spring:message code="" text="Wet Waste Composting" />
								</a>
							</h4>
						</div>
							...
							<div class="panel-body">
								...
								<div class="table-responsive">
									...
									<table id="wetWasteCompostingTable"
										...
										<tbody>
										<c:forEach items="${command.homeComposeDetailList}" var="data"
										varStatus="index">
											<tr class="firstWetWasteRow">
												...
												<td align="center"><form:select
														...
														cssClass="form-control mandColorClass" id="itemName${d}" disabled="true">
												...
												<td><form:input type="text" path="masterDto.homeComposeDetailList[${d}].swHomeCompCollection"
														class="form-control text-right hasNumber"
														id="collectedWetWaste${d}" disabled="true"></form:input></td>
												<td><form:input type="text" path="masterDto.homeComposeDetailList[${d}].swHomeCompPepared"
														class="form-control text-right hasNumber"
														id="compostPrepare${d}" disabled="true"></form:input></td>

												<td class="text-center">
												<a href="javascript:void(0);" data-toggle="tooltip"
													title="Add" data-placement="top"
													onclick="addEntryData('wetWasteCompostingTable');"
													class=" btn btn-success btn-sm" disabled="true"><i
														class="fa fa-plus-circle"></i></a>
												<a href="#" data-toggle="tooltip"
													data-placement="top" class="btn btn-danger btn-sm"
													onclick="deleteEntry($(this),'removedIds');" disabled="true"> <strong
