	...
	<div class="widget">
		...
		<div class="widget-content padding">
			...
			<form:form action="MRFMaster.html" name="MRFMaster" id="MRFMasterId"
				...
				<input id="MRFCFormId" type="hidden" value="MRFCEditForm"/>
				<div
					class="warning-div error-div alert alert-danger alert-dismissible"
					id="errorDiv" style="display: none;"></div>
				<input type="hidden" id="mrfcEditForm" value="MRFCEditForm"/>
				<h4>
					<spring:message code="swm.mrf.Plantdet" text="Plant Details" />
				</h4>
					<form:hidden path="PropertyActiveStatus" id="PropertyActiveStatus"/>
				<div class="form-group">
					<apptags:input labelCode="swm.mrf.plantId" path="mRFMasterDto.mrfPlantId" isReadonly="true"
				...
				<div class="form-group">
					...
					<apptags:date fieldclass="datepicker" labelCode="swm.mrf.dateOfOpr"
						datePath="mRFMasterDto.mrfDateOpen" isMandatory="false" readonly="true"
						cssClass="custDate mandColorClass">
					</apptags:date>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2 required-control "
						for="Decentralized"><spring:message code="swm.mrf.decentralised"
					...
					<div class="col-sm-4">
						<form:select path="mRFMasterDto.mrfDecentralised"
							...
							<form:option value="C" code=""><spring:message code="swm.mrf.centralise" text="Centralized" /></form:option>
							<form:option value="D" code=""><spring:message code="swm.mrf.decentralise" text="DeCentralized" /></form:option>
						</form:select>
					</div>
					<label class="control-label col-sm-2 required-control "
						for="Ownership"><spring:message code="swm.mrf.ownership" text="Ownership ?" /></label>
					<div class="col-sm-4">
						<form:select path="mRFMasterDto.mrfOwnerShip"
							...
							<form:option value="U" code=""><spring:message code="swm.mrf.ulb" text="ULB" /></form:option>
							<form:option value="O" code=""><spring:message code="swm.mrf.outsourcing" text="OutSourcing" /></form:option>
						</form:select>
					</div>
				</div>
				<div class="form-group">
					...
					<label class="control-label col-sm-2 required-control"
						for="DisposalSiteArea"><spring:message code="swm.mrf.reqPlantCap"
					...
					<div class="col-sm-4">
						<div class="input-group col-sm-12 ">
							...
							<span class="input-group-addon"><spring:message code="swm.mrf.MTPD"
									text="TPD" /></span>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="control-label col-sm-2  "
						for="Whether Part Of Intrigated Plant(Y/N)"><spring:message
							code="swm.mrf.wintegratedPlant" text="Whether Part Of Integrated Plant(Y/N)" /></label>
					<div class="col-sm-4">
						<form:select path="mRFMasterDto.mrfIsIntegratedPlant"
							cssClass="form-control" id="intrigatationId" onchange="changeIntegratedPlant()"
							data-rule-required="true">
							<form:option value="">
								<spring:message code="solid.waste.select" text="select" />
							</form:option>
							<form:option value="Y" code=""><spring:message code="solid.waste.Yes" text="Yes" /></form:option>
							<form:option value="N" code=""><spring:message code="solid.waste.No" text="No" /></form:option>
						</form:select>
					</div>
					<label class="control-label col-sm-2  "
						for="Integrated  With PlantId"><spring:message code="swm.mrf.integratedPlantId"
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<form:select path="mRFMasterDto.mrfIsrdf"
							cssClass="form-control chosen-select-no-results" id="rdfId" onchange="changeRDF()"
							data-rule-required="true">
							<form:option value="">
								<spring:message code="solid.waste.select" text="select" />
							</form:option>
				...
				<div class="form-group">
					<label class="control-label col-sm-2"
						for="Integrated With C&T(Y/N)"><spring:message code="swm.mrf.integtgratedC&T"
							text="Its Integrated with C&T (Y/N) " /></label>
					<div class="col-sm-4">
						<form:select path="mRFMasterDto.mrfIsctc"
							cssClass="form-control chosen-select-no-results" id="integratedCT" onchange="changeIntegratedCT()"
							data-rule-required="true">
							<form:option value="">
								<spring:message code="solid.waste.select" text="select" />
							</form:option>
					...
					<label class="control-label col-sm-2"
						for="Arrangement If Integrated"><spring:message code="swm.mrf.arrangemntIfIntegrated"
							...
							<table id="unitDetailTable"
								...
								<thead>
									<tr>
										...
										<th><spring:message code="route.master.vehicle.type" text="Vehicle Type" /></th>
										<th><spring:message code="swm.mrf.availCount" text="Available Count" /></th>
										<th><spring:message code="swm.mrf.reqCount" text="Required Count" /></th>
							...
							<table id="empDetailTable"
								...
								<thead>
									<tr>
										...
										<th><spring:message code="employee.verification.designation" text="Designation" /></th>
										<th><spring:message code="swm.mrf.availCount" text="Available Count" /></th>
										<th><spring:message code="swm.mrf.reqCount" text="Required Count" /></th>
								...
								<c:forEach var="employeeDet" items="${command.mRFMasterDto.tbSwMrfEmployeeDet}">
									<tr class="firstEmpRow">
										...
										<td><form:input type="text"
												...
												class="form-control text-right hasNumber" onchange="sum1()"
