			...
			<form:form action="PopulationMaster.html" name="PopulationMaster"
				...
				<div class="form-group">
					<label class="control-label col-sm-2 required-control" for="Year"><spring:message
							code="population.master.year" text="Year"></spring:message></label>
					<div class="col-sm-4">
					...
					<label class="control-label col-sm-2 required-control" for="Census"><spring:message
							code="population.master.population" text="Population" /></label>
					<div class="col-sm-4">
						<form:input path="populationMasterDTO.popEst" class="form-control"
