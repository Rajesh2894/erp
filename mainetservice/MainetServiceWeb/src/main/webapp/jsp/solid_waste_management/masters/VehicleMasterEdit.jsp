		...
		<div class="widget-content padding">
			...
			<form:form action="VehicleMaster.html" name="VehicleMaster"
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<form:input name="" path="vehicleMasterDTO.veRegNo" type="text" class="form-control "
							id="veReg"></form:input>
					</div>
				</div>
				<div class="form-group">
				...
				<div class=" form-group">
					...
					<div class="col-sm-4">
						...
						<form:option value="VGPS001"><spring:message
												code="vehicle.tracking.gps" text="Gps Based" /></form:option>
							<form:option value="VAPS002"><spring:message
												code="vehicle.tracking.app" text="App Based" /></form:option>
							<form:option value="VMAS003"><spring:message
												code="vehicle.tracking.manual" text="Mannual" /></form:option>
						</form:select>
					</div>
					...
					<div class="no hidebox">
						...
						<div class="form-group">
							<apptags:date fieldclass="date" labelCode="contract.mapping.contract.from.date"
								readonly="true" datePath="vehicleMasterDTO.veRentFromdate"
							...
							<apptags:date fieldclass="date" labelCode="contract.mapping.contract.to.date"
								readonly="true" datePath="vehicleMasterDTO.veRentTodate"
								isMandatory="true" cssClass="custDate mandColorClass">
							</apptags:date>
						</div>
						<div class="form-group">
