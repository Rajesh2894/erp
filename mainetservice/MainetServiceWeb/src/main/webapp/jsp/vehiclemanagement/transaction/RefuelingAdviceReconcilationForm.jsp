			...
			<form:form action="fuellingAdvice.html" name="RefuelingAdvice"
				...
				<div class="text-center padding-bottom-10">
					<button type="button" class="btn btn-blue-2"
						...
						onclick="searchVehicleFuelingReconcilationDetails('fuellingAdvice.html','searchVehicleFuelingReconcilationDetails')">
						<i class="fa fa-search"></i>
						<spring:message code="solid.waste.search" text="Search"></spring:message>
					</button>
					<button type="Reset" class="btn btn-warning" title='<spring:message code="solid.waste.reset" text="Reset" />' onclick="resetForm();">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									<apptags:input labelCode="fuelling.advice.invoiceNo"
										...
										isMandatory="true" onChange="isExistingInvoice()"
								...
								<div class="form-group">
									<apptags:input labelCode="fuelling.advice.invoiceAmount"
										...
										isMandatory="true" cssClass="hasDecimal text-right" isReadonly="true" />
																	<form:hidden path="vehicleFuelReconciationDTO.expenditureId"	id="expenditureId" /> 	<form:hidden path="vehicleFuelReconciationDTO.vendorId" 										id="vendorId" />
