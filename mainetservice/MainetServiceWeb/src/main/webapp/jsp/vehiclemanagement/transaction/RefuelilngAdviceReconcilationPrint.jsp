...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="fueling.advice.heading" text="Fuelling Advice Reconcilation" />
			</h2>
		</div>
									...
									<c:forEach items="${vehicleFuelReconcilationList}" var="item"
										...
										<tr>
											...
											<td><spring:eval
												...
												<td>${item.veNo}</td>
												<c:choose>
													<c:when test="${item.driverName ne 0}">
												...
												<td class="text-right"><c:set var="vefdCost"
														value="${item.vefdCost}"></c:set> ${vefdCost}</td>
