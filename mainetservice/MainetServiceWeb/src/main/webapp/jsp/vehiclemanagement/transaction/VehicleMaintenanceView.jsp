			...
			<form:form action="vehicleMaintenanceMgmt.html" name="VehicleMaintenance"
				...
				<div class="form-group">
					...
					<apptags:date fieldclass="datepicker"
						...
						cssClass="custDate mandColorClass" readonly="true" isDisabled="true">
					</apptags:date>
				</div>
							...
							<div class="panel-body">
								...
								<div class="form-group">
									<apptags:date fieldclass="datepicker"
										...
										cssClass="custDate" isMandatory="true" isDisabled="true">
									</apptags:date>
								...
								<div class="form-group">
									<apptags:textArea labelCode="vehicle.maintenance.remark"
										path="vehicleMaintenanceDTO.vemReason" isDisabled="true"></apptags:textArea>
								</div>
										...
										<c:forEach items="${command.attachDocsList}" var="lookUp">
											<tr>
												...
												<td><apptags:filedownload filename="${lookUp.attFname}"
														filePath="${lookUp.attPath}" actionUrl="vehicleMaintenanceMgmt.html?Download" /></td>
											</tr>
