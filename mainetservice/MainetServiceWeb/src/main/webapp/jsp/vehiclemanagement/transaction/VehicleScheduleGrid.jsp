...
<div class="widget">
	<div class="widget-header">
		<h2>
			<strong><spring:message code="vehicle.collection.scheduling"
								...
								<tr>
									...
									<td class="text-center">
										<button type="button" class="btn btn-blue-2 btn-sm"
											title="View"
											onclick="modifyVehicleScheduling(${vehiclescheduling.vesId},'vehicleScheduling.html','ViewVehicleScheduling','V')">
											<i class="fa fa-eye"></i>
										</button>
										<button type="button" class="btn btn-warning btn-sm margin-top-5 margin-bottom-5"
											title="Edit"
											onclick="modifyVehicleScheduling(${vehiclescheduling.vesId},'vehicleScheduling.html','EditVehicleScheduling','E')">
											<i class="fa fa-pencil"></i>
										</button>
										<button type="button" class="btn btn-danger btn-sm"
											title="Delete"
											onclick="deletevehicleScheduling(${vehiclescheduling.vesId},'vehicleScheduling.html','DeleteVehicleScheduling')">
