		...
		<div class="widget-content padding">
			<form:form action="vehicleScheduling.html"
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<form:select path="vehicleScheduleDto.veId" id="veDriverName"
							class="form-control chosen-select-no-results" label="Select">
							<form:option value="0">
								<spring:message code="solid.waste.select" text="select" /></form:option>
							<c:forEach items="${command.employeeBeanList}" var="lookup">
				...
				<div class="text-center clear padding-10">
					<button type="button" class="btn btn-blue-2"
						onclick="searchVehicleScheduling('vehicleScheduling.html', 'SearchVehicleScheduling');">
