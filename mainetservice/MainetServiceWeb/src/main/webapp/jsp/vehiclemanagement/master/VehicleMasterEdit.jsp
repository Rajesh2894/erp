	...
	<div class="widget">
		...
		<div class="widget-content padding">
			...
			<form:form action="veMasterCon.html" name="VehicleMaster"
				...
				<form:input name="" type="hidden" id="veId"
					path="vehicleMasterDTO.veId" />
				...
				<div class="form-group">
					<c:if test="${command.vehicleMasterDTO.veFlag eq 'Y'}">
						...
						<label class="col-sm-2 control-label" for=""><spring:message
								code="vehicle.master.vehicle.status" text="Status" /> </label>
						<div class="col-sm-4">
							...
							</label> </label> <label class="radio-inline "> <form:radiobutton
									id="status3" path="vehicleMasterDTO.veActive" value="S" /> <spring:message
									code="" text="Scrap" />
							</label>
						</div>
					</c:if>
					...
					<div class="no hidebox">
						<div class="form-group">
							...
							<apptags:input labelCode="vehicle.rent"
								...
								maxlegnth="15" cssClass="hasDecimal" />
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<form:textarea name="" path="vehicleMasterDTO.veRemarks" cols=""
							maxLength="250" rows="" class="form-control" id="Remarks"></form:textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<form:select path="vehicleMasterDTO.deptId"
							...
							data-rule-required="true" onchange="getEmployeeByDept(this);">
							<form:option value="">
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="Remarks"><spring:message
