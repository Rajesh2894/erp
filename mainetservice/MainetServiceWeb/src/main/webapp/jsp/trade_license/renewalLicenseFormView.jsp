									...
									<div class="form-group">
										...
										<label class="col-sm-2 control-label required-control"
											for="RenewallicenseToPeriod"><spring:message
												code="license.details.licenseToPeriod" text="Renewal License To Period" /></label>
										<div class="col-sm-4">
											<div class="input-group">
												<form:input class="form-control mandColorClass datepicker"
										...
										<thead>
											...
											<tr>
												<apptags:lookupFieldSet baseLookupCode="ITC" hasId="true"
													...
													columnWidth="20%" />
                                               <th width="20%"><spring:message code="license.details.item.value" text="Item Value"/></th> 
