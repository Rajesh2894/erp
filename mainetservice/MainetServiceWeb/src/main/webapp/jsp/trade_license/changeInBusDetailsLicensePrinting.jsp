...
<script type="text/javascript"
	src="js/trade_license/changeInBusDetailsPrinting.js"></script>
				...
				<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
					...
					<div class="row margin-top-10 clear">
						...
						<c:forEach
							...
							varStatus="status" var="owername">						
								<c:if test="${owername.troPr eq 'A'}">
									<p>
										<b><c:out value="${owername.troName}" /></b>
									</p>
								</c:if>
				...
				<div class="col-sm-10 col-xs-10 col-md-10 col-lg-10">
					...
					<div class="row margin-top-10 clear">
						...
						<div class="col-sm-3 col-md-3 col-xs-3">
							<p>
								<spring:message code="" text="Receipt No." />
						...
						<div class="col-sm-3 col-md-3 col-xs-3">
							<p>
								<spring:message code="" text="Receipt Date" />
