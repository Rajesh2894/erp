										...
										<thead>
											...
											<tr>
												...
												<c:if test="${dd gt 0 && dd ne null }">
													<th width="20%"><spring:message code="trade.item"
															text="Item Value" /></th>
												</c:if>
											</tr>
										</thead>
										...
										<tbody>
											<tr align="left">
												<td width="150px" rowspan="2"><spring:message
														code="trade.license.type"
														text="License Type/License Category" /></td>
												<td colspan="2"><spring:message code="trade.fees.det"
														text="Fees Details" /></td>
											</tr>
											<tr>
												<td><spring:message code="trade.type" text="Type" /></td>
												<td><spring:message code="trade.amount"
														text="Amount (Rs.)" /></td>
											</tr>
											...
											<tr>
												<td colspan="2"><spring:message code="trade.total.fees"
														text="Total Fees (Rs.)" /></td>
