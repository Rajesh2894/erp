...
<script type="text/javascript"
	src="js/trade_license/transferLicenseApproval.js"></script>
	...
	<div class="content">
		<div class="widget">
			<div class="widget-header">
				...
				<apptags:helpDoc url="TransferLicenseApprovalReprinting.html"></apptags:helpDoc>
			</div>

			<div class="widget-content padding">

				<form:form method="POST"
					action="TransferLicenseApprovalReprinting.html"
					class="form-horizontal" id="LicenseApprovalReprinting"
					name="LicenseApprovalReprintingForm">
							...
							<div id="Additional_Owners" class="panel-collapse collapse in">
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<form:input path="serviceMaster.smServiceName" type="text"
												class="form-control" readonly="true" />
										</div>
										<label class="col-sm-2 control-label"><spring:message
												code="master.loi.app.num" text="Application Number" /></label>
										<div class="col-sm-4">
											<form:input path="tradeDetailDTO.apmApplicationId"
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<form:input path="tradeDetailDTO.trdOwnerNm" type="text"
												class="form-control" readonly="true" />
										</div>
										<label class="col-sm-2 control-label"><spring:message
												code="master.loi.applicant.mob" text="Applicant Mobile No" /></label>
										<div class="col-sm-4">
											<form:input path="tradeDetailDTO.mobileNo" type="text"
												class="form-control" readonly="true" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label"><spring:message
												code="master.loi.applicant.email" text="Applicant Email Id" /></label>
										<div class="col-sm-4">
											<form:input path="tradeDetailDTO.emailId" type="text"
												class="form-control" readonly="true" />
										</div>
									</div>
								</div>
										...
										<thead>
											...
											<tr>
												<apptags:lookupFieldSet baseLookupCode="ITC" hasId="true"
													...
													columnWidth="20%" />
												<th width="60%"><spring:message code="trd.item.val"
														text="Item Value" /></th>
												<%-- 
						...
						<div class="padding-top-10 text-center">
							<c:if test="${command.viewMode ne 'H'}">
								<button type="button" class="btn btn-success" id="submitForm"
									onclick="transferLicenseNumber(this);">
									<spring:message code="trade.transfer.approval.print"
