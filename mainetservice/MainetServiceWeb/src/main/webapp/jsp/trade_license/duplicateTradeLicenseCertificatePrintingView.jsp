...
<div class="content animated slideInDown">
	<div class="widget invoice" id="receipt">
		<div class="widget-content padding">
			<form:form action="DuplicateLicensePrinting.html" class="form-horizontal"
				name="duplicateLicensePrinting" id="tradeLicenseReportPrinting">
				...
				<div class="row">
					...
					<div class="col-xs-6 col-sm-6 text-center">
						...
						<h3 class="text-center margin-top-20"><spring:message code="" text="(Duplicate License Copy)"/></h3>
						<%-- <p>
							<spring:message code=""
				...
				<div class="col-sm-10 col-xs-10 col-md-10 col-lg-10">
					<div class="row margin-top-10 clear">
						...
						<div class="col-sm-8 col-xs-8 text-left ">
							<p>
								From Date <b>${command.licenseFromDateDesc}</b> &nbsp&nbsp&nbsp     End Date <b>${command.tradeDetailDTO.licenseDateDesc}</b>
							</p>
						</div>
					</div>
