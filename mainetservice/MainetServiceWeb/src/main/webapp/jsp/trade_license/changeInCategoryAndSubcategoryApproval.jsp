...
<script type="text/javascript"
	src="js/trade_license/changeInCategoryAndSubcategoryApproval.js"></script>
	...
	<div class="content">
		<div class="widget">
			...
			<div class="widget-content padding">
				...
				<form:form method="POST" action="ChangeInCategorySubcategoryPrinting.html"
					class="form-horizontal" id="ChangeInCategorySubcategoryApproval"
					name="ChangeInCategorySubcategoryApproval">
										...
										<thead>
											...
											<tr>
												...
												<%-- <th width="8%"><spring:message code="trade.rate"></spring:message><span
														class="mand">*</span></th> --%>
												<th width="8%"><spring:message code="trade.item.value"></spring:message></th>
											</tr>
										</thead>
						...
						<div class="padding-top-10 text-center">
							<c:if test="${command.viewMode ne 'H' }">
								<button type="button" class="btn btn-success" id="submitForm"
									...
									<spring:message code="" text="ReprintLicense" />
								</button>
							</c:if>
