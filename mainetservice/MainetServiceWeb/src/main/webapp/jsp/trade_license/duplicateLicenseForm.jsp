...
<script type="text/javascript"
	src="js/trade_license/duplicateLicenseForm.js"></script>
			...
			<div class="widget-content padding">
				...
				<form:form action="DuplicateLicenseForm.html"
					...
					<div class="panel-group accordion-toggle"
						...
						<c:if
							test="${command.checklistCheck ne null && command.checklistCheck eq 'Y'}">
						...
						<c:if
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
								<fmt:formatNumber type="number" value="${command.offlineDTO.amountToShow}" pattern="#,###" var="amt"/>
									<form:input class="form-control" path=""
										value="${amt}" maxlength="12"
						...
						<c:if
							test="${command.licenseDetails ne null && command.paymentCheck eq null}">
							<div class="padding-top-10 text-center">
