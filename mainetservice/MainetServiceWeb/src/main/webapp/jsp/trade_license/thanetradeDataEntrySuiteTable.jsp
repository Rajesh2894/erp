...
<script type="text/javascript" src="js/trade_license/tradeOwnerThaneDataEntrySuite.js"></script>
<style>
	.hasWidth30{
		width:32%;
				...
				<c:choose>
					...
					<c:otherwise>
						<tr class="appendableClass">
							...
							<spring:message code='trade.lic.firstName' var="tradeFirstName" />
							<spring:message code='trade.lic.middleName' var="tradeMiddleName" />
							<spring:message code='trade.lic.lastName' var="tradeLastName" />
							
							<td><form:input
										path="command.tradeMasterDetailDTO.tradeLicenseOwnerdetailDTO[${d}].ownFname"
										type="text" placeholder="${tradeFirstName}"
										disabled="${command.viewMode eq 'V' ? true : false }"
										class="form-control unit required-control hasSpecialChara hasWidth30"
										id="troFirstName${d}" />
										<form:input
										path="command.tradeMasterDetailDTO.tradeLicenseOwnerdetailDTO[${d}].ownMname"
										type="text" placeholder="${tradeMiddleName}"
										disabled="${command.viewMode eq 'V' ? true : false }"
										class="form-control unit required-control hasSpecialChara hasWidth30"
										id="troMiddleName${d}" />
										<form:input
										path="command.tradeMasterDetailDTO.tradeLicenseOwnerdetailDTO[${d}].ownLname"
										type="text" placeholder="${tradeLastName}"
										disabled="${command.viewMode eq 'V' ? true : false }"
										class="form-control unit required-control hasSpecialChara hasWidth30"
										id="troLastName${d}" />
							</td>
