...
<script src="js/masters/connectionsize/connectionSizeScript.js"></script>
...
<div id="heading_wrapper" class="content">
	...
	<form:form  method="post" name=""  class="form-horizontal">
			...
			<div class="text-right padding-bottom-10">
					<a class="btn btn-success pullright addConnectionClass" ><i class="fa fa-plus-circle"></i> <spring:message code="water.add"/></a>
				</div>
			<div class="table">
