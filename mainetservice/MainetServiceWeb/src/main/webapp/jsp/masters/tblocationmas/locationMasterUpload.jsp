...
<div xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<script type="text/javascript" src="js/masters/tblocationmas/locationMasterUpload.js"></script>
	<script type="text/javascript" src="js/masters/tblocationmas/locationList.js"></script>
	...
	<div class="widget" id="widget">
		<div class="widget-header"
			<h2>
				<spring:message code="locationMas.locationMaster" text="Location Master" />
			</h2>
		...
		<div class="widget-content padding">
			...
			<!-- modelAttribute="tbAcVendormaster" -->
			<form:form class="form-horizontal" id="tbLocationMaster"
				 cssClass=" form-horizontal"
				method="POST" action="LocationMas.html">
				...
				<!------------------------- Upload Excel File and Download Template start --------------------------->
				<div class="form-group text-center" id="reload">
					...
					<div class="col-sm-3 text-left">
						...
						<small class="text-blue-2"><spring:message
							code="locationMas.excel.filesize" text="(Upload Excel upto 5MB )" /></small>
					</div>
					...
					<div class="col-sm-3 text-left">
						<button type="button" class="btn btn-success save"
							name="button-Cancel" value="export" onclick="downloadTemplate();"
							id="import">
							<spring:message code="locationMas.excel.downloadTemplate" text="Download Template" />
						</button>
					</div>
					<form:hidden path="uploadFileName" id="filePath" />
				</div>
				<!------------------------- Upload Excel File and Download Template end--------------------------->
				...
				<div class="text-center padding-top-20" id="savebutton">
					...
					<input type="button" class="btn btn-danger"
							onclick="javascript:openRelatedForm('LocationMas.html');"
