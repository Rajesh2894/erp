...
<script type="text/javascript" src="js/dms/kmsViewDocument.js"></script>
...
<div class="content">
	...
	<div class="widget">
		...
		<div class="widget-content padding">
			...
			<!-- Start Form -->
			<form:form action="KmsViewDocument.html" method="POST"
				...
				<div class="form-group">
					<apptags:lookupFieldSet baseLookupCode="KTD" hasId="true"
				...
				<div class="form-group">
					<apptags:input labelCode="dms.enterValue" path="metadataValue"
						cssClass="alphaNumeric" maxlegnth="50" />
					<div class="form-group">
						<label class="col-sm-2 control-label "> <spring:message
								code="" text="Document Type"></spring:message>
						</label>
						<div class="col-sm-4">
							<form:select id="docType" path="" cssClass="form-control"
				...
				<div class="text-center clear padding-10">
					...
					<button type="button" class="btn btn-warning" title="Reset"
						onclick="window.location.href='KmsViewDocument.html'">
								...
								<tbody>
									<c:forEach items="${command.dmsDocsMetadataDto}" var="dto"
										...
										<tr>
											...
											<td class="text-center"><c:set var="docNameStr"
													value="${dto.dmsDocName}"></c:set> <c:set var="docIdStr"
													value="${dto.dmsDocId}"></c:set> <c:choose>
													<c:when test="${fn:contains(docNameStr, ',')}">
														...
														<c:forEach items="${docNameSplitStr}" var="docName"
															...
															<apptags:filedownload filename="${docName}"
																...
																actionUrl="KmsViewDocument.html?Download" filePath="" />
															<br />
														</c:forEach>
													</c:when>
													<c:otherwise>
