...
<script type="text/javascript" src="js/dms/viewRetentionDetails.js"></script>
...
<div class="content">
	...
	<div class="widget">
		<div class="widget-header">
			<h2>
				<strong><spring:message code=""
						text="View Retention Documents" /></strong>
			</h2>
		</div>
		<div class="widget-content padding">
			...
			<!-- Start Form -->
			<form:form action="ViewRetentionDetails.html" method="POST"
				...
				<div class="text-center clear padding-10">
					...
					<button type="button" class="btn btn-warning" title="Reset"
						onclick="window.location.href='ViewRetentionDetails.html'">
				...
				<c:if test="${command.dmsRetentionDtoList ne null}">
					<div class="table-responsive">
						<div class="table-responsive margin-top-10">
							<table class="table table-striped table-condensed table-bordered"
								...
								<tbody>
									<c:forEach items="${command.dmsRetentionDtoList}" var="dto"
										varStatus="loop">
										<tr>
											...
											<td>
												<table
													...
													<c:forEach items="${dto.dmsRetentionDetDtoList}"
														var="detList">
														...
														<c:when test="${fn:contains(docNameStr, ',')}">
															...
															<c:forEach items="${docNameSplitStr}" var="docName"
																...
																<apptags:filedownload filename="${docName}"
																	...
																	actionUrl="ViewRetentionDetails.html?Download"
																	filePath="" />
																<br />
															</c:forEach>
														</c:when>
