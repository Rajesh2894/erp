...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2><spring:message code="NOC.service.name"
						text="NOC for Other Govt. Department" /></h2>
		</div>
		...
		<div class="widget-content padding">
			...
			<form:form action="NOCForOtherGovtDept.html" method="post"
				class="form-horizontal" name="NOCApplicationForm"
				id="NOCApplicationForm">
				...
				<h4 class="margin-top-0">
					<spring:message code="NHP.applicant.detail"
				...
				<div class="form-group">
					...
					<apptags:lookupFieldSet cssClass="form-control required-control"
						...
						pathPrefix="noCforOtherGovtDeptDto.cfcWard"
