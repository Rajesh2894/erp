								...
								<table class="table table-hover table-bordered table-striped">
									<tbody>
										<tr>
											...
											<th><spring:message code="CFC.document.group"
													text="Document Group" /></th>
											<th><spring:message code="CFC.document.status"
													text="Document Status" /></th>
											<th><spring:message code="CFC.document.upload"
						...
						<div class="form-group margin-top-10">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control"
									...
									href="rtsService.html?showChargeDetails"> <spring:message
