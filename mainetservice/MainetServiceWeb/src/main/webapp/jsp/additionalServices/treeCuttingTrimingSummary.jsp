	...
	<div class="widget">
		...
		<div class="widget-content padding">
			<form:form action="TreeCuttingTrimmingPermission.html" method="post"
				class="form-horizontal" name="TreeCuttingTrimmingPermissionSummary"
				id="TreeCuttingTrimmingPermissionSummary">
				...
				<h4 class="margin-top-0">
					<spring:message code="TCP.service.name"
						text="Tree Cutting Trimming Permission" />
				</h4>
				...
				<div class="table-responsive" id="export-excel">
					<div class="table-responsive margin-top-10">
						<table class="table table-striped table-condensed table-bordered"
							...
							<tbody>
								<c:forEach items="${command.cutingTrimingSummaryDtos}"
									...
									<tr>
										...
										<td class="text-center">
											...
											<button type="button" class="btn btn-blue-2 btn-sm"
												...
												onclick="viewTreeInfoData('TreeCuttingTrimmingPermission.html','viewTreeCuttingInfo','${data.appId}')">
												<i class="fa fa-eye"></i>
