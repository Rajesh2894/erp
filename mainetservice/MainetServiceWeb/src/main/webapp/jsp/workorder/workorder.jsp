...
$(document).ready(function() {
	 ...
	 $("#Submit").click(function () {
		 ...
		 if (!checkedNum) {
			 var remark=getLocalMessage("water.order.select.remark");
			 var errMsg = '<div class="closeme">	<ul><li><img alt="Close" title="Close" src="css/images/close.png" onclick="closeErrBox()" width="32"/>'+ remark +'</li></ul></div>';
			...
			$.ajax({
				...
				type: 'POST',
				 success : function(response) {						
					...
					record = record.replace(/%2F/gi, "/");
					var successMessage = getLocalMessage("Work.order.successfully.generated.for.application.number")+" "+record;
					showConfirmBox(successMessage);
				},
...
function proceed() {
 ...
 <ol class="breadcrumb">
      ...
      <li><spring:message code="water.order.work.view" text="Work Order View"></spring:message></li>
    </ol>
    <!-- ============================================================== --> 
    <!-- Start Content here --> 
    <!-- ============================================================== -->
    <div class="content"> 
      ...
      <div class="widget">
        <div class="widget-header">
          <h2><spring:message code="water.order.work.view" text="Work Order View"></spring:message></h2>
        ...
        <div class="mand-label clearfix">
		 ...
		 <div class="error-div alert alert-danger alert-dismissible"
          ...
          <form:form action="WorkOrder.html?create" modelAttribute="tbWorkOrder" name="tbWorkOrder" method="POST" class="form-horizontal" id="workOrderForm">
           ...
           <label class="col-sm-2 control-label"><spring:message code="onl.loi.serviceName"/></label>
            ...
            <div class="form-group">
              ...
              <c:choose>
              <c:when test="${not empty ref_No}">
              	<div class="col-sm-4">
               <input name="woApplicationId" type="text" class="form-control" value="${ref_No}" readonly="readonly">
              </div>
              </c:when>
              <c:otherwise>
              <div class="col-sm-4">
            ...
            <div class="form-group">
					<label class="col-sm-2 control-label"> <spring:message code="work.order.plumber.name"
							 text="Plumber Name" /></label>
					<div id="ulbPlumber">
						<div class="col-sm-4">
							 <form:select path="PlumId" class="form-control chosen-select-no-results"
								id="plumber">
								 <form:option value="">
									<spring:message code="water.dataentry.select" />
								</form:option>
								<c:forEach items="${plumberList}" var="lookUp">
             ...
             <h4> <spring:message code="Remarks.According.To.Deparment.And.Service" text="Remarks According To  Deparment And Service"></spring:message></h4>
             <div class="mand-label clearfix">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-condensed">
                <tr>
                  <th width="100"><spring:message code="water.uploadDoc.srNo" text="Sr. No."></spring:message></th>
                  <th><spring:message code="water.remark" text="Remarks"></spring:message></th>
                  <th width="50"><label class="padding-left-20 margin-bottom-10"><input type="checkbox" name="All" id="selectall" class="pull-left"><spring:message code="all" text="All"></spring:message></label></th>
                </tr>
            ...
            <div class="text-center margin-top-10">
                ...
                <input type="button" value="<spring:message code="water.btn.back"/>"
