		...
		$(document).ready(
				function() {
					$("#report-table").dataTable({
						...
						"lengthChange" : true,
						"columnDefs": [
							  {bSortable: false, targets: [0,1,7,8]}
							]
					});
				});
			...
			<form:form action="" method="get">
				<div class="row">
					  ...
					  <div class="col-xs-11 col-sm-11"> 	
						...
						<div class="col-xs-12 col-sm-12 margin-left-20">
				...
				<div id="export-excel">
					<div class="table-responsive margin-top-10">
						<table class="table table-bordered margin-bottom-10"
							...
							<thead>
								<tr>
                                    <th class="text-center" width="5%"><spring:message code="care.srno" text="Sr. No." /></th>  
									...
									<th class="text-center" width="10%" data-sortinitialorder="asc"><spring:message
											code="care.Dept.reports.address" text="Address" /></br>
						...
						<!-- 	<tfoot>
							...
							<c:set var="rowCount" value="0" scope="page" /> 
								<c:forEach items="${command.complaintReport.complaints}" var="complaint" varStatus="status">
									<tr>
									  <%-- <td style="text-align: center;"><c:set var="rowCount" value="${rowCount+1}"
                                        ...
                                        <td><c:out
												value="${complaint.referenceMode}"></c:out></td>    
										<%-- <td style="text-align: center;"><c:out
												value="${complaint.codIdOperLevel1}"></c:out></td> --%>
										<%-- <td style="text-align: center;"><c:out
												value="${complaint.codIdOperLevel2}"></c:out></td> --%>
										...
										<td><c:out
												value="${complaint.locNameEng}"></c:out> <c:out
												value="${complaint.pincode}"></c:out></br>
											<c:out
												value="${complaint.apaMobilno}"></c:out></br>
										    <c:out
												value="${complaint.apaEmail}"></c:out></td>		
										<%-- <td style="text-align: center;"><c:out
