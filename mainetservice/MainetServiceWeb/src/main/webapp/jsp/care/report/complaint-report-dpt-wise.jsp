          ...
          <form:form action="" method="get">
						...
						<c:otherwise>
                     	...
                     	<div class="col-xs-12 col-sm-12">
				            ...
				            <div class="row margin-top-5 margin-left-5 label-text">
				            	...
				            	<div class="col-xs-3 col-sm-3"><%=(new java.util.Date()).toLocaleString()%></div>
				            </div>
				         </div>     
			    </div>        
            </div> 
            ...
            <div class="table-responsive margin-top-10">
              <table class="table table-bordered margin-bottom-10" id="report-table">
              	<div class="excel-title" id='tlExcel'>${command.complaintReport.title}</div>
              		<thead>
	               		<tr>
	               		 ...
	               		 <%-- <c:if test="${command.complaintReport.showDepartment}"> 
		                  	<th class="text-center" width="8%"  data-sortinitialorder="asc"><spring:message code="care.reports.department" text="Department"/></th>
		                  </c:if>  --%>
		              ...
		              <%--     <c:set var="prefix" value="${command.prefixName}"></c:set>
		                 ...
		                 <th  class="text-center" width="3%" style="vertical-align: middle;"><spring:message code="care.reports.SrNo" text="Sr. No."/></th>
		                 <th class="text-center"  width="8%"  data-sortinitialorder="asc"><spring:message code="care.reports.department" text="Department"/></th>
		                  <th class="text-center" width="8%" data-sortinitialorder="asc"><spring:message code="care.Dept.reports.zone" text="Ward karyalaya"/></th>
		                  <th class="text-center" width="3%" data-sortinitialorder="asc"><spring:message code="care.Dept.reports.ward" text="Ward "/></th>
		                  <th class="text-center"  width="8%" data-sortinitialorder="asc"><spring:message code="care.reports.complaintType" text="Complaint Type"/></th>
		                   <th class="text-center"  width="8%"  data-sortinitialorder="asc"><spring:message code="care.reports.complaintDesc" text="Complaint Description"/></th>
		                   <th class="text-center" width="6%" data-sortinitialorder="asc"><spring:message code="care.reports.daysAssignedForResolution" text="No. of Days assigned for resolution"/></th>
		                 <th class="text-center"  width="8%" data-sortinitialorder="asc"><spring:message code="care.reports.tokenNo" text="Complaint Number"/></th>
		                  <th class="text-center"  width="8%" data-sortinitialorder="asc"><spring:message code="prop.rec.print.app.no" text="Application Number"/></th>
		                  <th class="text-center" width="8%" data-sortinitialorder="asc"><spring:message code="care.reports.dateOfRequest" text="Date of Request"/></th>
		                 <th class ="text-center" width="8%" data-sortinitialorder="asc"><spring:message code="care.Dept.reports.applicantName" text="Applicant Name"/></th>
		                 <th class="text-center"  width="8%" data-sortinitialorder="asc"><spring:message code="care.Dept.reports.address" text="Address"/></br>
		                 																<spring:message code="care.Dept.reports.mobileNumber" text="Mobile Number"/></br>
		                 																<spring:message code="care.Dept.reports.email" text="Email Id"/></th>
		                  <%-- <th class ="text-center" width="8%" data-sortinitialorder="asc"><spring:message code="care.Dept.reports.mobileNumber" text="Mobile Number"/></th>
		                  <th class ="text-center" width="8%" data-sortinitialorder="asc"><spring:message code="care.Dept.reports.email" text="Email Id"/></th> --%>
		                   <th class="text-center" width="8%" data-sortinitialorder="asc"><spring:message code="care.reports.status" text="Complaint Status"/></th>
     		...
     		<%-- 			 	<c:if test="${not empty prefix}">
     					 	...
     					 	<%-- <c:if test="${command.complaintReport.showDepartment}"> 
     					 		<td ><c:out value="${complaint.departmentName}"></c:out></td> 	</c:if> --%>
     					 	<td class="text-center">${status.index + 1}</td>	
     					 	<td><c:out value="${complaint.departmentName}"></c:out></td>
     				
                           <td><c:out value="${complaint.codIdOperLevel1}"></c:out></td>
     					 	<td><c:out value="${complaint.codIdOperLevel2}"></c:out></td>
     					 	<td><c:out value="${complaint.comlaintSubType}"></c:out></td>
     					     <td><c:out value="${complaint.complaintDesc}"></c:out></td> 
     					 <%-- 	<td style="text-align: center;"><c:out value="${complaint.slaDuration}"></c:out></td> --%>
     					   ...
     					   <td data-sortinitialorder="desc"><c:out value="${complaint.complaintId}"></c:out></td>
     					 	<td data-sortinitialorder="desc"><c:out value="${complaint.applicationId}"></c:out></td>
     					    ...
     					    <td><c:out value="${complaint.apmName}"></c:out></td>
     					 	...
     					 	<%-- <td style="text-align: center;">
     					 	<c:out value="${complaint.locNameEng}"></c:out>
     					 	<c:out value="${complaint.pincode}"></c:out>
     					 	</td>
     					 	
     					 	<td style="text-align: center;"><c:out value="${complaint.apaMobilno}"></c:out></td>
     					   <td style="text-align: center;"><c:out value="${complaint.apaEmail}"></c:out></td> --%>
     					   <td>
     					 	<c:out value="${complaint.locNameEng}"></c:out>
     					 	<c:out value="${complaint.pincode}"></c:out></br>
     					 	<c:out value="${complaint.apaMobilno}"></c:out></br>
     					 	<c:out value="${complaint.apaEmail}"></c:out></td>
     					    <td style="text-align: center;"><c:out value="${complaint.status}"></c:out></td>
     					 	</tr>
      				</c:forEach>
     				</tbody>
             ...
             <div class="text-center margin-top-10 remove-btn">
              ...
              <button type="button" class="btn btn-warning hidden-print" onclick="javascript:openRelatedForm('GrievanceReport.html?grievanceDeptWise','this');"><spring:message code="care.back" text="Back"/></button>
            </div> 
          </form:form>
          <style>
				@media print {
