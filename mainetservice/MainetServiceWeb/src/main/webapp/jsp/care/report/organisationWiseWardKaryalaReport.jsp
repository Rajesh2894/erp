...
<script type="text/javascript" src="js/care/careBirtReport.js"></script>
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="care.organisation.statistics.report"
					text="Ward Karyalaya Wise Report" />
		...
		<div class="widget-content padding">
			...
			<form:form action="CareReportBirtForm.html"
				cssClass="form-horizontal" id="careReports">
				...
				<div class="form-group">
					...
					<div class="radio col-sm-4 margin-top-5">
						...
						<label> <form:radiobutton
								path="careReportRequest.reportName" value="D" id="detailUlb"
								onclick="getReportType(this)" /> <spring:message
								code="care.stats.detail" text="Detail" /></label> <label> <form:radiobutton
								path="careReportRequest.reportName" value="S" id="summaryUlb"
								onclick="getReportType(this)" /> <spring:message
