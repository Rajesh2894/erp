...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="care.district.statistics.report"
					text="District Wise Statistics Report" />
			</h2>
		</div>
		<div class="widget-content padding">
			...
			<form:form action="CareReportBirtForm.html"
				cssClass="form-horizontal" id="careDistrictReports">
