...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="care.departmentWise.statistics.report"
					text="Department Wise Complaint Summary Report" />
			</h2>
		</div>
		<div class="widget-content padding">
			...
			<form:form action="CareReportBirtForm.html"
				cssClass="form-horizontal" id="careDeptReports">
