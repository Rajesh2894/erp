          ...
          <form:form action="" method="get">
			 ...
			 <div class="row">
	            ...
	            <div class="row margin-top-10  padding-left-10-per">
					...
					<%-- 	<p class="margin-bottom-0 margin-top-0 padding-top-5">
						...
						<p><spring:message code="care.reports.generatedBy" text="Generated By"/>: ${userSession.employee.empname} ${userSession.employee.empmname} ${userSession.employee.emplname}</p>
            ...
            <div class="table-responsive margin-top-10">
              <table class="table table-bordered margin-bottom-10 care-exl-export" id="report-table">
              		...
              		<thead>
	               		<tr>	               		
		                 <th  class="text-center" width="8%" style="vertical-align: middle;"><spring:message code="care.reports.SrNo" text="Sr. No."/></th>
		                 <th class="text-center"  width="8%"  data-sortinitialorder="asc"><spring:message code="care.reports.department" text="Complaint Type"/></th>
		                  <th class="text-center"  width="10%" data-sortinitialorder="asc"><spring:message code="care.reports.complaintType" text="Complaint Sub Type"/></th>
		                   <th class="text-center"  width="10%"  data-sortinitialorder="asc"><spring:message code="care.total.noOf.complaint" text="Total Number of Complaints"/></th>
		                </tr>
	                </thead>
	                ...
	                <tbody>
     				...
     				<c:forEach items="${command.complaintReport.complaintList}" var="complaint" varStatus="status">
     					<tr>
      				       ...
      				       <c:set var="totalCount" value="${totalCount + complaint.totalnoOfComplaints}" scope="page" />
      				</c:forEach>
     				</tbody>
     				<tfoot>
