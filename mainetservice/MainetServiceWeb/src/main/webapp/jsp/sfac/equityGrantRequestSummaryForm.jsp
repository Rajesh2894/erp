...
<div class="content animated top">
	<div class="widget">
		<div class="widget-header">
			...
			<apptags:helpDoc url="EquityGrantRequest.html"></apptags:helpDoc>
		</div>

		<div class="widget-content padding">
			<form:form id="EquityGrantRequestSummaryForm" action="EquityGrantRequest.html"
				...
				<div class="text-center margin-bottom-10">
					...
					<button type="button" class="btn btn-warning" title="Reset"
						onclick="window.location.href='EquityGrantRequest.html'">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped"
						...
						<tbody>
							<c:choose>
											<c:when test="${fn:length(command.equityGrantMasterDtos)>0 }">
							<c:forEach items="${command.equityGrantMasterDtos}"
								...
								<tr>
									...
									<td class="text-center">
										<button type="button" class="btn btn-blue-2 btn-sm"
											title="View"
											onclick="modifyCase(${dto.egId},'EquityGrantRequest.html','EDIT','V')">
											<i class="fa fa-eye"></i>
										</button>  <c:if test="${dto.appStatus eq 'REJECTED'}"> 
										<button type="button" class="btn btn-warning btn-sm"
											title="Edit"
											onclick="modifyCase(${dto.egId},'EquityGrantRequest.html','EDIT','E')">
