...
<div class="content animated top">
	<div class="widget">
		<div class="widget-header">
			...
			<apptags:helpDoc url="MilestoneCompletionApproval.html"></apptags:helpDoc>
		</div>

		<div class="widget-content padding">
			<form:form id="MilestoneCompletionApproval"
				action="MilestoneCompletionApproval.html" method="post"
				...
				<div class="text-center padding-top-10">
						...
						<button type="button" class="btn btn-success"
							...
							onclick="saveMilestoneCompletionApprovalData(this);">
