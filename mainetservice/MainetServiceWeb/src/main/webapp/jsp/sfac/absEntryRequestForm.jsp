...
table#absEntryTable tbody tr th.text-left {
	text-align: left;
}
...
table#absEntryTable>thead>tr:nth-child(2)>th:nth-child(1), table#absEntryTable>thead>tr:nth-child(2)>th:nth-child(2)
	{
	width: 5.8rem;
}
table
...
<div class="content animated top">
	<div class="widget">
		...
		<div class="widget-content padding">
			<form:form id="ABSEntryForm" action="ABSEntryForm.html" method="post"
