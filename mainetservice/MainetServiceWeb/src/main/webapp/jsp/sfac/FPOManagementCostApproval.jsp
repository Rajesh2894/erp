...
<div class="content animated top">
	<div class="widget">
		<div class="widget-header">
			...
			<apptags:helpDoc url="FPOManagementCostApproval.html"></apptags:helpDoc>
		</div>

		<div class="widget-content padding">
			<form:form id="fpoMgmtCostForm" action="FPOManagementCostApproval.html"
						...
						<div id="FPODetails" class="panel-collapse collapse in">
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<form:input path="dto.foFpoMasterDto.fpoName" id="fpoName$"
							...
							<c:forEach items="${command.masterDtoList}" var="dto">
								<form:option value="${dto.fpoId}">${dto.fpoName}</form:option>
									...
									<div class="col-sm-4">
										<form:input path="dto.foFpoMasterDto.cbboName" id="cbboName"
											class="form-control " disabled="true" />
							...
							<c:forEach items="${command.cbboMasterList}" var="cbbo">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<form:input path="dto.foFpoMasterDto.iaName" id="iaName"
											class="form-control " disabled="true" />
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" class="collapsed"
									...
									<spring:message code="sfac.fpo.mgmtCost"
										text="Management Cost Details" />
								</a>
							</h4>
						</div>
						<div id="mcDetails" class="panel-collapse collapse">
							<div class="panel-body">
									...
									<thead>
										<tr>
											...
											<th width="15%"><spring:message
													code="sfac.fpo.mc.particulars" text="Particulars" /></th>

											<th><spring:message code="sfac.fpo.mc.mce"
													text="Management cost Expected" /></th>
											...
											<c:when
												...
												<c:forEach var="dto"
													...
													<tr class="appendableMCDetails">
														...
														<td><form:input
																path="dto.fpoManagementCostDetailDTOs[${d}].managementCostIncurred"
																disabled="${command.viewMode eq 'V' ? true : false }"
																id="managementCostIncurred${d}"
																class="form-control hasAmount " /></td>



														<td class="text-center"><c:if
																test="${command.viewMode ne 'V'}">
																<a class="btn btn-blue-2 btn-sm addCostButton"
																	title='<spring:message code="sfac.fpo.add" text="Add" />'
																	onclick="addCostButton(this);"> <i
																	class="fa fa-plus-circle"></i></a>
																<a class='btn btn-danger btn-sm deleteCostDetails '
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" class="collapsed"
									...
									<spring:message code="sfac.fpo.mc.docDetails"
										text="Document Details" />
								</a>
							</h4>
						</div>
						<div id="docDetails" class="panel-collapse collapse">
							<div class="panel-body">
								<c:set var="d" value="0" scope="page"></c:set>
								<table
									class="table table-bordered table-striped contact-details-table"
											...
											<c:when
												...
												<c:forEach var="dto"
													...
													<tr class="appendableDocDetails">
														...
														<td><form:input
																path="dto.fpoManagementCostDocDetailDTOs[${d}].documentDescription"
																disabled="${command.viewMode eq 'V' ? true : false }"
																id="documentDescription${d}" class="form-control " /></td>
														...
														<td class="text-center"><c:if
																test="${command.viewMode ne 'V'}">
																<a class="btn btn-blue-2 btn-sm addDocButton"
																	title='<spring:message code="sfac.fpo.add" text="Add" />'
																	onclick="fileCountUpload(this);"> <i
																	class="fa fa-plus-circle"></i></a>
																<a class='btn btn-danger btn-sm deleteDocDetails '
																	title='<spring:message code="sfac.fpo.delete" text="Delete" />'
				...
				<div class="text-center padding-top-10">
					<button type="button" align="center" class="btn btn-green-3"
						...
						onclick="saveFPOManagementCostApprovalData(this);">
