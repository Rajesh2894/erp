...
<div class="content animated top">
	<div class="widget">
		...
		<div class="widget-content padding">
			<form:form id="FundReleaseRequestForm"
				action="FundReleaseRequestForm.html" method="post"
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<form:input path="dto.fileReferenceNumber" disabled="${command.viewMode eq 'V' ? true : false }"
											id="fileReferenceNumber" class="form-control alphaNumeric" maxlength="50" />
									</div>
								...
								<table
									...
									<thead>
										<tr>
											...
											<th ><spring:message code="sfac.fund.release.req.utilized.amount"
													text="Utilized Amount" /></th>
											<th><spring:message code="sfac.fund.release.req.newDemand" text="New Demand" /></th>
											<th width="15%"><spring:message code="sfac.fund.release.req.utlization.report" text="Upload Utilization Report" /></th>
											...
											<c:when
												...
												<c:forEach var="dto"
													...
													<tr class="appendableNewDemandetails">
														...
														<td><div><c:set var="baseLookupCode" value="PDF" /> <form:select
														...
														<td><form:input
																...
																readonly="true" id="allocatedNoOfFPO${d}" class="form-control" /></td>
															<td><form:input
														...
														<td><form:input
																path="dto.fundReleaseRequestDetailDtos[${d}].newDemand"
																 id="newDemand${d}" class="form-control" onblur="calculateTotal('${d}');"
																 disabled="${command.viewMode eq 'V' ? true : false }"
																 onkeypress="return hasAmount(event, this, 10, 2)"/></td>
															<td>
															...
															<apptags:formField
														fieldType="7"
														fieldPath="dto.fundReleaseRequestDetailDtos[${d}].attachments[0].uploadedDocumentPath"
													...
													validnFunction="ALL_UPLOAD_VALID_EXTENSION">
														...
														<td class="text-center"><c:if
																...
																<a class='btn btn-danger btn-sm deleteNewDemandDetails '
																	...
																	onclick="deleteNewDemandDetails($(this),${d});"> <i
																	class="fa fa-trash"></i>
																</a>
															</c:if></td>
				...
				<div class="text-center padding-top-10">
					<c:if test="${command.viewMode ne 'V'}">
						<button type="button" class="btn btn-success"
							...
							onclick="saveFundRelaseRequestForm(this);">
					...
					<apptags:backButton url="FundReleaseRequestForm.html"></apptags:backButton>
				</div>
