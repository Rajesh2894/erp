	...
	<div class="content animated top">
		<div class="widget">
			...
			<div class="text-center"> 
						<button type="button" class="btn btn-success text-center" title="Search"
							onclick="searchBirthData(this)" text-align = "center">
							
							<spring:message code="BirthRegDto.search"/>
						</button>
						<button type="button" class="btn btn-warning btn-yellow-2 text-center"
							title="Reset"
