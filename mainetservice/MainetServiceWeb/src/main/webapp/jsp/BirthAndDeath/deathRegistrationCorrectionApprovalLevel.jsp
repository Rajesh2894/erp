		...
		<div class="widget">
			...
			<div class="widget-content padding">
				<form:form id="frmDeathRegCorrForm"
					action="DeathRegCorrectionApprovalLevel.html" method="POST"
													...
													<c:forEach items="${command.fetchDocumentList}"
														...
														<tr>
															...
															<td align="center"><apptags:filedownload
																	...
																	actionUrl="DeathRegCorrectionApprovalLevel.html?Download">
				...
				<c:if test="${command.saveMode ne null && command.saveMode eq 'V'}">
				<c:if test="${command.sendBackRemark ne null}">
				<div class="form-group">
				 <apptags:textArea
								labelCode="TbDeathregDTO.form.remark" isMandatory="true" isDisabled="true"
								path="sendBackRemark" cssClass="hasNumClass form-control"
								maxlegnth="100" />
				</div>
				</c:if>
					<div class="form-group">
					...
					<div class="text-center">
					     <c:choose>
							<c:when test="${command.saveMode ne null && command.saveMode eq 'V'}">
