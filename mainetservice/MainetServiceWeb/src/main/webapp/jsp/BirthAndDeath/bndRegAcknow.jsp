			...
			<form action="" method="get" class="bnd-acknowledgement">
				...
				<div class="row margin-bottom-10 margin-left-0 margin-right-0">
					...
					<div class="col-xs-9 col-sm-10">
						:<span class="margin-left-20">${command.ackDto.applicantTitle} ${command.ackDto.applicantName}</span>
					</div>
				</div>
				...
				<div class="row margin-bottom-10 margin-left-0 margin-right-0">
					...
					<div class="col-xs-9 col-sm-10">
						:<span class="margin-left-20"></span><span>${command.ackDto.serviceShortCode}</span>
					</div>
				</div>
