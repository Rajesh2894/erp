...
<script type="text/javascript" src="js/birthAndDeath/birthRegistration.js"></script>
<script type="text/javascript" src="js/birthAndDeath/birthRegistrationApproval.js"></script>
	...
	<div class="content animated top">
		<div class="widget">
			<div class="widget-header">
				<h2>
					<spring:message code="BirthRegistrationDTO.form.name" text="Birth Registration Form" />
				</h2>
			...
			<div class="widget-content padding">
				<form:form id="frmBirthRegApproval"
					action="BirthRegApproval.html" method="POST"
					...
					<div class="form-group">
						...
						<apptags:lookupField
							...
							datePath="birthRegDto.brDob"  isDisabled="true" >
						</apptags:date>
					...
					<div class="form-group">
						<apptags:input labelCode="Parent’s Permanent Address"
						...
						<apptags:input labelCode="Parent’s Permanent Address (Regional)"
					...
					<div class="form-group">
						...
						<label class="control-label col-sm-2 required-control"
							for="Census"> <spring:message code="bnd.ward" text="WARD" />
						</label>
					...
					<div class="form-group">
							...
							datePath="birthRegDto.brRegDate"  isDisabled="true" >
						</apptags:date>
				...
				maxlegnth="100" />
					...
					<div class="text-center">
						...
						<!-- <button type="button" class="btn btn-warning btn-yellow-2"
							title="Submit" onclick="resetBirthData(this)">
							Reset
						</button> -->
