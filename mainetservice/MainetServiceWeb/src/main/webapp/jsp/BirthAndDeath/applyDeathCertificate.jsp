...
<script type="text/javascript" src="js/birthAndDeath/applyDeathCertificate.js"></script>
...
<div class="pagediv">
	...
	<div class="widget">
		<div class="widget-header">
			<h2>
				<b><spring:message code="rts.deathcertapplform"
						text="Death Certificate Application Form" /></b>
			</h2>
		...
		<div class="widget-content padding">
			<form:form id="frmDeathCertificateForm"
				action="applyForDeathCertificates.html" method="POST"
							...
							<div id="deathRegCor-1" class="panel-collapse collapse in">
								<div class="panel-body">
									<div class="form-group">
										...
										<c:if test="${command.saveMode ne 'V' && command.deathCertificateDTO.chargeStatus eq 'CA' }">
											<label for="amount"
													...
													<c:forEach items="${command.checkList}" var="lookUp"
														...
														<tr>
													        ...
													        class="form-control" id="docTypeSelect_${lk.index}">
													         ...
													         <c:forEach items="${command.getLevelData('UDN')}" var="docLookup">	
								...
								<c:forEach items="${command.checkList}" var="lookUp">
									<tr>
										...
										<td align="center"><apptags:filedownload
												...
												actionUrl="applyForDeathCertificates.html?Download" >
				...
				<div class="text-center">
					<c:if test="${command.saveMode ne 'V'}">
						<button type="button" value="<spring:message code="bt.save"/>"
							...
							onclick="saveDeathCertificateData(frmDeathCertificateForm)">
