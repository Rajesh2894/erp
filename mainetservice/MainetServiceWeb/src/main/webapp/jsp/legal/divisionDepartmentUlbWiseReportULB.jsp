...
<script src="js/legal/divisionDepartmentUlbWiseReportULB.js"></script>
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="lgl.ulb.form"
					text="Division Department UlbWise Report" />
			</h2>
		</div>
		<div class="widget-content padding">
			...
			<form:form action="UlbDivisionDepartment.html"
				cssClass="form-horizontal" id="divisionULBForm">
				...
				<div class="form-group">
					...
					<div class="radio col-sm-4 margin-top-5">
						<label> <form:radiobutton path="legalReport.csereportName"
								...
								code="lgl.division.Department.ulb.report"
								...
								code="lgl.division.ulbwise.ulb.report"
