...
<script src="js/legal/caseImplDetailsReport.js"></script>
...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code=""
					text="Case Implementation Details Report" />
			</h2>
		</div>
		...
		<div class="widget-content padding">
			...
			<form:form action="CaseImplementationDetailsReport.html"
				cssClass="form-horizontal" id="caseImplDetailsReport">
	 	...
	 	<div class="form-group">
				...
				<div class="padding-top-10 text-center">
					...
					<button type="Reset" class="btn btn-warning" id="resetForm"
						onclick="window.location.href='CaseImplementationDetailsReport.html'">
