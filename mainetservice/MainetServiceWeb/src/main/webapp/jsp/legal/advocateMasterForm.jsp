		...
		<div class="widget-content padding">
			...
			<form:form action="AdvocateMaster.html" name="AdvocateMaster"
				...
				<div class="form-group">
					...
					<label for="text-1" class="control-label col-sm-2"><spring:message
							code="lgl.appointment.endDate" text="Appointment End Date" /></label>
					<div class="col-sm-4">
						<div class="input-group">
				...
				<div class="form-group">
					...
					<%-- <apptags:input labelCode="lgl.advocate.fee.amount" path="advocateMasterDTO.advFeeAmt"  onBlur="return hasAmount(event,this,12,2)"></apptags:input> --%>
