...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="legal.case.tracker.report"
					text=" Case Tracker Report" />
			</h2>
		</div>
			...
			<form:form action="ResponseSheetReport.html"
				...
				<div class="form-group">
					<apptags:date labelCode="legal.casePendency.active.from.date"
						datePath="legalReport.csefrmDate" 
					...
					<apptags:date labelCode="legal.casePendency.active.to.date"
						datePath="legalReport.csetoDate" 
						cssClass="form-control" fieldclass="datepicker"
						></apptags:date>
				<%-- 	<label class="col-sm-2 control-label required-control"> <spring:message
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label required-control"
						for="inwardType"> <spring:message code="legal.case.status"
				...
				<div class="padding-top-10 text-center">
					<button type="button" class="btn btn-success btn-submit" id="save"
						onclick="saveCaseTrackerForm(this)">
