			...
			<form:form action="ShiftMaster.html" method="POST"
				...
				<div class="form-group">
					<label class="control-label col-sm-2 required-control" for="">
						<spring:message code="ShiftMasterDTO.currentShiftId" text="Current Shift" />
					</label>
				...
				<div class="form-group">
					<apptags:input labelCode="ShiftMasterDTO.fromTime"
						path="shiftMasterDTO.fromTime"
						isDisabled="${command.saveMode eq 'V'}" isMandatory="true" maxlegnth="5"
						cssClass="hasNumber mandColorClass" />

					<apptags:input labelCode="ShiftMasterDTO.toTime"
						path="shiftMasterDTO.toTime"
						isDisabled="${command.saveMode eq 'V'}" isMandatory="true" maxlegnth="5"
						cssClass="hasNumber mandColorClass" />
				...
				<div class="form-group">
					...
					<apptags:radio radioLabel="ShiftMasterDTO.yes,ShiftMasterDTO.no"
						...
						defaultCheckedValue="N" disabled="${command.saveMode eq 'V' }" />
				...
				<div class="form-group">
					<apptags:radio
						...
						defaultCheckedValue="A" disabled="${command.saveMode eq 'V' }" />
				</div> 
				</c:if>
				...
				<div class="text-center clear padding-10">
					...
					<c:if test="${command.saveMode eq 'A'}">
						<button type="Reset" class="btn btn-warning"
							...
							<spring:message code="ShiftMasterDTO.form.reset" text="Reset"></spring:message>
						</button>
					</c:if>
