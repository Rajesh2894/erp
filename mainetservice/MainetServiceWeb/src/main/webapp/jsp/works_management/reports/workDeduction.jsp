...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="work.deduction.report" text="Deduction Report" />
			</h2>
			<div class="additional-btn">
				                <apptags:helpDoc url="DeductionReport.html"></apptags:helpDoc>
		...
		<div class="widget-content padding">
			...
			<form:form action="DeductionReport.html" class="form-horizontal"
				id="deductionReport" name="deductionReport">
