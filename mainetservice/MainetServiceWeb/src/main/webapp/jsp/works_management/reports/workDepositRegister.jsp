...
<div class="content">
	<div class="widget">
		<div class="widget-header">
			<h2>
				<spring:message code="work.deposit.refund.report"
					text="Deposit Refund Liability Register" />
			</h2>
		...
		<div class="widget-content padding">
			...
			<form:form action="DepositRefundLibilityRegisterReport.html"
				class="form-horizontal" id="depositRegisterReport"
				name="depositRegisterReport">
				...
				<div class="text-center padding-bottom-10">
					<button class="btn btn-success " type="button"
						onclick="viewDepositRegisterReport();">
