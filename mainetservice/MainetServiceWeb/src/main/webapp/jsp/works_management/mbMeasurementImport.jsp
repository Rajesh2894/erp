...
<div xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<script src="js/works_management/measurementBook.js"></script>
	...
	<div class="widget" id="widget">
		<div class="widget-header">
			...
			<h2>
				<spring:message code="" text="Measurement Sheet" />
			</h2>
		...
		<div class="widget-content padding">
			...
			<form:form class="form-horizontal" id="tbAcBudgetCode"
				...
				method="POST" action="MeasurementBook.html">
				...
				<div class="text-center padding-top-20" id="savebutton">
					...
					<input type="button" id="Reset"
						...
						onclick="exportTemplate();" value="Reset"></input>
					<button type="button" class="btn btn-danger back"
						onclick="measurementSheet();">
