...
<div xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<script src="js/account/generalbank/bankMasterUpload.js"></script>
	...
	<div class="widget" id="widget">
		<div class="widget-header"
			<h2>
				<spring:message code="bank.master.title" text="Bank Master" />
			</h2>
		...
		<div class="widget-content padding">
			<form:form class="form-horizontal" id="tbBankMaster"
				modelAttribute="tbBankMaster" cssClass=" form-horizontal"
				method="POST" action="GeneralBankMaster.html">
				...
				<spring:hasBindErrors name="tbBankMaster">
				...
				<div class="form-group text-center" id="reload">
					...
					<div class="col-sm-3 text-left">
						...
						<small class="text-blue-2"><spring:message
								code="store.master.excel.upload.max" text="(Upload Excel upto 5MB )" /></small>
					</div>
					...
					<div class="col-sm-3 text-left">
						<button type="button" class="btn btn-success save"
							...
							id="import">
							<spring:message code="material.item.master.downloadtemplete"
				...
				<div class="text-center padding-top-20" id="savebutton">
					...
					<input type="button" id="Reset"
						...
						value="<spring:message code="material.management.reset" text="Reset"/>"></input> <input
						type="button" class="btn btn-danger"
						onclick="javascript:openRelatedForm('GeneralBankMaster.html');"
