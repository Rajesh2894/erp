...
@Entity
@Table(name = "tb_fm_vehicle_log_book")
public class FmVehicleLogBook implements Serializable {
	/**
	 * 
	 */
	...
	@Column(name = "typeOfVehicle", precision = 15)
	...
	public static String[] getPkValues() {
		return new String[] { "FI", "vehicle_log_book", "CASHDEP_DET_ID" };
	}
