 ...
 *//*
@Entity
@Table(name = "TB_FM_VEHICLE_DET")
public class FmVehicleMasterDet implements Serializable {
    ...
    private FmVehicleMaster tbSwVehicleMaster;

    public FmVehicleMasterDet() {
    }
    ...
    public FmVehicleMaster getTbSwVehicleMaster() {
        return tbSwVehicleMaster;
    }

    public void setTbSwVehicleMaster(FmVehicleMaster tbSwVehicleMaster) {
