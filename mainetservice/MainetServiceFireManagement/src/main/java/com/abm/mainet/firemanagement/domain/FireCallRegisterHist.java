 ...
 */
@Entity
@Table(name = "tb_fm_complain_register_hist")
public class FireCallRegisterHist implements Serializable {
	...
	@Column(name = "cmplnt_id_h", unique = true, nullable = false)
	private Long cmplntHid;
	...
	@Column(name="h_status", length=100)
	 ...
	 */
	public void setCpdFireStation(Long cpdFireStation) {
	...
	/**
	 * @return the cmplntHid
	 */
	public Long getCmplntHid() {
		return cmplntHid;
	}

	/**
	 * @param cmplntHid the cmplntHid to set
	 */
	public void setCmplntHid(Long cmplntHid) {
		this.cmplntHid = cmplntHid;
	}
	...
	public String[] getPkValues() {
		return new String[] { "FM", "TB_FM_COMPLAIN_REGISTER_HIST", "CMPLNT_ID_H" };
	}
