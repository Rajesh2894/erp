 ...
 *//*
@Entity
@Table(name = "TB_FM_CONTVEND_MAPPING_HIST")
public class FmVendorContractMappingHistory implements Serializable {
    ...
    public FmVendorContractMappingHistory() {
    }
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_FM_CONTVEND_MAPPING_HIST", "MAP_ID_H" };
    }
}*/