 ...
 */
@Entity
@Table(name = "TB_VM_VEHICLE_SCHEDULING_HIST")
public class VehicleScheduleHist implements Serializable {
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "VM", "TB_VM_VEHICLE_SCHEDULING_HIST", "VES_ID_H" };
    }
}