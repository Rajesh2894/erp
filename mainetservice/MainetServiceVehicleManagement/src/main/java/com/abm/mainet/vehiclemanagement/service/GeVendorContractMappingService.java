...
import com.abm.mainet.vehiclemanagement.domain.VmVendorContractMappingHistory;
import com.abm.mainet.vehiclemanagement.dto.VendorContractMappingDTO;
import com.abm.mainet.vehiclemanagement.mapper.GeVendorContractMappingMapper;
import com.abm.mainet.vehiclemanagement.repository.GeVendorContractMappingRepository;
 ...
 */
@Service
public class GeVendorContractMappingService implements IVendorContractMappingService {

    /** The vehicle master repository. */
    @Autowired
    private GeVendorContractMappingRepository vendorContractMappingRepository;

    /** The vehicle master mapper. */
    @Autowired
    private GeVendorContractMappingMapper vendorContractMappingMapper;
    ...
    public void delete(Long vendorContractMappingId, Long empId, String ipMacAdd) {
        VmVendorContractMapping master = vendorContractMappingRepository.findOne(vendorContractMappingId);
     ...
     */
    private VmVendorContractMapping mapped(VendorContractMappingDTO vendorContractMappingDetails) {
        VmVendorContractMapping master = vendorContractMappingMapper
    ...
    public VendorContractMappingDTO save(VendorContractMappingDTO vendorContractMappingDetails) {
        VmVendorContractMapping master = mapped(vendorContractMappingDetails);
    ...
    public List<VendorContractMappingDTO> save(List<VendorContractMappingDTO> vendorContractMappingDTOList) {
        List<VmVendorContractMapping> masterList = vendorContractMappingMapper
        ...
        masterList.forEach(master -> {
            VmVendorContractMappingHistory masterHistory = new VmVendorContractMappingHistory();
     ...
     */
    private void saveVendorHistory(VmVendorContractMapping master, String status) {
        VmVendorContractMappingHistory masterHistory = new VmVendorContractMappingHistory();
