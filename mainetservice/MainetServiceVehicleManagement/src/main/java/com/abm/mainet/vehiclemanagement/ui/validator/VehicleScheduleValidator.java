...
@Component
public class VehicleScheduleValidator extends BaseEntityValidator<VehicleScheduleDTO> {
    @Override
    protected void performValidations(VehicleScheduleDTO entity,
        ...
        if (entity.getTbSwVehicleScheddets() != null && !entity.getTbSwVehicleScheddets().isEmpty()) {
			/*
			 * for (VehicleScheduleDetDTO detDto : entity.getTbSwVehicleScheddets()) { if
			 * (detDto.getStartime() != null) {
			 * entityValidationContext.rejectIfEmpty(detDto.getStartime(), "startime"); } if
			 * (detDto.getEndtime() != null) {
