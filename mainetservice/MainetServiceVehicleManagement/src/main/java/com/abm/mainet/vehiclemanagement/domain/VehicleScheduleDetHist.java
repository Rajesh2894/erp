 ...
 */
@Entity
@Table(name = "TB_VM_VEHICLE_SCHEDDET_HIST")
public class VehicleScheduleDetHist implements Serializable {
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_VM_VEHICLE_SCHEDDET_HIST", "VESD_ID_H" };
    }
