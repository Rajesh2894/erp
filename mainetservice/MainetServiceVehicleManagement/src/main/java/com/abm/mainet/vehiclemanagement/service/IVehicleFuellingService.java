...
public interface IVehicleFuellingService {
    ...
    void deleteVehicleDet(Long vefID,Long vefdId,Long empId, String ipMacAdd);
	...
	List<VehicleFuellingDTO> getVehicleFuellingByVefIdsAndPumpId(List<Long> vefIdList, Long puId, Long orgId);
