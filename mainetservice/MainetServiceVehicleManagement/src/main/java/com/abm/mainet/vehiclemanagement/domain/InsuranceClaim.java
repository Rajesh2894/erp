...
@Entity
@Table(name="tb_vm_insurance_Claim")
public class InsuranceClaim implements Serializable{
	...
	@Column(name = "insurance_Claim_Id", unique = true, nullable = false)
	...
	@Column(name = "claim_approved_amt")
	...
	public String[] getPkValues() {
		return new String[] { "VM", "tb_vm_insurance_Claim", "insurance_Claim_Id" };
	}
