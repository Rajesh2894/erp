...
/**
 * The persistent class for the TB_VM_VEHICLEFUEL_INREC_HIST database table.
 * 
 * @author Lalit.Prusti
 *
 ...
 */
@Entity
@Table(name = "TB_VM_VEHICLEFUEL_INREC_HIST")
public class VmVehicleFuelReconciationHistory implements Serializable {
    ...
    public VmVehicleFuelReconciationHistory() {
    }
