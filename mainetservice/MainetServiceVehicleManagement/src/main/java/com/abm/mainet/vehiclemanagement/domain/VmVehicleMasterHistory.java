 ...
 */
@Entity
@Table(name = "TB_VM_VEHICLE_MAST_HIST")
public class VmVehicleMasterHistory implements Serializable {
    ...
    @Column(name = "VE_FUEL_CAPACITY",  precision = 10, scale = 2)
    private BigDecimal veFuelCapacity;

    public VmVehicleMasterHistory() {
    }
