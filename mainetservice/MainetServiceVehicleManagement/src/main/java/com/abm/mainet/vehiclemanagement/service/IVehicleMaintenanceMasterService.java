...
public interface IVehicleMaintenanceMasterService {
	 ...
	 * @return
	 */
	List<VehicleMaintenanceMasterDTO> serchVehicleMaintenanceByveDowntimeAndveDowntimeUnit(Long vehicleType,
			Long orgId);
	 ...
	 * @return
	 */
	List<VehicleMaintenanceMasterDTO> serchVehicleMaintenance(Long vehicleType, Long vehId, Long orgId);

	void savePSCLVehicleMaintenanceMaster(VehicleMaintenanceMasterDTO vehicleMaintenanceMasterDTO);

	void preventiveVehicleMaintenanceAlert(QuartzSchedulerMaster runtimeBean, List<Object> parameterList);
