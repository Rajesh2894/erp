 ...
 */
@Entity
@Table(name = "TB_VEHICLE_DET")
public class VehicleMasterDetails implements Serializable {
    ...
    private VeVehicleMaster tbSwVehicleMaster;

    public VehicleMasterDetails() {
    }
    ...
    public VeVehicleMaster getTbSwVehicleMaster() {
        return tbSwVehicleMaster;
    }

    public void setTbSwVehicleMaster(VeVehicleMaster tbSwVehicleMaster) {
        this.tbSwVehicleMaster = tbSwVehicleMaster;
    }

    public String[] getPkValues() {
        return new String[] { "VM", "TB_VEHICLE_DET", "VED_ID" };
    }
}
