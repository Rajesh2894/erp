...
public interface IVehicleScheduleService {
    ...
    String vehicleScheduleValidate(VehicleScheduleDTO vehicleScheduleDto);
     ...
     */
	/*
	 * VehicleFuellingDTO findFuelExpenditureDetails(Long orgId, Long veVetype, Long
	 * veNo, Date fromdate, Date todate, Long pumpId);
	 */
    /**
     * find Fuel Expenditure Details
    ...
    void deleteVehicleScheduleDet(Long vehicleScheduleId,Long vehicleScheduleDetId, Long empId, String ipMacAdd);
