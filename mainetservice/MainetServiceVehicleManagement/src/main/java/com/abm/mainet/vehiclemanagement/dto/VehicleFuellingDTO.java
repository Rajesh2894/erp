...
public class VehicleFuellingDTO implements Serializable {
    ...
    private Long veEmpId;
    
    private Date vePurchaseDt;
    private Date veRentFromDt;
    private Date veRentToDt;
    private String veDeptFlag;
    
    private String vehiclePurchaseDate;
    private String vehicleFromDate;
    private String vehicleToeDate;
    ...
    public Date getVePurchaseDt() {
		return vePurchaseDt;
	}

	public void setVePurchaseDt(Date vePurchaseDt) {
		this.vePurchaseDt = vePurchaseDt;
	}

	public Date getVeRentFromDt() {
		return veRentFromDt;
	}

	public void setVeRentFromDt(Date veRentFromDt) {
		this.veRentFromDt = veRentFromDt;
	}

	public Date getVeRentToDt() {
		return veRentToDt;
	}

	public void setVeRentToDt(Date veRentToDt) {
		this.veRentToDt = veRentToDt;
	}

	public String getVeDeptFlag() {
		return veDeptFlag;
	}

	public void setVeDeptFlag(String veDeptFlag) {
		this.veDeptFlag = veDeptFlag;
	}

	public Long getVeEmpId() {
		return veEmpId;
	}

	public void setVeEmpId(Long veEmpId) {
		this.veEmpId = veEmpId;
	}
	...
	public String getVehicleToeDate() {
		return vehicleToeDate;
	}

	public void setVehicleToeDate(String vehicleToeDate) {
		this.vehicleToeDate = vehicleToeDate;
	}
