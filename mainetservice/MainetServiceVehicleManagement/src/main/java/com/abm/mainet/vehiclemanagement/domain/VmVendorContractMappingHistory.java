 ...
 */
@Entity
@Table(name = "TB_VM_CONTVEND_MAPPING_HIST")
public class VmVendorContractMappingHistory implements Serializable {
    ...
    public VmVendorContractMappingHistory() {
    }
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_VM_CONTVEND_MAPPING_HIST", "MAP_ID_H" };
    }
}