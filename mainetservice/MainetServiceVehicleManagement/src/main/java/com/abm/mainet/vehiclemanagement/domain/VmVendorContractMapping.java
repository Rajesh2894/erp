 ...
 */
@Entity
@Table(name = "TB_VM_CONTVEND_MAPPING")
public class VmVendorContractMapping implements Serializable {
    ...
    public VmVendorContractMapping() {
    }
    ...
    public String[] getPkValues() {
        ...
        return new String[] { "SWM", "TB_SW_CONTVEND_MAPPING", "MAP_ID" };
    }
}