 ...
 */
@Repository
public interface GeVendorContractMappingRepository extends JpaRepository<VmVendorContractMapping, Long> {
     ...
     * @return
     */
    List<VmVendorContractMapping> findByContIdAndOrgid(Long contId, Long orgid);
