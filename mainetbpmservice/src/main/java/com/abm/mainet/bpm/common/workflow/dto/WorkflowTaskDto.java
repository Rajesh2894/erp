...
public class WorkflowTaskDto implements Serializable {
    ...
    private List<WorkflowActionDto> workFlowActionList = new ArrayList<>();
    ...
    public List<WorkflowActionDto> getWorkFlowActionList() {
        return workFlowActionList;
    }

    public void setWorkFlowActionList(List<WorkflowActionDto> workFlowActionList) {
