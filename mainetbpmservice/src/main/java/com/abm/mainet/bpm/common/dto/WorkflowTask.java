...
public class WorkflowTask implements Serializable {
    ...
    private Set<Long> correlatedTaskIds = new HashSet<>();
    ...
    public Set<Long> getCorrelatedTaskIds() {
        return correlatedTaskIds;
    }

    public void setCorrelatedTaskIds(Set<Long> correlatedTaskIds) {
        this.correlatedTaskIds = correlatedTaskIds;
    }
