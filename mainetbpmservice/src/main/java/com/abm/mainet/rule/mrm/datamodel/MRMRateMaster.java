package com.abm.mainet.rule.mrm.datamodel;
...
public class MRMRateMaster extends CommonModel implements Serializable {

    private static final long serialVersionUID = 690437497966577311L;
    private long taxId;
    ...
    public MRMRateMaster() {
        taxType = MainetConstants.Common.NA;
        parentTaxCode = MainetConstants.Common.NA;
        taxCode = MainetConstants.Common.NA;
        taxCategory = MainetConstants.Common.NA;
        taxSubCategory = MainetConstants.Common.NA;
        slab1 = 0l;
        slab2 = 0l;
        slab3 = 0l;
        slabRate1 = 0.0d;
        ...
        flatRate = 0.0d;
        percentageRate = 0.0d;
        chargeApplicableAt = MainetConstants.Common.NA;
        rateStartDate = 0;
    }
    ...
    public long getRateFromDate(String rateFromDate) throws ParseException {
        SimpleDateFormat dateFormatter = new SimpleDateFormat(MainetConstants.Common.DATE_FORMAT);
