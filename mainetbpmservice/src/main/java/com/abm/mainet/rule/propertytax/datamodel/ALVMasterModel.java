...
public class ALVMasterModel extends CommonModel {
    ...
    private double additionalALVRate;
    ...
    //#16298 Added on behalf of srikanth
    ...
    public String toString() {
        return "ALVMasterModel [constructionClass=" + constructionClass + ", occupancyFactor=" + occupancyFactor
                + ", roadType=" + roadType + ", taxableArea=" + taxableArea + ", ageFactor=" + ageFactor + ", floorNo="
                + floorNo + ", rateStartDate=" + rateStartDate + ", arvStdRate=" + arvStdRate + ", arv=" + arv + ", rv="
                + rv + ", cv=" + cv + ", multiplicationFactor=" + multiplicationFactor + ", sddrRate=" + sddrRate
                ...
                + ", constructionCompletionDate=" + constructionCompletionDate + ", monthlyRent=" + monthlyRent
                + ", multiplicationFactorTax=" + multiplicationFactorTax + ", propertyIsMixed=" + propertyIsMixed
                + ", factor=" + factor + "]";
    }
	...
	public void setSlab(final double slab1, final double slab2, final double slab3,
            final double slab4, final double slab5) {
