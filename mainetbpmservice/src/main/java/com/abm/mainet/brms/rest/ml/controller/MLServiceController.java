package com.abm.mainet.brms.rest.ml.controller;
...
import com.abm.mainet.brms.rest.ml.service.IMLService;
...
public class MLServiceController {
    ...
    @RequestMapping(value = "/getNewTradeLicenseFee", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<WSResponseDTO> doGetNewTradeLicenseFee(@RequestBody WSRequestDTO requestDTO) {
        WSResponseDTO responseDTO = null;
        try {
            responseDTO = mlService.getNewTradeLicenseFee(requestDTO);
