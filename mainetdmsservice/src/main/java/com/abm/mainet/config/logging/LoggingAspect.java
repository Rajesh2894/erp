...
public class LoggingAspect {
     ...
     */
    @Pointcut("within("
            + "com.abm.mainet.*.service.* || "
            + "com.abm.mainet.*..service.* || "
            + "com.abm.mainet.*..service.impl.* || "
            + "com.abm.mainet.dms.utility.* || "
            + "com.abm.mainet.*.repository.* || "
            + "com.abm.mainet.*..controller.* || "
            + "com.abm.mainet.util.* || "
            + "com.abm.mainet.common.exception.* || "
            + "com.abm.mainet.config.logging.* || "
            + "com.abm.mainet.*.utility.*)")
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        log.info(
                MainetConstants.LOGGING.START_TIME_METHOD_NAME + getMethodName(joinPoint)
                        + MainetConstants.LOGGING.START_TIME_MILLI_SECOND
                        + getDuration(start));
        Object result;
        try {
        ...
        log.info(MainetConstants.LOGGING.END_TIME_METHOD_NAME + getMethodName(joinPoint)
                + MainetConstants.LOGGING.END_TIME_MILLI_SECOND
                + getDuration(start));
        return result;
    }
